...
// ********************************************************************
//
// $Id: Tst52ElectronPenelope.cc,v 1.1 2007-04-12 12:00:17 guatelli Exp $
...
Tst52ElectronPenelope::Tst52ElectronPenelope(const G4String& name): 
G4VPhysicsConstructor(name)
{ 
 G4cout<< "Electron Penelope Processes initialized !!!!" << G4endl;
 facValue = 0.02;//default value
}

Tst52ElectronPenelope::~Tst52ElectronPenelope()
{ }

void Tst52ElectronPenelope::ConstructProcess()
{
...
void Tst52ElectronPenelope::SetFacRange(G4double value)
{
 facValue = value;
