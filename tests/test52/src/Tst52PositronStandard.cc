...
// ********************************************************************
//
// $Id: Tst52PositronStandard.cc,v 1.1 2007-04-12 12:00:17 guatelli Exp $
...
Tst52PositronStandard::Tst52PositronStandard(const G4String& name): G4VPhysicsConstructor(name)
{
 G4cout<< "Positron Standard Processes initialized !!!!" << G4endl;
 facValue = 0.02;//default value 
}

Tst52PositronStandard::~Tst52PositronStandard()
{ }

void Tst52PositronStandard::ConstructProcess()
{
...
void Tst52PositronStandard::SetFacRange(G4double value)
{
 facValue = value;
