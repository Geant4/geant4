...
// ********************************************************************
//
// $Id: EventAction.cc,v 1.1 2009-11-27 16:06:28 mkossov Exp $
...
EventAction::EventAction(RunAction* RA, HistoManager* histo)
  : runaction(RA), histoManager(histo), drawFlag("none"), printModulo(10000)
{
...
void EventAction::BeginOfEventAction(const G4Event* evt)
{
 ...
 if( !(evtNb%printModulo) ) G4cout<<"EventAction::BeginOfEventAction: ev# "<<evtNb<<G4endl;

 // initialisation
 EnergyDeposit  = TrakLenCharged = TrakLenNeutral = 0.; 
 nbStepsCharged = nbStepsNeutral = TransmitFlag   = ReflectFlag = 0;    
}
...
void EventAction::EndOfEventAction(const G4Event* evt)
{
 ...
 // histoManager->FillHisto(1, EnergyDeposit); // Not defined
