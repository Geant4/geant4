...
// ********************************************************************
//
// $Id: RunAction.cc,v 1.1 2009-11-27 16:06:28 mkossov Exp $
...
{
  G4cout<<"RunAction::BeginOfRunAction: run# "<<aRun->GetRunID()<<" starts"<< G4endl;
  fTimer.Start();
  //initialisation
...
void RunAction::EndOfRunAction(const G4Run* aRun)
{
  ...
  // print histograms
  histoManager->SaveHisto();

  fTimer.Stop();
  G4cout<<"RunAction::EndOfRunAction: timeOfRun = "<<fTimer.GetUserElapsed()<<" s"<<G4endl;
