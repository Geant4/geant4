...
//
//
// $Id: Tst65DetectorMessenger.cc,v 1.1 2010-11-24 15:15:29 tkoi Exp $
...
Tst65DetectorMessenger::Tst65DetectorMessenger(Tst65DetectorConstruction * myDC)
:myDetector(myDC)
{
  G4String defParam;
...
Tst65DetectorMessenger::~Tst65DetectorMessenger()
{
  delete selMatCmd;
  delete mydetDir;
}

void Tst65DetectorMessenger::SetNewValue(G4UIcommand * command,G4String newValues)
{
