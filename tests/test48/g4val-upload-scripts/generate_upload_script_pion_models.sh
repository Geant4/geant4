...
script=${testname}-upload-piminus-models.xml
...
printf "<observable>kinetic energy of seconadry neutron</observable>\n" >> ${script}
...
printf "<imageblob>pim-${target[$i]}-models.gif</imageblob>\n" >> ${script}
