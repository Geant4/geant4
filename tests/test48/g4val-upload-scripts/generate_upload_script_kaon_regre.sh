...
#
# usage:
# source generate_upload_script_kaon_regre.sh geant4-10.00-ref08 internal
#
...
script=${testname}-upload-kminus-regre.xml
...
printf "<imageblob>kminus-H-Bert-regre.gif</imageblob>\n" >> ${script}
