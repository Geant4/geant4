...
G4Material* MaterialsList::GetMaterial(const G4String& name) { 
  ...
  if (name == "Al") {
    ...
    ma = new G4Material("Oxygen", 8, 16.0*g/mole, 1.14*g/cm3);
  } else if ( name == "N" ) {
    ma = new G4Material("Nitrogen", 7, 14.01*g/mole, 0.808*g/cm3);
  } else if (name == "Nb") {
