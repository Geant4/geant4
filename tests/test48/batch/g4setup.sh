...
export G4INSTALL=/home-cluck/yarba_j/work/test-geant4.9.5-ref10/geant4
...
export G4DATA=/home-cluck/g4p/pbs/g4.9.5.r10/geant4.9.5.r10/data
export G4LEDATA=${G4DATA}/G4EMLOW6.32
export G4LEVELGAMMADATA=${G4DATA}/PhotonEvaporation2.2
export G4NEUTRONHPDATA=${G4DATA}/G4NDL4.1
export G4RADIOACTIVEDATA=${G4DATA}/RadioactiveDecay3.5
