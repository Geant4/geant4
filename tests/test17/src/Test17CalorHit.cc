...
Test17CalorHit::Test17CalorHit(const Test17CalorHit& right)
{
...
const Test17CalorHit& Test17CalorHit::operator=(const Test17CalorHit& right)
{
  EdepAbs = right.EdepAbs; TrackLengthAbs = right.TrackLengthAbs;
  EdepGap = right.EdepGap; TrackLengthGap = right.TrackLengthGap;
  return *this;
...
int Test17CalorHit::operator==(const Test17CalorHit& right) const
{
  return 0;
}
