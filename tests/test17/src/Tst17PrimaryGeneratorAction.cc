...
#include "Tst17PrimaryGeneratorMessenger.hh"
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
 ...
 G4String Tst17PrimaryGeneratorAction::thePrimaryParticleName="e-" ; 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

Tst17PrimaryGeneratorAction::Tst17PrimaryGeneratorAction(
                                            Tst17DetectorConstruction* Tst17DC)
:Tst17Detector(Tst17DC),rndmFlag("off"),xvertex(0.),yvertex(0.),zvertex(0.),
 vertexdefined(false)
{
  G4int n_particle = 1;
  ...
  gunMessenger = new Tst17PrimaryGeneratorMessenger(this);
  ...
  zvertex = -0.5*(Tst17Detector->GetAbsorberThickness());
...
void Tst17PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
  ...
  else
  {
    x0 = 0. ;
    y0 = 0. ;
    z0 = -0.5*(Tst17Detector->GetWorldSizeZ()) ;
  }
  G4double r0,phi0 ;
  if (rndmFlag == "on")
     {r0 = (Tst17Detector->GetAbsorberRadius())*sqrt(G4UniformRand());
...
G4String Tst17PrimaryGeneratorAction::GetPrimaryName()
{
   return thePrimaryParticleName ;
}

void Tst17PrimaryGeneratorAction::Setzvertex(G4double z)
{
  vertexdefined = true ;
  zvertex = z ;
