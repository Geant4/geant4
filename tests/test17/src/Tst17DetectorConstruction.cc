...
#include "Tst17DetectorMessenger.hh"

#include "Tst17CalorimeterSD.hh"
...
Tst17DetectorConstruction::Tst17DetectorConstruction()
 ...
 magField(NULL),calorimeterSD(NULL),worldchanged(false)
{
  ...
  WorldSizeZ = 20.*cm;
  WorldSizeR = 20.*cm;
  AbsorberThickness = 10.*cm;
  AbsorberRadius   = 10.*cm;
  zAbsorber = 0.*cm ;

  // create commands for interactive definition of the calorimeter  
  detectorMessenger = new Tst17DetectorMessenger(this);
}
...
G4VPhysicalVolume* Tst17DetectorConstruction::Construct()
{
  DefineMaterials();
...
void Tst17DetectorConstruction::DefineMaterials()
{ 
...
G4VPhysicalVolume* Tst17DetectorConstruction::ConstructCalorimeter()
{
  ...
  if(!calorimeterSD)
  {
    calorimeterSD = new Tst17CalorimeterSD("CalorSD",this);
...
void Tst17DetectorConstruction::PrintCalorParameters()
{
...
void Tst17DetectorConstruction::SetAbsorberMaterial(G4String materialChoice)
{
...
void Tst17DetectorConstruction::SetWorldMaterial(G4String materialChoice)
{
  // get the pointer to the material table
  const G4MaterialTable* theMaterialTable = G4Material::GetMaterialTable();
...
void Tst17DetectorConstruction::SetAbsorberThickness(G4double val)
{
...
void Tst17DetectorConstruction::SetAbsorberRadius(G4double val)
{
...
void Tst17DetectorConstruction::SetWorldSizeZ(G4double val)
{
  worldchanged=true;
  WorldSizeZ = val;
  ComputeCalorParameters();
...
void Tst17DetectorConstruction::SetWorldSizeR(G4double val)
{
  worldchanged=true;
  WorldSizeR = val;
  ComputeCalorParameters();
...
void Tst17DetectorConstruction::SetAbsorberZpos(G4double val)
{
  zAbsorber  = val;
  ComputeCalorParameters();
}  
...
void Tst17DetectorConstruction::SetMagField(G4double fieldValue)
{
...
void Tst17DetectorConstruction::UpdateGeometry()
{
