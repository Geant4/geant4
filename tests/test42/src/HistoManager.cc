...
void HistoManager::bookHisto()
{
  ...
  histo->add1D("h5","Log10 Energy (MeV) of protons",nBinsE,-5.,5.,1.0);
  histo->add1D("h6","Log10 Energy (MeV) of neutrons",nBinsE,-5.,5.,1.0);
  histo->add1D("h7","Log10 Energy (MeV) of charged pions",nBinsE,-4.,6.,1.0);
  histo->add1D("h8","Log10 Energy (MeV) of pi0",nBinsE,-4.,6.,1.0);
  histo->add1D("h9","Log10 Energy (MeV) of charged kaons",nBinsE,-4.,6.,1.0);
  histo->add1D("h10","Log10 Energy (MeV) of neutral kaons",nBinsE,-4.,6.,1.0);
  histo->add1D("h11","Log10 Energy (MeV) of deuterons and tritons",nBinsE,-5.,5.,1.0);
  histo->add1D("h12","Log10 Energy (MeV) of He3 and alpha",nBinsE,-5.,5.,1.0);
  histo->add1D("h13","Log10 Energy (MeV) of Generic Ions",nBinsE,-5.,5.,1.0);
  histo->add1D("h14","Log10 Energy (MeV) of muons",nBinsE,-4.,6.,1.0);
  histo->add1D("h15","log10 Energy (MeV) of side-leaked neutrons",nBinsE,-5.,5.,1.0);
  histo->add1D("h16","log10 Energy (MeV) of forward-leaked neutrons",nBinsE,-5.,5.,1.0);
  histo->add1D("h17","log10 Energy (MeV) of backward-leaked neutrons",nBinsE,-5.,5.,1.0);
  histo->add1D("h18","log10 Energy (MeV) of leaking protons",nBinsE,-4.,6.,1.0);
