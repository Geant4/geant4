...
//
//
// $Id: Ts42Cerenkov.hh,v 1.1 2007-12-11 14:41:49 grichine Exp $
...
#ifndef Ts42Cerenkov_h
#define Ts42Cerenkov_h 1
...
class Ts42Cerenkov : public G4VDiscreteProcess  
{
...
public: // Without description
	...
	Ts42Cerenkov(const G4String& processName = "Cerenkov", 
                            G4ProcessType type = fElectromagnetic);

	// Ts42Cerenkov(const Ts42Cerenkov &right);
...
inline 
G4bool Ts42Cerenkov::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
inline 
void Ts42Cerenkov::SetTrackSecondariesFirst(const G4bool state) 
{ 
	fTrackSecondariesFirst = state;
}

inline
void Ts42Cerenkov::SetMaxNumPhotonsPerStep(const G4int NumPhotons) 
{ 
	fMaxPhotons = NumPhotons;
}

inline
void Ts42Cerenkov::DumpPhysicsTable() const
{
...
inline G4PhysicsTable* Ts42Cerenkov::GetPhysicsTable() const
{
  return thePhysicsTable;
}

#endif /* Ts42Cerenkov_h */
