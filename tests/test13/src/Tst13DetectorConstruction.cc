...
// and all its terms.
//
// $Id: Tst13DetectorConstruction.cc,v 1.2 1999-12-15 14:54:48 gunter Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//

#include "Tst13DetectorConstruction.hh"

#include "Tst13DetectorMessenger.hh"
...
Tst13DetectorConstruction::Tst13DetectorConstruction()
:simpleBoxLog(NULL),selectedMaterial(NULL),Air(NULL),Al(NULL),Pb(NULL)
{
  detectorMessenger = new Tst13DetectorMessenger(this);
  materialChoice = "Pb";
}
...
void Tst13DetectorConstruction::SelectMaterial(G4String val)
{
  materialChoice = val;
...
void Tst13DetectorConstruction::SelectMaterialPointer()
{
//--------- Material definition ---------
...
G4VPhysicalVolume* Tst13DetectorConstruction::Construct()
{
  SelectMaterialPointer();
