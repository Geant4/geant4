...
// ********************************************************************
//
// $Id: PhysListEmPenelope08.cc,v 1.1 2010-03-19 09:55:53 pandola Exp $
...
PhysListEmPenelope08::PhysListEmPenelope08(const G4String& name)
...
PhysListEmPenelope08::~PhysListEmPenelope08()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void PhysListEmPenelope08::ConstructProcess()
{
  ...
  while( (*theParticleIterator)() ){
    ...
    if (particleName == "gamma") {
      ...
      G4Penelope08PhotoElectricModel* thePEPenelopeModel = new 
	G4Penelope08PhotoElectricModel();
      ...
      G4Penelope08ComptonModel* theComptonPenelopeModel = 
	new G4Penelope08ComptonModel();
      ...
      G4Penelope08GammaConversionModel* theGCPenelopeModel = 
	new G4Penelope08GammaConversionModel();
      theGammaConversion->AddEmModel(0,theGCPenelopeModel);
      pmanager->AddDiscreteProcess(theGammaConversion);

      //Rayleigh scattering
      G4RayleighScattering* theRayleigh = new G4RayleighScattering();
      G4Penelope08RayleighModel* theRayleighPenelopeModel = 
	new G4Penelope08RayleighModel();
