...
#    if [ X$sym_debopt = Xo ]
#    then
#	g4sbr=/afs/cern.ch/sw/geant4/stt/$devprod/src/geant4/tests/tools/bin/g4sbr.o.sh
#    else
#	g4sbr=/afs/cern.ch/sw/geant4/stt/$devprod/src/geant4/tests/tools/bin/g4sbr.d.sh
#    fi
