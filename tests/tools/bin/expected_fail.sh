...
EXPECTED_FAIL exam-ext-electromagnetic-testem7-build \
...
EXPECTED_FAIL exam-ext-electromagnetic-testem8-build \
	x86_64-slc5-gcc43-opt	\
	x86_64-slc5-gcc43-dbg	\
	i686-slc5-gcc43-opt	\
	i686-slc5-gcc43-dbg
...
#28-Apr
# 3-Nov back for slc4 64 bit opt, sent mail to Pete in October already 
