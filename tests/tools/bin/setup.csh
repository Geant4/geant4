...
alias N01     "$G4WORKDIR/bin/$G4SYSTEM/exampleN01"
alias N02     "$G4WORKDIR/bin/$G4SYSTEM/exampleN02"
alias N03     "$G4WORKDIR/bin/$G4SYSTEM/exampleN03"
alias gdbN01  "gdb $G4WORKDIR/bin/$G4SYSTEM/exampleN01"
alias gdbN02  "gdb $G4WORKDIR/bin/$G4SYSTEM/exampleN02"
alias gdbN03  "gdb $G4WORKDIR/bin/$G4SYSTEM/exampleN03"
