...
// and all its terms.
//
// $Id: Tst15DetectorConstruction.cc,v 1.1 1999-11-18 14:48:14 stesting Exp $
...
void Tst15DetectorConstruction::SelectMaterialPointer()
{
//--------- Material definition ---------
...
G4VPhysicalVolume* Tst15DetectorConstruction::Construct()
{
  SelectMaterialPointer();
