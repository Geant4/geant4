...
//
//
// $Id: Tst38MuonPhysics.cc,v 1.1 2006-05-03 07:09:59 mkossov Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
// 

#include "Tst38MuonPhysics.hh"

Tst38MuonPhysics::Tst38MuonPhysics(const G4String& name): G4VPhysicsConstructor(name){}

Tst38MuonPhysics::~Tst38MuonPhysics(){}

void Tst38MuonPhysics::ConstructParticle()
{
  // Mu
...
void Tst38MuonPhysics::ConstructProcess()
{
