...
//
//
// $Id: Tst22HadronPhysics.cc,v 1.1 2006-05-03 07:09:59 mkossov Exp $
...
Tst22HadronPhysics::Tst22HadronPhysics(const G4String& name)
                    :  G4VPhysicsConstructor(name)
{
}

Tst22HadronPhysics::~Tst22HadronPhysics()
{
}
...
void Tst22HadronPhysics::ConstructParticle()
{
...
void Tst22HadronPhysics::ConstructProcess()
{
