...
//
//
// $Id: Tst22DetectorMessenger.cc,v 1.1 2006-05-03 07:09:59 mkossov Exp $
...
Tst22DetectorMessenger::Tst22DetectorMessenger(Tst22DetectorConstruction * myDC)
:myDetector(myDC)
{
  G4String defParam;
...
void Tst22DetectorMessenger::SetNewValue(G4UIcommand * command,G4String newValues)
{
