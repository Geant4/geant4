...
//
// Author:        V. Grichine based jn  G4CoulombScatteringModel
//
...
private:
  ...
  G4WeMoHardScatModel & operator=(const G4WeMoHardScatModel &right);
  G4WeMoHardScatModel(const  G4WeMoHardScatModel&);
