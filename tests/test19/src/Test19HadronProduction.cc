...
#include "Test19HadronProduction.hh"
...
Test19HadronProduction::Test19HadronProduction(const G4String& aName)
 :G4VDiscreteProcess(aName), theGenerator(0) { InitializeMe(); }

// Model Navigation tool for initialization of the particular model (?)
void Test19HadronProduction::InitializeMe() {} // M.K.? What for is this member function?

// the G4VParticleChange must be cleaned up by caller! - Bad G4 style (?)
Test19HadronProduction::~Test19HadronProduction() {if(theGenerator) delete theGenerator;}

// Trivial definition of the PostStep InteractionLength definition
G4double Test19HadronProduction::PostStepGetPhysicalInteractionLength
...
void Test19HadronProduction::SetSecondaryGenerator(Test19VSecondaryGenerator* gen)
{
...
G4VParticleChange* Test19HadronProduction::PostStepDoIt(const G4Track& track,const G4Step&)
{
