...
//
//
// $Id: Tst62PhysicsList.cc,v 1.2 2010-03-18 00:02:06 kaitanie Exp $
...
Tst62PhysicsList::Tst62PhysicsList():  G4VUserPhysicsList()
{
  SetVerboseLevel(1);
}

Tst62PhysicsList::~Tst62PhysicsList()
{
}

void Tst62PhysicsList::ConstructParticle()
{
...
void Tst62PhysicsList::ConstructAllBosons()
{
...
void Tst62PhysicsList::ConstructAllLeptons()
{
...
void Tst62PhysicsList::ConstructAllMesons()
{
...
void Tst62PhysicsList::ConstructAllBaryons()
{
...
void Tst62PhysicsList::ConstructAllIons()
{
...
void Tst62PhysicsList::ConstructAllShortLiveds()
{
...
void Tst62PhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructLeptHad();
...
void Tst62PhysicsList::ConstructEM()
{
...
void Tst62PhysicsList::ConstructHad()
{
    ...
    G4InclAblaCascadeInterface * theInclAbla = new G4InclAblaCascadeInterface;
...
// done with the generator model (most of the above is also available as default)
   ...
   while ((*theParticleIterator)()) {
      ...
      if (particleName == "pi+") {
         ...
         theInelasticProcess->RegisterMe(theInclAbla);
...
void Tst62PhysicsList::ConstructLeptHad()
{;}

#include "G4Decay.hh"
void Tst62PhysicsList::ConstructGeneral()
{
...
void Tst62PhysicsList::SetCuts()
{
  if (verboseLevel >0){
    G4cout << "Tst62PhysicsList::SetCuts:";
