...
//
//
// $Id: Tst62DetectorConstruction.cc,v 1.1 2008-11-10 11:06:21 kaitanie Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//

#include "Tst62DetectorConstruction.hh"

#include "Tst62DetectorMessenger.hh"
...
Tst62DetectorConstruction::Tst62DetectorConstruction()
  :simpleBoxLog(0),selectedMaterial(0),theH(0),theC(0),theSi(0),theCu(0),thePb(0),theU(0),theTh(0)
{
  detectorMessenger = new Tst62DetectorMessenger(this);
  materialChoice = "Pb";
}
...
void Tst62DetectorConstruction::SelectMaterial(G4String val)
{
  materialChoice = val;
...
void Tst62DetectorConstruction::SelectMaterialPointer()
{
//--------- Material definition ---------
...
G4VPhysicalVolume* Tst62DetectorConstruction::Construct()
{
  SelectMaterialPointer();
