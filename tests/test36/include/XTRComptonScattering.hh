...
//
//
// $Id: XTRComptonScattering.hh,v 1.1 2006-05-17 16:09:24 grichine Exp $
...
#ifndef XTRComptonScattering_h
#define XTRComptonScattering_h 1
...
class XTRComptonScattering : public G4VDiscreteProcess

{
  public:  // with description

  XTRComptonScattering(const G4String& processName ="compt",
		            G4ProcessType type = fElectromagnetic);

    ~XTRComptonScattering();
  ...
  private:
     ...
     XTRComptonScattering& operator=(const XTRComptonScattering &right);
     XTRComptonScattering(const XTRComptonScattering& );
