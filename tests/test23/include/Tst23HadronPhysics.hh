...
//
//
// $Id: Tst23HadronPhysics.hh,v 1.3 2004-03-05 15:23:17 mkossov Exp $
...
// ------------------------------------------------------------
#ifndef Tst23HadronPhysics_h
#define Tst23HadronPhysics_h 1
...
// CHIPS nuclear capture process manager - One for both
#include "G4QCaptureAtRest.hh"

class Tst23HadronPhysics : public G4VPhysicsConstructor
{
  public: 
    Tst23HadronPhysics(const G4String& name ="hadron");
    virtual ~Tst23HadronPhysics();
  ...
  protected:
   ...
   //#endif
   G4QCaptureAtRest thePionMinusAbsorption; // CHIPS instead
   ...
   //#endif
   G4QCaptureAtRest theKaonMinusAbsorption; // CHIPS instead
   ...
   G4QCaptureAtRest theAntiNeutronAnnihilation; // CHIPS instead
