...
//
//
// $Id: Tst23DetectorConstruction.hh,v 1.1 2001-12-14 14:53:23 kurasige Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//

#ifndef Tst23DetectorConstruction_h
#define Tst23DetectorConstruction_h 1

class G4VPhysicalVolume;
class G4LogicalVolume;
class G4Material;
class Tst23DetectorMessenger;

#include "G4VUserDetectorConstruction.hh"
#include "globals.hh"

class Tst23DetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    Tst23DetectorConstruction();
    ~Tst23DetectorConstruction();
  ...
  private:
     ...
     Tst23DetectorMessenger * detectorMessenger;    
};
