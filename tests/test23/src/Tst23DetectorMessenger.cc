...
//
//
// $Id: Tst23DetectorMessenger.cc,v 1.1 2001-12-14 14:53:41 kurasige Exp $
...
Tst23DetectorMessenger::Tst23DetectorMessenger(Tst23DetectorConstruction * myDC)
:myDetector(myDC)
{
  G4String defParam;
...
void Tst23DetectorMessenger::SetNewValue(G4UIcommand * command,G4String newValues)
{
