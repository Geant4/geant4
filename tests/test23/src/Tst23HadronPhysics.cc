...
//
//
// $Id: Tst23HadronPhysics.cc,v 1.3 2004-03-05 15:25:44 mkossov Exp $
...
Tst23HadronPhysics::Tst23HadronPhysics(const G4String& name)
                    :  G4VPhysicsConstructor(name)
{
}

Tst23HadronPhysics::~Tst23HadronPhysics()
{
}
...
void Tst23HadronPhysics::ConstructParticle()
{
...
void Tst23HadronPhysics::ConstructProcess()
{
  ...
  pManager->AddRestProcess(&theSigmaMinusAnnihilation); // CHIPS addition
  ...
  pManager->AddRestProcess(&theAntiSigmaPlusAnnihilation); // CHIPS addition
  ...
  pManager->AddRestProcess(&theXiMinusAnnihilation); // CHIPS addition
  ...
  pManager->AddRestProcess(&theOmegaMinusAnnihilation); // CHIPS addition
