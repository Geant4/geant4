...
Test49HadronProduction::Test49HadronProduction(const G4String& aName)
 :G4VDiscreteProcess(aName), theGenerator(0) { InitializeMe(); }

// Model Navigation tool for initialization of the particular model (?)
void Test49HadronProduction::InitializeMe() {} // M.K.? What for is this member function?

// the G4VParticleChange must be cleaned up by caller! - Bad G4 style (?)
Test49HadronProduction::~Test49HadronProduction() {if(theGenerator) delete theGenerator;}

// Trivial definition of the PostStep InteractionLength definition
G4double Test49HadronProduction::PostStepGetPhysicalInteractionLength
...
void Test49HadronProduction::SetSecondaryGenerator(Test49VSecondaryGenerator* gen)
{
...
G4VParticleChange* Test49HadronProduction::PostStepDoIt(const G4Track& track,const G4Step&)
{
