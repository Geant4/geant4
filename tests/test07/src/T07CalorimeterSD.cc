...
// and all its terms.
//
// $Id: T07CalorimeterSD.cc,v 1.2 1999-12-15 14:54:40 gunter Exp $
...
void T07CalorimeterSD::Initialize(G4HCofThisEvent*HCE)
{
...
G4bool T07CalorimeterSD::ProcessHits(G4Step* aStep,G4TouchableHistory* ROhist)
{
