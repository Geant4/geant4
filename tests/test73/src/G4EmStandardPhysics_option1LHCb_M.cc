...
// ********************************************************************
//
// $Id: G4EmStandardPhysics_option1LHCb_M.cc,v 1.22 2010-12-19 18:11:05 vnivanch Exp $
...
G4EmStandardPhysics_option1LHCb_M::G4EmStandardPhysics_option1LHCb_M(G4int ver, bool apply, bool newForE )
	: G4VPhysicsConstructor("G4EmStandardPhysics_option1LHCb_M"), verbose(ver), applyCut(apply), newForElectrons(newForE)
{
