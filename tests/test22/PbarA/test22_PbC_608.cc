...
// ----------------------------- Momentum distributions----------------------
    ...
    PbarC06Mom<<G4Version<<G4endl;
    PbarC06Mom<<" Pmod       Prot       Pip "<< G4endl;
    ...
    { 
     Pmom+=12.; 
     PbarC06Mom<<Pmom<<"    "; 
     for(G4int jj=0;jj < 2; jj++){PbarC06Mom << MomUzhi[ii][jj]<<"    ";}
     PbarC06Mom<<G4endl;
    }  
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PbarC06Y<<G4Version<<G4endl;
    PbarC06Y<<"  Y        P        Pip"<< G4endl;
    ...
    { 
     Yu+=0.04; 
     PbarC06Y<<Yu<<"    ";
     for(G4int jj=0;jj < 2; jj++){PbarC06Y<<RapUzhi[ii][jj]<<"    ";}
     PbarC06Y<<G4endl;
    }
