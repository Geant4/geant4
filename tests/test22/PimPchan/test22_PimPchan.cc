...
//-------------------------- Global histograms  -------------------------
std::ofstream PimPtopo("PimPtopo.dat",std::ios::out);
std::ofstream PimPchan("PimPchan.dat",std::ios::out);
...
//+++++++++++++++++ For each particle in the event ++++++++++++++++++++++
	...
	else if ( pname == "sigma+" )     {Ncharged++;}
	else if ( pname == "sigma-" )     {Ncharged++;}
	else if ( pname == "anti_sigma+" ){Ncharged++;}
	else if ( pname == "anti_sigma-" ){Ncharged++;}
...
if((Ncharged == 0) && (Nother == 0) && (Nneutron == 1) && (Npi0 ==1)) 
{Xs[Uzhi_run][4]++; if(verbose > 0) G4cout<<" n Pi0 "<<G4endl;}

      Nother=     Nproton+NprotonBar +
                  NneutronBar+
                  Npim+Npip + 
                  NKm+NKp+NK0s+NK0l + 
                  NLambda+NLambdaBar + 
                  NSigma0+NSigma0Bar +
                  Neta+Neta_prime + Ngamma;
if((Ncharged == 0) && (Nother == 0) && (Nneutron == 1) && (Npi0 ==2)) 
{Xs[Uzhi_run][5]++; if(verbose > 0) G4cout<<" n 2Pi0 "<<G4endl;}
      ...
      Nother=     Nproton+NprotonBar +
                  ...
                  NSigma0+NSigma0Bar +
                  Neta+Neta_prime + Ngamma;
if((Ncharged == 2) && (Nother == 0) && (Nneutron == 1) && (Npip == 1) && (Npim == 1)) 
{Xs[Uzhi_run][6]++;} // G4cout<<" 6 "<<G4endl;}
      ...
      Nother=     NprotonBar +
                  ...
                  NSigma0+NSigma0Bar +
                  Neta+Neta_prime + Ngamma;
if((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (Npi0 == 1) && (Npim == 1)) 
{Xs[Uzhi_run][7]++; if(verbose > 0) G4cout<<" p Pip Pim "<<G4endl;}
      ...
      Nother=     Nproton+NprotonBar +
                  ...
                  NSigma0+NSigma0Bar +
                  Neta+Neta_prime + Ngamma;
if((Ncharged == 0) && (Nother == 0) && (Nneutron == 1) && (Npi0 ==3)) 
{Xs[Uzhi_run][8]++; if(verbose > 0) G4cout<<" n 3Pi0 "<<G4endl;}
      ...
      Nother=     NprotonBar +
                  ...
                  NSigma0+NSigma0Bar +
                  Neta+Neta_prime + Ngamma;
if((Ncharged == 4) && (Nother == 0) && (Nproton == 1) && (Npip == 1) && (Npim == 2)) 
{Xs[Uzhi_run][9]++; if(verbose > 0) G4cout<<" p Pip 2Pim "<<G4endl;}
      ...
      Nother=     NprotonBar +
                  ...
                  NSigma0+NSigma0Bar +
                  Neta+Neta_prime + Ngamma;
if((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (Npim == 1)) 
{Xs[Uzhi_run][10]++; TopoUzhi[Uzhi_run][2]--; if(verbose > 0) G4cout<<" Pim P "<<G4endl;}   //  Ntotal--;
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
PimPtopo<<G4Version<<G4endl;
PimPtopo<<" Plab  S0   S2   S4   S6   S8   S10 "
...
for(G4int ii=0;ii<Uzhi_run;ii++) 
 ...
 PimPchan<<G4Version<<G4endl;
  PimPchan<<" Plab      Xtot     Xel    Xin     NPi0    N2pi0     Npippim  Ppi0pim    N3pi0     Ppip2pim     PimP"<< G4endl;

for(G4int ii=0;ii<Uzhi_run;ii++) //--------------------------------- Uzhi
  {
   for(G4int jj=0;jj<11;jj++) {PimPchan<<" "<<Xs[ii][jj];};
    PimPchan<<G4endl;
  };
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  delete pFrame;
