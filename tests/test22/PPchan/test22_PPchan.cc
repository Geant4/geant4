...
//-------------------------- Global histograms  -------------------------
std::ofstream PPtopo("PPtopo.dat",std::ios::out);
std::ofstream PPchan("PPchan.dat",std::ios::out);
...
if((Ncharged == 2) && (Nother == 0) && (Nproton == 2) && (Npi0 ==1)) 
{Xs[Uzhi_run][4]++; if(verbose>0)  {G4cout<<"pp pi0 "<<G4endl; G4int Uzh; G4cin>>Uzh;}
}
...
if((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (Nneutron == 1) && (Npip ==1)) 
{Xs[Uzhi_run][5]++; if(verbose>0) {G4cout<<" pn pi+ "<<G4endl; G4int Uzh; G4cin>>Uzh;}
}
...
if((Ncharged == 4) && (Nother == 0) && (Nproton == 2) && (Npip == 1) && (Npim == 1)) 
{Xs[Uzhi_run][6]++; if(verbose>0) {G4cout<<" 2p pi+ pi- "<<G4endl; G4int Uzh; G4cin>>Uzh;}
}
...
if((Ncharged == 4) && (Nother == 0) && (Nproton == 1) && (Nneutron == 1) && (Npip == 2) && (Npim == 1)) 
{Xs[Uzhi_run][7]++; if(verbose>0) {G4cout<<" pn 2pi+ pi- "<<G4endl; G4int Uzh; G4cin>>Uzh;}
}
...
if((Ncharged == 4) && (Nother == 0) && (Nproton == 2) && (Npip ==1) && (Npim ==1) && (Npi0 ==1)) 
{Xs[Uzhi_run][8]++; if(verbose>0) {G4cout<<" pp pi+ pi- pi0 "<<G4endl; G4int Uzhi; G4cin>>Uzhi;}
}
      Nother=     NprotonBar +
                  Nneutron+NneutronBar+
                  Npip+Npim+Npi0 + 
...
if((Ncharged == 2) && (Nother == 0) && (Nproton == 1) && (NLambda ==1) && (NKp ==1)) 
{Xs[Uzhi_run][9]++; if(verbose>0) {G4cout<<" L P K+ "<<G4endl; G4int Uzhi; G4cin>>Uzhi;}
}

if((Ncharged == 2) && (Nother == 0) && (Nproton == 2)) 
{Xs[Uzhi_run][10]++; TopoUzhi[Uzhi_run][2]--;                      //  Ntotal--;
//  G4cout<<" El pp "<<G4endl; //G4int Uzh; G4cin>>Uzh;
}
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
Xs[Uzhi_run][10]*=sigTot/nevt;// sigTot/nevt;  Elastic scattering
...
PPtopo<<G4Version<<G4endl;

PPtopo<<"################# Topological cross-sections #################"<<G4endl;
PPtopo<<" Plab   S0    S2    S4    S6    S8   S10  S12    S14   S16   S18   S20    S22 "
...
PPchan<<G4Version<<G4endl;
PPchan<<"################# Inelastic cross-sections #################"<<G4endl;
PPchan<<" Plab   Xtot    Xel     Xin    PPPi0    PNpip   PPpippim  PN2pippim   PPpippimpi0  LPKp   PP"<< G4endl;

for(G4int ii=0;ii<Uzhi_run;ii++) //--------------------------------- Uzhi
  {
   for(G4int jj=0;jj<11;jj++) {PPchan<<" "<<Xs[ii][jj];};
    PPchan<<G4endl;
  }
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  delete pFrame;
