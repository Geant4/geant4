...
//
//
// $Id: Tst38EMPhysics.cc,v 1.1 2006-05-02 10:27:31 mkossov Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
// 

#include "Tst38EMPhysics.hh"

Tst38EMPhysics::Tst38EMPhysics(const G4String& name): G4VPhysicsConstructor(name)
{
  theGammaReaction = new G4GammaNuclearReaction;
  theElectroReaction = new G4ElectroNuclearReaction;
}

Tst38EMPhysics::~Tst38EMPhysics(){}

void Tst38EMPhysics::ConstructParticle()
{
  // gamma
...
void Tst38EMPhysics::ConstructProcess()
{
