...
//-------------------------- Global histograms  -------------------------
//std::ofstream PimP40y("PimP40y.dat",std::ios::out);
std::ofstream PimP40x("PimP40x.dat",std::ios::out);
//std::ofstream PimP40pt2("PimP40pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PimP40y<<G4Version<<G4endl;
    PimP40y<<"  Y        P        Neut         Pip          Pim          Kp"
         <<"        Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
     PimP40y<<Yu<<" ";
     for(G4int jj=0;jj < 7; jj++){PimP40y<<YUzhi[ii][jj]<<" ";}
     PimP40y<<G4endl;
    }
*/
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PimP40x<<G4Version<<G4endl;
    PimP40x<<"  Xf        P        Neut          Pip          Pim          Kp"
        <<"       Km          Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PimP40x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PimP40x << XfUzhi[ii][jj]/3.14159<<" ";}
      PimP40x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PimP40pt2<<G4Version<<G4endl;
    PimP40pt2<<"  Pt2        P        Neut         Pip      Pim      Kp"
           <<"      Km       Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PimP40pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PimP40pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PimP40pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
