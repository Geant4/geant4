...
//-------------------------- Global histograms  -------------------------
std::ofstream PipP100y("PipP100y.dat",std::ios::out);
//std::ofstream PipP100x("PipP100x.dat",std::ios::out);
std::ofstream PipP100pt2("PipP100pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PipP100y<<G4Version<<G4endl;
    PipP100y<<"  Y        P       Neut      Pip       Pim      Kp"
         <<"     Km       Pbar "<< G4endl;

    for(G4int ii=0; ii <100; ii++)
  {for(G4int jj=0;jj < 7; jj++){YUzhi[ii][jj]*= 10./Ninelast*sigIn/sigIn;};};
    ...
    { 
     Yu+=0.1; 
     PipP100y<<Yu<<" ";
     for(G4int jj=0;jj < 7; jj++){PipP100y<<YUzhi[ii][jj]<<" ";}
     PipP100y<<G4endl;
    }
//
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    PipP100x<<G4Version<<G4endl;
    PipP100x<<"  Xf      P       Neut       Pip          Pim      Kp"
        <<"     Km       Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PipP100x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PipP100x << XfUzhi[ii][jj]/3.14159<<" ";}
      PipP100x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PipP100pt2<<G4Version<<G4endl;
    PipP100pt2<<"  Pt2      P      Neut       Pip      Pim      Kp"
           <<"    Km     Pbar"<< G4endl;

    for(G4int ii=0; ii <100; ii++)
    {for(G4int jj=0;jj < 7; jj++){Pt2Uzhi[ii][jj]*= 1./Ninelast*sigIn/0.015;};}; // 2 forward and backward
    ...
    { 
     Pt2u+=0.015; 
     PipP100pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PipP100pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PipP100pt2<<G4endl;
    }
//
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
