...
//-------------------------- Global histograms  -------------------------
std::ofstream PimP100y("PimP100y.dat",std::ios::out);
//std::ofstream PimP100x("PimP100x.dat",std::ios::out);
std::ofstream PimP100pt2("PimP100pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
 ...
 PimP100y<<G4Version<<G4endl;   
 PimP100y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
     PimP100y<<Yu<<" ";
     for(G4int jj=0;jj < 7; jj++){PimP100y<<YUzhi[ii][jj]<<" ";}
     PimP100y<<G4endl;
    }
//
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
   ...
   PimP100x<<G4Version<<G4endl;    
   PimP100x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PimP100x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PimP100x << XfUzhi[ii][jj]/3.14159<<" ";}
      PimP100x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
 ...
 G4cout<< "******** Pt2 ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
   PimP100pt2 <<G4Version<<G4endl; 
   PimP100pt2<<"  Pt2          P          Neut            Pip          Pim          Kp"
           <<"          Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PimP100pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PimP100pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PimP100pt2<<G4endl;
    }
//
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
