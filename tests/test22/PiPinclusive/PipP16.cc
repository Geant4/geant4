...
//-------------------------- Global histograms  -------------------------
//std::ofstream PipP16y("PipP16y.dat",std::ios::out);
std::ofstream PipP16x("PipP16x.dat",std::ios::out);
std::ofstream PipP16pt2("PipP16pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    G4cout<< "******** Rapidity ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
     ...
     PipP16y<<G4Version<<G4endl;
     PipP16y<<"  Y         P         Neut       Pip        Pim       Kp"
         <<"      Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
     PipP16y<<Yu<<" ";
     for(G4int jj=0;jj < 7; jj++){PipP16y<<YUzhi[ii][jj]<<" ";}
     PipP16y<<G4endl;
    }
*/
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PipP16x<<G4Version<<G4endl;
    PipP16x<<"  Xf       P      Neut       Pip      Pim      Kp"
        <<"      Km       Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PipP16x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PipP16x << XfUzhi[ii][jj]/3.14159<<" ";}
      PipP16x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PipP16pt2<<G4Version<<G4endl;
    PipP16pt2<<"  Pt2      P      Neut       Pip      Pim      Kp"
           <<"     Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PipP16pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PipP16pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PipP16pt2<<G4endl;
    }
