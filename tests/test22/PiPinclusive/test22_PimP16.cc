...
//-------------------------- Global histograms  -------------------------
//std::ofstream PimP16y("PimP16y.dat",std::ios::out);
std::ofstream PimP16x("PimP16x.dat",std::ios::out);
std::ofstream PimP16pt2("PimP16pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
   ...
   PimP16y<<G4Version<<G4endl;    
   PimP16y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
     PimP16y<<Yu<<" ";
     for(G4int jj=0;jj < 7; jj++){PimP16y<<YUzhi[ii][jj]<<" ";}
     PimP16y<<G4endl;
    }
*/
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PimP16x<<G4Version<<G4endl;    
    PimP16x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PimP16x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PimP16x << XfUzhi[ii][jj]/3.14159<<" ";}
      PimP16x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PimP16pt2<<G4Version<<G4endl;
    PimP16pt2<<"  Pt2         P         Neut       Pip      Pim        Kp"
           <<"          Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PimP16pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PimP16pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PimP16pt2<<G4endl;
    }
