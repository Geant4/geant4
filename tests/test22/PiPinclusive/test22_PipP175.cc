...
//-------------------------- Global histograms  -------------------------
//std::ofstream PipP175y("PipP175y.dat",std::ios::out);
std::ofstream PipP175x("PipP175x.dat",std::ios::out);
//std::ofstream PipP175pt2("PipP175pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PipP175y<<G4Version<<G4endl;
    PipP175y<<"  Y       P       Neut      Pip      Pim      Kp"
         <<"     Km       Pbar "<< G4endl;

    for(G4int ii=0; ii <100; ii++)
    {for(G4int jj=0;jj < 7; jj++){YUzhi[ii][jj]*= 10./Ninelast*sigIn/sigTot;};};
    ...
    { 
     Yu+=0.1; 
     PipP175y<<Yu<<" ";
     for(G4int jj=0;jj < 7; jj++){PipP175y<<YUzhi[ii][jj]<<" ";}
     PipP175y<<G4endl;
    }
*/
//
// ----------------------------- Xf distributions----------------------// Uzhi ++++
   ...
   PipP175x<<G4Version<<G4endl;
   PipP175x<<"  Xf       P      Neut       Pip       Pim       Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PipP175x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PipP175x << XfUzhi[ii][jj]/3.14159<<" ";}
      PipP175x<<G4endl;
     }
    }  
//
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PipP175pt2<<G4Version<<G4endl;
    PipP175pt2<<"  Pt2       P      Neut       Pip       Pim       Kp"
           <<"     Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PipP175pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PipP175pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PipP175pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
