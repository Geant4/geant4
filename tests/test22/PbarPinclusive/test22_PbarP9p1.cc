...
//-------------------------- Global histograms  -------------------------
std::ofstream PbarP9p1y("PbarP9p1y.dat",std::ios::out);
//std::ofstream PbarP9p1x("PbarP9p1x.dat",std::ios::out);
//std::ofstream PbarP9p1pt2("PbarP9p1pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PbarP9p1y<<G4Version<<G4endl;
    PbarP9p1y<<"  Y          P        Neut       Pip          Pim         Kp"
         <<"     Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
      PbarP9p1y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PbarP9p1y<<YUzhi[ii][jj]<<" ";}
      PbarP9p1y<<G4endl;
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PbarP9p1x<<G4Version<<G4endl;
    PbarP9p1x<<"  Xf       P       Neut        Pip        Pim          Kp"
        <<"      Km         Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PbarP9p1x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PbarP9p1x << XfUzhi[ii][jj]<<" ";}
      PbarP9p1x<<G4endl;
     }
    }  
*/
...
Pim          Kp"
    ...
    { 
     Pt2u+=0.015; 
     PbarP9p1pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PbarP1p1pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PbarP9p1pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
