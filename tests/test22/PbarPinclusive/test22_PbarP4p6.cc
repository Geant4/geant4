...
//-------------------------- Global histograms  -------------------------
std::ofstream PbarP4p6y("PbarP4p6y.dat",std::ios::out);
//std::ofstream PbarP4p6x("PbarP4p6x.dat",std::ios::out);
//std::ofstream PbarP4p6pt2("PbarP4p6pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PbarP4p6y<<G4Version<<G4endl;
    PbarP4p6y<<"  Y          P        Neut       Pip          Pim         Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
      ...
      PbarP4p6y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PbarP4p6y<<YUzhi[ii][jj]<<" ";}
      PbarP4p6y<<G4endl;
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PbarP4p6x<<G4Version<<G4endl;
    PbarP4p6x<<"  Xf           P          Neut            Pip          
Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PbarP4p6x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PbarP4p6x << XfUzhi[ii][jj]<<" ";}
      PbarP4p6x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PbarP4p6pt2<<"  Pt2          P          Neut            Pip          Pim          Kp"
           <<"    Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PbarP4p6pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PbarP4p6pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PbarP4p6pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
