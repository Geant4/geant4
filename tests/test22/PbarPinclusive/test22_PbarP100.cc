...
//-------------------------- Global histograms  -------------------------
std::ofstream PbarP100y("PbarP100y.dat",std::ios::out);
//std::ofstream PbarP100x("PbarP100x.dat",std::ios::out);
//std::ofstream PbarP100pt2("PbarP100pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PbarP100y<<G4Version<<G4endl;
    PbarP100y<<"  Y          P        Neut       Pip          Pim        Kp"
         <<"        Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
      PbarP100y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PbarP100y<<YUzhi[ii][jj]<<" ";}
      PbarP100y<<G4endl;
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PbarP100x<<G4Version<<G4endl;
    PbarP100x<<"  Xf          P          Neut        Pip       Pim      Kp"
        <<"       Km         Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PbarP100x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PbarP100x << XfUzhi[ii][jj]<<" ";}
      PbarP100x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PbarP100pt2<<"  Pt2          P          Neut         Pip        Pim          Kp"
           <<"    Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PbarP100pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PbarP100pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PbarP100pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
