...
//-------------------------- Global histograms  -------------------------
std::ofstream PbarP14p8y("PbarP14p8y.dat",std::ios::out);
//std::ofstream PbarP14p8x("PbarP14p8x.dat",std::ios::out);
//std::ofstream PbarP14p8pt2("PbarP14p8pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PbarP14p8y<<G4Version<<G4endl;
    PbarP14p8y<<"  Y        P       Neut       Pip        Pim        Kp"
         <<"       Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
      PbarP14p8y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PbarP14p8y<<YUzhi[ii][jj]<<" ";}
      PbarP14p8y<<G4endl;
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PbarP14p8x<<G4Version<<G4endl;
    PbarP14p8x<<"  Xf       P        Neut          Pip        Pim          Kp"
        <<"      Km        Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PbarP14p8x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PbarP14p8x << XfUzhi[ii][jj]<<" ";}
      PbarP14p8x<<G4endl;
     }
    }  
*/
...
Pim          Kp"
    ...
    { 
     Pt2u+=0.015; 
     PbarP14p8pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PbarP14p8pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PbarP14p8pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
