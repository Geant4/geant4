...
//-------------------------- Global histograms  -------------------------
std::ofstream PbarP7p3y("PbarP7p3y.dat",std::ios::out);
//std::ofstream PbarP7p3x("PbarP7p3x.dat",std::ios::out);
//std::ofstream PbarP7p3pt2("PbarP7p3pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PbarP7p3y<<G4Version<<G4endl;
    PbarP7p3y<<"  Y          P        Neut       Pip          Pim         Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
      PbarP7p3y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PbarP7p3y<<YUzhi[ii][jj]<<" ";}
      PbarP7p3y<<G4endl;
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PbarP7p3x<<G4Version<<G4endl;
    PbarP7p3x<<"  Xf           P          Neut            Pip          
Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PbarP7p3x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PbarP7p3x << XfUzhi[ii][jj]<<" ";}
      PbarP7p3x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PbarP7p3pt2<<"  Pt2          P          Neut            Pip          Pim          Kp"
           <<"    Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PbarP7p3pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PbarP7p3pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PbarP7p3pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
