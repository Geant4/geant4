...
//-------------------------- Global histograms  -------------------------
std::ofstream PbarP5p7y("PbarP5p7y.dat",std::ios::out);
//std::ofstream PbarP5p7x("PbarP5p7x.dat",std::ios::out);
std::ofstream PbarP5p7pt2("PbarP5p7pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    { 
     Yu+=0.1; 
      PbarP5p7y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PbarP5p7y<<YUzhi[ii][jj]<<" ";}
      PbarP5p7y<<G4endl;
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PbarP5p7x<<G4Version<<G4endl;
    PbarP5p7x<<"  Xf           P          Neut            Pip          
Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PbarP5p7x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PbarP5p7x << XfUzhi[ii][jj]<<" ";}
      PbarP5p7x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PbarP5p7pt2<<G4Version<<G4endl;
    PbarP5p7pt2<<"  Pt2      P      Neut      Pip      Pim      Kp"
           <<"    Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PbarP5p7pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PbarP5p7pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PbarP5p7pt2<<G4endl;
    }
