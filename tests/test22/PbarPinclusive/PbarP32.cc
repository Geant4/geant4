...
//-------------------------- Global histograms  -------------------------
std::ofstream PbarP32y("PbarP32y.dat",std::ios::out);
//std::ofstream PbarP32x("PbarP32x.dat",std::ios::out);
std::ofstream PbarP32pt2("PbarP32pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PbarP32y<<G4Version<<G4endl;
    PbarP32y<<"  Y          P        Neut       Pip          Pim         Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
      PbarP32y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PbarP32y<<YUzhi[ii][jj]<<" ";}
      PbarP32y<<G4endl;
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PbarP32x<<G4Version<<G4endl;
    PbarP32x<<"  Xf        P        Neut         Pip         Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PbarP32x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PbarP32x << XfUzhi[ii][jj]<<" ";}
      PbarP32x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PbarP32pt2<<G4Version<<G4endl;
    PbarP32pt2<<"  Pt2      P       Neut         Pip       Pim       Kp"
           <<"    Km      Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PbarP32pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PbarP32pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PbarP32pt2<<G4endl;
    }
