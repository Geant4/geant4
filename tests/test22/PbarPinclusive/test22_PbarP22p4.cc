...
//-------------------------- Global histograms  -------------------------
std::ofstream PbarP22p4y("PbarP22p4y.dat",std::ios::out);
//std::ofstream PbarP22p4x("PbarP22p4x.dat",std::ios::out);
std::ofstream PbarP22p4pt2("PbarP22p4pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PbarP22p4y<<G4Version<<G4endl;
    PbarP22p4y<<"  Y         P        Neut       Pip          Pim       Kp"
         <<"       Km       Pbar "<< G4endl;
    ...
    { 
     Yu+=0.1; 
      PbarP22p4y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PbarP22p4y<<YUzhi[ii][jj]<<" ";}
      PbarP22p4y<<G4endl;
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    G4cout<< "******** Xf distr ******* at Plab "<<Plab<<" Xin " << sigIn<< G4endl;
    PbarP22p4x<<G4Version<<G4endl;
    PbarP22p4x<<"  Xf           P          Neut            Pip          
Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PbarP22p4x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PbarP22p4x << XfUzhi[ii][jj]<<" ";}
      PbarP22p4x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PbarP22p4pt2<<G4Version<<G4endl;
    PbarP22p4pt2<<"  Pt2        P        Neut       Pip       Pim         Kp"
           <<"     Km      Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PbarP22p4pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PbarP22p4pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PbarP22p4pt2<<G4endl;
    }
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
