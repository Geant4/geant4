...
//-------------------------- Global histograms  -------------------------
std::ofstream PP158y("PP158y.dat",std::ios::out);
std::ofstream PP158x("PP158x.dat",std::ios::out);
//std::ofstream PP158pt2("PP158pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    { 
     ...
     {
      PP158y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PP158y<<YUzhi[ii][jj]<<" ";}
      PP158y<<G4endl;
     }
    }
//
...
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    { 
     ...
     {
      PP158x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PP158x << XfUzhi[ii][jj]<<" ";}
      PP158x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PP158pt2<<"  Pt2          P          Neut            Pip          Pim          Kp"
           <<"          Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PP158pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PP158pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PP158pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
