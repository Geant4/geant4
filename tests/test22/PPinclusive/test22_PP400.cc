...
//-------------------------- Global histograms  -------------------------
std::ofstream PP400y("PP400y.dat",std::ios::out);
std::ofstream PP400x("PP400x.dat",std::ios::out);
//std::ofstream PP400pt2("PP400pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PP400y<<G4Version<<G4endl;
    PP400y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     ...
     {
      PP400y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PP400y<<YUzhi[ii][jj]<<" ";}
      PP400y<<G4endl;
     }
    }
//
...
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    PP400x<<G4Version<<G4endl;
    PP400x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PP400x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PP400x << XfUzhi[ii][jj]<<" ";}
      PP400x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PP400pt2<<"  Pt2          P          Neut            Pip          Pim          Kp"
           <<"          Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PP400pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PP400pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PP400pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
