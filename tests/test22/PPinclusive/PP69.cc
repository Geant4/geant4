...
//-------------------------- Global histograms  -------------------------
std::ofstream PP69y("PP69y.dat",std::ios::out);
//std::ofstream PP69x("PP69x.dat",std::ios::out);
//std::ofstream PP69pt2("PP69pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PP69y<<G4Version<<G4endl;
    PP69y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     ...
     {
      PP69y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PP69y<<YUzhi[ii][jj]<<" ";}
      PP69y<<G4endl;
     }
    }
/*
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    PP69x<<G4Version<<G4endl;
    PP69x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PP69x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PP69x << XfUzhi[ii][jj]<<" ";}
      PP69x<<G4endl;
     }
    }  
*/
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    { 
     Pt2u+=0.015; 
     PP69pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PP69pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PP69pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
