...
//-------------------------- Global histograms  -------------------------
std::ofstream PP100y("PP100y.dat",std::ios::out);
std::ofstream PP100x("PP100x.dat",std::ios::out);
//std::ofstream PP100pt2("PP100pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PP100y<<G4Version<<G4endl;
    PP100y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     ...
     {
      PP100y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PP100y<<YUzhi[ii][jj]<<" ";}
      PP100y<<G4endl;
     }
    }
//
...
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    PP100x<<G4Version<<G4endl;
    PP100x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PP100x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PP100x << XfUzhi[ii][jj]<<" ";}
      PP100x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PP100pt2<<"  Pt2          P          Neut            Pip          Pim          Kp"
           <<"          Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PP100pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PP100pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PP100pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
