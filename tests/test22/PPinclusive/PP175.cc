...
//-------------------------- Global histograms  -------------------------
//std::ofstream PP175y("PP175y.dat",std::ios::out);
std::ofstream PP175x("PP175x.dat",std::ios::out);
//std::ofstream PP175pt2("PP175pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PP175y<<G4Version<<G4endl;
    PP175y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     ...
     {
      PP175y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PP175y<<YUzhi[ii][jj]<<" ";}
      PP175y<<G4endl;
     }
    }
*/
...
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    PP175x<<G4Version<<G4endl;
    PP175x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PP175x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PP175x << XfUzhi[ii][jj]<<" ";}
      PP175x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    Pp175pt2<<G4Version<<G4endl;
    PP175pt2<<"  Pt2          P          Neut            Pip          Pim          Kp"
           <<"          Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PP175pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PP175pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PP175pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
