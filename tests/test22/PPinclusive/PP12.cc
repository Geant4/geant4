...
//-------------------------- Global histograms  -------------------------
std::ofstream PP12y("PP12y.dat",std::ios::out);
std::ofstream PP12x("PP12x.dat",std::ios::out);
std::ofstream PP12pt2("PP12pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PP12y<<G4Version<<G4endl;
    PP12y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     ...
     {
      PP12y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PP12y<<YUzhi[ii][jj]<<" ";}
      PP12y<<G4endl;
     }
    }
...
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    PP12x<<G4Version<<G4endl;
    PP12x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PP12x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PP12x << XfUzhi[ii][jj]<<" ";}
      PP12x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    { 
     Pt2u+=0.015; 
     PP12pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PP12pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PP12pt2<<G4endl;
    }
