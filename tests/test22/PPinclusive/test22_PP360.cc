...
//-------------------------- Global histograms  -------------------------
//std::ofstream PP360y("PP360y.dat",std::ios::out);
std::ofstream PP360x("PP360x.dat",std::ios::out);
//std::ofstream PP360pt2("PP360pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PP360y<<G4Version<<G4endl;
    PP360y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     ...
     {
      PP360y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PP360y<<YUzhi[ii][jj]<<" ";}
      PP360y<<G4endl;
     }
    }
*/
...
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    PP360x<<G4Version<<G4endl;
    PP360x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PP360x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PP360x << XfUzhi[ii][jj]<<" ";}
      PP360x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    PP360pt2<<"  Pt2          P          Neut            Pip          Pim          Kp"
           <<"          Km     Pbar"<< G4endl;
    ...
    { 
     Pt2u+=0.015; 
     PP360pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PP360pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PP360pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
