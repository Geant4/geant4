...
//-------------------------- Global histograms  -------------------------
std::ofstream PP24y("PP24y.dat",std::ios::out);
std::ofstream PP24x("PP24x.dat",std::ios::out);
//std::ofstream PP24pt2("PP24pt2.dat",std::ios::out);
...
//----------------------------- Rapidity distributions------------------// Uzhi ++++
    ...
    PP24y<<G4Version<<G4endl;
    PP24y<<"  Y            P            Neut         Pip          Pim          Kp"
         <<"          Km       Pbar "<< G4endl;
    ...
    { 
     ...
     {
      PP24y<<Yu<<" ";
      for(G4int jj=0;jj < 7; jj++){PP24y<<YUzhi[ii][jj]<<" ";}
      PP24y<<G4endl;
     }
    }
...
// ----------------------------- Xf distributions----------------------// Uzhi ++++
    ...
    PP24x<<G4Version<<G4endl;
    PP24x<<"  Xf           P          Neut            Pip          Pim          Kp"
        <<"          Km             Pbar"<< G4endl;
    ...
    { 
     ...
     {
      PP24x<<Xu<<" "; 
      for(G4int jj=0;jj < 7; jj++){PP24x << XfUzhi[ii][jj]<<" ";}
      PP24x<<G4endl;
     }
    }  
...
//----------------------------- Pt2 distributions----------------------// Uzhi ++++
    ...
    { 
     Pt2u+=0.015; 
     PP24pt2<<Pt2u<<" ";                                    
     for(G4int jj=0;jj < 7; jj++){PP24pt2 << Pt2Uzhi[ii][jj]<<" ";}
     PP24pt2<<G4endl;
    }
*/
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ Uzhi 
