...
//
//
// $Id: Tst50DetectorConstruction.cc,v 1.21 2003-05-17 18:11:53 guatelli Exp $
...
Tst50DetectorConstruction::Tst50DetectorConstruction()
  :targetMaterial(0),defaultMaterial(0),
   ...
   solidTarget(0),logicTarget(0),physiTarget(0), targetSD(0),
...
{ 
  ...
  density     = 1.e-5*g/cm3;
  pressure    = 2.e-2*bar;
  temperature = STP_Temperature;         //from PhysicalConstants.hh
