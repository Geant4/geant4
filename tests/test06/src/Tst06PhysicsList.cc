...
// and all its terms.
//
// $Id: Tst06PhysicsList.cc,v 1.4 1999-10-03 09:58:02 kurasige Exp $
...
Tst06PhysicsList::Tst06PhysicsList()
: G4VUserPhysicsList()
{
...
void Tst06PhysicsList::ConstructParticle()
{
...
void Tst06PhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void Tst06PhysicsList::ConstructMesons()
{
 //  mesons
...
void Tst06PhysicsList::ConstructBaryons()
{
//  barions
...
void Tst06PhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructGeneral();
...
void Tst06PhysicsList::ConstructEM()
{
...
void Tst06PhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
void Tst06PhysicsList::SetGammaCut(G4double val)
{
  ResetCuts();
  cutForGamma = val;
}
...
void Tst06PhysicsList::SetElectronCut(G4double val)
{
  ResetCuts();
  cutForElectron = val;
}
...
void Tst06PhysicsList::SetProtonCut(G4double val)
{
  ResetCuts();
  cutForProton = val;
}
