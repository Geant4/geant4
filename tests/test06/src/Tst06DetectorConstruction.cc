...
//
//
// $Id: Tst06DetectorConstruction.cc,v 1.4 2003-02-19 17:26:59 vnivanch Exp $
...
Tst06DetectorConstruction::Tst06DetectorConstruction()
:simpleBoxLog(0),selectedMaterial(0),Air(0),Al(0),Pb(0)
{
  detectorMessenger = new Tst06DetectorMessenger(this);
  materialChoice = "Pb";
}
...
void Tst06DetectorConstruction::SelectMaterial(G4String val)
{
  materialChoice = val;
...
void Tst06DetectorConstruction::SelectMaterialPointer()
{
//--------- Material definition ---------
...
G4VPhysicalVolume* Tst06DetectorConstruction::Construct()
{
  SelectMaterialPointer();
