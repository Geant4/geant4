...
// ********************************************************************
//
// $Id: PhysListEmPenelope01.cc,v 1.1 2010/03/19 09:55:53 pandola Exp $
// GEANT4 tag $Name:  $
...
PhysListEmPenelope01::PhysListEmPenelope01(const G4String& name)
...
PhysListEmPenelope01::~PhysListEmPenelope01()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void PhysListEmPenelope01::ConstructProcess()
{
  ...
  while( (*theParticleIterator)() ){
    ...
    if (particleName == "gamma") {
      ...
      G4Penelope01PhotoElectricModel* thePEPenelopeModel = new 
      	G4Penelope01PhotoElectricModel();
      ...
      G4Penelope01ComptonModel* theComptonPenelopeModel = 
      	new G4Penelope01ComptonModel();
      ...
      G4Penelope01GammaConversionModel* theGCPenelopeModel = 
	new G4Penelope01GammaConversionModel();
      theGammaConversion->AddEmModel(0,theGCPenelopeModel);
      pmanager->AddDiscreteProcess(theGammaConversion);
      G4cout << "Using Penelope01 for Gamma Conversion" << G4endl;

      //Rayleigh scattering
      G4RayleighScattering* theRayleigh = new G4RayleighScattering();
      G4Penelope01RayleighModel* theRayleighPenelopeModel = 
	new G4Penelope01RayleighModel();
      ...
      G4cout << "Using Penelope01 for Rayleigh" << G4endl;
      ...
      G4Penelope01IonisationModel* theIoniPenelope = 
	new G4Penelope01IonisationModel();
      ...
      G4Penelope01BremsstrahlungModel* theBremPenelope = new 
      	G4Penelope01BremsstrahlungModel();      
      ...
      G4cout << "Using Penelope01 for e- Bremsstrahlung " << G4endl;
	...
	G4Penelope01BremsstrahlungModel();
      ...
      eBrem->AddEmModel(0,theBremPenelope);
      pmanager->AddProcess(eBrem, -1,-3, 3);
      G4cout << "Using Penelope01 for e+ Bremsshtrahlung " << G4endl;
	...
	G4PenelopeAnnihilationModel();
      ...
      G4cout << "Using Penelope per e+ annihilation" << G4endl;	
