...
// ********************************************************************
//
// $Id: Tst32SteppingAction.cc,v 1.1 2002-06-13 12:16:36 jwellisc Exp $
...
Tst32SteppingAction::Tst32SteppingAction()
{
  nevent = 0;
}
...
void Tst32SteppingAction::UserSteppingAction(const G4Step* theStep)
{
