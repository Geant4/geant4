...
//
//
// $Id: Tst32DetectorMessenger.cc,v 1.1 2002-06-13 12:16:35 jwellisc Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//

#include "Tst32DetectorMessenger.hh"
...
Tst32DetectorMessenger::Tst32DetectorMessenger(Tst32DetectorConstruction * myDC)
:myDetector(myDC)
{
  G4String defParam;
...
void Tst32DetectorMessenger::SetNewValue(G4UIcommand * command,G4String newValues)
{
