...
//
//
// $Id: Tst32DetectorConstruction.cc,v 1.3 2006-06-29 21:59:07 gunter Exp $
...
G4int Tst32DetectorConstruction::materialIndex =-1;
const G4String Tst32DetectorConstruction::materialName[N_MaterialType]
  = {  "Air", "Al", "Pb" };

Tst32DetectorConstruction::Tst32DetectorConstruction()
{
  for (size_t idx=0; idx<N_Regions; idx++) {
    simpleBoxLog[idx]=0;
    selectedMaterial[idx]=0;
  }
  detectorMessenger = new Tst32DetectorMessenger(this);
}
...
void Tst32DetectorConstruction::SelectMaterial(G4String val)
{
...
void Tst32DetectorConstruction::SelectMaterialPointer()
{
//--------- Material definition ---------
...
G4VPhysicalVolume* Tst32DetectorConstruction::Construct()
{
  SelectMaterialPointer();
...
//    G4VPhysicalVolume* simpleBoxDetector0 =
  ...
  G4String SDname = "Tst32";
  Tst32SensitiveDetector* pSD = new Tst32SensitiveDetector( SDname );
...
const G4String& Tst32DetectorConstruction::GetMaterialName(G4int idx)
{
