...
// and all its terms.
//
// $Id: Tst12PhysicsList.cc,v 1.3 1999-10-03 10:07:25 kurasige Exp $
...
Tst12PhysicsList::Tst12PhysicsList():  G4VUserPhysicsList()
{
  SetVerboseLevel(1);
}

Tst12PhysicsList::~Tst12PhysicsList()
{
}

void Tst12PhysicsList::ConstructParticle()
{
...
void Tst12PhysicsList::ConstructAllBosons()
{
...
void Tst12PhysicsList::ConstructAllLeptons()
{
...
void Tst12PhysicsList::ConstructAllMesons()
{
...
void Tst12PhysicsList::ConstructAllBaryons()
{
...
void Tst12PhysicsList::ConstructAllIons()
{
...
void Tst12PhysicsList::ConstructAllShortLiveds()
{
...
void Tst12PhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructLeptHad();
...
void Tst12PhysicsList::ConstructHad()
{
...
void Tst12PhysicsList::ConstructLeptHad()
{;}

#include "G4Decay.hh"
void Tst12PhysicsList::ConstructGeneral()
{
...
void Tst12PhysicsList::SetCuts()
{
  if (verboseLevel >0){
    G4cout << "Tst12PhysicsList::SetCuts:";
