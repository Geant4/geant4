...
Tst51PhotonPenelope::Tst51PhotonPenelope(const G4String& name): G4VPhysicsConstructor(name)
{ }

Tst51PhotonPenelope::~Tst51PhotonPenelope()
{ }

void Tst51PhotonPenelope::ConstructProcess()
{
