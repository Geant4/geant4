...
Tst51PhotonStandard::Tst51PhotonStandard(const G4String& name): G4VPhysicsConstructor(name)
{ }

Tst51PhotonStandard::~Tst51PhotonStandard()
{ }

void Tst51PhotonStandard::ConstructProcess()
{
