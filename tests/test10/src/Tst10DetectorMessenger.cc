  ...
  : myDetector(myDC)
{
  ...
  selDetCmd->SetCandidates("Sphere Orb Box Cone Tube Hype Torus Para Paraboloid Trd GenericTrap Polyhedra Polycone TwistedBox TwistedTrd TwistedTrap TwistedTrap2");
