...
// which is converted to the standard G4VParticleChange in the Test39HadronProduction 
...
// ======================================================================================
//
//      ---------- Test39VSecondaryGenerator -------
// 
//    Converted from Test29 to Test39 by Mikhail Kossov, 7 Jan 2005 
//
//---------------------------------------------------------------------------------------

#ifndef Test39VSecondaryGenerator_Test39VSecondaryGenerator_h
#define Test39VSecondaryGenerator_Test39VSecondaryGenerator_h 1
...
class Test39VSecondaryGenerator
{
public:

  Test39VSecondaryGenerator(G4HadronicInteraction* hadi, G4Material* mat);
  virtual ~Test39VSecondaryGenerator();
...
private:
  ...
  Test39VSecondaryGenerator(const Test39VSecondaryGenerator&);
  Test39VSecondaryGenerator& operator = (const Test39VSecondaryGenerator &right);
...
#endif  // Test39VSecondaryGenerator_Test39VSecondaryGenerator_h
