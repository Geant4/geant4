...
// and all its terms.
//
// $Id: Tst14DetectorConstruction.cc,v 1.2 1999-06-14 14:26:14 aforti Exp $
...
void Tst14DetectorConstruction::SelectMaterial(G4String val)
{
  materialChoice = val;
...
void Tst14DetectorConstruction::SelectMaterialPointer()
{
//--------- Material definition ---------
