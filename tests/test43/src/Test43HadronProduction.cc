...
Test43HadronProduction::Test43HadronProduction(const G4String& aName)
...
void Test43HadronProduction::InitializeMe()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

Test43HadronProduction::~Test43HadronProduction()
{
...
G4double Test43HadronProduction::PostStepGetPhysicalInteractionLength(
                       const G4Track&,
                             G4double,
...
void Test43HadronProduction::SetSecondaryGenerator(Test43VSecondaryGenerator* gen)
{
  if(theGenerator) delete theGenerator;
  theGenerator = gen;
}
...
G4VParticleChange* Test43HadronProduction::PostStepDoIt(
                    const G4Track& track,
                    const G4Step&)
{
