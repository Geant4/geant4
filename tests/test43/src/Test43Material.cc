...
void Test43Material::Initialise()
{
...
G4Material* Test43Material::GetMaterial(const G4String& name)
{ 

  //  const G4MaterialTable* theMaterialTable = G4Material::GetMaterialTable();

    G4Material* ma= 
    G4NistManager::Instance()->FindOrBuildMaterial(name, false);

    if ( !ma ) G4Material* ma = G4Material::GetMaterial(name);
