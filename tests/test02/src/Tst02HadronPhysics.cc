...
// and all its terms.
//
// $Id: Tst02HadronPhysics.cc,v 1.1 2001-01-06 07:04:25 kurasige Exp $
...
Tst02HadronPhysics::Tst02HadronPhysics(const G4String& name)
                    :  G4VPhysicsConstructor(name)
{
}

Tst02HadronPhysics::~Tst02HadronPhysics()
{
}
...
void Tst02HadronPhysics::ConstructParticle()
{
...
void Tst02HadronPhysics::ConstructProcess()
{
