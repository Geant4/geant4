...
// and all its terms.
//
// $Id: Tst02PhysicsList.cc,v 1.3 1999-10-03 09:49:55 kurasige Exp $
...
Tst02PhysicsList::Tst02PhysicsList():  G4VUserPhysicsList()
{
  SetVerboseLevel(1);
}
...
void Tst02PhysicsList::ConstructParticle()
{
...
void Tst02PhysicsList::ConstructAllBaryons()
{
...
void Tst02PhysicsList::ConstructEM()
{
...
void Tst02PhysicsList::ConstructHad()
{
...
void Tst02PhysicsList::ConstructLeptHad()
{;}

#include "G4Decay.hh"
void Tst02PhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
void Tst02PhysicsList::AddParameterisation()
{
