...
// and all its terms.
//
// $Id: Tst02IonPhysics.cc,v 1.1 2001-01-06 07:04:26 kurasige Exp $
...
Tst02IonPhysics::Tst02IonPhysics(const G4String& name)
                 :  G4VPhysicsConstructor(name)
{
}

Tst02IonPhysics::~Tst02IonPhysics()
{
}
...
void Tst02IonPhysics::ConstructParticle()
{
...
void Tst02IonPhysics::ConstructProcess()
{
