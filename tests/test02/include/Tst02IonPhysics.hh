...
// and all its terms.
//
// $Id: Tst02IonPhysics.hh,v 1.1 2001-01-06 07:04:25 kurasige Exp $
...
// ------------------------------------------------------------
#ifndef Tst02IonPhysics_h
#define Tst02IonPhysics_h 1
...
class Tst02IonPhysics : public G4VPhysicsConstructor
{
  public: 
    Tst02IonPhysics(const G4String& name="ion");
    virtual ~Tst02IonPhysics();
