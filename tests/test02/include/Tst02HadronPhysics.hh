...
// and all its terms.
//
// $Id: Tst02HadronPhysics.hh,v 1.1 2001-01-06 07:04:24 kurasige Exp $
...
// ------------------------------------------------------------
#ifndef Tst02HadronPhysics_h
#define Tst02HadronPhysics_h 1
...
class Tst02HadronPhysics : public G4VPhysicsConstructor
{
  public: 
    Tst02HadronPhysics(const G4String& name ="hadron");
    virtual ~Tst02HadronPhysics();
