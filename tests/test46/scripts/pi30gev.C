...
Int_t i;
gPad->SetLogx();
TH1F* hh = gPad->DrawFrame(0.005,0.10,200,0.20,tit[1]);
...
// patch02
Double_t e0[nd] = {0.1791, 0.1795, 0.1778, 0.1766, 0.1781, 0.1758, 0.1774, 0.1755, 0.1763};
Double_t e1[nd] = {0.1696, 0.1712, 0.1715, 0.1695, 0.1695, 0.1670, 0.1680, 0.1672, 0.1679};
Double_t e2[nd] = {0.1774, 0.1783, 0.1768, 0.1766, 0.1782, 0.1726, 0.1594, 0.1562, 0.1019};
