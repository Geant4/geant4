...
//
//
// $Id: Tst63DetectorMessenger.cc,v 1.1 2009-07-30 13:43:43 gunter Exp $
...
Tst63DetectorMessenger::Tst63DetectorMessenger(Tst63DetectorConstruction * myDC)
:myDetector(myDC)
{
  G4String defParam;
...
Tst63DetectorMessenger::~Tst63DetectorMessenger()
{
  delete selMatCmd;
  delete mydetDir;
}

void Tst63DetectorMessenger::SetNewValue(G4UIcommand * command,G4String newValues)
{
