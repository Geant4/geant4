...
//
//
// $Id: Tst63PhysicsList.cc,v 1.1 2009-07-30 13:43:43 gunter Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
#include "globals.hh"
#include "Tst63PhysicsList.hh"
...
Tst63PhysicsList::Tst63PhysicsList():  G4VUserPhysicsList()
{
  SetVerboseLevel(1);
}

Tst63PhysicsList::~Tst63PhysicsList()
{
}

void Tst63PhysicsList::ConstructParticle()
{
...
void Tst63PhysicsList::ConstructAllBosons()
{
...
void Tst63PhysicsList::ConstructAllLeptons()
{
...
void Tst63PhysicsList::ConstructAllMesons()
{
...
void Tst63PhysicsList::ConstructAllBaryons()
{
...
void Tst63PhysicsList::ConstructAllIons()
{
...
void Tst63PhysicsList::ConstructAllShortLiveds()
{
...
void Tst63PhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructLeptHad();
...
void Tst63PhysicsList::ConstructEM()
{
...
void Tst63PhysicsList::ConstructHad()
{
    ...
    G4ExcitationHandler * theHandler = new G4ExcitationHandler;
        ...
        theHandler->SetMaxAandZForFermiBreakUp(63, 6);
...
void Tst63PhysicsList::ConstructLeptHad()
{;}

#include "G4Decay.hh"
void Tst63PhysicsList::ConstructGeneral()
{
...
void Tst63PhysicsList::SetCuts()
{
  if (verboseLevel >0){
    G4cout << "Tst63PhysicsList::SetCuts:";
