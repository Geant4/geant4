...
//
//
// $Id: Tst63DetectorConstruction.cc,v 1.1 2009-07-30 13:43:43 gunter Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//

#include "Tst63DetectorConstruction.hh"

#include "Tst63DetectorMessenger.hh"
...
Tst63DetectorConstruction::Tst63DetectorConstruction()
:simpleBoxLog(0),selectedMaterial(0),Air(0),Al(0),Pb(0),elN(0),elO(0)
{
  detectorMessenger = new Tst63DetectorMessenger(this);
  materialChoice = "Pb";
}
...
void Tst63DetectorConstruction::SelectMaterial(G4String val)
{
  materialChoice = val;
...
void Tst63DetectorConstruction::SelectMaterialPointer()
{
//--------- Material definition ---------
...
G4VPhysicalVolume* Tst63DetectorConstruction::Construct()
{
  SelectMaterialPointer();
