...
//
//
// $Id: Tst20PhysicsListMessenger.cc,v 1.5 2007-11-09 18:33:00 pia Exp $
...
Tst20PhysicsListMessenger::Tst20PhysicsListMessenger(Tst20PhysicsList * list) : physicsList(list)
{
