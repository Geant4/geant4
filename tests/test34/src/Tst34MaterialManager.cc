...
void Tst34MaterialManager::storeElement(G4String name,G4String symbol, double z, double a)
{
...
void Tst34MaterialManager::storeMaterial(G4String name, double z, double a, double d)
{
...
void Tst34MaterialManager::storeMaterial(G4String name, double d, int ncomponent)
{
	if (mlist.find(name)!=mlist.end())
	{
		cout<<"attempt of redefining an existing material "<<endl;
...
void Tst34MaterialManager::addMaterial(G4String n1,G4String n2,double fraction)
{
	G4Material *mat=getMaterial(n1);
	mat->AddMaterial(getMaterial(n2),fraction);
}

void Tst34MaterialManager::addElement(G4String n1,G4String n2,double fraction)
{
	G4Material *mat=getMaterial(n1);
	mat->AddElement(getElement(n2),fraction);
}

void Tst34MaterialManager::addElement(G4String n1,G4String n2,int natoms)
{
	G4Material *mat=getMaterial(n1);
