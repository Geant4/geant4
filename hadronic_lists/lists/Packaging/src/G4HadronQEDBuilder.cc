...
#include "PortingDisclaimer.hh"

G4HadronQEDBuilder::G4HadronQEDBuilder(): wasActivated(false) 
{
  if(!(PortingDisclaimer::PrintLocalDisclaimer()))
  {
      G4Exception("G4HadronQEDBuilder", "007", FatalException,
                   "library screw-up: linking went badly wrong" );
  }
}
