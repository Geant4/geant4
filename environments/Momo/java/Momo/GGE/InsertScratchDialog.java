...
public class InsertScratchDialog extends JDialog implements ActionListener{
   JButton b1, b2;
   JLabel label1, label2;
   private MaterialFrame matFrame;
   public InsertScratchDialog(MaterialFrame matFrame){
      super(matFrame,"Insert Material (Scratch)",false);
