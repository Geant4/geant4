...
// ********************************************************************
//
// $Id: G4IonBuilder.cc,v 1.1 2005-11-11 12:23:11 vnivanch Exp $
...
G4IonBuilder::G4IonBuilder(const G4String& name)
                  :  G4VPhysicsConstructor(name), wasActivated(false)
{
}

G4IonBuilder::~G4IonBuilder()
{
  if(wasActivated) {
...
void G4IonBuilder::ConstructProcess()
{
 ...
 void G4IonBuilder::ConstructParticle()
 {
