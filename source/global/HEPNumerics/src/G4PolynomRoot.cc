...
// G4PolynomRoot.cc
//
//// Algorithm based on : Jenkins-Traub
//
...
void G4PolynomRoot::ComputeFixedShiftPolynomial(G4int l2,G4int *nz)
{
...
void G4PolynomRoot::QuadraticPolynomialIteration(G4double *uu,G4double *vv,G4int *nz)
{
 ...
 */
  G4double ui,vi;
  G4double mp,omp,ee,relstp,t,zm;
 ...
 */
  ...
  ee *= (5.0 *mre + 4.0*are);
  ee = ee - (5.0*mre+2.0*are)*(std::fabs(a+t)+std::fabs(b)*zm)+2.0*are*std::fabs(t);
...
void G4PolynomRoot::RealPolynomialIteration(G4double *sss, G4int *nz, G4int *iflag)
{
...
void G4PolynomRoot::ComputeScalarFactors(G4int *type)
{
...
void G4PolynomRoot::ComputeNextPolynomial(G4int *type)
{
...
void G4PolynomRoot::ComputeNewEstimate(G4int type,G4double *uu,G4double *vv)
{
...
void G4PolynomRoot::Quadratic(G4double a,G4double b1,G4double c,G4double *sr,G4double *si,
