...
#define G4VERSION_TAG "$Name: geant4-10-06-patch-03 $"
#endif
...
static const G4String G4Version = "$Name: geant4-10-06-patch-03 [MT]$";
#else
static const G4String G4Version = "$Name: geant4-10-06-patch-03 $";
#endif
