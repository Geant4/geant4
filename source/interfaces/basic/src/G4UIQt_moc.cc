...
**      by: The Qt MOC ($Id: G4UIQt_moc.cc,v 1.9 2007/11/30 14:28:50 lgarnier Exp $)
**
...
QMetaObject* G4UIQt::staticMetaObject()
{
    ...
    static const QUMethod slot_5 = {"HelpTreeDoubleClicCallback", 1, param_slot_5 };
	...
	{ "HelpTreeDoubleClicCallback(QListViewItem*)", &slot_5, QMetaData::Private },
...
bool G4UIQt::qt_invoke( int _id, QUObject* _o )
{
    ...
    case 5: HelpTreeDoubleClicCallback((QListViewItem*)static_QUType_ptr.get(_o+1)); break;
...
#if defined(Q_MOC_OUTPUT_REVISION) && (Q_MOC_OUTPUT_REVISION == 58)

/****************************************************************************
** Meta object code from reading C++ file 'G4UIQt.hh'
**
** Created: jeu. 22. nov. 13:59:01 2007
...
static const char qt_meta_stringdata_G4UIQt[] = {
    "G4UIQt\0\0text\0myClicked(QString)\0ExitSession()\0"
    "ClearButtonCallback()\0CommandEnteredCallback()\0"
    "ButtonCallback(QString)\0HelpTreeClicCallback()\0ShowHelpCallback()\0"
    "CommandHistoryCallback()\0"
};
...
#if defined(Q_MOC_OUTPUT_REVISION) && (Q_MOC_OUTPUT_REVISION == 59)
