...
// ********************************************************************
//
// Original Author: G.Barrand
//
// This UI was rewritten by Ovidio Pena-Rodriguez (March, 2021)
// --------------------------------------------------------------------
...
G4bool G4UIWin32::CreateComponents(HWND aWindow) {
    ...
    int btnBMP[NUM_BUTTONS] = {STD_FILEOPEN, STD_FILESAVE, -1,
                               STD_FIND, STD_FIND, -1,
                               15 + HIST_FORWARD, -1,
                               STD_HELP, -1,
                               STD_FILENEW, STD_FILESAVE};
    int btnSTL[NUM_BUTTONS] = {TBSTYLE_BUTTON, TBSTYLE_BUTTON, TBSTYLE_SEP,
                               TBSTYLE_BUTTON, TBSTYLE_BUTTON, TBSTYLE_SEP,
                               TBSTYLE_BUTTON, TBSTYLE_SEP,
                               TBSTYLE_BUTTON, TBSTYLE_SEP,
                               TBSTYLE_BUTTON, TBSTYLE_BUTTON};
    int btnCMD[NUM_BUTTONS] = {ID_OPEN_MACRO, ID_SAVE_VIEWER_STATE, -1,
...
G4bool G4UIWin32::ResizeComponents(HWND aWindow) {
    ...
    int iTreeViewHeight, iTreeViewWidth;
    int iEditHeight, iEditWidth;
...
void G4UIWin32::AddText(LPSTR text) {
    if ((fHWndEditor != nullptr) && (text != nullptr) && (text[0] != '\0')) {
        ...
        int ndx = GetWindowTextLength(fHWndEditor);
...
/****************************************************************************************************/
/*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
G4bool ConvertStringToInt(const char* aString, int& aInt) {
    aInt = 0;
