...
,fLastQTabSizeY(0)
{
  ...
  fCoutTBWidget = new QWidget(fUITabWidget);
  fVisParametersTBWidget = new QWidget(fUITabWidget);
  ...
  fMyVSplitter->addWidget(fUITabWidget);
