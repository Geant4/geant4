...
class G4Event 
{
  ...
  extern G4DLLEXPORT G4ThreadLocal G4Allocator<G4Event> *anEventAllocator_G4MT_TLS_;
#else
  extern G4DLLIMPORT G4ThreadLocal G4Allocator<G4Event> *anEventAllocator_G4MT_TLS_;
#endif
