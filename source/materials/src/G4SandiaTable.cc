...
// $Id: G4SandiaTable.cc,v 1.38 2010-11-19 14:52:12 grichine Exp $
...
{  
  ...
  if ( fVerbose > 0 )
  {
    G4cout<<fMaterial->GetName()<<G4endl;

    for( G4int i = 0; i <= interval2; i++)
    {
      G4cout<<i<<"\t"<<GetSandiaMatTablePAI(i,0)/eV<<"\t"<<this->GetSandiaMatTablePAI(i,1)
