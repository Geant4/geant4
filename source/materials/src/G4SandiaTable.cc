...
G4double  
G4SandiaTable::GetSandiaCofForMaterialPAI(G4int interval, G4int j) const
{
...
const G4double* 
G4SandiaTable::GetSandiaCofForMaterialPAI(G4double energy) const
{
...
G4double
G4SandiaTable::GetIonizationPot(G4int Z) const
{
  assert (Z>0 && Z<101);
