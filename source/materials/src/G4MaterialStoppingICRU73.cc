...
//
//
// $Id: G4MaterialStoppingICRU73.cc,v 1.5 2009-03-18 10:15:10 alechner Exp $
					   ...
					   const G4String& matName)
{
  ...
  if( matName == namesMat[0] ) {
     ...
     if( ionZ == 3 ) {
        G4double Y_3[53]={1.481,1.6,1.8,1.961,2.091,2.197,2.28,2.347,2.399,2.52,2.526,2.488,2.432,2.302,2.17,2.046,1.932,1.829,1.735,1.649,1.321,1.102,0.9471,0.8318,0.6725,0.5676,0.4931,0.4374,0.394,0.3592,0.3306};
        physicsVector = CreatePhysicsVector(E,Y_3,factor);
     }
     else if( ionZ == 4 ) {
        G4double Y_4[53]={1.894,2.058,2.337,2.571,2.77,2.938,3.08,3.198,3.296,3.576,3.664,3.67,3.638,3.521,3.379,3.233,3.092,2.958,2.833,2.716,2.242,1.905,1.656,1.464,1.193,1.009,0.8775,0.7783,0.7009,0.6388,0.5877};
        physicsVector = CreatePhysicsVector(E,Y_4,factor);
     }
     else if( ionZ == 5 ) {
        G4double Y_5[53]={2.237,2.443,2.798,3.099,3.361,3.59,3.79,3.963,4.112,4.582,4.781,4.853,4.861,4.786,4.657,4.508,4.355,4.203,4.057,3.917,3.321,2.871,2.525,2.252,1.852,1.575,1.372,1.218,1.097,1,0.9198};
        physicsVector = CreatePhysicsVector(E,Y_5,factor);
     }
     else if( ionZ == 6 ) {
        G4double Y_6[53]={2.522,2.767,3.196,3.564,3.887,4.174,4.429,4.656,4.856,5.536,5.867,6.022,6.085,6.072,5.972,5.835,5.681,5.521,5.362,5.207,4.515,3.965,3.527,3.172,2.638,2.258,1.974,1.756,1.584,1.444,1.328};
        physicsVector = CreatePhysicsVector(E,Y_6,factor);
     }
     else if( ionZ == 7 ) {
        G4double Y_7[53]={2.767,3.047,3.541,3.97,4.349,4.69,4.997,5.274,5.523,6.419,6.901,7.156,7.287,7.359,7.305,7.192,7.049,6.892,6.729,6.565,5.804,5.168,4.645,4.212,3.542,3.052,2.681,2.391,2.16,1.97,1.813};
        physicsVector = CreatePhysicsVector(E,Y_7,factor);
     }
     else if( ionZ == 8 ) {
        G4double Y_8[53]={2.982,3.293,3.847,4.333,4.766,5.158,5.514,5.839,6.135,7.245,7.888,8.255,8.465,8.639,8.644,8.566,8.443,8.297,8.137,7.972,7.164,6.457,5.86,5.354,4.552,3.952,3.488,3.121,2.825,2.581,2.377};
        physicsVector = CreatePhysicsVector(E,Y_8,factor);
     }
     else if( ionZ == 9 ) {
        G4double Y_9[53]={3.17,3.508,4.116,4.653,5.135,5.573,5.973,6.341,6.68,7.991,8.796,9.279,9.572,9.852,9.921,9.882,9.783,9.65,9.498,9.335,8.499,7.738,7.079,6.512,5.596,4.896,4.347,3.906,3.547,3.248,2.997};
        physicsVector = CreatePhysicsVector(E,Y_9,factor);
     }
     else if( ionZ == 10 ) {
        G4double Y_10[53]={3.34,3.702,4.357,4.942,5.469,5.95,6.392,6.801,7.18,8.682,9.65,10.26,10.64,11.04,11.18,11.18,11.11,11,10.86,10.7,9.851,9.046,8.335,7.713,6.693,5.897,5.265,4.752,4.329,3.975,3.676};
        physicsVector = CreatePhysicsVector(E,Y_10,factor);
     }
     else if( ionZ == 11 ) {
        G4double Y_11[53]={3.478,3.859,4.556,5.183,5.753,6.275,6.757,7.205,7.623,9.316,10.45,11.19,11.68,12.21,12.44,12.5,12.47,12.38,12.25,12.11,11.26,10.42,9.668,8.996,7.875,6.986,6.27,5.682,5.193,4.78,4.428};
        physicsVector = CreatePhysicsVector(E,Y_11,factor);
     }
     else if( ionZ == 12 ) {
        G4double Y_12[53]={3.623,4.019,4.749,5.412,6.018,6.578,7.096,7.578,8.029,9.891,11.19,12.06,12.65,13.32,13.64,13.76,13.77,13.71,13.6,13.47,12.63,11.77,10.98,10.27,9.058,8.087,7.294,6.638,6.087,5.62,5.218};
        physicsVector = CreatePhysicsVector(E,Y_12,factor);
     }
     else if( ionZ == 13 ) {
        G4double Y_13[53]={3.754,4.165,4.923,5.616,6.256,6.849,7.401,7.917,8.4,10.42,11.88,12.88,13.58,14.4,14.82,15.01,15.07,15.04,14.96,14.85,14.04,13.16,12.33,11.58,10.3,9.246,8.38,7.655,7.042,6.518,6.066};
        physicsVector = CreatePhysicsVector(E,Y_13,factor);
     }
     else if( ionZ == 14 ) {
        G4double Y_14[53]={3.88,4.303,5.086,5.806,6.474,7.097,7.68,8.225,8.738,10.9,12.51,13.65,14.45,15.43,15.95,16.21,16.32,16.34,16.28,16.18,15.41,14.52,13.67,12.89,11.53,10.41,9.478,8.69,8.019,7.442,6.941};
        physicsVector = CreatePhysicsVector(E,Y_14,factor);
     }
     else if( ionZ == 15 ) {
        G4double Y_15[53]={4,4.433,5.238,5.982,6.678,7.329,7.94,8.515,9.057,11.36,13.11,14.39,15.31,16.46,17.1,17.45,17.63,17.69,17.67,17.6,16.9,16.02,15.15,14.34,12.92,11.72,10.71,9.853,9.117,8.48,7.924};
        physicsVector = CreatePhysicsVector(E,Y_15,factor);
     }
     else if( ionZ == 16 ) {
        G4double Y_16[53]={4.111,4.556,5.384,6.154,6.876,7.554,8.193,8.796,9.366,11.81,13.7,15.11,16.14,17.47,18.23,18.68,18.92,19.03,19.06,19.02,18.4,17.54,16.66,15.83,14.34,13.08,12,11.07,10.27,9.578,8.966};
        physicsVector = CreatePhysicsVector(E,Y_16,factor);
     }
     else if( ionZ == 17 ) {
        G4double Y_17[53]={4.234,4.688,5.534,6.322,7.066,7.768,8.431,9.058,9.652,12.22,14.24,15.78,16.92,18.43,19.31,19.85,20.16,20.33,20.39,20.39,19.85,19.01,18.13,17.28,15.74,14.41,13.27,12.28,11.43,10.67,10.01};
        physicsVector = CreatePhysicsVector(E,Y_17,factor);
     }
     else if( ionZ == 18 ) {
        G4double Y_18[53]={4.333,4.796,5.658,6.463,7.224,7.946,8.63,9.28,9.896,12.58,14.71,16.37,17.63,19.31,20.31,20.94,21.32,21.54,21.64,21.67,21.21,20.38,19.49,18.63,17.04,15.65,14.46,13.42,12.51,11.72,11.01};
     ...
     if( ionZ == 3 ) {
        G4double Z_3[53]={1.572,1.764,2.123,2.452,2.743,2.998,3.22,3.417,3.593,4.244,4.656,4.924,5.094,5.266,5.319,5.315,5.281,5.229,5.167,5.099,4.73,4.375,4.056,3.775,3.31,2.946,2.656,2.419,2.222,2.057,1.915};
        physicsVector = CreatePhysicsVector(E,Z_3,factor);
     }
     else if( ionZ == 4 ) {
        G4double Z_4[53]={1.032,1.139,1.311,1.439,1.539,1.618,1.683,1.737,1.781,1.917,1.966,1.971,1.955,1.896,1.828,1.759,1.693,1.631,1.571,1.516,1.284,1.113,0.983,0.8813,0.7334,0.6312,0.5563,0.4989,0.4534,0.4163,0.3856};
        physicsVector = CreatePhysicsVector(E,Z_4,factor);
     }
     else if( ionZ == 5 ) {
        G4double Z_5[53]={1.181,1.315,1.542,1.72,1.861,1.977,2.073,2.154,2.224,2.452,2.56,2.603,2.61,2.574,2.512,2.443,2.372,2.302,2.234,2.169,1.883,1.66,1.483,1.34,1.127,0.9759,0.863,0.7755,0.7057,0.6485,0.6009};
        physicsVector = CreatePhysicsVector(E,Z_5,factor);
     }
     else if( ionZ == 6 ) {
        G4double Z_6[53]={1.3,1.455,1.729,1.954,2.137,2.29,2.419,2.529,2.625,2.955,3.132,3.222,3.26,3.26,3.214,3.152,3.083,3.011,2.939,2.868,2.542,2.273,2.053,1.871,1.591,1.386,1.231,1.11,1.011,0.9306,0.8628};
        physicsVector = CreatePhysicsVector(E,Z_6,factor);
     }
     else if( ionZ == 7 ) {
        G4double Z_7[53]={1.399,1.569,1.88,2.146,2.369,2.557,2.718,2.858,2.981,3.417,3.669,3.814,3.892,3.94,3.921,3.873,3.811,3.742,3.67,3.597,3.246,2.941,2.682,2.463,2.117,1.858,1.658,1.499,1.369,1.262,1.171};
        physicsVector = CreatePhysicsVector(E,Z_7,factor);
     }
     else if( ionZ == 8 ) {
        G4double Z_8[53]={1.49,1.672,2.01,2.311,2.571,2.793,2.986,3.155,3.305,3.849,4.181,4.385,4.508,4.614,4.628,4.601,4.551,4.49,4.421,4.35,3.985,3.65,3.358,3.105,2.697,2.384,2.138,1.939,1.776,1.64,1.524};
        physicsVector = CreatePhysicsVector(E,Z_8,factor);
     }
     else if( ionZ == 9 ) {
        G4double Z_9[53]={1.572,1.764,2.123,2.452,2.743,2.998,3.22,3.417,3.593,4.244,4.656,4.924,5.094,5.266,5.319,5.315,5.281,5.229,5.167,5.099,4.73,4.375,4.056,3.775,3.31,2.946,2.656,2.419,2.222,2.057,1.915};
        physicsVector = CreatePhysicsVector(E,Z_9,factor);
     }
     else if( ionZ == 10 ) {
        G4double Z_10[53]={1.652,1.85,2.226,2.576,2.895,3.178,3.429,3.652,3.853,4.609,5.103,5.435,5.657,5.901,5.999,6.024,6.009,5.97,5.917,5.855,5.49,5.121,4.779,4.473,3.957,3.545,3.212,2.937,2.707,2.511,2.343};
        physicsVector = CreatePhysicsVector(E,Z_10,factor);
     }
     else if( ionZ == 11 ) {
        G4double Z_11[53]={1.725,1.93,2.319,2.685,3.026,3.335,3.611,3.86,4.085,4.946,5.522,5.921,6.199,6.522,6.671,6.731,6.739,6.717,6.675,6.621,6.271,5.893,5.534,5.205,4.642,4.185,3.81,3.497,3.232,3.006,2.81};
        physicsVector = CreatePhysicsVector(E,Z_11,factor);
     }
     else if( ionZ == 12 ) {
        G4double Z_12[53]={1.8,2.011,2.41,2.788,3.146,3.477,3.777,4.049,4.297,5.258,5.915,6.381,6.713,7.118,7.322,7.42,7.454,7.451,7.423,7.379,7.047,6.665,6.292,5.945,5.34,4.842,4.428,4.079,3.782,3.527,3.304};
        physicsVector = CreatePhysicsVector(E,Z_12,factor);
     }
     else if( ionZ == 13 ) {
        G4double Z_13[53]={1.872,2.089,2.498,2.885,3.256,3.604,3.925,4.219,4.487,5.546,6.283,6.817,7.206,7.697,7.96,8.099,8.163,8.181,8.17,8.138,7.835,7.455,7.072,6.71,6.067,5.53,5.078,4.695,4.366,4.08,3.83};
        physicsVector = CreatePhysicsVector(E,Z_13,factor);
     }
     else if( ionZ == 14 ) {
        G4double Z_14[53]={1.942,2.166,2.583,2.978,3.358,3.72,4.059,4.371,4.66,5.81,6.625,7.226,7.673,8.253,8.577,8.76,8.856,8.897,8.904,8.885,8.619,8.245,7.856,7.481,6.805,6.232,5.746,5.329,4.97,4.656,4.38};
        physicsVector = CreatePhysicsVector(E,Z_14,factor);
     }
     else if( ionZ == 15 ) {
        G4double Z_15[53]={2.007,2.237,2.663,3.065,3.452,3.825,4.178,4.508,4.814,6.052,6.945,7.613,8.119,8.792,9.184,9.417,9.55,9.62,9.648,9.648,9.429,9.07,8.681,8.297,7.592,6.984,6.463,6.013,5.622,5.278,4.975};
        physicsVector = CreatePhysicsVector(E,Z_15,factor);
     }
     else if( ionZ == 16 ) {
        G4double Z_16[53]={2.071,2.309,2.745,3.153,3.546,3.928,4.293,4.638,4.961,6.283,7.25,7.983,8.548,9.316,9.78,10.06,10.24,10.34,10.39,10.41,10.24,9.904,9.518,9.129,8.4,7.761,7.207,6.725,6.303,5.93,5.599};
        physicsVector = CreatePhysicsVector(E,Z_16,factor);
     }
     else if( ionZ == 17 ) {
        G4double Z_17[53]={2.134,2.38,2.826,3.24,3.638,4.025,4.401,4.758,5.095,6.494,7.533,8.331,8.953,9.818,10.35,10.69,10.91,11.04,11.11,11.15,11.05,10.73,10.35,9.958,9.209,8.542,7.959,7.447,6.996,6.597,6.24};
        physicsVector = CreatePhysicsVector(E,Z_17,factor);
     }
     else if( ionZ == 18 ) {
        G4double Z_18[53]={2.199,2.452,2.911,3.332,3.735,4.128,4.511,4.879,5.229,6.701,7.809,8.67,9.348,10.31,10.92,11.31,11.56,11.73,11.83,11.89,11.83,11.54,11.17,10.77,10,9.31,8.699,8.16,7.683,7.258,6.877};
     ...
     if( ionZ == 3 ) {
        G4double XX_3[53]={2.663,2.892,3.261,3.535,3.734,3.875,3.973,4.038,4.08,4.092,3.977,3.829,3.678,3.391,3.138,2.917,2.724,2.553,2.403,2.269,1.774,1.459,1.241,1.082,0.8659,0.7257,0.6271,0.5539,0.4973,0.452,0.415};
        physicsVector = CreatePhysicsVector(E,XX_3,factor);
     }
     else if( ionZ == 4 ) {
        G4double XX_4[53]={3.295,3.605,4.129,4.549,4.881,5.138,5.334,5.481,5.59,5.801,5.764,5.645,5.498,5.186,4.887,4.611,4.361,4.135,3.929,3.741,3.016,2.524,2.17,1.905,1.535,1.289,1.115,0.9851,0.8841,0.8034,0.7374};
        physicsVector = CreatePhysicsVector(E,XX_4,factor);
     }
     else if( ionZ == 5 ) {
        G4double XX_5[53]={3.789,4.174,4.84,5.395,5.855,6.232,6.535,6.778,6.969,7.445,7.532,7.474,7.356,7.057,6.741,6.436,6.148,5.88,5.632,5.402,4.472,3.807,3.311,2.93,2.382,2.011,1.743,1.541,1.383,1.257,1.153};
        physicsVector = CreatePhysicsVector(E,XX_5,factor);
     }
     else if( ionZ == 6 ) {
        G4double XX_6[53]={4.173,4.625,5.421,6.101,6.682,7.175,7.589,7.932,8.214,9.005,9.254,9.283,9.213,8.956,8.645,8.328,8.019,7.723,7.444,7.181,6.08,5.257,4.624,4.125,3.39,2.878,2.503,2.217,1.993,1.812,1.663};
        physicsVector = CreatePhysicsVector(E,XX_6,factor);
     }
     else if( ionZ == 7 ) {
        G4double XX_7[53]={4.521,5.025,5.925,6.708,7.394,7.99,8.506,8.946,9.32,10.46,10.9,11.04,11.04,10.86,10.57,10.26,9.946,9.635,9.336,9.049,7.81,6.846,6.084,5.47,4.544,3.884,3.392,3.012,2.711,2.467,2.266};
        physicsVector = CreatePhysicsVector(E,XX_7,factor);
     }
     else if( ionZ == 8 ) {
        G4double XX_8[53]={4.828,5.377,6.371,7.249,8.029,8.721,9.332,9.866,10.33,11.83,12.49,12.77,12.86,12.77,12.53,12.24,11.92,11.61,11.3,11,9.647,8.56,7.678,6.953,5.837,5.023,4.407,3.926,3.54,3.226,2.964};
        physicsVector = CreatePhysicsVector(E,XX_8,factor);
     }
     else if( ionZ == 9 ) {
        G4double XX_9[53]={5.063,5.651,6.724,7.682,8.543,9.318,10.01,10.63,11.18,13.03,13.93,14.35,14.53,14.54,14.36,14.09,13.79,13.47,13.16,12.85,11.42,10.24,9.259,8.442,7.162,6.211,5.48,4.902,4.435,4.051,3.729};
        physicsVector = CreatePhysicsVector(E,XX_9,factor);
     }
     else if( ionZ == 10 ) {
        G4double XX_10[53]={5.278,5.897,7.037,8.065,8.998,9.846,10.62,11.31,11.94,14.13,15.28,15.86,16.14,16.28,16.16,15.92,15.64,15.33,15.02,14.7,13.21,11.95,10.88,9.983,8.55,7.468,6.625,5.951,5.402,4.947,4.564};
        physicsVector = CreatePhysicsVector(E,XX_10,factor);
     }
     else if( ionZ == 11 ) {
        G4double XX_11[53]={5.468,6.118,7.326,8.428,9.437,10.36,11.22,12,12.71,15.31,16.77,17.58,18.03,18.38,18.38,18.23,18.01,17.74,17.45,17.15,15.65,14.31,13.14,12.13,10.48,9.207,8.196,7.378,6.704,6.141,5.665};
        physicsVector = CreatePhysicsVector(E,XX_11,factor);
     }
     else if( ionZ == 12 ) {
        G4double XX_12[53]={5.677,6.333,7.561,8.693,9.738,10.7,11.6,12.42,13.18,16.06,17.74,18.7,19.24,19.7,19.76,19.63,19.41,19.13,18.84,18.53,16.98,15.58,14.37,13.32,11.6,10.26,9.187,8.317,7.596,6.99,6.474};
        physicsVector = CreatePhysicsVector(E,XX_12,factor);
     }
     else if( ionZ == 13 ) {
        G4double XX_13[53]={5.878,6.551,7.813,8.982,10.07,11.08,12.02,12.9,13.72,16.89,18.83,19.98,20.67,21.32,21.48,21.42,21.24,21,20.72,20.42,18.86,17.42,16.15,15.03,13.18,11.73,10.55,9.59,8.785,8.104,7.521};
        physicsVector = CreatePhysicsVector(E,XX_13,factor);
     }
     else if( ionZ == 14 ) {
        G4double XX_14[53]={6.078,6.766,8.057,9.258,10.38,11.43,12.42,13.34,14.2,17.63,19.83,21.18,22.01,22.84,23.12,23.13,23,22.79,22.53,22.24,20.7,19.22,17.9,16.72,14.77,13.2,11.93,10.88,9.998,9.247,8.6};
        physicsVector = CreatePhysicsVector(E,XX_14,factor);
     }
     else if( ionZ == 15 ) {
        G4double XX_15[53]={6.312,7.015,8.334,9.566,10.72,11.81,12.83,13.79,14.7,18.38,20.82,22.38,23.37,24.41,24.82,24.93,24.86,24.69,24.47,24.21,22.7,21.2,19.83,18.61,16.53,14.86,13.48,12.33,11.36,10.52,9.805};
        physicsVector = CreatePhysicsVector(E,XX_15,factor);
     }
     else if( ionZ == 16 ) {
        G4double XX_16[53]={6.503,7.226,8.58,9.845,11.04,12.16,13.22,14.22,15.16,19.09,21.78,23.54,24.69,25.96,26.52,26.72,26.72,26.6,26.41,26.18,24.73,23.22,21.82,20.55,18.37,16.58,15.1,13.85,12.79,11.88,11.08};
        physicsVector = CreatePhysicsVector(E,XX_16,factor);
     }
     else if( ionZ == 17 ) {
        G4double XX_17[53]={6.746,7.481,8.856,10.14,11.36,12.51,13.6,14.63,15.61,19.74,22.65,24.61,25.92,27.41,28.11,28.4,28.47,28.4,28.25,28.05,26.66,25.15,23.72,22.41,20.13,18.25,16.67,15.34,14.2,13.22,12.36};
        physicsVector = CreatePhysicsVector(E,XX_17,factor);
     }
     else if( ionZ == 18 ) {
        G4double XX_18[53]={6.88,7.63,9.027,10.33,11.57,12.74,13.85,14.91,15.91,20.22,23.34,25.5,26.96,28.67,29.51,29.89,30.03,30.01,29.89,29.71,28.38,26.87,25.42,24.07,21.73,19.77,18.12,16.72,15.52,14.47,13.56};
     ...
     if( ionZ == 3 ) {
        G4double YY_3[53]={2.7,2.933,3.311,3.589,3.789,3.93,4.026,4.09,4.129,4.134,4.014,3.864,3.711,3.421,3.166,2.942,2.747,2.575,2.423,2.288,1.788,1.47,1.25,1.09,0.8721,0.7307,0.6314,0.5576,0.5005,0.4549,0.4176};
        physicsVector = CreatePhysicsVector(E,YY_3,factor);
     }
     else if( ionZ == 4 ) {
        G4double YY_4[53]={3.338,3.654,4.189,4.618,4.955,5.214,5.409,5.555,5.662,5.863,5.82,5.698,5.548,5.232,4.93,4.652,4.4,4.17,3.962,3.773,3.04,2.544,2.187,1.919,1.546,1.298,1.123,0.9916,0.8899,0.8086,0.7421};
        physicsVector = CreatePhysicsVector(E,YY_4,factor);
     }
     else if( ionZ == 5 ) {
        G4double YY_5[53]={3.839,4.23,4.909,5.475,5.944,6.325,6.631,6.874,7.064,7.528,7.607,7.545,7.424,7.121,6.802,6.493,6.203,5.932,5.681,5.449,4.509,3.837,3.337,2.952,2.399,2.025,1.754,1.551,1.392,1.265,1.16};
        physicsVector = CreatePhysicsVector(E,YY_5,factor);
     }
     else if( ionZ == 6 ) {
        G4double YY_6[53]={4.229,4.687,5.496,6.189,6.782,7.283,7.702,8.048,8.33,9.11,9.349,9.373,9.3,9.037,8.723,8.403,8.09,7.792,7.51,7.244,6.131,5.3,4.66,4.156,3.414,2.898,2.52,2.232,2.006,1.823,1.673};
        physicsVector = CreatePhysicsVector(E,YY_6,factor);
     }
     else if( ionZ == 7 ) {
        G4double YY_7[53]={4.586,5.096,6.008,6.805,7.503,8.11,8.634,9.08,9.455,10.58,11.02,11.15,11.15,10.96,10.67,10.36,10.04,9.722,9.419,9.129,7.876,6.902,6.131,5.511,4.576,3.911,3.415,3.032,2.729,2.483,2.28};
        physicsVector = CreatePhysicsVector(E,YY_7,factor);
     }
     else if( ionZ == 8 ) {
        G4double YY_8[53]={4.9,5.456,6.463,7.354,8.146,8.851,9.473,10.01,10.48,11.98,12.63,12.9,12.98,12.89,12.64,12.35,12.03,11.71,11.4,11.09,9.73,8.63,7.739,7.006,5.879,5.058,4.436,3.951,3.563,3.246,2.983};
        physicsVector = CreatePhysicsVector(E,YY_8,factor);
     }
     else if( ionZ == 9 ) {
        G4double YY_9[53]={5.141,5.736,6.822,7.793,8.667,9.455,10.16,10.79,11.35,13.2,14.08,14.5,14.67,14.68,14.49,14.22,13.91,13.59,13.27,12.96,11.52,10.32,9.33,8.504,7.212,6.253,5.515,4.933,4.463,4.075,3.752};
        physicsVector = CreatePhysicsVector(E,YY_9,factor);
     }
     else if( ionZ == 10 ) {
        G4double YY_10[53]={5.361,5.988,7.141,8.182,9.127,9.988,10.77,11.48,12.11,14.32,15.45,16.02,16.3,16.43,16.3,16.06,15.77,15.46,15.14,14.82,13.32,12.04,10.97,10.06,8.609,7.517,6.667,5.988,5.435,4.976,4.591};
        physicsVector = CreatePhysicsVector(E,YY_10,factor);
     }
     else if( ionZ == 11 ) {
        G4double YY_11[53]={5.555,6.214,7.436,8.551,9.573,10.51,11.38,12.17,12.89,15.53,16.98,17.77,18.21,18.55,18.56,18.4,18.17,17.9,17.61,17.31,15.8,14.44,13.25,12.23,10.57,9.277,8.256,7.43,6.75,6.182,5.702};
        physicsVector = CreatePhysicsVector(E,YY_11,factor);
     }
     else if( ionZ == 12 ) {
        G4double YY_12[53]={5.769,6.434,7.677,8.821,9.878,10.86,11.76,12.6,13.37,16.28,17.95,18.9,19.44,19.88,19.93,19.8,19.57,19.3,19,18.68,17.12,15.7,14.48,13.41,11.68,10.32,9.246,8.369,7.642,7.032,6.512};
        physicsVector = CreatePhysicsVector(E,YY_12,factor);
     }
     else if( ionZ == 13 ) {
        G4double YY_13[53]={5.974,6.657,7.934,9.117,10.22,11.24,12.19,13.08,13.91,17.12,19.06,20.2,20.88,21.51,21.67,21.6,21.42,21.17,20.89,20.59,19.02,17.56,16.27,15.14,13.28,11.81,10.62,9.65,8.838,8.152,7.565};
        physicsVector = CreatePhysicsVector(E,YY_13,factor);
     }
     else if( ionZ == 14 ) {
        G4double YY_14[53]={6.18,6.877,8.185,9.4,10.54,11.6,12.59,13.52,14.4,17.88,20.07,21.41,22.23,23.05,23.32,23.33,23.19,22.98,22.72,22.43,20.86,19.37,18.03,16.85,14.87,13.29,12.01,10.95,10.06,9.301,8.65};
        physicsVector = CreatePhysicsVector(E,YY_14,factor);
     }
     else if( ionZ == 15 ) {
        G4double YY_15[53]={6.421,7.134,8.471,9.718,10.89,11.98,13.02,13.99,14.9,18.64,21.09,22.63,23.61,24.64,25.04,25.14,25.07,24.9,24.67,24.41,22.88,21.37,19.99,18.75,16.65,14.95,13.56,12.4,11.42,10.59,9.861};
        physicsVector = CreatePhysicsVector(E,YY_15,factor);
     }
     else if( ionZ == 16 ) {
        G4double YY_16[53]={6.617,7.35,8.723,10,11.21,12.34,13.41,14.42,15.38,19.36,22.06,23.81,24.95,26.21,26.75,26.95,26.95,26.83,26.64,26.4,24.93,23.41,21.99,20.7,18.5,16.69,15.19,13.94,12.87,11.95,11.15};
        physicsVector = CreatePhysicsVector(E,YY_16,factor);
     }
     else if( ionZ == 17 ) {
        G4double YY_17[53]={6.866,7.613,9.008,10.31,11.54,12.7,13.8,14.84,15.83,20.02,22.95,24.9,26.2,27.67,28.36,28.65,28.71,28.64,28.49,28.28,26.87,25.35,23.9,22.57,20.27,18.37,16.78,15.44,14.29,13.29,12.43};
        physicsVector = CreatePhysicsVector(E,YY_17,factor);
     }
     else if( ionZ == 18 ) {
        G4double YY_18[53]={7.003,7.765,9.183,10.51,11.75,12.94,14.06,15.12,16.14,20.5,23.65,25.8,27.25,28.94,29.76,30.15,30.28,30.26,30.14,29.95,28.6,27.08,25.61,24.25,21.87,19.9,18.23,16.82,15.61,14.56,13.64};
     ...
     if( ionZ == 3 ) {
        G4double ZZ_3[53]={2.626,2.84,3.191,3.461,3.665,3.817,3.927,4.004,4.056,4.102,3.998,3.853,3.702,3.413,3.158,2.934,2.739,2.567,2.415,2.28,1.782,1.465,1.247,1.087,0.8706,0.7299,0.631,0.5575,0.5005,0.455,0.4178};
        physicsVector = CreatePhysicsVector(E,ZZ_3,factor);
     }
     else if( ionZ == 4 ) {
        G4double ZZ_4[53]={3.272,3.565,4.061,4.463,4.79,5.052,5.258,5.419,5.542,5.803,5.787,5.675,5.529,5.215,4.912,4.634,4.381,4.152,3.944,3.756,3.026,2.533,2.179,1.913,1.542,1.296,1.122,0.9911,0.8898,0.8087,0.7423};
        physicsVector = CreatePhysicsVector(E,ZZ_4,factor);
     }
     else if( ionZ == 5 ) {
        G4double ZZ_5[53]={3.773,4.142,4.776,5.304,5.749,6.122,6.431,6.684,6.89,7.432,7.551,7.505,7.391,7.091,6.772,6.463,6.172,5.901,5.65,5.418,4.484,3.817,3.322,2.94,2.392,2.02,1.752,1.549,1.391,1.265,1.161};
        physicsVector = CreatePhysicsVector(E,ZZ_5,factor);
     }
     else if( ionZ == 6 ) {
        G4double ZZ_6[53]={4.154,4.593,5.358,6.009,6.568,7.049,7.46,7.809,8.103,8.968,9.262,9.311,9.25,8.994,8.68,8.358,8.045,7.747,7.465,7.199,6.093,5.269,4.636,4.137,3.403,2.891,2.516,2.23,2.004,1.823,1.673};
        physicsVector = CreatePhysicsVector(E,ZZ_6,factor);
     }
     else if( ionZ == 7 ) {
        G4double ZZ_7[53]={4.49,4.984,5.86,6.616,7.276,7.854,8.36,8.799,9.179,10.39,10.89,11.07,11.08,10.9,10.61,10.3,9.974,9.66,9.357,9.068,7.823,6.859,6.097,5.484,4.56,3.9,3.408,3.029,2.727,2.482,2.28};
        physicsVector = CreatePhysicsVector(E,ZZ_7,factor);
     }
     else if( ionZ == 8 ) {
        G4double ZZ_8[53]={4.778,5.321,6.298,7.152,7.907,8.578,9.173,9.7,10.16,11.73,12.46,12.78,12.89,12.81,12.57,12.27,11.95,11.63,11.32,11.01,9.659,8.571,7.691,6.967,5.854,5.042,4.427,3.945,3.56,3.245,2.983};
        physicsVector = CreatePhysicsVector(E,ZZ_8,factor);
     }
     else if( ionZ == 9 ) {
        G4double ZZ_9[53]={4.992,5.575,6.637,7.578,8.418,9.171,9.847,10.45,11,12.9,13.88,14.35,14.56,14.59,14.4,14.13,13.83,13.51,13.19,12.87,11.44,10.26,9.279,8.463,7.187,6.237,5.506,4.928,4.461,4.076,3.753};
        physicsVector = CreatePhysicsVector(E,ZZ_9,factor);
     }
     else if( ionZ == 10 ) {
        G4double ZZ_10[53]={5.182,5.797,6.931,7.948,8.865,9.693,10.44,11.12,11.74,13.98,15.21,15.85,16.17,16.33,16.21,15.98,15.69,15.38,15.06,14.74,13.24,11.98,10.91,10.01,8.584,7.503,6.66,5.986,5.436,4.979,4.595};
        physicsVector = CreatePhysicsVector(E,ZZ_10,factor);
     }
     else if( ionZ == 11 ) {
        G4double ZZ_11[53]={5.352,5.998,7.203,8.3,9.298,10.21,11.04,11.81,12.5,15.13,16.68,17.56,18.04,18.43,18.44,18.29,18.05,17.78,17.48,17.18,15.67,14.32,13.15,12.14,10.5,9.226,8.218,7.401,6.728,6.166,5.69};
        physicsVector = CreatePhysicsVector(E,ZZ_11,factor);
     }
     else if( ionZ == 12 ) {
        G4double ZZ_12[53]={5.542,6.193,7.42,8.551,9.59,10.54,11.42,12.23,12.98,15.85,17.62,18.66,19.26,19.76,19.83,19.7,19.47,19.2,18.89,18.58,17.02,15.62,14.41,13.36,11.64,10.3,9.233,8.362,7.64,7.033,6.516};
        physicsVector = CreatePhysicsVector(E,ZZ_12,factor);
     }
     else if( ionZ == 13 ) {
        G4double ZZ_13[53]={5.724,6.39,7.649,8.82,9.905,10.91,11.84,12.71,13.51,16.66,18.69,19.93,20.68,21.38,21.56,21.5,21.32,21.07,20.79,20.48,18.91,17.47,16.19,15.08,13.24,11.78,10.61,9.641,8.835,8.153,7.569};
        physicsVector = CreatePhysicsVector(E,ZZ_13,factor);
     }
     else if( ionZ == 14 ) {
        G4double ZZ_14[53]={5.905,6.583,7.868,9.073,10.2,11.25,12.23,13.14,13.99,17.4,19.66,21.1,22.01,22.91,23.21,23.22,23.09,22.87,22.61,22.32,20.76,19.28,17.95,16.78,14.83,13.26,11.99,10.94,10.06,9.304,8.656};
        physicsVector = CreatePhysicsVector(E,ZZ_14,factor);
     }
     else if( ionZ == 15 ) {
        G4double ZZ_15[53]={6.12,6.81,8.118,9.352,10.51,11.61,12.63,13.58,14.48,18.13,20.63,22.28,23.34,24.47,24.91,25.02,24.95,24.78,24.55,24.28,22.76,21.26,19.89,18.67,16.59,14.92,13.54,12.39,11.42,10.59,9.867};
        physicsVector = CreatePhysicsVector(E,ZZ_15,factor);
     }
     else if( ionZ == 16 ) {
        G4double ZZ_16[53]={6.294,7,8.338,9.604,10.8,11.94,13,14,14.94,18.82,21.55,23.41,24.65,26.01,26.6,26.81,26.81,26.69,26.5,26.26,24.79,23.28,21.88,20.61,18.43,16.64,15.16,13.92,12.86,11.95,11.15};
        physicsVector = CreatePhysicsVector(E,ZZ_16,factor);
     }
     else if( ionZ == 17 ) {
        G4double ZZ_17[53]={6.522,7.237,8.59,9.875,11.1,12.26,13.36,14.39,15.37,19.45,22.4,24.45,25.86,27.46,28.19,28.5,28.57,28.5,28.34,28.13,26.72,25.21,23.78,22.47,20.2,18.32,16.75,15.42,14.28,13.3,12.44};
        physicsVector = CreatePhysicsVector(E,ZZ_17,factor);
     }
     else if( ionZ == 18 ) {
        G4double ZZ_18[53]={6.642,7.369,8.739,10.04,11.28,12.47,13.59,14.66,15.66,19.93,23.08,25.32,26.89,28.72,29.6,30.01,30.15,30.13,30,29.82,28.46,26.94,25.49,24.15,21.81,19.86,18.22,16.82,15.61,14.57,13.65};
     ...
     if( ionZ == 3 ) {
        G4double Z3_3[53]={2.388,2.599,2.949,3.221,3.429,3.584,3.697,3.778,3.833,3.892,3.802,3.672,3.534,3.269,3.032,2.824,2.64,2.478,2.334,2.206,1.73,1.426,1.215,1.06,0.8501,0.7134,0.6172,0.5456,0.4901,0.4457,0.4094};
        physicsVector = CreatePhysicsVector(E,Z3_3,factor);
     }
     else if( ionZ == 4 ) {
        G4double Z3_4[53]={2.938,3.224,3.715,4.119,4.451,4.718,4.929,5.095,5.222,5.5,5.5,5.404,5.275,4.99,4.712,4.455,4.219,4.005,3.809,3.631,2.937,2.464,2.122,1.866,1.506,1.267,1.097,0.97,0.8712,0.7922,0.7274};
        physicsVector = CreatePhysicsVector(E,Z3_4,factor);
     }
     else if( ionZ == 5 ) {
        G4double Z3_5[53]={3.35,3.707,4.329,4.856,5.304,5.683,5.999,6.26,6.472,7.035,7.172,7.144,7.048,6.781,6.491,6.208,5.939,5.687,5.453,5.235,4.35,3.712,3.235,2.867,2.336,1.975,1.714,1.517,1.363,1.239,1.137};
        physicsVector = CreatePhysicsVector(E,Z3_5,factor);
     }
     else if( ionZ == 6 ) {
        G4double Z3_6[53]={3.652,4.071,4.816,5.459,6.019,6.505,6.924,7.281,7.583,8.477,8.792,8.86,8.817,8.597,8.316,8.024,7.737,7.461,7.199,6.951,5.908,5.122,4.515,4.034,3.323,2.826,2.461,2.183,1.963,1.786,1.64};
        physicsVector = CreatePhysicsVector(E,Z3_6,factor);
     }
     else if( ionZ == 7 ) {
        G4double Z3_7[53]={3.922,4.388,5.229,5.97,6.625,7.207,7.719,8.168,8.557,9.804,10.33,10.52,10.56,10.41,10.16,9.879,9.587,9.299,9.019,8.751,7.582,6.665,5.936,5.347,4.453,3.813,3.335,2.965,2.671,2.432,2.235};
        physicsVector = CreatePhysicsVector(E,Z3_7,factor);
     }
     else if( ionZ == 8 ) {
        G4double Z3_8[53]={4.155,4.659,5.587,6.416,7.16,7.83,8.43,8.965,9.439,11.05,11.81,12.15,12.28,12.24,12.03,11.77,11.49,11.19,10.91,10.62,9.358,8.327,7.487,6.792,5.717,4.93,4.331,3.863,3.487,3.18,2.924};
        physicsVector = CreatePhysicsVector(E,Z3_8,factor);
     }
     else if( ionZ == 9 ) {
        G4double Z3_9[53]={4.323,4.856,5.853,6.759,7.58,8.326,9.004,9.617,10.17,12.12,13.13,13.63,13.86,13.93,13.78,13.55,13.28,12.99,12.7,12.41,11.08,9.959,9.028,8.246,7.016,6.097,5.387,4.825,4.369,3.994,3.679};
        physicsVector = CreatePhysicsVector(E,Z3_9,factor);
     }
     else if( ionZ == 10 ) {
        G4double Z3_10[53]={4.476,5.033,6.084,7.054,7.943,8.758,9.505,10.19,10.81,13.1,14.37,15.04,15.38,15.59,15.51,15.31,15.06,14.78,14.49,14.2,12.81,11.62,10.61,9.753,8.378,7.332,6.514,5.859,5.324,4.879,4.504};
        physicsVector = CreatePhysicsVector(E,Z3_10,factor);
     }
     else if( ionZ == 11 ) {
        G4double Z3_11[53]={4.616,5.195,6.301,7.337,8.298,9.189,10.01,10.78,11.48,14.16,15.75,16.66,17.17,17.6,17.65,17.54,17.34,17.1,16.84,16.56,15.17,13.91,12.8,11.83,10.25,9.023,8.044,7.25,6.594,6.045,5.58};
        physicsVector = CreatePhysicsVector(E,Z3_11,factor);
     }
     else if( ionZ == 12 ) {
        G4double Z3_12[53]={4.777,5.356,6.47,7.526,8.518,9.443,10.31,11.11,11.86,14.79,16.6,17.68,18.3,18.85,18.96,18.87,18.68,18.44,18.17,17.89,16.45,15.15,14,13,11.35,10.06,9.029,8.184,7.482,6.891,6.387};
        physicsVector = CreatePhysicsVector(E,Z3_12,factor);
     }
     else if( ionZ == 13 ) {
        G4double Z3_13[53]={4.935,5.524,6.657,7.74,8.767,9.736,10.65,11.5,12.3,15.5,17.58,18.86,19.64,20.38,20.6,20.59,20.44,20.23,19.98,19.71,18.28,16.93,15.73,14.67,12.91,11.51,10.37,9.435,8.652,7.988,7.419};
        physicsVector = CreatePhysicsVector(E,Z3_13,factor);
     }
     else if( ionZ == 14 ) {
        G4double Z3_14[53]={5.095,5.692,6.842,7.946,9.003,10.01,10.95,11.85,12.69,16.14,18.46,19.95,20.88,21.83,22.17,22.23,22.14,21.96,21.73,21.47,20.05,18.68,17.43,16.32,14.45,12.95,11.72,10.7,9.846,9.114,8.483};
        physicsVector = CreatePhysicsVector(E,Z3_14,factor);
     }
     else if( ionZ == 15 ) {
        G4double Z3_15[53]={5.29,5.897,7.06,8.183,9.265,10.3,11.28,12.22,13.1,16.78,19.34,21.03,22.13,23.31,23.8,23.95,23.92,23.79,23.59,23.36,21.98,20.59,19.31,18.15,16.18,14.57,13.24,12.12,11.18,10.37,9.67};
        physicsVector = CreatePhysicsVector(E,Z3_15,factor);
     }
     else if( ionZ == 16 ) {
        G4double Z3_16[53]={4.155,4.659,5.587,6.416,7.16,7.83,8.43,8.965,9.439,11.05,11.81,12.15,12.28,12.24,12.03,11.77,11.49,11.19,10.91,10.62,9.358,8.327,7.487,6.792,5.717,4.93,4.331,3.863,3.487,3.18,2.924};
        physicsVector = CreatePhysicsVector(E,Z3_16,factor);
     }
     else if( ionZ == 17 ) {
        G4double Z3_17[53]={5.652,6.28,7.478,8.633,9.757,10.84,11.89,12.88,13.84,17.92,20.93,23.04,24.48,26.13,26.92,27.27,27.38,27.35,27.23,27.05,25.8,24.41,23.08,21.84,19.69,17.89,16.37,15.09,13.98,13.02,12.19};
        physicsVector = CreatePhysicsVector(E,Z3_17,factor);
     }
     else if( ionZ == 18 ) {
        G4double Z3_18[53]={5.752,6.391,7.603,8.767,9.901,11,12.07,13.09,14.06,18.31,21.52,23.82,25.42,27.31,28.25,28.7,28.88,28.9,28.81,28.66,27.47,26.08,24.73,23.47,21.25,19.38,17.8,16.45,15.28,14.27,13.38};
