...
#ifndef G4EXTERNALDEDXTABLE_HH
#define G4EXTERNALDEDXTABLE_HH
...
class G4ExternalDEDXTable : public G4VIonDEDXTable {

 public:
   G4ExternalDEDXTable();
   virtual ~G4ExternalDEDXTable();
