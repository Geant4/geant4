...
inline G4Element* G4NistManager::FindElement(G4int Z) const { return elmBuilder->FindElement(Z); }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline G4Element* G4NistManager::FindOrBuildElement(G4int Z, G4bool isotopes)
{
...
inline G4Element* G4NistManager::FindOrBuildElement(const G4String& symb, G4bool isotopes)
{
...
inline G4int G4NistManager::GetZ(const G4String& symb) const { return elmBuilder->GetZ(symb); }
...
inline G4double G4NistManager::GetIsotopeMass(G4int Z, G4int N) const
{
...
inline G4double G4NistManager::GetAtomicMass(G4int Z, G4int N) const
{
...
inline G4double G4NistManager::GetTotalElectronBindingEnergy(G4int Z) const
{
...
inline G4double G4NistManager::GetIsotopeAbundance(G4int Z, G4int N) const
{
...
inline G4int G4NistManager::GetNistFirstIsotopeN(G4int Z) const
{
...
inline G4int G4NistManager::GetNumberOfNistIsotopes(G4int Z) const
{
...
inline const std::vector<G4String>& G4NistManager::GetNistElementNames() const
{
...
inline void G4NistManager::PrintElement(G4int Z) const { elmBuilder->PrintElement(Z); }
...
inline G4int G4NistManager::GetVerbose() const { return verbose; }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline G4Material* G4NistManager::FindMaterial(const G4String& name) const
{
...
inline G4Material* G4NistManager::FindOrBuildMaterial(const G4String& name, G4bool, G4bool warning)
{
...
inline G4Material* G4NistManager::FindSimpleMaterial(G4int Z) const
{
...
inline G4Material* G4NistManager::FindOrBuildSimpleMaterial(G4int Z, G4bool warning)
{
...
inline G4Material* G4NistManager::ConstructNewMaterial(const G4String& name,
  const std::vector<G4String>& elm, const std::vector<G4int>& nbAtoms, G4double dens, G4bool,
  G4State state, G4double T, G4double P)

{
  return matBuilder->ConstructNewMaterial(name, elm, nbAtoms, dens, state, T, P);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline G4Material* G4NistManager::ConstructNewMaterial(const G4String& name,
  const std::vector<G4String>& elm, const std::vector<G4double>& w, G4double dens, G4bool,
  G4State state, G4double T, G4double P)
{
...
inline G4Material* G4NistManager::ConstructNewGasMaterial(
  const G4String& name, const G4String& nameNist, G4double temp, G4double pres, G4bool)
{
...
inline G4Material* G4NistManager::ConstructNewIdealGasMaterial(const G4String& name,
  const std::vector<G4String>& elm, const std::vector<G4int>& nbAtoms, G4bool, G4double T,
  G4double P)
{
  return matBuilder->ConstructNewIdealGasMaterial(name, elm, nbAtoms, T, P);
}
...
inline const std::vector<G4String>& G4NistManager::GetNistMaterialNames() const
{
...
inline G4double G4NistManager::GetZ13(G4double A) const { return g4pow->A13(A); }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

inline G4double G4NistManager::GetZ13(G4int Z) const { return g4pow->Z13(Z); }
...
inline G4double G4NistManager::GetLOGZ(G4int Z) const { return g4pow->logZ(Z); }
