...
// ********************************************************************
//
// $Id: G4P2DummyManager.hh 70604 2013-06-03 11:27:06Z ihrivnac $

// Manager class for P2 for managers which do not support this object 
// type. It will just issue warnings. 

// Author: Ivana Hrivnacova, 24/07/2014  (ivana@ipno.in2p3.fr)

#ifndef G4P2DummyManager_h
#define G4P2DummyManager_h 1
...
class G4P2DummyManager : public G4VP2Manager
{
  public:
    G4P2DummyManager(const G4AnalysisManagerState& state);
    virtual ~G4P2DummyManager();
