...
// ********************************************************************
//
// $Id: G4H3DummyManager.hh 70604 2013-06-03 11:27:06Z ihrivnac $

// Manager class for H3 for managers which do not support this object 
// type. It will just issue warnings. 

// Author: Ivana Hrivnacova, 24/07/2014  (ivana@ipno.in2p3.fr)

#ifndef G4H3DummyManager_h
#define G4H3DummyManager_h 1
...
class G4H3DummyManager : public G4VH3Manager
{
  public:
    G4H3DummyManager(const G4AnalysisManagerState& state);
    virtual ~G4H3DummyManager();
