...
//
//
// $Id: F01RunAction.cc,v 1.1 2001-10-11 07:12:57 grichine Exp $
...
void F01RunAction::FillNbOfSteps(G4double ns)
{
#ifndef G4NOHIST
...
void F01RunAction::FillEn(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F01RunAction::FillTt(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F01RunAction::FillTb(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F01RunAction::FillTsec(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F01RunAction::FillGammaSpectrum(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F01RunAction::FillTh(G4double Th)
{
#ifndef G4NOHIST
...
void F01RunAction::FillThBack(G4double Th)
{
#ifndef G4NOHIST
...
void F01RunAction::FillR(G4double R )
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F01RunAction::Fillvertexz(G4double z )
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F01RunAction::SethistName(G4String name)
{
  histName = name ;
  G4cout << " hist file = " << histName << G4endl;
}

void F01RunAction::SetnbinStep(G4int nbin)
{
  nbinStep = nbin ;
  if(nbinStep>0)
...
void F01RunAction::SetSteplow(G4double low)
{
  Steplow = low ;
  if(nbinStep>0)
  G4cout << " low  in the #step plot = " << Steplow << G4endl ;
}
void F01RunAction::SetStephigh(G4double high)
{
  Stephigh = high ;
  if(nbinStep>0)
...
void F01RunAction::SetnbinEn(G4int nbin)
{
  nbinEn = nbin ;
...
void F01RunAction::SetEnlow(G4double Elow)
{
  Enlow = Elow ;
  if(nbinEn>0) G4cout << " Elow  in the  Edep plot = " << Enlow << G4endl ;
}

void F01RunAction::SetEnhigh(G4double Ehigh)
{
  Enhigh = Ehigh ;
...
void F01RunAction::SetnbinGamma(G4int nbin)
{
  nbinGamma = nbin ;
  if(nbinGamma>0)
...
void F01RunAction::SetElowGamma(G4double Elow)
{
  ElowGamma = Elow ;
  if(nbinGamma>0)
...
void F01RunAction::SetEhighGamma(G4double Ehigh)
{
  EhighGamma = Ehigh ;
  if(nbinGamma>0)
...
void F01RunAction::SetnbinTt(G4int nbin)
{
  nbinTt = nbin ;
  if(nbinTt>0)
...
void F01RunAction::SetTtlow(G4double Elow)
{
  Ttlow = Elow ;
  if(nbinTt>0)
...
void F01RunAction::SetTthigh(G4double Ehigh)
{
  Tthigh = Ehigh ;
  if(nbinTt>0)
...
void F01RunAction::SetnbinTb(G4int nbin)
{
  nbinTb = nbin ;
  if(nbinTb>0)
...
void F01RunAction::SetTblow(G4double Elow)
{
  Tblow = Elow ;
  if(nbinTb>0)
...
void F01RunAction::SetTbhigh(G4double Ehigh)
{
  Tbhigh = Ehigh ;
  if(nbinTb>0)
...
void F01RunAction::SetnbinTsec(G4int nbin)
{
  nbinTsec = nbin ;
  if(nbinTsec>0)
...
void F01RunAction::SetTseclow(G4double Elow)
{
  Tseclow = Elow ;
  if(nbinTsec>0)
...
void F01RunAction::SetTsechigh(G4double Ehigh)
{
  Tsechigh = Ehigh ;
  if(nbinTsec>0)
...
void F01RunAction::SetnbinR(G4int nbin)
{
  nbinR  = nbin ;
  if(nbinR>0)
...
void F01RunAction::SetRlow(G4double rlow)
{
  Rlow = rlow ;
  if(nbinR>0)
...
void F01RunAction::SetRhigh(G4double rhigh)
{
  Rhigh = rhigh ;
  if(nbinR>0)
...
void F01RunAction::Setnbinzvertex(G4int nbin)
{
  nbinvertexz  = nbin ;
  if(nbinvertexz>0)
...
void F01RunAction::Setzlow(G4double z)
{
  zlow = z ;
  if(nbinvertexz>0)
...
void F01RunAction::Setzhigh(G4double z)
{
  zhigh = z ;
  if(nbinvertexz>0)
...
void F01RunAction::SetnbinTh(G4int nbin)
{
  nbinTh = nbin ;
  if(nbinTh>0)
...
void F01RunAction::SetThlow(G4double Tlow)
{
  Thlow = Tlow ;
  if(nbinTh>0)
...
void F01RunAction::SetThhigh(G4double Thigh)
{
  Thhigh = Thigh ;
  if(nbinTh>0)
...
void F01RunAction::SetnbinThBack(G4int nbin)
{
  nbinThback = nbin ;
  if(nbinThback>0)
...
void F01RunAction::SetThlowBack(G4double Tlow)
{
  Thlowback = Tlow ;
  if(nbinThback>0)
...
void F01RunAction::SetThhighBack(G4double Thigh)
{
  Thhighback = Thigh ;
  if(nbinThback>0)
