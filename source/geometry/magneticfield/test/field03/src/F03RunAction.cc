...
//
//
// $Id: F03RunAction.cc,v 1.2 2003-06-16 16:51:43 gunter Exp $
...
void F03RunAction::EndOfRunAction(const G4Run* aRun)
{
 ...
 G4int prec = G4cout.precision(6);
  ...
  if(nbinR >0)
  {
    ...
    std::ofstream fileOut("diameter.out", std::ios::out ) ;
    fileOut.setf( std::ios::scientific, std::ios::floatfield );

    std::ofstream normOut("normDiameter.out", std::ios::out ) ;
    normOut.setf( std::ios::scientific, std::ios::floatfield );
...
void F03RunAction::FillNbOfSteps(G4double ns)
{
#ifndef G4NOHIST
...
void F03RunAction::FillEn(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F03RunAction::FillTt(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F03RunAction::FillTb(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F03RunAction::FillTsec(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F03RunAction::FillGammaSpectrum(G4double En)
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F03RunAction::FillTh(G4double Th)
{
#ifndef G4NOHIST
...
void F03RunAction::FillThBack(G4double Th)
{
#ifndef G4NOHIST
...
void F03RunAction::FillR(G4double R )
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F03RunAction::Fillvertexz(G4double z )
{
#ifndef G4NOHIST
  G4double bin ;
  G4int ibin;
...
void F03RunAction::SethistName(G4String name)
{
  histName = name ;
  G4cout << " hist file = " << histName << G4endl;
}

void F03RunAction::SetnbinStep(G4int nbin)
{
  nbinStep = nbin ;
  if(nbinStep>0)
...
void F03RunAction::SetSteplow(G4double low)
{
  Steplow = low ;
  if(nbinStep>0)
  G4cout << " low  in the #step plot = " << Steplow << G4endl ;
}
void F03RunAction::SetStephigh(G4double high)
{
  Stephigh = high ;
  if(nbinStep>0)
...
void F03RunAction::SetnbinEn(G4int nbin)
{
  nbinEn = nbin ;
...
void F03RunAction::SetEnlow(G4double Elow)
{
  Enlow = Elow ;
  if(nbinEn>0) G4cout << " Elow  in the  Edep plot = " << Enlow << G4endl ;
}

void F03RunAction::SetEnhigh(G4double Ehigh)
{
  Enhigh = Ehigh ;
...
void F03RunAction::SetnbinGamma(G4int nbin)
{
  nbinGamma = nbin ;
  if(nbinGamma>0)
...
void F03RunAction::SetElowGamma(G4double Elow)
{
  ElowGamma = Elow ;
  if(nbinGamma>0)
...
void F03RunAction::SetEhighGamma(G4double Ehigh)
{
  EhighGamma = Ehigh ;
  if(nbinGamma>0)
...
void F03RunAction::SetnbinTt(G4int nbin)
{
  nbinTt = nbin ;
  if(nbinTt>0)
...
void F03RunAction::SetTtlow(G4double Elow)
{
  Ttlow = Elow ;
  if(nbinTt>0)
...
void F03RunAction::SetTthigh(G4double Ehigh)
{
  Tthigh = Ehigh ;
  if(nbinTt>0)
...
void F03RunAction::SetnbinTb(G4int nbin)
{
  nbinTb = nbin ;
  if(nbinTb>0)
...
void F03RunAction::SetTblow(G4double Elow)
{
  Tblow = Elow ;
  if(nbinTb>0)
...
void F03RunAction::SetTbhigh(G4double Ehigh)
{
  Tbhigh = Ehigh ;
  if(nbinTb>0)
...
void F03RunAction::SetnbinTsec(G4int nbin)
{
  nbinTsec = nbin ;
  if(nbinTsec>0)
...
void F03RunAction::SetTseclow(G4double Elow)
{
  Tseclow = Elow ;
  if(nbinTsec>0)
...
void F03RunAction::SetTsechigh(G4double Ehigh)
{
  Tsechigh = Ehigh ;
  if(nbinTsec>0)
...
void F03RunAction::SetnbinR(G4int nbin)
{
  nbinR  = nbin ;
  if(nbinR>0)
...
void F03RunAction::SetRlow(G4double rlow)
{
  Rlow = rlow ;
  if(nbinR>0)
...
void F03RunAction::SetRhigh(G4double rhigh)
{
  Rhigh = rhigh ;
  if(nbinR>0)
...
void F03RunAction::Setnbinzvertex(G4int nbin)
{
  nbinvertexz  = nbin ;
  if(nbinvertexz>0)
...
void F03RunAction::Setzlow(G4double z)
{
  zlow = z ;
  if(nbinvertexz>0)
...
void F03RunAction::Setzhigh(G4double z)
{
  zhigh = z ;
  if(nbinvertexz>0)
...
void F03RunAction::SetnbinTh(G4int nbin)
{
  nbinTh = nbin ;
  if(nbinTh>0)
...
void F03RunAction::SetThlow(G4double Tlow)
{
  Thlow = Tlow ;
  if(nbinTh>0)
...
void F03RunAction::SetThhigh(G4double Thigh)
{
  Thhigh = Thigh ;
  if(nbinTh>0)
...
void F03RunAction::SetnbinThBack(G4int nbin)
{
  nbinThback = nbin ;
  if(nbinThback>0)
...
void F03RunAction::SetThlowBack(G4double Tlow)
{
  Thlowback = Tlow ;
  if(nbinThback>0)
...
void F03RunAction::SetThhighBack(G4double Thigh)
{
  Thhighback = Thigh ;
  if(nbinThback>0)
