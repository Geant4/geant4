                                 ...
                                 G4double hinitial )
{
  ...
  static __thread G4int  noGoodSteps =0 ;  // Bad = chord > curve-len 
...
G4MagInt_Driver::WarnSmallStepSize( G4double hnext, G4double hstep, 
                                    ...
                                    G4int nstp)
{
  static __thread G4int noWarningsIssued =0;
...
G4MagInt_Driver::WarnEndPointTooFar (G4double endPointDist, 
                                     ...
                                     G4int     dbg)
{
  static __thread G4double maxRelError=0.0;
  ...
  { 
    static __thread G4int noWarnings = 0;
    std::ostringstream message;
...

{
  ...
  static __thread G4int tot_no_trials=0; 
                                  ...
                                  G4double&    dyerr )
{
  ...
  static __thread G4int no_call=0; 
  no_call ++; 
                  ...
                  G4int                subStepNo)
{
    ...
    static __thread G4int noPrecision= 5;
                  ...
                  G4double             dotVeloc_StartCurr)
{
    ...
    static __thread G4double oldCurveLength= 0.0;
    static __thread G4double oldSubStepLength= 0.0;
    static __thread G4int oldSubStepNo= -1;
