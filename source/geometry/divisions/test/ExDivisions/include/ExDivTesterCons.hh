...
#ifndef ExDivTesterCons_H
#define ExDivTesterCons_H 1
...
class ExDivTesterCons : public ExVDivTester
{ 
  public:  

  ExDivTesterCons( PVType& pvtype, std::vector<G4String>& extraPars );
  virtual ~ExDivTesterCons(){};
