...
{
  static G4ThreadLocal G4PVDivisionFactory *theFactory_G4MT_TLS_ = 0 ; if (!theFactory_G4MT_TLS_) theFactory_G4MT_TLS_ = new  G4PVDivisionFactory  ;  G4PVDivisionFactory &theFactory = *theFactory_G4MT_TLS_;
  if (!fgInstance)
  {
