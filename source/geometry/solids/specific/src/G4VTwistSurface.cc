                                      ...
                                      G4bool        withtol) 
{
   ...
   static __thread G4RotationMatrix *unitrot_G4MT_TLS_ = 0 ; if (!unitrot_G4MT_TLS_) unitrot_G4MT_TLS_ = new  G4RotationMatrix  ;  G4RotationMatrix &unitrot = *unitrot_G4MT_TLS_;  // unit matrix
