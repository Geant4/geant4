...
//
//
// $Id: G4Polycone.cc,v 1.21 2005-08-03 15:53:42 danninos Exp $
...
{   
  ...
  G4double Aone, Atwo, Afive, phi, xRand, yRand, zRand, fDPhi, fSPhi, cosu, sinu;
...
G4ThreeVector G4Polycone::GetPointOnSurface() const
{
  ...
  areas.push_back(pi*(sqr(original_parameters->Rmax[numPlanes])-
		      sqr(original_parameters->Rmin[numPlanes])));
