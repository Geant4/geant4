...
// NOTE: xRot = rotation such that x axis->y axis & y axis->-x axis
    ...
    G4Cons c2("Full Cone",0,50,0,100,50,0,2*pi) ;
...
// DistanceToOut(P,V)
    ...
    assert(ApproxEqual(dist,std::sqrt(200.0))&&*pgoodNorm);
