...
//
//
// $Id: UPolyconeSide.cc 66885 2013-01-16 17:37:13Z gunter $
//
// 
// --------------------------------------------------------------------
...
//template <class PolyconeSidePrivateSubclass> UThreadLocal PolyconeSidePrivateSubclass* /////UMTPrivateSubInstanceManager<PolyconeSidePrivateSubclass>::offset = 0;

//01.25.2009 Xin Dong: Phase II change for Geant4 multi-threading.
//This new field helps to use the class UPolyconeSideSubInstanceManager
//introduced in the "UPolyconeSide.hh" file.
///UPolyconeSideSubInstanceManager UPolyconeSide::g4polyconeSideSubInstanceManager;
...
//	g4polyconeSideInstanceID = g4polyconeSideSubInstanceManager.CreateSubInstance();
	...
	fSurfaceArea = 0.0;
//	fPhiPCSUMTThreadPrivate.first = UVector3(0,0,0);
//	fPhiPCSUMTThreadPrivate.second= 0.0;
																						...
																						double *bestDistance )
{
	...
	*bestDistance = std::sqrt( dFrom*dFrom + dOut2 );
	...
	double rds = p.Perp();
	if (rds!=0.) { return UVector3(rNorm*p.x/rds,rNorm*p.y/rds,zNorm); }
...
//	if (fPhiPCSUMTThreadPrivate.first != p)
//	{
		val = p.Phi();
//		fPhiPCSUMTThreadPrivate.first = p;
//		fPhiPCSUMTThreadPrivate.second = val;
//	}
//	else
//	{
//		val = fPhiPCSUMTThreadPrivate.second;
//	}
	return val;
}
