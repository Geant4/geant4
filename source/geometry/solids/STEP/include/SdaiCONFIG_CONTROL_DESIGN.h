...
// regenerate it.
/* $Id: SdaiCONFIG_CONTROL_DESIGN.h,v 1.5 2000-06-09 10:59:47 gcosmo Exp $  */
...
class SdaiMeasure_value  :  public
#ifndef WIN32
 SCLP23(Select)
#else
 SDAI::Select
...
class SdaiComposite_curve_segment  :    public SCLP23(Application_instance) {
...
extern Inverse_attribute *a_242Imap_usage;
...
extern Derived_attribute *a_282Dface_bounds;
...
extern Derived_attribute *a_284Daxis_line;
...
extern Derived_attribute *a_341Dnamed_unit_dimensions;
...
extern Derived_attribute *a_348Dupper_index_on_knots;
...
extern Derived_attribute *a_357Dp;
...
extern Derived_attribute *a_359Dweights;
...
extern Derived_attribute *a_376Dknot_u_upper;
extern Derived_attribute *a_377Dknot_v_upper;
...
extern Derived_attribute *a_381Dpath_edge_list;
...
extern Derived_attribute *a_391Du;

class SdaiCartesian_transformation_operator_2d  :    public SdaiCartesian_transformation_operator  {
 
#ifdef __OSTORE__
  friend void SdaiCartesian_transformation_operator_2d_access_hook_in(void *, 
	enum os_access_reason, void *, void *, void *);
#endif
  protected:
  public:  
	...
	SdaiCartesian_transformation_operator_2d (SCLP23(Application_instance) *se, int *addAttrs = 0); 
...
#ifdef __OSTORE__
void SdaiCartesian_transformation_operator_2d_access_hook_in(void *object, 
	enum os_access_reason reason, void *user_data, 
	void *start_range, void *end_range);
#endif
...
#ifdef __OSTORE__
SCLP23(Application_instance_ptr) 
create_SdaiCartesian_transformation_operator_2d(os_database *db);

#elif __O3DB__
inline SCLP23(Application_instance_ptr) 
create_SdaiCartesian_transformation_operator_2d () {  return (SCLP23(Application_instance_ptr)) new SdaiCartesian_transformation_operator_2d ;  }
#else
...
class SdaiSurface_patch  :    public SCLP23(Application_instance) {
...
class SdaiOffset_curve_2d  :    public SdaiCurve  {
...
#ifdef __OSTORE__
  friend void SdaiOffset_curve_2d_access_hook_in(void *, 
	enum os_access_reason, void *, void *, void *);
#endif
  protected:
	SCLP23(Application_instance_ptr) _basis_curve ;
  ...
  public:  
	...
	SdaiOffset_curve_2d ( ); 
	SdaiOffset_curve_2d (SCLP23(Application_instance) *se, int *addAttrs = 0); 
...
#ifdef __OSTORE__
void SdaiOffset_curve_2d_access_hook_in(void *object, 
	enum os_access_reason reason, void *user_data, 
	void *start_range, void *end_range);
#endif
...
#ifdef __OSTORE__
SCLP23(Application_instance_ptr) 
create_SdaiOffset_curve_2d(os_database *db);

#elif __O3DB__
inline SCLP23(Application_instance_ptr) 
create_SdaiOffset_curve_2d () {  return (SCLP23(Application_instance_ptr)) new SdaiOffset_curve_2d ;  }
#else
