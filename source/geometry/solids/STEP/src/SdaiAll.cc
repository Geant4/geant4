...
// regenerate it.
/* $Id: SdaiAll.cc,v 1.1 2000-01-21 13:42:58 gcosmo Exp $  */ 
#include <schema.h>
...
*/
#ifndef MSWIN
	s_config_control_design->AddFunction("FUNCTION local_relatives_of_product_definitions(\n             definition_set: SET OF product_definition;\n             total_definitions: SET OF product_definition;\n             relation_subtype: STRING\n    ): SET OF product_definition;\n\n  LOCAL\n    i           : INTEGER;\n    local_def   : SET OF product_definition := [];\n    local_pdr   : SET OF product_definition_relationship := [];\n    local_total : SET OF product_definition := [];\n  END_LOCAL;\n  REPEAT i := 1 TO HIINDEX(definition_set) BY 1;\n    local_pdr := local_pdr + bag_to_set(USEDIN(definition_set[i],\n        relation_subtype + '.RELATING_PRODUCT_DEFINITION'));\n  END_REPEAT;\n  REPEAT i := 1 TO HIINDEX(local_pdr) BY 1;\n    local_def := local_def + local_pdr[i].related_product_definition;\n  END_REPEAT;\n  IF (SIZEOF(local_def) - SIZEOF(total_definitions)) = 0 THEN\n    RETURN(local_def);\n  ELSE\n    local_total := total_definitions + local_def;\n    RETURN(local_def + local_relatives_of_product_definitions(local_def - \n        total_definitions,local_total,relation_subtype));\n  END_IF;\n\nEND_FUNCTION; -- local_relatives_of_product_definitions\n");
#endif
/*
FUNCTION local_relatives_of_product_definitions(
             definition_set: SET OF product_definition;
...
*/
	...
	config_control_designt_characterized_definition = new SelectTypeDescriptor (
		  ...
		  (char*)("SELECT (Characterized_Product_Definition, Shape_Definition)"),	// Description
	...
	config_control_designt_change_request_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Product_Definition_Formation)"),	// Description
	...
	config_control_designt_characterized_product_definition = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Product_Definition, Product_Definition_Relationship)"),	// Description
	...
	config_control_designt_reversible_topology_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Edge, Path, Face, Face_Bound, Closed_Shell, Open_Shell)"),	// Description
	...
	config_control_designt_axis2_placement = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Axis2_Placement_2d, Axis2_Placement_3d)"),	// Description
	...
	config_control_designt_specified_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Product_Definition, Shape_Aspect)"),	// Description
	...
	config_control_designt_measure_value = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Area_Measure, Context_Dependent_Measure, Count_Measure, Descriptive_Measure, Length_Measure, Mass_Measure, Plane_Angle_Measure, Parameter_Value, Positive_Length_Measure, Positive_Plane_Angle_Measure, Solid_Angle_Measure, Volume_Measure)"),	// Description
	...
	config_control_designt_person_organization_select = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Person_And_Organization)"),	// Description
	...
	config_control_designt_pcurve_or_surface = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Pcurve, Surface)"),	// Description
	...
	config_control_designt_classified_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Product_Definition_Formation, Assembly_Component_Usage)"),	// Description
	...
	config_control_designt_vector_or_direction = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Vector, Direction)"),	// Description
	...
	config_control_designt_wireframe_model = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Shell_Based_Wireframe_Model, Edge_Based_Wireframe_Model)"),	// Description
	...
	config_control_designt_geometric_set_select = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Point, Curve, Surface)"),	// Description
	...
	config_control_designt_person_organization_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Change, Start_Work, Change_Request, Start_Request, Configuration_Item, Product, Product_Definition_Formation, Product_Definition, Contract, Security_Classification)"),	// Description
	...
	config_control_designt_date_time_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Product_Definition, Change_Request, Start_Request, Change, Start_Work, Approval_Person_Organization, Contract, Security_Classification, Certification)"),	// Description
	...
	config_control_designt_shell = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Open_Shell, Closed_Shell, Vertex_Shell, Wire_Shell)"),	// Description
	...
	config_control_designt_transformation = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Item_Defined_Transformation, Functionally_Defined_Transformation)"),	// Description
	...
	config_control_designt_boolean_operand = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Solid_Model)"),	// Description
	...
	config_control_designt_certified_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Supplied_Part_Relationship)"),	// Description
	...
	config_control_designt_date_time_select = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Date_And_Time)"),	// Description
	...
	config_control_designt_curve_on_surface = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Pcurve, Surface_Curve, Composite_Curve_On_Surface)"),	// Description
	...
	config_control_designt_trimming_select = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Cartesian_Point, Parameter_Value)"),	// Description
	...
	config_control_designt_unit = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Named_Unit)"),	// Description
	...
	config_control_designt_reversible_topology = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Reversible_Topology_Item, List_Of_Reversible_Topology_Item, Set_Of_Reversible_Topology_Item)"),	// Description
	...
	config_control_designt_shape_definition = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Product_Definition_Shape, Shape_Aspect, Shape_Aspect_Relationship)"),	// Description
	...
	config_control_designt_supported_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Action_Directive, Action, Action_Method)"),	// Description
	...
	config_control_designt_approved_item = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Product_Definition_Formation, Product_Definition, Configuration_Effectivity, Configuration_Item, Security_Classification, Change_Request, Change, Start_Request, Start_Work, Certification, Contract)"),	// Description
	...
	config_control_designt_surface_model = new SelectTypeDescriptor (
		  ...
		  sdaiSELECT,	// FundamentalType
		  s_config_control_design,	// Originating Schema
		  (char*)("SELECT (Shell_Based_Surface_Model)"),	// Description
	...
	wr = new Where_rule("wr1: (SELF\\cartesian_transformation_operator.dim = 3);\n");
	...
	wr = new Where_rule("wr1: ('CONFIG_CONTROL_DESIGN.CHARACTERIZED_PRODUCT_DEFINITION' IN TYPEOF\n\t(SELF\\        property_definition.definition));\n");
	...
	config_control_designe_cartesian_transformation_operator_2d = new EntityDescriptor(
		  "Cartesian_Transformation_Operator_2d", s_config_control_design, SCLLOG(LFalse), SCLLOG(LFalse),
		  (Creator) create_SdaiCartesian_transformation_operator_2d );
	s_config_control_design->AddEntity(config_control_designe_cartesian_transformation_operator_2d);
	config_control_designe_cartesian_transformation_operator_2d->_where_rules = new Where_rule__list;
	wr = new Where_rule("wr1: (SELF\\cartesian_transformation_operator.dim = 2);\n");
	config_control_designe_cartesian_transformation_operator_2d->_where_rules->Append(wr);
	...
	config_control_designe_offset_curve_2d = new EntityDescriptor(
		  "Offset_Curve_2d", s_config_control_design, SCLLOG(LFalse), SCLLOG(LFalse),
		  (Creator) create_SdaiOffset_curve_2d );
	s_config_control_design->AddEntity(config_control_designe_offset_curve_2d);
	config_control_designe_offset_curve_2d->_where_rules = new Where_rule__list;
	wr = new Where_rule("wr1: (basis_curve.dim = 2);\n");
	config_control_designe_offset_curve_2d->_where_rules->Append(wr);
