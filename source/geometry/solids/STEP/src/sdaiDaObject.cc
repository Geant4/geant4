...
{
    G4cout << "****WARNING: virtual DAObject::Access_hook_in() called" << G4endl;
...
{
    G4cout << "ERROR DAObject::create_TIE() called." << G4endl;
    return 0;
}
#endif
...
SCLP23(DAObject_SDAI)::Access_hook_in(void *object, 
	...
	void *start_range, void *end_range)
{
    G4cout << "****WARNING: virtual DAObject_SDAI::Access_hook_in() called" << G4endl;
...
{ 
    G4cout << "ERROR DAObject_SDAI::create_TIE() called." << G4endl;  
    return 0;
}
#endif
