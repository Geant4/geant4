...
/* $Id: s_HEADER_SCHEMA_init.cc,v 1.3 2000-01-21 13:43:14 gcosmo Exp $ */
...
/*
	a_11STEP_VERSION = new AttrDescriptor("step_version",t_sdaiSTRING,SCLLOG(LFalse),SCLLOG(LFalse),AttrType_Explicit,*HEADER_SCHEMAe_FILE_NAME);
