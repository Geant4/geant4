...
// regenerate it.
/* $Id: SdaiCONFIG_CONTROL_DESIGN_init.cc,v 1.3 2000-01-21 13:43:04 gcosmo Exp $ */
#ifndef  SCHEMA_H
#include <schema.h>
#endif
#include <Registry.h>
...
/////////	 ENTITY curve
	...
	config_control_designe_curve->AddSupertype_Stmt("SUPERTYPE OF (ONEOF (line,conic,pcurve,surface_curve,offset_curve_2d,offset_curve_3d,\n        curve_replica))");
...
/////////	 ENTITY axis1_placement
	...
	a_77Dz->initializer_("NVL(normalise(axis),direction([0,0,1]))");
	reg.AddEntity (*config_control_designe_axis1_placement);
/////////	 END_ENTITY axis1_placement

/////////	 ENTITY bounded_curve

	config_control_designe_bounded_curve->AddSupertype_Stmt("SUPERTYPE OF (ONEOF (polyline,b_spline_curve,trimmed_curve,composite_curve))");
...
/////////	 ENTITY topological_representation_item
	...
	config_control_designe_topological_representation_item->AddSupertype_Stmt("SUPERTYPE OF (ONEOF (vertex,edge,face_bound,face,connected_edge_set,connected_face_set,\n        vertex_shell,wire_shell,loop ANDOR path))");
...
/////////	 ENTITY surface_curve
	...
	config_control_designe_surface_curve->AddSupertype_Stmt("SUPERTYPE OF (ONEOF (intersection_curve,seam_curve))");
...
/////////	 ENTITY representation_map
  ...
  a_242Imap_usage =
	...
	a_242Imap_usage->inverted_attr_id_("mapping_source");
	a_242Imap_usage->inverted_entity_id_("mapped_item");
...
/////////	 ENTITY dimensional_exponents
  ...
  a_264thermodynamic_temperature_exponent =
  ...
  a_266luminous_intensity_exponent =
...
/////////	 ENTITY context_dependent_shape_representation
	...
	a_270represented_product_relation =
...
/////////	 ENTITY oriented_face
  ...
  a_282Dface_bounds =
	...
	a_282Dface_bounds->initializer_("conditional_reverse(SELF.orientation,SELF.face_element.bounds)");
...
/////////	 ENTITY surface_of_revolution
	...
	a_284Daxis_line->initializer_("line(axis_position.location,vector(axis_position.z,1))");
...
/////////	 ENTITY si_unit
  ...
  a_340name =
	...
	a_341Dnamed_unit_dimensions->initializer_("dimensions_for_si_unit(SELF.name)");
...
/////////	 ENTITY b_spline_curve_with_knots
  ...
  a_348Dupper_index_on_knots =
	...
	a_348Dupper_index_on_knots->initializer_("SIZEOF(knots)");
...
/////////	 ENTITY axis2_placement_3d
  ...
  a_357Dp =
	...
	a_357Dp->initializer_("build_axes(axis,ref_direction)");
...
/////////	 ENTITY rational_b_spline_surface
  ...
  a_359Dweights =
	...
	a_359Dweights->initializer_("make_array_of_array(weights_data,0,u_upper,0,v_upper)");
...
/////////	 ENTITY b_spline_surface_with_knots
  ...
  a_376Dknot_u_upper =
	...
	a_376Dknot_u_upper->initializer_("SIZEOF(u_knots)");
  a_377Dknot_v_upper =
	...
	a_377Dknot_v_upper->initializer_("SIZEOF(v_knots)");
...
/////////	 ENTITY oriented_path
  ...
  a_381Dpath_edge_list =
	...
	a_381Dpath_edge_list->initializer_("conditional_reverse(SELF.orientation,SELF.path_element.edge_list)");
...
/////////	 ENTITY cartesian_transformation_operator_2d
  ...
  a_391Du =
	  new Derived_attribute("u",t_69,SCLLOG(LFalse),SCLLOG(LFalse), AttrType_Deriving,
	...
	a_391Du->initializer_("base_axis(2,SELF\\cartesian_transformation_operator.axis1,SELF\\\n        cartesian_transformation_operator.axis2,?)");
...
/////////	 ENTITY surface_patch
  ...
  a_397Iusing_surfaces =
	  new Inverse_attribute("using_surfaces",t_70,SCLLOG(LFalse),SCLLOG(LFalse),
	  *config_control_designe_surface_patch);
...
/////////	 ENTITY polyline
  ...
  a_407points =
	  new AttrDescriptor("points",t_71,SCLLOG(LFalse),SCLLOG(LFalse), AttrType_Explicit,
...
/////////	 ENTITY cc_design_date_and_time_assignment
  ...
  a_419items =
	  new AttrDescriptor("items",t_73,SCLLOG(LFalse),SCLLOG(LFalse), AttrType_Explicit,
...
/////////	 ENTITY oriented_closed_shell
  ...
  a_422Dconnected_face_set_cfs_faces =
	  new Derived_attribute("connected_face_set.cfs_faces",t_74,SCLLOG(LFalse),SCLLOG(LFalse), AttrType_Deriving,
	  *config_control_designe_oriented_closed_shell);
...
/////////	 ENTITY poly_loop
	...
	t_75->UniqueElements(SCLLOG(LTrue));
	t_75->FundamentalType(LIST_TYPE);
	t_75->Description("LIST [3:?] OF UNIQUE cartesian_point");
...
/////////	 ENTITY wire_shell
  ...
  a_432wire_shell_extent =
	  new AttrDescriptor("wire_shell_extent",t_76,SCLLOG(LFalse),SCLLOG(LFalse), AttrType_Explicit,
...
/////////	 ENTITY global_unit_assigned_context
	...
	t_77->OriginatingSchema(s_config_control_design);
	t_77->ReferentType(config_control_designt_unit);
  a_440units =
	  new AttrDescriptor("units",t_77,SCLLOG(LFalse),SCLLOG(LFalse), AttrType_Explicit,
