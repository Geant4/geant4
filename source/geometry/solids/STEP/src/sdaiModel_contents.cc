...
{
    // removed 'const' qualifier from return type since meaningless -  GC
    return (SCLP23(Model_contents_instances_ptr)) &_instances;
}
...
{
    // removed 'const' qualifier from return type since meaningless -  GC
    return (SCLP23(Entity_extent__set_var))&_folders;
}
...
{
    // removed 'const' qualifier from return type since meaningless -  GC
    return (SCLP23(Entity_extent__set_var))&_populated_folders;
}
