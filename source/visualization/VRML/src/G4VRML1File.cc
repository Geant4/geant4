...
// and all its terms.
//
// $Id: G4VRML1File.cc,v 1.2 1999-01-09 16:27:43 allison Exp $
...
G4VSceneHandler* G4VRML1File::CreateScene(const G4String& name) 
{
...
G4VViewer* G4VRML1File::CreateView(G4VSceneHandler& scene, const G4String& name)
{
