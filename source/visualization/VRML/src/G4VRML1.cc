...
// and all its terms.
//
// $Id: G4VRML1.cc,v 1.2 1999-01-09 16:27:42 allison Exp $
...
G4VSceneHandler* G4VRML1::CreateScene(const G4String& name) 
{
...
G4VViewer* G4VRML1::CreateView(G4VSceneHandler& scene, const G4String& name)
{
