...
G4VVisCommand::G4VVisCommand () { if (!fCurrentTouchablePath_G4MT_TLS_) fCurrentTouchablePath_G4MT_TLS_ = new G4ModelingParameters::PVNameCopyNoPath  ; if (!fCurrentTextLayout_G4MT_TLS_) fCurrentTextLayout_G4MT_TLS_ = new G4Text::Layout             ( G4Text::left) ; if (!fCurrentTextColour_G4MT_TLS_) fCurrentTextColour_G4MT_TLS_ = new G4Colour                   ( G4Colour::Blue()) ; if (!fCurrentColour_G4MT_TLS_) fCurrentColour_G4MT_TLS_ = new G4Colour                   ( G4Colour::White()) ;}
