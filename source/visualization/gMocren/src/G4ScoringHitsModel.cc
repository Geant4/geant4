...
//
//
// $Id: G4ScoringHitsModel.cc,v 1.1 2009-04-01 13:16:11 akimura Exp $
...
G4ScoringHitsModel::~G4ScoringHitsModel () {}

G4ScoringHitsModel::G4ScoringHitsModel ():
  fpCurrentHit(0)
{
  fGlobalTag = "G4ScoringHitsModel for all hits.";
  fGlobalDescription = fGlobalTag;
}

#include "G4GMocrenFileSceneHandler.hh"
const bool DEBUG = false;//true;
void G4ScoringHitsModel::DescribeYourselfTo (G4VGraphicsScene& sceneHandler)
{
  if(DEBUG) G4cout << "G4ScoringHitsModel::DescribeYourselfTo() "
