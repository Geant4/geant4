...
//
//
// $Id: G4QElectroNuclearCrossSection.hh,v 1.1 2004-03-05 13:23:03 mkossov Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
//
// GEANT4 physics class: G4QElectroNuclearCrossSection -- header file
// M.V. Kossov, CERN-ITEP(Moscow), 4-FEB-2004
// The last update: M.V. Kossov, CERN/ITEP (Moscow) 4-Feb-04
//
// Short description: this G4 class calculates electroNuclear cross section for
// particular Element (GetCrossSection member function)

#ifndef G4QElectroNuclearCrossSection_h
#define G4QElectroNuclearCrossSection_h 1
...
class G4QElectroNuclearCrossSection : public G4QVLeptoNuclearCrossSection
{
public:

  G4QElectroNuclearCrossSection() : G4QVLeptoNuclearCrossSection()  {}

  ~G4QElectroNuclearCrossSection() {}
...
private:
  ...
  static G4double  ml;       // Electron mass
  static G4double  ml2;      // Squared Electron mass
  static G4double  lml;      // Logarithm of the Electron mass
};

inline G4double G4QElectroNuclearCrossSection::DFun(G4double x)// Parametrization of PhNuCS
{
...
inline G4double G4QElectroNuclearCrossSection::Fun(G4double x) // Integrated PhotroNuc CS
{
