...
//
//
// $Id: G4QMuonNuclearCrossSection.hh,v 1.1 2004-03-05 13:23:03 mkossov Exp $
...
//
// Short description: this G4 class calculates muonNuclear cross section for
...
class G4QMuonNuclearCrossSection : public G4QVLeptoNuclearCrossSection
{
public:

  G4QMuonNuclearCrossSection() : G4QVLeptoNuclearCrossSection()  {}
...
private:
  ...
  static G4double  ml;       // Muon mass
  static G4double  ml2;      // Squared Muon mass
  static G4double  lml;      // Logarithm of the muon mass
};

inline G4double G4QMuonNuclearCrossSection::DFun(G4double x) // Parametrization of PhNuCS
{
...
inline G4double G4QMuonNuclearCrossSection::Fun(G4double x) // Integrated PhotroNuc CS
{
