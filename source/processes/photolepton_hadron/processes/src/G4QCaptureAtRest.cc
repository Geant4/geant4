...
//  Header of the G4QCaptureAtRest class of the CHIPS Simulation Branch in GEANT4
// ------------------------------------------------------------------------------
...
G4VParticleChange* G4QCaptureAtRest::AtRestDoIt(const G4Track& track, const G4Step& step)
{
  ...
  delete output;
  aParticleChange.SetLocalEnergyDeposit(EnergyDeposition); // Fill EnergyDepos for Muons
