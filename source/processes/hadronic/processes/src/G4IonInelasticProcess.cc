...
//  Date:        27 July 2011
//  Description: .cc file for G4IonInelasticProcess, mainly for
...
{
  outFile << "G4IonInelasticProcess handles the inelastic scattering of ions\n" 
          << "with A > 4 from nuclei by invoking one or more hadronic models\n"
