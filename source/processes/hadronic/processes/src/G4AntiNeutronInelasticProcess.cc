...
void G4AntiNeutronInelasticProcess::Description() const
{
  ...
  if (dirName) {
    ...
    outFile << "<title>Description of G4AntiNeutronInelasticProcess</title>\n";
    outFile << "</head>\n";
    outFile << "<body>\n";

    outFile << "This process handles the inelastic scattering of anti-neutrons\n" 
