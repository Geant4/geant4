...
void G4ProtonInelasticProcess::Description() const
{
  ...
  if (dirName) {
    ...
    outFile << "<title>Description of G4ProtonInelasticProcess</title>\n";
    outFile << "</head>\n";
    outFile << "<body>\n";

    outFile << "This process handles the inelastic scattering of protons\n" 
