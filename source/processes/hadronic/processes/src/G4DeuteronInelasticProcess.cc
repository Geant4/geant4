...
void G4DeuteronInelasticProcess::Description() const
{
  ...
  if (dirName) {
    ...
    outFile << "<title>Description of G4DeuteronInelasticProcess</title>\n";
    outFile << "</head>\n";
    outFile << "<body>\n";

    outFile << "This process handles the inelastic scattering of deuterons\n" 
