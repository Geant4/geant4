...
#ifndef G4PhotoFissionProcess_h
#define G4PhotoFissionProcess_h 1
 
#include "G4HadronicProcess.hh"

class G4PhotoFissionProcess : public G4HadronicProcess
{
  public:
    
    G4PhotoFissionProcess(const G4String& processName = "photonFission")
