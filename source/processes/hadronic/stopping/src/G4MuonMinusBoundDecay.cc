...
{
  // Initialized data
  static G4ThreadLocal G4double zeff[101] = { 0.,
  ...
  static G4ThreadLocal G4int ListZExp[ListZE] = { 1, 2,
  ...
  static G4ThreadLocal G4double ListCaptureVel[ListZE] = { 0.000725, 0.000356,
