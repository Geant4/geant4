...
{
  static __thread G4int index;
  static __thread G4int l;
  static __thread G4int nopt;
  static __thread G4int i;
...
{
  static __thread G4int i;
  static __thread G4float r, p1, p2, p3;
  static __thread G4int fivex;
  static __thread G4float rr, ran, rrr, ran1;
...
{
  static __thread G4float brr[3] = { G4float(.125),G4float(.25),G4float(.5) };

  G4float r__1;

  static __thread G4int i, ii, kk;
  static __thread G4int nt;
  static __thread G4float cfa, eka;
  static __thread G4int ika, nbl;
  static __thread G4float ran, pcm;
  static __thread G4int isw;
  static __thread G4float tex;
  static __thread G4ParticleDefinition* ipa1;
  static __thread G4float ran1, ran2, ekin, tkin;
  static __thread G4float targ;
  static __thread G4ParticleDefinition* inve;
  static __thread G4float ekin1, ekin2, black;
  static __thread G4float pnrat, rmnve1, rmnve2;
  static __thread G4float ek, en;
...
G4double G4AntiNeutronAnnihilationAtRest::ExNu(G4float ek1)
{
  ...
  static __thread G4float cfa, gfa, ran1, ran2, ekin1, atno3;
  static __thread G4int magic;
  static __thread G4float fpdiv;
