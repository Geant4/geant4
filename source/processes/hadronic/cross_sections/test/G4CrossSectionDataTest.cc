...
//
//
// $Id: G4CrossSectionDataTest.cc,v 1.10 2006-11-09 10:16:49 grichine Exp $
...
// Process definition
  ...
  G4ProtonInelasticCrossSection hpwIn;
  ...
  for(i = 0; i < iMax; i++)
  {
   ...
   // sig = hpwIn.GetCrossSection(theDynamicParticle,theElement, 273*kelvin);
