...
void pimCuIneSum()
{
  ...
  simRead.open("pim-Cu-inelastic.dat");
  ...
  */
  ...
  gg->SetTitle("#pi^{-}-Cu inelastic cross-section");
  ...
  */
  ...
  TCanvas* myc = new TCanvas("myc", "#pi^{-}-Cu inelastic cross-section");
  ...
  gg->GetYaxis()->SetRangeUser(450,1300);
