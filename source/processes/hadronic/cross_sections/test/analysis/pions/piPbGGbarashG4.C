...
void piPbGGbarashG4()
{
  ...
  Double_t stDubna[10] = {3160.,3070.,2930.,2820.,2750.,2710.,2655.,2640.,2640.,2640.};

  Double_t siDubna[10] = {1840.,1800.,1720.,1640.,1620.,1570.,1530.,1530.,1530.,1530.};
  ...
  /*
  TCanvas *c1 = new TCanvas("c1","n-Pb total cross-section",20,20,700,500);
  ...
  */
  ...
  TMultiGraph* mg = 
  new TMultiGraph("mg", "#pi^{-}-Pb cross-sections");
  ...
  TCanvas* myc = new TCanvas("myc", "#pi^{-}-Pb cross-sections");
  ...
  /*
  TH1F *histS = 
  new TH1F("histS","n-Pb total cross-section",
