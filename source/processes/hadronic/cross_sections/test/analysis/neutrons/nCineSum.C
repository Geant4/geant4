...
void nCineSum()
{
  ...
  simRead.open("n-C-inelastic.dat");
  ...
  */
  ...
  gg->SetTitle("n-C inelastic cross-section");
  ...
  */
  ...
  TCanvas* myc = new TCanvas("myc", "n-C inelastic cross-section");
  ...
  gg->GetYaxis()->SetRangeUser(180,320);
