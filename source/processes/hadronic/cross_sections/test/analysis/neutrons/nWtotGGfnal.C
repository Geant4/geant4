...
void nWtotGGfnal()
{
  ...
  Double_t sFNAL[7] == {2840.,2804.,2786.,2751.,2746.,2748.,2720.};
  Double_t yFNAL[7] == {46.,16.,11.,12.,16.,16.,18.};
  ...
  */
  ...
  TMultiGraph* mg = 
  new TMultiGraph("mg", "n-W total cross-section");
  ...
  TCanvas* myc = new TCanvas("myc", "n-W total cross-section");
