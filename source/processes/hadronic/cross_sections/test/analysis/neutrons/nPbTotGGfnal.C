...
void nPbTotGGfnal()
{
  ...
  Double_t sFNAL[7] == {2973.,2986.,2981.,2951.,2959.,2926.,2919.};
  Double_t yFNAL[7] == {85.,25.,21.,28.,32.,32.,48};
  ...
  */
  ...
  TMultiGraph* mg = 
  new TMultiGraph("mg", "n-Pb total cross-section");
  ...
  TCanvas* myc = new TCanvas("myc", "n-Pb total cross-section");
