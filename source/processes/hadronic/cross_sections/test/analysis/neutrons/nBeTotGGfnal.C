...
void nBeTotGGfnal()
{
  ...
  Double_t sFNAL[7] == {263.9,269.7,266.5,271.1,273.5,270.8,273.8};
  Double_t yFNAL[7] == {5.7,2.8,1.3,1.2,1.3,1.3,1.6};
  ...
  */
  ...
  TMultiGraph* mg = 
  new TMultiGraph("mg", "n-Be total cross-section");
  ...
  TCanvas* myc = new TCanvas("myc", "n-Be total cross-section");
