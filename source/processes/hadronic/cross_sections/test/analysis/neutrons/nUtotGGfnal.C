...
void nUtotGGfnal()
{
  ...
  Double_t sFNAL[7] == {3402.,3410.,3399.,3362.,3353.,3365.,3297};
  Double_t yFNAL[7] == {113.,29.,26.,32.,39.,46.,60.};
  ...
  */
  ...
  TMultiGraph* mg = 
  new TMultiGraph("mg", "n-U total cross-section");
  ...
  TCanvas* myc = new TCanvas("myc", "n-U total cross-section");
