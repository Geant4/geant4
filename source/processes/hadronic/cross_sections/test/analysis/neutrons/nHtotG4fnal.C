...
void nHtotG4fnal()
{
  ...
  Double_t sFNAL[7] == {38.2,38.98,39.17,39.52,39.79,39.66,40.32};
  Double_t yFNAL[7] == {0.9,0.33,0.19,0.18,0.24,0.24,0.23};
  ...
  /*
  TCanvas *c1 = new TCanvas("c1","n-H total cross-section",20,20,700,500);
  ...
  */
  ...
  TMultiGraph* mg = 
  new TMultiGraph("mg", "n-H total cross-section");
  ...
  TCanvas* myc = new TCanvas("myc", "n-H total cross-section");
  ...
  /*
  TH1F *histS = 
  new TH1F("histS","n-H total cross-section",
