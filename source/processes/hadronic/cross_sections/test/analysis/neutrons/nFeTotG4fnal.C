...
void nFeTotG4fnal()
{
  ...
  Double_t sFNAL[7] == {1100.,1122.,1110.,1110.,1112.,1113.,1107.};
  Double_t yFNAL[7] == {29.,11.,7.,8.,8.,8.,10.};
  ...
  /*
  TCanvas *c1 = new TCanvas("c1","n-Fe total cross-section",20,20,700,500);
  ...
  */
  ...
  TMultiGraph* mg = 
  new TMultiGraph("mg", "n-Fe total cross-section");
  ...
  TCanvas* myc = new TCanvas("myc", "n-Fe total cross-section");
  ...
  /*
  TH1F *histS = 
  new TH1F("histS","n-Fe total cross-section",
