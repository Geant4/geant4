...
G4int     G4ChipsProtonInelasticXS::lastN=0;   // The last N of calculated nucleus
G4int     G4ChipsProtonInelasticXS::lastZ=0;   // The last Z of calculated nucleus
G4double  G4ChipsProtonInelasticXS::lastP=0.;  // Last used in cross section Momentum
G4double  G4ChipsProtonInelasticXS::lastTH=0.; // Last threshold momentum
G4double  G4ChipsProtonInelasticXS::lastCS=0.; // Last value of the Cross Section
G4int     G4ChipsProtonInelasticXS::lastI=0;   // The last position in the DAMDB
