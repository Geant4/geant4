...
G4ChipsKaonZeroElasticXS::G4ChipsKaonZeroElasticXS():G4VCrossSectionDataSet("ChipsKaonZeroElasticXS")
{
  theKMinusCS = new G4ChipsKaonMinusElasticXS;
  theKPlusCS = new G4ChipsKaonPlusElasticXS;
}
