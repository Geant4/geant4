...
G4int     G4ChipsPionMinusInelasticXS::lastN=0;   // The last N of calculated nucleus
G4int     G4ChipsPionMinusInelasticXS::lastZ=0;   // The last Z of calculated nucleus
G4double  G4ChipsPionMinusInelasticXS::lastP=0.;  // Last used cross section Momentum
G4double  G4ChipsPionMinusInelasticXS::lastTH=0.; // Last threshold momentum
G4double  G4ChipsPionMinusInelasticXS::lastCS=0.; // Last value of the Cross Section
G4int     G4ChipsPionMinusInelasticXS::lastI=0;   // The last position in the DAMDB
std::vector<G4double*>* G4ChipsPionMinusInelasticXS::LEN = new std::vector<G4double*>;
std::vector<G4double*>* G4ChipsPionMinusInelasticXS::HEN = new std::vector<G4double*>;
