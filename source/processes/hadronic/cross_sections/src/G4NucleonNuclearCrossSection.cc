...
const G4double G4NucleonNuclearCrossSection::e1[38] =     
{
  .02, .04, .06, .08,  .1, .12, .13, .14, .15, .16, .17, .18, .19, .20, .22, .24, .26, 
  .28, .30, .35, .40, .45,  0.5, 0.55,   0.6, 0.7,  0.8,  0.9,   1,   2,   3,   5,  10,   
  20,   50,  100,  500, 1000
};
const G4double G4NucleonNuclearCrossSection::he_t[38] =   
{ 
  40,  70, 108, 152, 208, 276, 300, 320, 329, 333, 332, 328, 322, 310, 288, 260, 
  240, 216, 196, 144, 125, 112,108.5,  109, 110.5, 117,  123,128.5, 135, 110,  96,  
  87,  85, 83.5, 83.5, 83.5, 83.5, 83.5
};
const G4double G4NucleonNuclearCrossSection::he_in[38] =  
{ 
  18,  38,  62,  98, 136, 176, 190, 200, 209, 212, 212, 208, 204, 196, 176, 164, 150, 
  134, 124,97.5,  90,  85, 82.5, 83.5,  86.5,  93, 97.5,  100, 102,  83,  77,  75,  
  74, 72.5, 72.5, 72.5, 72.5, 72.5
};
const G4double G4NucleonNuclearCrossSection::be_m_t[38] = 
{
  150, 210, 294, 396, 520, 600, 623, 635, 642, 640, 630, 615, 600, 576, 540, 504, 
  470, 435, 400, 340, 294, 258,  236,  230,   233, 244,  257,  270, 276, 250, 230, 
  215, 205,  194,  188,  186,  186,  186
};
const G4double G4NucleonNuclearCrossSection::be_m_in[38] =
{ 
  90, 126, 177, 240, 320, 380, 400, 410, 414, 410, 400, 387, 371, 360, 333, 312, 
  285, 260, 237, 216, 198, 187,  182,  180,   182, 187,  193,  203, 207, 179, 172, 
  165, 159,  155,  144,  144,  144,  144
};
const G4double G4NucleonNuclearCrossSection::be_p_t[24] = 
{ 
  96, 150, 222, 320, 430, 514, 545, 565, 574, 574, 564, 552, 535, 522, 490, 462, 
  432, 398, 367, 314, 276, 248,  232,  230
};
const G4double G4NucleonNuclearCrossSection::be_p_in[24] =
{ 
  60,  95, 142, 194, 262, 319, 345, 361, 364, 364, 354, 350, 330, 319, 298, 280, 
  258, 237, 216, 200, 189, 183,  182,  180
};
const G4double G4NucleonNuclearCrossSection::e2[39] =    
{
  .02, .04, .06, .08, 0.1, .11, .12, .13, .14, .15, .16, .17, .18, 0.2, .22, .24, 
  .26, .28, 0.3, .35, 0.4, .45, 0.5, .55, .575, 0.6, 0.7, 0.8, 0.9,   1,   2,   3,   
  5,  10,  20,  50, 100, 500, 1000
};
const G4double G4NucleonNuclearCrossSection::c_m_t[39] = 
{
  204, 260, 366, 517, 630, 673, 694, 704, 710, 711, 706, 694, 676, 648, 616, 584, 
  548, 518, 489, 426, 376, 342, 323, 310,  312, 313, 319, 333, 342, 348, 310, 290, 
  268, 250, 245, 237, 234, 234,  234
};
const G4double G4NucleonNuclearCrossSection::c_m_in[39] =
{
  128, 160, 224, 315, 388, 416, 430, 438, 444, 445, 440, 432, 416, 400, 380, 354, 
  320, 304, 288, 264, 246, 240, 233, 232,  233, 234, 238, 246, 252, 256, 220, 210, 
  198, 187, 183, 176, 174, 174,  174
};
const G4double G4NucleonNuclearCrossSection::c_p_t[24] = 
{
  140, 192, 294, 428, 594, 642, 662, 687, 685, 688, 684, 672, 656, 630, 598, 567, 
  533, 504, 474, 416, 369, 336, 319, 310
};
const G4double G4NucleonNuclearCrossSection::c_p_in[24] =
{ 
  94, 132, 184, 260, 370, 398, 408, 420, 426, 428, 424, 416, 400, 386, 366, 340, 
  308, 294, 280, 257, 241, 236, 231, 232
};
const G4double G4NucleonNuclearCrossSection::n_m_t[39] = 
{
  246, 308, 424, 590, 729, 776, 800, 821, 822, 817, 800, 778, 768, 728, 690, 654, 
  615, 584, 556, 480, 430, 393, 373, 367,  368, 370, 375, 388, 390, 397, 364, 337, 
  310, 291, 275, 268, 268, 268,  268
};
const G4double G4NucleonNuclearCrossSection::n_m_in[39] =
{
  155, 188, 256, 360, 456, 492, 512, 526, 526, 520, 504, 491, 475, 450, 425, 396, 
  376, 360, 340, 300, 282, 270, 265, 265,  266, 268, 273, 280, 288, 288, 256, 237, 
  226, 218, 208, 202, 202, 202,  202
};
const G4double G4NucleonNuclearCrossSection::n_p_t[27] = 
{
  150, 212, 328, 500, 680, 735, 762, 781, 782, 779, 770, 748, 740, 706, 672, 633, 
  600, 569, 541, 467, 419, 385, 368, 364,  366, 368, 375
};
const G4double G4NucleonNuclearCrossSection::n_p_in[27] =
{ 
  90, 140, 208, 300, 426, 467, 490, 504, 504, 500, 484, 474, 460, 437, 413, 381, 
365, 350, 330, 292, 276, 267, 263, 264,  265, 267, 273
};
