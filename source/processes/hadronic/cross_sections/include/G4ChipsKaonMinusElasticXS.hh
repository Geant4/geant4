...
//
//
// GEANT4 physics class: G4ChipsKaonMinusElasticXS -- header file
...
#ifndef G4ChipsKaonMinusElasticXS_h
#define G4ChipsKaonMinusElasticXS_h 1
...
class G4ChipsKaonMinusElasticXS : public G4VCrossSectionDataSet, public G4ChipsBaseXS
{

public:

  G4ChipsKaonMinusElasticXS();               // Constructor
