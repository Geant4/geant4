...
//
//
// GEANT4 physics class: G4ChipsPionPlusElasticXS -- header file
...
#ifndef G4ChipsPionPlusElasticXS_h
#define G4ChipsPionPlusElasticXS_h 1
...
class G4ChipsPionPlusElasticXS : public G4VCrossSectionDataSet, public G4ChipsBaseXS
{
public:

  G4ChipsPionPlusElasticXS();               // Constructor
