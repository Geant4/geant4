...
//
//
// GEANT4 physics class: G4ChipsProtonElasticXS -- header file
...
#ifndef G4ChipsProtonElasticXS_h
#define G4ChipsProtonElasticXS_h 1
...
class G4ChipsProtonElasticXS : public G4VCrossSectionDataSet, public G4ChipsBaseXS
{
public:

  G4ChipsProtonElasticXS();               // Constructor
