...
{
  static __thread G4HadronicWhiteBoard *theInstance_G4MT_TLS_ = 0 ; if (!theInstance_G4MT_TLS_) theInstance_G4MT_TLS_ = new  G4HadronicWhiteBoard  ;  G4HadronicWhiteBoard &theInstance = *theInstance_G4MT_TLS_;
  return theInstance;
}
