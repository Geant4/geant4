...
G4FFG_FUNCTIONENTER__
    ...
    ElementNames_ = new G4NeutronHPNames;
...
G4FFG_FUNCTIONENTER__
    ...
    // Calculate the total energy available to the daughter products
        ...
        } while(FragmentsKE > RemainingEnergy_);
...
G4FFG_FUNCTIONENTER__
    ...
    do
    {
        ...
        MeanAlphaEnergy -= 0.1;
    } while(TotalAlphaEnergy >= RemainingEnergy_);
...
G4FFG_FUNCTIONENTER__
    ...
    if(RemainingEnergy_ != 0)
    {
        ...
        while(RemainingEnergy_ >= G4FFGDefaultValues::MeanGammaEnergy )
        {
...
G4FFG_FUNCTIONENTER__
    ...
    } while (TotalNeutronEnergy > RemainingEnergy_);
...
G4FFG_FUNCTIONENTER__
    ...
    G4int WhichTree = 0;
    while(Trees_[WhichTree].IsEnd != TRUE)
    {
