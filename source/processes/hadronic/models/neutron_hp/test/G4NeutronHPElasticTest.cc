...
// and all its terms.
//
// $Id: G4NeutronHPElasticTest.cc,v 1.1 1999-01-08 16:33:43 gunter Exp $
...
//  combined bug in G4LegendreTable and G4PhotonDist fixed
     ...
     // existiert: Data/Inelastic/F24/7_14_Nitrogen line 300, 
// combined bug in G4LegendreTable and G4PhotonDist fixed
     // Init runs
...
// Fix for reading, sampling to be tested
     ...
     // File-name: ../Data/Inelastic/F01/13_27_Aluminum
