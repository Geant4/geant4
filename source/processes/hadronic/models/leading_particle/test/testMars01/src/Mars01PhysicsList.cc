...
// and all its terms.
//
// $Id: Mars01PhysicsList.cc,v 1.1 2001-12-13 14:58:47 kurasige Exp $
...
Mars01PhysicsList::Mars01PhysicsList():  G4VUserPhysicsList()
{
...
Mars01PhysicsList::~Mars01PhysicsList()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void Mars01PhysicsList::ConstructParticle()
{
...
void Mars01PhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void Mars01PhysicsList::ConstructLeptons()
{
  // leptons
  //  e+/-
...
void Mars01PhysicsList::ConstructMesons()
{
  //  mesons
  //    light mesons
...
void Mars01PhysicsList::ConstructBaryons()
{
  //  barions
...
void Mars01PhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructMarsProc();
...
void Mars01PhysicsList::ConstructEM()
{
...
#include "G4Decay.hh"
void Mars01PhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
void Mars01PhysicsList::ConstructMarsProc()
{
  Mars01EminCut* killProcess = new Mars01EminCut();
...
void Mars01PhysicsList::SetCuts()
{
