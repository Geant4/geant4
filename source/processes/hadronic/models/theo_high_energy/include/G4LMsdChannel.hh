...
//
//
// $Id: G4LMsdChannel.hh 66241 2012-12-13 18:34:42Z gunter $
//
...
#ifndef G4LMsdChannel_h
#define G4LMsdChannel_h
...
class G4LMsdChannel
{
  ...
  private:
        G4LMsdChannel(const G4LMsdChannel &);
	const G4LMsdChannel & operator=(const G4LMsdChannel &);
	int operator==(const G4LMsdChannel &) const;
	int operator!=(const G4LMsdChannel &) const;
