...

{
  ...
  public:
      ...
      void SetLMsdChannel(G4LMsdChannel *const value);
...
inline const G4VIntraNuclearTransportModel * G4LMsdGenerator::GetTransport() const
{
  return theTransport;
}

inline void G4LMsdGenerator::SetTransport(G4VIntraNuclearTransportModel *const  value)
{
  theTransport = value;
}

inline const G4VHighEnergyGenerator * G4LMsdGenerator::GetHighEnergyGenerator() const
{
  return theHighEnergyGenerator;
}

inline void G4LMsdGenerator::SetHighEnergyGenerator(G4VHighEnergyGenerator *const  value)
{
  theHighEnergyGenerator= value;
}

inline void G4LMsdGenerator::SetLMsdChannel(G4LMsdChannel *const value)
{
  fLMsdChannel = value;
}

inline const G4HadFinalState * G4LMsdGenerator::GetFinalState() const
{
