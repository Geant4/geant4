...
//
//
// $Id: G4LMsdChannel.cc 81515 2014-06-02 12:14:12Z gunter $
//
...
G4double G4LMsdChannel::GetFraction(G4Nucleus &theNucleus,
    const G4DynamicParticle & thePrimary)
{
    #ifdef debug_scatter   
      G4cout << "G4LMsdChannel:: P=" << thePrimary.GetTotalMomentum()
  ...
  ratios=theQuasiElastic->GetRatios(thePrimary.GetTotalMomentum(),
    ...
    #ifdef debug_scatter   
      G4cout << "G4LMsdChannel::ratios " << ratios.first << " x " <<ratios.second
...
G4KineticTrackVector * G4LMsdChannel::Scatter(G4Nucleus &theNucleus,
                                                      const G4DynamicParticle & thePrimary)
{
  ...
  if (result.first.e() > 0.)
    ...
    //G4cout << "Warning - G4LMsdChannel::Scatter no scattering" << G4endl;
    //return 0;       //no scatter
  ...
  {
    G4cout << "Warning - G4LMsdChannel::Scatter E-p non conservation : "
