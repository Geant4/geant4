...
{
  int iiii=0;
  G4String theNames[11]={"isoinputs/Lead/isoinput204_82_01.out",
                         "isoinputs/Lead/isoinput204_82_10.out",
                         "isoinputs/Lead/isoinput204_82_20.out",
                         "isoinputs/Lead/isoinput204_82_30.out",  
                         "isoinputs/Lead/isoinput204_82_40.out",
                         "isoinputs/Lead/isoinput204_82_50.out",
                         "isoinputs/Lead/isoinput204_82_60.out",  
                         "isoinputs/Lead/isoinput204_82_70.out",
                         "isoinputs/Lead/isoinput204_82_80.out",
                         "isoinputs/Lead/isoinput204_82_90.out",
                         "isoinputs/Lead/isoinput204_82_99.out"};

  double energies[11]={1., 10., 20., 30., 40., 50., 60., 70., 80., 90., 99.};
  double xsec[11]={6.08, 5.03, 5.748, 5.748, 5.748, 5.748, 5.748, 5.748, 5.748, 5.748, 5.748};
...
//      cout << energies[i]<<" "<<theCounter[j][i]/1000000.<<" ";
    ...
    {
//      cout << energies[i]<<" "<<theCounter[j][i]/1000000.<<" ";
      cout <<xsec[i]*sqrt(theCounter[j][i])/1000000.+0.2*xsec[i]*theCounter[j][i]/1000000.<<" ";
    }
    cout <<G4endl;
  }
  G4std::ifstream aDataSet("/data/NeutronProductionData/G4NDL0.2//IsotopeProduction/CrossSection/82_204_Lead", G4std::ios::in);
  int niso;
  aDataSet >> niso;
  ...
  for(i=0; i<counter; i++)
  {
    if(6*(pictureCount/6) == pictureCount) 
    {
       ...
       cout << "fo/file 66 lead204"<<pictureCount/6<<".ps"<<G4endl<<"meta 66 -111"<<G4endl;
    }
    if(theList[i]=="UNCHANGED") i++;
    for(j=0; j<niso; j++)
    {
    ...
    cout << "title_gl 'isotopes produced by neutrons on 204Pb'"<<G4endl;
