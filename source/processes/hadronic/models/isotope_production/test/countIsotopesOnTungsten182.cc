...
{
  int iiii=0;
  G4String theNames[11]={"isoinputs/Tungsten/isoinput182_74_01.out",
                         "isoinputs/Tungsten/isoinput182_74_10.out",
                         "isoinputs/Tungsten/isoinput182_74_20.out",
                         "isoinputs/Tungsten/isoinput182_74_30.out",  
                         "isoinputs/Tungsten/isoinput182_74_40.out",
                         "isoinputs/Tungsten/isoinput182_74_50.out",
                         "isoinputs/Tungsten/isoinput182_74_60.out",  
                         "isoinputs/Tungsten/isoinput182_74_70.out",
                         "isoinputs/Tungsten/isoinput182_74_80.out",
                         "isoinputs/Tungsten/isoinput182_74_90.out",
                         "isoinputs/Tungsten/isoinput182_74_99.out"};

  double energies[11]={1., 10., 20., 30., 40., 50., 60., 70., 80., 90., 99.};
  double xsec[11]={6.549, 4.858, 5.341,  5.341, 5.341, 5.341, 5.341, 5.341, 5.341, 5.341, 5.341};
...
//      cout << energies[i]<<" "<<theCounter[j][i]/1000000.<<" ";
  ...
  G4std::ifstream aDataSet("/data/NeutronProductionData/G4NDL0.2//IsotopeProduction/CrossSection/74_182_Tungsten", G4std::ios::in);
  int niso;
  aDataSet >> niso;
  ...
  for(i=0; i<counter; i++)
  {
    if(6*(pictureCount/6) == pictureCount) 
    {
       ...
       cout << "fo/file 66 tungsten182"<<pictureCount/6<<".ps"<<G4endl<<"meta 66 -113"<<G4endl;
    }
    if(theList[i]=="UNCHANGED") i++;
    for(j=0; j<niso; j++)
    {
    ...
    cout << "title_gl 'isotopes produced by neutrons on 182W'"<<G4endl;
