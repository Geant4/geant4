...
{
  int iiii=0;
  G4String theNames[11]={"isoinputs/Zinc/isoinput68_30_01.out",
                         "isoinputs/Zinc/isoinput68_30_10.out",
                         "isoinputs/Zinc/isoinput68_30_20.out",
                         "isoinputs/Zinc/isoinput68_30_30.out",  
                         "isoinputs/Zinc/isoinput68_30_40.out",
                         "isoinputs/Zinc/isoinput68_30_50.out",
                         "isoinputs/Zinc/isoinput68_30_60.out",  
                         "isoinputs/Zinc/isoinput68_30_70.out",
                         "isoinputs/Zinc/isoinput68_30_80.out",
                         "isoinputs/Zinc/isoinput68_30_90.out",
                         "isoinputs/Zinc/isoinput68_30_99.out"};
...
//      cout << energies[i]<<" "<<theCounter[j][i]/1000000.<<" ";
  ...
  G4std::ifstream aDataSet("/data/NeutronProductionData/G4NDL0.2//IsotopeProduction/CrossSection/30_68_Zinc", G4std::ios::in);
  int niso;
  aDataSet >> niso;
  ...
  for(i=0; i<counter; i++)
  {
    if(6*(pictureCount/6) == pictureCount) 
    {
       ...
       cout << "fo/file 66 zinc68_"<<pictureCount/6<<".ps"<<G4endl<<"meta 66 -113"<<G4endl;
    }
    if(theList[i]=="UNCHANGED") i++;
    for(j=0; j<niso; j++)
    {
    ...
    cout << "title_gl 'isotopes produced by neutrons on 68Zn'"<<G4endl;
