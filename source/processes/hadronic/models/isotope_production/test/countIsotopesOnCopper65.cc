...
{
  int iiii=0;
  G4String theNames[11]={"isoinputs/Copper/isoinput65_29_01.out",
                         "isoinputs/Copper/isoinput65_29_10.out",
                         "isoinputs/Copper/isoinput65_29_20.out",
                         "isoinputs/Copper/isoinput65_29_30.out",  
                         "isoinputs/Copper/isoinput65_29_40.out",
                         "isoinputs/Copper/isoinput65_29_50.out",
                         "isoinputs/Copper/isoinput65_29_60.out",  
                         "isoinputs/Copper/isoinput65_29_70.out",
                         "isoinputs/Copper/isoinput65_29_80.out",
                         "isoinputs/Copper/isoinput65_29_90.out",
                         "isoinputs/Copper/isoinput65_29_99.out"};

  double energies[11]={1., 10., 20., 30., 40., 50., 60., 70., 80., 90., 99.};
  double xsec[11]={3.98, 3.48, 2.48, 2.48, 2.48, 2.48, 2.48, 2.48, 2.48, 2.48, 2.48};
...
//      cout << energies[i]<<" "<<theCounter[j][i]/1000000.<<" ";
  ...
  G4std::ifstream aDataSet("/data/NeutronProductionData/G4NDL0.2//IsotopeProduction/CrossSection/29_65_Copper", G4std::ios::in);
  int niso;
  aDataSet >> niso;
  ...
  for(i=0; i<counter; i++)
  {
    if(6*(pictureCount/6) == pictureCount) 
    {
       ...
       cout << "fo/file 66 copper65_"<<pictureCount/6<<".ps"<<G4endl<<"meta 66 -113"<<G4endl;
    }
    if(theList[i]=="UNCHANGED") i++;
    for(j=0; j<niso; j++)
    {
    ...
    cout << "title_gl 'isotopes produced by neutrons on 65Cu'"<<G4endl;
