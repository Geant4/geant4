...
{
  int iiii=0;
  G4String theNames[11]={"isoinputs/Silicon/isoinput30_14_01.out",
                         "isoinputs/Silicon/isoinput30_14_10.out",
                         "isoinputs/Silicon/isoinput30_14_20.out",
                         "isoinputs/Silicon/isoinput30_14_30.out",  
                         "isoinputs/Silicon/isoinput30_14_40.out",
                         "isoinputs/Silicon/isoinput30_14_50.out",
                         "isoinputs/Silicon/isoinput30_14_60.out",  
                         "isoinputs/Silicon/isoinput30_14_70.out",
                         "isoinputs/Silicon/isoinput30_14_80.out",
                         "isoinputs/Silicon/isoinput30_14_90.out",
                         "isoinputs/Silicon/isoinput30_14_99.out"};
...
//      cout << energies[i]<<" "<<theCounter[j][i]/1000000.<<" ";
  ...
  G4std::ifstream aDataSet("/data/NeutronProductionData/G4NDL0.2//IsotopeProduction/CrossSection/14_30_Silicon", G4std::ios::in);
  int niso;
  aDataSet >> niso;
  ...
  for(i=0; i<counter; i++)
  {
    if(6*(pictureCount/6) == pictureCount) 
    {
       ...
       cout << "fo/file 66 silicon30"<<pictureCount/6<<".ps"<<G4endl<<"meta 66 -113"<<G4endl;
    }
    if(theList[i]=="UNCHANGED") i++;
    for(j=0; j<niso; j++)
    {
    ...
    cout << "title_gl 'isotopes produced by neutrons on 30Si'"<<G4endl;
