...
{
  int iiii=0;
  G4String theNames[11]={"isoinputs/Lead/isoinput206_82_01.out",
                         "isoinputs/Lead/isoinput206_82_10.out",
                         "isoinputs/Lead/isoinput206_82_20.out",
                         "isoinputs/Lead/isoinput206_82_30.out",  
                         "isoinputs/Lead/isoinput206_82_40.out",
                         "isoinputs/Lead/isoinput206_82_50.out",
                         "isoinputs/Lead/isoinput206_82_60.out",  
                         "isoinputs/Lead/isoinput206_82_70.out",
                         "isoinputs/Lead/isoinput206_82_80.out",
                         "isoinputs/Lead/isoinput206_82_90.out",
                         "isoinputs/Lead/isoinput206_82_99.out"};
...
//      cout << energies[i]<<" "<<theCounter[j][i]/1000000.<<" ";
  ...
  G4std::ifstream aDataSet("/data/NeutronProductionData/G4NDL0.2//IsotopeProduction/CrossSection/82_206_Lead", G4std::ios::in);
  int niso;
  aDataSet >> niso;
  ...
  for(i=0; i<counter; i++)
  {
    if(6*(pictureCount/6) == pictureCount) 
    {
       ...
       cout << "fo/file 66 lead206"<<pictureCount/6<<".ps"<<G4endl<<"meta 66 -113"<<G4endl;
    }
    if(theList[i]=="UNCHANGED") i++;
    for(j=0; j<niso; j++)
    {
    ...
    cout << "title_gl 'isotopes produced by neutrons on 206Pb'"<<G4endl;
