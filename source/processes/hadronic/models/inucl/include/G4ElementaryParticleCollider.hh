...
vector<G4int> generateOutgoingKindsFor2toMany(
...
pair<G4double, G4double> adjustIntervalForElastic(G4double ekin, G4double ak, G4double ae,
 G4int k, G4int l, const vector<G4double>& ssv, G4double st) const;
