...
//
//
// $Id: exrdm01RunAction.cc,v 1.2 2006-12-13 15:47:16 gunter Exp $
...
exrdm01RunAction::exrdm01RunAction()
{
}
...
void exrdm01RunAction::BeginOfRunAction(const G4Run* aRun)
{
...
void exrdm01RunAction::EndOfRunAction(const G4Run* )
{
