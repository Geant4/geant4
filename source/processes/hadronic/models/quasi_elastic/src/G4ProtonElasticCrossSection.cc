...
//
//
// $Id: G4ProtonElasticCrossSection.cc,v 1.4 2010-06-25 09:45:53 gunter Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
//
// G4 Physics class: G4ProtonElasticCrossSection for pA elastic cross sections
...
const G4int G4ProtonElasticCrossSection::nPoints=128;//#ofPt in the AMDB table(>anyPar)(D)
const G4int G4ProtonElasticCrossSection::nLast=nPoints-1;// theLastElement in the table(D)
G4double  G4ProtonElasticCrossSection::lPMin=-8.;  // Min tabulated logarithmicMomentum(D)
G4double  G4ProtonElasticCrossSection::lPMax= 8.;  // Max tabulated logarithmicMomentum(D)
G4double  G4ProtonElasticCrossSection::dlnP=(lPMax-lPMin)/nLast;// LogStep in the table(D)
G4bool    G4ProtonElasticCrossSection::onlyCS=true;// Flag toCalculateOnlyCS(not Si/Bi)(L)
G4double  G4ProtonElasticCrossSection::lastSIG=0.; // Last calculated cross section    (L)
G4double  G4ProtonElasticCrossSection::lastLP=-10.;// Last log(mom_ofTheIncidentHadron)(L)
G4double  G4ProtonElasticCrossSection::lastTM=0.;  // Last t_maximum                   (L)
G4double  G4ProtonElasticCrossSection::theSS=0.;   // The Last sq.slope of 1st difr.Max(L)
G4double  G4ProtonElasticCrossSection::theS1=0.;   // The Last mantissa of 1st difr.Max(L)
G4double  G4ProtonElasticCrossSection::theB1=0.;   // The Last slope of 1st difruct.Max(L)
G4double  G4ProtonElasticCrossSection::theS2=0.;   // The Last mantissa of 2nd difr.Max(L)
G4double  G4ProtonElasticCrossSection::theB2=0.;   // The Last slope of 2nd difruct.Max(L)
G4double  G4ProtonElasticCrossSection::theS3=0.;   // The Last mantissa of 3d difr. Max(L)
G4double  G4ProtonElasticCrossSection::theB3=0.;   // The Last slope of 3d difruct. Max(L)
G4double  G4ProtonElasticCrossSection::theS4=0.;   // The Last mantissa of 4th difr.Max(L)
G4double  G4ProtonElasticCrossSection::theB4=0.;   // The Last slope of 4th difruct.Max(L)
G4int     G4ProtonElasticCrossSection::lastTZ=0;   // Last atomic number of the target
G4int     G4ProtonElasticCrossSection::lastTN=0;   // Last # of neutrons in the target
G4double  G4ProtonElasticCrossSection::lastPIN=0.; // Last initialized max momentum
G4double* G4ProtonElasticCrossSection::lastCST=0;  // Elastic cross-section table
G4double* G4ProtonElasticCrossSection::lastPAR=0;  // Parameters for FunctionalCalculation
G4double* G4ProtonElasticCrossSection::lastSST=0;  // E-dep of sq.slope of the 1st dif.Max
G4double* G4ProtonElasticCrossSection::lastS1T=0;  // E-dep of mantissa of the 1st dif.Max
G4double* G4ProtonElasticCrossSection::lastB1T=0;  // E-dep of the slope of the 1st difMax
G4double* G4ProtonElasticCrossSection::lastS2T=0;  // E-dep of mantissa of the 2nd difrMax
G4double* G4ProtonElasticCrossSection::lastB2T=0;  // E-dep of the slope of the 2nd difMax
G4double* G4ProtonElasticCrossSection::lastS3T=0;  // E-dep of mantissa of the 3d difr.Max
G4double* G4ProtonElasticCrossSection::lastB3T=0;  // E-dep of the slope of the 3d difrMax
G4double* G4ProtonElasticCrossSection::lastS4T=0;  // E-dep of mantissa of the 4th difrMax
G4double* G4ProtonElasticCrossSection::lastB4T=0;  // E-dep of the slope of the 4th difMax
G4int     G4ProtonElasticCrossSection::lastN=0;    // The last N of calculated nucleus
G4int     G4ProtonElasticCrossSection::lastZ=0;    // The last Z of calculated nucleus
G4double  G4ProtonElasticCrossSection::lastP=0.;   // Last used in cross section Momentum
G4double  G4ProtonElasticCrossSection::lastTH=0.;  // Last threshold momentum
G4double  G4ProtonElasticCrossSection::lastCS=0.;  // Last value of the Cross Section
G4int     G4ProtonElasticCrossSection::lastI=0;    // The last position in the DAMDB

std::vector<G4double*> G4ProtonElasticCrossSection::PAR; // Vector of pars for functCalcul
std::vector<G4double*> G4ProtonElasticCrossSection::CST; // Vector of cross-section table
std::vector<G4double*> G4ProtonElasticCrossSection::SST; // Vector of the 1st SquaredSlope
std::vector<G4double*> G4ProtonElasticCrossSection::S1T; // Vector of the 1st mantissa
std::vector<G4double*> G4ProtonElasticCrossSection::B1T; // Vector of the 1st slope
std::vector<G4double*> G4ProtonElasticCrossSection::S2T; // Vector of the 2nd mantissa
std::vector<G4double*> G4ProtonElasticCrossSection::B2T; // Vector of the 2nd slope
std::vector<G4double*> G4ProtonElasticCrossSection::S3T; // Vector of the 3d mantissa
std::vector<G4double*> G4ProtonElasticCrossSection::B3T; // Vector of the 3d slope
std::vector<G4double*> G4ProtonElasticCrossSection::S4T; // Vector of the 4th mantissa (g)
std::vector<G4double*> G4ProtonElasticCrossSection::B4T; // Vector of the 4th slope (glor)

G4ProtonElasticCrossSection::G4ProtonElasticCrossSection()
{
}
...
G4VCrossSection* G4ProtonElasticCrossSection::GetPointer()
{
  static G4ProtonElasticCrossSection theCrossSection;//*StaticBody of theQEl CrossSection*
  return &theCrossSection;
}

// The main member function giving the collision cross section (P is in IU, CS is in mb)
// Make pMom in independent units ! (Now it is MeV)
G4double G4ProtonElasticCrossSection::GetCrossSection(G4bool fCS,G4double pMom, G4int tgZ,
                                                       G4int tgN, G4int pPDG)
{
  ...
  if(pPDG!=2212)
  {
    G4cout<<"*Warning*G4ProtonElCS::GetCS: *** Found pPDG="<<pPDG<<" =--=> CS=0"<<G4endl;
...
G4double G4ProtonElasticCrossSection::CalculateCrossSection(G4bool CS, G4int F, G4int I,
                                             G4int PDG, G4int tgZ, G4int tgN, G4double pIU)
{
  ...
  if(lastLP>lPMin && lastLP<=lastPIN)   // Linear fit is made using precalculated tables
  {
    if(lastLP==lastPIN)
    {
      ...
      if(blast<0 || blast>=nLast) G4cout<<"G4EleastCS::CCS:b="<<blast<<","<<nLast<<G4endl;
...
G4double G4ProtonElasticCrossSection::GetPTables(G4double LP, G4double ILP, G4int PDG,
                                                  G4int tgZ, G4int tgN)
{
  ...
  if(PDG==2212)
  {
    ...
    if(LP>ILP)
    {
      ...
      if(ini<nPoints)
      {
        ...
        else G4cout<<"*Warning*G4ProtonElasticCrossSection::GetPTables: PDG="<<PDG<<", Z="
  ...
  {
    G4cerr<<"*Error*G4ProtonElasticCrossSection::GetPTables: PDG="<<PDG<<", Z="<<tgZ
...
G4double G4ProtonElasticCrossSection::GetExchangeT(G4int tgZ, G4int tgN, G4int PDG)
{
  ...
  if(PDG!=2212) G4cout<<"**Warning*G4ProtonElasticCrossSection::GetExT:PDG="<<PDG<<G4endl;
  if(onlyCS) G4cout<<"**Warning*G4ProtonElasticCrossSection::GetExchanT:onlyCS=1"<<G4endl;
  ...
  if(q2<0.) q2=0.;
  if(!(q2>=-1.||q2<=1.)) G4cout<<"*NAN*G4ElasticCrossSect::GetExchangeT: -t="<<q2<<G4endl;
  if(q2>lastTM)
  {
    q2=lastTM;
  }
...
G4double G4ProtonElasticCrossSection::GetSlope(G4int tgZ, G4int tgN, G4int PDG)
{
  static const G4double GeVSQ=gigaelectronvolt*gigaelectronvolt;
  if(onlyCS) G4cout<<"*Warning*G4ProtonElasticCrossSection::GetSlope:onlyCS=true"<<G4endl;
  if(lastLP<-4.3) return 0.;          // S-wave for p<14 MeV/c (kinE<.1MeV)
  if(PDG!=2212)
  {
    G4cerr<<"*Error*G4ProtonElasticCrossSection::GetSlope: PDG="<<PDG<<", Z="<<tgZ<<", N="
          <<tgN<<", while it is defined only for PDG=2212"<<G4endl;
  }
  if(theB1<0.) theB1=0.;
  if(!(theB1>=-1.||theB1<=1.))G4cout<<"*NAN*G4ElasticCrossSect::Getslope:"<<theB1<<G4endl;
  return theB1/GeVSQ;
}

// Returns half max(Q2=-t) in independent units (MeV^2)
G4double G4ProtonElasticCrossSection::GetHMaxT()
{
...
G4double G4ProtonElasticCrossSection::GetTabValues(G4double lp, G4int PDG, G4int tgZ,
                                                    G4int tgN)
{
  if(PDG!=2212) G4cout<<"*Warning*G4ProtonElasticCrossSection::GetTabV:PDG="<<PDG<<G4endl;
  if(tgZ<0 || tgZ>92)
  {
    G4cout<<"*Warning*G4ProtonElCS::GetTabValue: (1-92) No isotopes for Z="<<tgZ<<G4endl;
    return 0.;
  }
...
G4double G4ProtonElasticCrossSection::GetQ2max(G4int PDG, G4int tgZ, G4int tgN,
                                                G4double pP)
{
...
//    G4double mt=G4QPDGCode(90000000+tgZ*1000+tgN).GetMass()*.001; // Target mass in GeV
    ...
    G4double dmt=mt+mt;
    G4double mandelstam_s=dmt*std::sqrt(pP2+mProt2)+mProt2+mt*mt;// Mondelstam s
    return dmt*dmt*pP2/mandelstam_s;
  }
  else
  {
    G4cerr<<"*Error*G4ProtonElasticCrossSection::GetQ2max: PDG="<<PDG<<", Z="<<tgZ<<", N="
