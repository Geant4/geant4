...
//
//
// GEANT4 physics class: G4ProtonElasticCrossSection -- header file
...
#ifndef G4ProtonElasticCrossSection_h
#define G4ProtonElasticCrossSection_h 1

#include <vector>
#include "Randomize.hh"
#include "G4VCrossSection.hh"

class G4ProtonElasticCrossSection : public G4VCrossSection
{
protected:

  G4ProtonElasticCrossSection();               // Constructor
