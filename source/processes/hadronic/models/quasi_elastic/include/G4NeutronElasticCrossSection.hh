...
//
//
// GEANT4 physics class: G4NeutronElasticCrossSection -- header file
...
#ifndef G4NeutronElasticCrossSection_h
#define G4NeutronElasticCrossSection_h 1

#include <vector>
#include "Randomize.hh"
#include "G4VCrossSection.hh"

class G4NeutronElasticCrossSection : public G4VCrossSection
{
protected:

  G4NeutronElasticCrossSection();               // Constructor

public:

  ~G4NeutronElasticCrossSection();

  static G4VCrossSection* GetPointer(); // Gives a pointer to this singletone
