...
// and all its terms.
//
// $Id: G4HEXiMinusInelastic.cc,v 1.2 1999-06-16 04:42:50 kurasige Exp $
...
ApplyYourself( const G4Track &aTrack, G4Nucleus &targetNucleus )
  {
    ...
    if(incidentKineticEnergy < 1.)
      { 
        G4cout << "GHEXiMinusInelastic: incident energy < 1 GeV" << endl;
      }
    if(verboseLevel > 1)
      {
        G4cout << "G4HEXiMinusInelastic::ApplyYourself" << endl;
