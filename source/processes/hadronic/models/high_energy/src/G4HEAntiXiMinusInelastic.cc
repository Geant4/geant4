...
void G4HEAntiXiMinusInelastic::Description() const
{
  ...
  if (dirName) {
    ...
    outFile << "<title>Description of anti-Xi- High Energy Parameterized Model</title>\n";
    outFile << "</head>\n";
    outFile << "<body>\n";

    outFile << "G4HEAntiXiMinusInelastic is one of the High Energy\n"
