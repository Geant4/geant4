...
void G4HEProtonInelastic::Description() const
{
  ...
  if (dirName) {
    ...
    outFile << "<title>Description of proton High Energy Parameterized Model</title>\n";
    outFile << "</head>\n";
    outFile << "<body>\n";

    outFile << "G4HEProtonInelastic is one of the High Energy\n"
