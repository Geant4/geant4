...
void G4HEAntiProtonInelastic::Description() const
{
  ...
  if (dirName) {
    ...
    outFile << "<title>Description of anti-proton High Energy Parameterized Model</title>\n";
    outFile << "</head>\n";
    outFile << "<body>\n";

    outFile << "G4HEAntiProtonInelastic is one of the High Energy\n"
