...
void G4HEKaonZeroShortInelastic::Description() const
{
  ...
  if (dirName) {
    ...
    outFile << "<title>Description of K0S High Energy Parameterized Model</title>\n";
    outFile << "</head>\n";
    outFile << "<body>\n";

    outFile << "G4HEKaonZeroShortInelastic is one of the High Energy\n"
