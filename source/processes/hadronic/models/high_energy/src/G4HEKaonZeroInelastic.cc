...
void G4HEKaonZeroInelastic::Description() const
{
  ...
  if (dirName) {
    ...
    outFile << "<title>Description of K0 High Energy Parameterized Model</title>\n";
    outFile << "</head>\n";
    outFile << "<body>\n";

    outFile << "G4HEKaonZeroInelastic is one of the High Energy\n"
