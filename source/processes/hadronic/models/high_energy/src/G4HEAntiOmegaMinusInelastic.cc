...
{
  outFile << "G4HEAntiOmegaMinusInelastic is one of the High Energy\n"
...
// on the whole performance of the program. Take AntiLambda instaed. 
{
  ...
  static G4ThreadLocal G4double protmulAn[numMulAn],protnormAn[numSec]; 
  static G4ThreadLocal G4double neutmul[numMul],  neutnorm[numSec];   // neutron constants
  static G4ThreadLocal G4double neutmulAn[numMulAn],neutnormAn[numSec];
