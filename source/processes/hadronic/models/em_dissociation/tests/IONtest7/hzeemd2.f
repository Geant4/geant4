...
C**************************************************************
C      
      SUBROUTINE PRINTEMD (AP, ZP, AT, ZT, E)
      ...
      WRITE (6,
     + '("CROSS-SECTION FOR PROTON PRODUCTION FROM PROJECTILE  = ",
     + F15.7, " mbarns")') QJ
      CALL YIELDEM (AP, ZP, AT, ZT, AP-1.0,ZP, E, QJ)
      WRITE (6,
     + '("CROSS-SECTION FOR NEUTRON PRODUCTION FROM PROJECTILE = ",
     + F15.7, " mbarns")') QJ
      CALL YIELDEM (AT, ZT, AP, ZP, AT-1.0,ZT-1.0, E, QJ)
      WRITE (6,
     +'("CROSS-SECTION FOR PROTON PRODUCTION FROM TARGET      = ",
     + F15.7, " mbarns")') QJ
      CALL YIELDEM (AT, ZT, AP, ZP, AT-1.0,ZT, E, QJ)
      WRITE (6,
     +'("CROSS-SECTION FOR NEUTRON PRODUCTION FROM TARGET     = ",
     + F15.7, " mbarns")') QJ
