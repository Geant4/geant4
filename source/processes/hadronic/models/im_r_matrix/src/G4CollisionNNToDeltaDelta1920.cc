...
//
//
// $Id: G4CollisionNNToDeltaDelta1920.cc,v 1.2 2003/11/19 15:35:30 hpw Exp $ //
...
{ 
  ...
  G4CollisionComposite::AddComponent(new G4ConcreteNNToDeltaDeltastar(aNeutron, aProton, aDeltapp, aDm_1920));
