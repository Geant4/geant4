...
// ********************************************************************
//
// $Id: G4NuTauNucleusNcModel.cc 91806 2015-08-06 12:20:45Z gcosmo $
//
...
using namespace CLHEP;
    ...
    G4Mutex G4NuTauNucleusNcModel::numuNucleusModel = G4MUTEX_INITIALIZER;
#endif     


G4NuTauNucleusNcModel::G4NuTauNucleusNcModel(const G4String& name) 
...
G4NuTauNucleusNcModel::~G4NuTauNucleusNcModel()
{}


void G4NuTauNucleusNcModel::ModelDescription(std::ostream& outFile) const
{

    outFile << "G4NuTauNucleusNcModel is a tau-neutrino-nucleus (neutral current) scattering\n"
...
void G4NuTauNucleusNcModel::InitialiseModel()
{
...
G4bool G4NuTauNucleusNcModel::IsApplicable(const G4HadProjectile & aPart, 
					        G4Nucleus & )
{
  G4bool result  = false;
...
G4HadFinalState* G4NuTauNucleusNcModel::ApplyYourself(
		 const G4HadProjectile& aTrack, G4Nucleus& targetNucleus)
{
  ...
  { 
    ...
    aLept = new G4DynamicParticle( theNuTau, lv2 );  
...
void G4NuTauNucleusNcModel::SampleLVkr(const G4HadProjectile & aTrack, G4Nucleus& targetNucleus)
{
  fBreak = false;
