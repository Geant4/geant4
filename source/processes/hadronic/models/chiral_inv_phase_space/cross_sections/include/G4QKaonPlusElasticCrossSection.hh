...
//
//
// GEANT4 physics class: G4QKaonPlusElasticCrossSection -- header file
...
#ifndef G4QKaonPlusElasticCrossSection_h
#define G4QKaonPlusElasticCrossSection_h 1
...
class G4QKaonPlusElasticCrossSection : public G4VQCrossSection
{
protected:

  G4QKaonPlusElasticCrossSection();               // Constructor
