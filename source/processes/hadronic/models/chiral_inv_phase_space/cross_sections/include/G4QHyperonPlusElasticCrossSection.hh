...
#ifndef G4QHyperonPlusElasticCrossSection_h
...
class G4QHyperonPlusElasticCrossSection : public G4VQCrossSection
{
protected:

  G4QHyperonPlusElasticCrossSection();               // Constructor

public:

  ~G4QHyperonPlusElasticCrossSection();
