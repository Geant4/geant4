...
//
//
// $Id: G4QANuENuclearCrossSection.cc,v 1.1 2009-11-16 18:15:43 mkossov Exp $
...
// ****************************************************************************************
// ----------------------------------------------------------------------------------------
// Short description: antinu_e -> e cross-section
// ----------------------------------------------------------------------------------------
...
std::vector<G4double*>* G4QANuENuclearCrossSection::TX = new std::vector<G4double*>;
std::vector<G4double*>* G4QANuENuclearCrossSection::QE = new std::vector<G4double*>;
