...
std::vector<G4double*>* G4QTauNuclearCrossSection::J1 = new std::vector<G4double*>;
std::vector<G4double*>* G4QTauNuclearCrossSection::J2 = new std::vector<G4double*>;
std::vector<G4double*>* G4QTauNuclearCrossSection::J3 = new std::vector<G4double*>;
