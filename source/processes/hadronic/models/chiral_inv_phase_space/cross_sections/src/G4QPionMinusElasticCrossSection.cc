                                                  ...
                                                  G4int tgZ, G4int tgN)
{
  ...
  const G4int n_pimpel=14;                // #of parameters for pp-elastic (<nPoints=128)
  G4double pimp_el[n_pimpel]=
                           {1.27,1.53,.0676,3.5,.36,.04,.017,.0025,.0557,2.4,7.,.7,.6,.05};
                                                    ...
                                                    G4int tgN)
{
  ...
  if ( tgZ == 1 && tgN == 0 ) // PiMin+P
  {
    ...
    return lastPAR[1]/(dl1*dl1+lastPAR[2])+
           (lastPAR[8]*dl2*dl2+lastPAR[9]+lastPAR[10]/sp)/(1.+lastPAR[11]/p4)+
