...
const G4int G4QKaonMinusElasticCrossSection::nPoints=128;//#ofPt in AMDB table(>anyPar)/D
const G4int G4QKaonMinusElasticCrossSection::nLast=nPoints-1;// theLastElement inTable /D
G4double  G4QKaonMinusElasticCrossSection::lPMin=-8.;  //Min tabulatedLogarithmMomentum/D
G4double  G4QKaonMinusElasticCrossSection::lPMax= 8.;  //Max tabulatedLogarithmMomentum/D
G4double  G4QKaonMinusElasticCrossSection::dlnP=(lPMax-lPMin)/nLast;// LogStep inTable /D
G4bool    G4QKaonMinusElasticCrossSection::onlyCS=true;//Flag toCalculOnlyCS(not Si/Bi)/L
G4double  G4QKaonMinusElasticCrossSection::lastSIG=0.; //Last calculated cross section /L
G4double  G4QKaonMinusElasticCrossSection::lastLP=-10.;//LastLog(mom_of IncidentHadron)/L
G4double  G4QKaonMinusElasticCrossSection::lastTM=0.; //Last t_maximum                /L
G4double  G4QKaonMinusElasticCrossSection::theSS=0.;  //TheLastSqSlope of 1st difr.Max/L
G4double  G4QKaonMinusElasticCrossSection::theS1=0.;  //TheLastMantissa of 1st difrMax/L
G4double  G4QKaonMinusElasticCrossSection::theB1=0.;  //TheLastSlope of 1st difructMax/L
G4double  G4QKaonMinusElasticCrossSection::theS2=0.;  //TheLastMantissa of 2nd difrMax/L
G4double  G4QKaonMinusElasticCrossSection::theB2=0.;  //TheLastSlope of 2nd difructMax/L
G4double  G4QKaonMinusElasticCrossSection::theS3=0.;  //TheLastMantissa of 3d difr.Max/L
G4double  G4QKaonMinusElasticCrossSection::theB3=0.;  //TheLastSlope of 3d difruct.Max/L
G4double  G4QKaonMinusElasticCrossSection::theS4=0.;  //TheLastMantissa of 4th difrMax/L
G4double  G4QKaonMinusElasticCrossSection::theB4=0.;  //TheLastSlope of 4th difructMax/L
G4int     G4QKaonMinusElasticCrossSection::lastTZ=0;  // Last atomic number of theTarget
G4int     G4QKaonMinusElasticCrossSection::lastTN=0;  // Last # of neutrons in theTarget
G4double  G4QKaonMinusElasticCrossSection::lastPIN=0.;// Last initialized max momentum
G4double* G4QKaonMinusElasticCrossSection::lastCST=0; // Elastic cross-section table
G4double* G4QKaonMinusElasticCrossSection::lastPAR=0; // ParametersForFunctionCalculation
G4double* G4QKaonMinusElasticCrossSection::lastSST=0; // E-dep ofSqardSlope of 1st difMax
G4double* G4QKaonMinusElasticCrossSection::lastS1T=0; // E-dep of mantissa of 1st dif.Max
G4double* G4QKaonMinusElasticCrossSection::lastB1T=0; // E-dep of the slope of 1st difMax
G4double* G4QKaonMinusElasticCrossSection::lastS2T=0; // E-dep of mantissa of 2nd difrMax
G4double* G4QKaonMinusElasticCrossSection::lastB2T=0; // E-dep of the slope of 2nd difMax
G4double* G4QKaonMinusElasticCrossSection::lastS3T=0; // E-dep of mantissa of 3d difr.Max
G4double* G4QKaonMinusElasticCrossSection::lastB3T=0; // E-dep of the slope of 3d difrMax
G4double* G4QKaonMinusElasticCrossSection::lastS4T=0; // E-dep of mantissa of 4th difrMax
G4double* G4QKaonMinusElasticCrossSection::lastB4T=0; // E-dep of the slope of 4th difMax
G4int     G4QKaonMinusElasticCrossSection::lastN=0;   // The last N of calculated nucleus
G4int     G4QKaonMinusElasticCrossSection::lastZ=0;   // The last Z of calculated nucleus
G4double  G4QKaonMinusElasticCrossSection::lastP=0.;  // LastUsed inCrossSection Momentum
G4double  G4QKaonMinusElasticCrossSection::lastTH=0.; // Last threshold momentum
G4double  G4QKaonMinusElasticCrossSection::lastCS=0.; // Last value of the Cross Section
G4int     G4QKaonMinusElasticCrossSection::lastI=0;   // The last position in the DAMDB

std::vector<G4double*> G4QKaonMinusElasticCrossSection::PAR;//Vector ofParsForFunctCalcul
std::vector<G4double*> G4QKaonMinusElasticCrossSection::CST;//Vector ofCrossSection table
std::vector<G4double*> G4QKaonMinusElasticCrossSection::SST;//Vector ofThe1st SquardSlope
std::vector<G4double*> G4QKaonMinusElasticCrossSection::S1T;//Vector of the 1st mantissa
std::vector<G4double*> G4QKaonMinusElasticCrossSection::B1T;//Vector of the1st slope
std::vector<G4double*> G4QKaonMinusElasticCrossSection::S2T;//Vector of the2nd mantissa
std::vector<G4double*> G4QKaonMinusElasticCrossSection::B2T;//Vector of the2nd slope
std::vector<G4double*> G4QKaonMinusElasticCrossSection::S3T;//Vector of the3d mantissa
std::vector<G4double*> G4QKaonMinusElasticCrossSection::B3T;//Vector of the3d slope
std::vector<G4double*> G4QKaonMinusElasticCrossSection::S4T;//Vector ofThe4th mantissa(g)
std::vector<G4double*> G4QKaonMinusElasticCrossSection::B4T;//Vector ofThe4th slope(glor)

G4QKaonMinusElasticCrossSection::G4QKaonMinusElasticCrossSection()
{
}
...
G4VQCrossSection* G4QKaonMinusElasticCrossSection::GetPointer()
{
  static G4QKaonMinusElasticCrossSection theCrossSection;//StaticBody of the QElCrossSect
  return &theCrossSection;
}

// The main member function giving the collision cross section (P is in IU, CS is in mb)
// Make pMom in independent units ! (Now it is MeV)
G4double G4QKaonMinusElasticCrossSection::GetCrossSection(G4bool fCS, G4double pMom,
                                                         G4int tgZ, G4int tgN, G4int pPDG)
{
  ...
  onlyCS=fCS;
#ifdef pdebug
  G4cout<<"G4QKaMiusElCS::GetCS:>>>f="<<fCS<<", p="<<pMom<<", Z="<<tgZ<<"("<<lastZ<<") ,N="
        <<tgN<<"("<<lastN<<"), T="<<pEn<<"("<<lastTH<<")"<<",Sz="<<colN.size()<<G4endl;
  //CalculateCrossSection(fCS,-27,j,pPDG,lastZ,lastN,pMom); // DUMMY TEST
#endif
  if(pPDG != -321)
  {
    G4cout<<"*Warning*G4QKaonMinusElaCS::GetCS:*>Found pPDG="<<pPDG<<" ==> CS=0"<<G4endl;
    //CalculateCrossSection(fCS,-27,j,pPDG,lastZ,lastN,pMom); // DUMMY TEST
  ...
  {                                  // The nucleus with projPDG is found in AMDB
    if(colN[i]==tgN && colZ[i]==tgZ) // Isotope is foind in AMDB
    {
...
#ifdef pdebug
      G4cout<<"G4QKMElCS::GetCS:*Found* P="<<pMom<<",Threshold="<<lastTH<<",i="<<i<<G4endl;
      //CalculateCrossSection(fCS,-27,i,pPDG,lastZ,lastN,pMom); // DUMMY TEST
#endif
      if(pEn<=lastTH)
      {
#ifdef pdebug
        G4cout<<"G4QKMElCS::GetCS:Found T="<<pEn<<" < Threshold="<<lastTH<<",CS=0"<<G4endl;
        //CalculateCrossSection(fCS,-27,i,pPDG,lastZ,lastN,pMom); // DUMMY TEST
#endif
      ...
      {
#ifdef pdebug
        G4cout<<"G4QKaonMinusElastCS::GetCS: P="<<pMom<<",CS="<<lastCS*millibarn<<G4endl;
#endif
...
#ifdef pdebug
      G4cout<<"G4QKMElCS::G:UpdateDB P="<<pMom<<",f="<<fCS<<",I="<<lastI<<",i="<<i<<G4endl;
#endif
      lastCS=CalculateCrossSection(fCS,-1,i,pPDG,lastZ,lastN,pMom); // read & update
#ifdef pdebug
      G4cout<<"G4QKaonMinusElCS::GetCrosSec:****>New(inDB) Calculated CS="<<lastCS<<G4endl;
      //CalculateCrossSection(fCS,-27,i,pPDG,lastZ,lastN,pMom); // DUMMY TEST
#endif
      if(lastCS<=0. && pEn>lastTH)    // Correct the threshold
      {
#ifdef pdebug
        G4cout<<"G4QKaonMinusElCS::GetCS: T="<<pEn<<"(CS=0) > Threshold="<<lastTH<<G4endl;
#endif
        lastTH=pEn;
      }
...
#ifdef pdebug
    G4cout<<"---G4QKaonMinusElasticCrossSection::GetCrosSec:pPDG="<<pPDG<<",i="<<i<<",N="
  ...
  {
#ifdef pdebug
    G4cout<<"G4QKaonMinusElCS::GetCS:CalNewP="<<pMom<<",f="<<fCS<<",lastI="<<lastI<<G4endl;
#endif
...
#ifdef pdebug
      G4cout<<"G4QKaonMinusElasticCrossSection::GetCS:NewThr="<<lastTH<<",T="<<pEn<<G4endl;
#endif
      if(pEn>lastTH)
      {
#ifdef pdebug
        G4cout<<"G4QKaonMinusElCS::GetCS:1st T="<<pEn<<"(CS=0)>Threshold="<<lastTH<<G4endl;
#endif
        lastTH=pEn;
      }
    }
#ifdef pdebug
    G4cout<<"G4QKaonMinusElCS::GetCS:NCS="<<lastCS<<",lZ="<<lastN<<",lN="<<lastZ<<G4endl;
...
#ifdef pdebug
    G4cout<<"G4QKMElCS::GetCS:1st,P="<<pMom<<"(MeV),CS="<<lastCS*millibarn<<"(mb)"<<G4endl;
    //CalculateCrossSection(fCS,-27,lastI,pPDG,lastZ,lastN,pMom); // DUMMY TEST
#endif
  ...
  {
#ifdef pdebug
    G4cout<<"G4QKaonMinusElasticCrossSection::GetCS: Update lastI="<<lastI<<G4endl;
#endif
    colP[lastI]=pMom;
    colCS[lastI]=lastCS;
  }
#ifdef pdebug
  G4cout<<"G4QKMElCS::GetCSec:End,P="<<pMom<<"(MeV),CS="<<lastCS*millibarn<<"(mb)"<<G4endl;
  //CalculateCrossSection(fCS,-27,lastI,pPDG,lastZ,lastN,pMom); // DUMMY TEST
  G4cout<<"G4QKaonMinusElasticCrossSection::GetCrosSec:**End**, onlyCS="<<onlyCS<<G4endl;
#endif
  return lastCS*millibarn;
}
...
G4double G4QKaonMinusElasticCrossSection::CalculateCrossSection(G4bool CS, G4int F,
...
#ifdef pdebug
  G4cout<<"G4QKaonMinusElasticCS::CalcCS: onlyCS="<<onlyCS<<",F="<<F<<",p="<<pIU<<G4endl;
#endif
...
#ifdef pdebug
      G4cout<<"G4QKaonMinusElCS::CalCS:DB updated for I="<<I<<",*,PIN4="<<PIN[4]<<G4endl;
#endif
    }
#ifdef pdebug
    G4cout<<"G4QKaonMinusElasticCS::CalcCS:*read*,LP="<<lastLP<<",PIN="<<lastPIN<<G4endl;
#endif
    if(lastLP>lastPIN && lastLP<lPMax)
    {
      lastPIN=GetPTables(lastLP,lastPIN,PDG,tgZ,tgN);// Can update upper logP-Limit in tabs
#ifdef pdebug
      G4cout<<"G4QKMElCS::CalcCS:updated(I),LP="<<lastLP<<"<IN["<<I<<"]="<<lastPIN<<G4endl;
#endif
...
#ifdef pdebug
    G4cout<<"G4QKaonMinusElasticCS::CalcCS:*ini*,lstLP="<<lastLP<<",min="<<lPMin<<G4endl;
#endif
    lastPIN = GetPTables(lastLP,lPMin,PDG,tgZ,tgN); // Returns the new P-limit for tables
#ifdef pdebug
    G4cout<<"G4QKaMiElCS::CCS:i,Z="<<tgZ<<",N="<<tgN<<",PDG="<<PDG<<",LP"<<lastPIN<<G4endl;
#endif
...
#ifdef pdebug
    G4cout<<"G4QKaonMinusElCS::CalcCS:*updated(O)*,LP="<<lastLP<<"<IN="<<lastPIN<<G4endl;
#endif
  }
#ifdef pdebug
  G4cout<<"G4QKaMiElCS::CalcCS:lastLP="<<lastLP<<",lPM="<<lPMin<<",lPIN="<<lastPIN<<G4endl;
#endif
  if(!onlyCS) lastTM=GetQ2max(PDG, tgZ, tgN, pMom); // Calculate (-t)_max=Q2_max (GeV2)
#ifdef pdebug
  G4cout<<"G4QKaMiElCrosSec::CalcCS: oCS="<<onlyCS<<",-t="<<lastTM<<", p="<<lastLP<<G4endl;
#endif
...
#ifdef pdebug
      G4cout<<"G4QKaonMinusElasticCS::CalculateCS:(E) S1="<<theS1<<",B1="<<theB1<<G4endl;
#endif
    }
    else
    {
...
#ifdef pdebug
      G4cout<<"G4QKaonMinusElasticCrossSection::CalcCrossSection:Sig="<<lastSIG<<",P="
...
#ifdef pdebug
        G4cout<<"G4QKaonMinusElasticCS::CalcCrossSect: b="<<blast<<", ls="<<lastL<<",SL="
...
#ifdef pdebug
        G4cout<<"G4QKaonMinusElasticCrossSection::CalcCS: s3l="<<S3TL<<", sh3="<<shift
...
#ifdef pdebug
        G4cout<<"G4QKaonMinusElasticCrossSection::CalcCS: s4l="<<S4TL<<", sh4="<<shift
...
#ifdef pdebug
      G4cout<<"G4QKaonMinusElasticCS::CalculateCS:(I) S1="<<theS1<<",B1="<<theB1<<G4endl;
#endif
    }
  }
...
#ifdef pdebug
  G4cout<<"G4QKaonMinusElasticCrossSection::CalculateCS: END, onlyCS="<<onlyCS<<G4endl;
#endif
  return lastSIG;
}

// It has parameter sets for all tZ/tN/PDG, using them the tables can be created/updated
G4double G4QKaonMinusElasticCrossSection::GetPTables(G4double LP,G4double ILP, G4int PDG,
                                                       G4int tgZ, G4int tgN)
{
  ...
  if(PDG == -321)
  {
    ...
    if(lastPAR[nLast]!=pwd) // A unique flag to avoid the repeatable definition
    {
...
#ifdef pdebug
         G4cout<<"G4QKMElCS::CalcCS:la "<<lastPAR[38]<<", "<<lastPAR[39]<<", "<<lastPAR[40]
...
#ifdef pdebug
         G4cout<<"G4QKMElCS::CalcCS:ha "<<lastPAR[41]<<", "<<lastPAR[42]<<", "<<lastPAR[43]
      ...
      lastB4T[0]=theB4;
#ifdef pdebug
      G4cout<<"G4QKaonMinusElasticCrossSection::GetPTables:ip=0(init), lp="<<lp<<",S1="
      ...
      if(ini<nPoints)
      {
        ...
        if(fin>=ini)
        {
          ...
          for(G4int ip=ini; ip<=fin; ip++)        // Calculate tabular CS,S1,B1,S2,B2,S3,B3
          {
            ...
            lastB4T[ip]=theB4;
#ifdef pdebug
            G4cout<<"G4QKaonMinusElasticCrossSection::GetPTables:ip="<<ip<<",lp="<<lp
        ...
        else G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetPTables: PDG="<<PDG
...
#ifdef pdebug
    else G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetPTa:PDG="<<PDG<<",Z="<<tgZ
...
G4double G4QKaonMinusElasticCrossSection::GetExchangeT(G4int tgZ, G4int tgN, G4int PDG)
{
  ...
  {
#ifdef tdebug
    G4cout<<"G4QKaonMinusElCS::GetExT: TM="<<lastTM<<",S1="<<theS1<<",B1="<<theB1<<",S2="
    ...
    if(ds1>.0001)
      G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetExT:1p "<<ts1<<"#"<<lastTM
    ...
    if(ds2>.0001)
      G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetExT:2p "<<ts2<<"#"<<lastTM
    ...
    if(ds3>.0001)
      G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetExT:3p "<<ts3<<"#"<<lastTM
  ...
  else
  {
    G4double a=tgZ+tgN;
#ifdef tdebug
    G4cout<<"G4QKaonMinusElasticCrossSection::GetExT:a="<<a<<",t="<<lastTM<<",S1="<<theS1
    ...
    if(ds1>.0001)
      G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetExT:1a "<<ts1<<"#"<<lastTM
            <<",d="<<ds1<<",R1="<<R1<<",E1="<<E1<<G4endl;
#endif
    ...
    G4double ds2=std::fabs(ts2-lastTM)/lastTM;
    if(ds2>.0001)
      G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetExT:2a "<<ts2<<"#"<<lastTM
            <<",d="<<ds2<<",R2="<<R2<<",E2="<<E2<<G4endl;
#endif
    G4double E3=lastTM*theB3;
    ...
    G4double ds3=std::fabs(ts3-lastTM)/lastTM;
    if(ds3>.0001)
      G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetExT:3a "<<ts3<<"#"<<lastTM
    ...
    if(ds4>.0001)
      G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetExT:4a "<<ts4<<"#"<<lastTM
...
#ifdef tdebug
    G4cout<<"G4QKMElCS::GExT:1="<<I1<<",2="<<I2<<",3="<<I3<<",4="<<I4<<",r="<<rand<<G4endl;
#endif
    if(rand<I1)
    {
      G4double ran=R1*G4UniformRand();
...
#ifdef tdebug
      G4cout<<"G4QKMElCS::GExT:Q2="<<q2<<",ss="<<tss/2<<",b1="<<theB1<<",t1="<<ts1<<G4endl;
#endif
    }
    else if(rand<I12)
    {
...
#ifdef tdebug
      G4cout<<"G4QKMElCS::GetExT: Q2="<<q2<<",r2="<<R2<<",b2="<<theB2<<",t2="<<ts2<<G4endl;
#endif
    }
    else if(rand<I13)
    {
...
#ifdef tdebug
      G4cout<<"G4QKMElCS::GetExT: Q2="<<q2<<",r3="<<R2<<",b3="<<theB2<<",t3="<<ts2<<G4endl;
#endif
    }
    else
    {
...
#ifdef tdebug
      G4cout<<"G4QKMElCS::GET:Q2="<<q2<<",m="<<lastTM<<",b4="<<theB3<<",t4="<<ts3<<G4endl;
#endif
    }
  }
  if(q2<0.) q2=0.;
  ...
  {
#ifdef tdebug
    G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GET:-t="<<q2<<">"<<lastTM<<G4endl;
#endif
    q2=lastTM;
  }
  return q2*GeVSQ;
...
G4double G4QKaonMinusElasticCrossSection::GetSlope(G4int tgZ, G4int tgN, G4int PDG)
{
  static const G4double GeVSQ=gigaelectronvolt*gigaelectronvolt;
#ifdef tdebug
  G4cout<<"G4QKaonMinusECS::GetS:"<<onlyCS<<",Z="<<tgZ<<",N="<<tgN<<",PDG="<<PDG<<G4endl;
#endif
  if(onlyCS)G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetSl:onlCS=true"<<G4endl;
...
G4double G4QKaonMinusElasticCrossSection::GetHMaxT()
{
...
G4double G4QKaonMinusElasticCrossSection::GetTabValues(G4double lp, G4int PDG, G4int tgZ,
                                                    G4int tgN)
{
  if(PDG!=-321)G4cout<<"*Warning*G4QKaonMinusElasticCrossSection::GetTV:PDG="<<PDG<<G4endl;
  if(tgZ<0 || tgZ>92)
  {
  ...
  //{
#ifdef isodebug
  //  G4cout<<"*Warning*G4QKaonMinusElasticCS::GetTabVal:NoIsotopes for Z="<<tgZ<<G4endl;
#endif
  //  return 0.;
  //}
#ifdef pdebug
  G4cout<<"G4QKaonMinusECS::GetTV: l="<<lp<<",Z="<<tgZ<<",N="<<tgN<<",PDG="<<PDG<<G4endl;
#endif
  ...
  if ( tgZ == 1 && tgN == 0 )           // KaonMinus+P
  {
    ...
    theB4=0.; 
#ifdef tdebug
    G4cout<<"G4QKaonMinusElasticCrossSection::GetTabV:TM="<<lastTM<<",S1="<<theS1<<",B1="
...
#ifdef tdebug
      G4cout<<"G4QKaonMinusElasticCS::GetTabV: lA, p="<<p<<",S1="<<theS1<<",B1="<<theB1
...
#ifdef tdebug
      G4cout<<"G4QKaonMinusElasticCS::GetTabVal:hA,p="<<p<<",S1="<<theS1<<",B1="<<theB1
            <<",SS="<<theSS<<",S2="<<theS2<<",B2="<<theB2<<",S3="<<theS3<<",B3="<<theB3
            <<",S4="<<theS4<<",B4="<<theB4<<G4endl;
#endif
    }
...
G4double G4QKaonMinusElasticCrossSection::GetQ2max(G4int PDG, G4int tgZ, G4int tgN,
                                                    G4double pP)
{
