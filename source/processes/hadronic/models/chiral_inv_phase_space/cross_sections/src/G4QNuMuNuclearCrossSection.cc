...
//
//
// $Id: G4QNuMuNuclearCrossSection.cc,v 1.1 2009-11-16 18:15:43 mkossov Exp $
...
// ****************************************************************************************
// ---------------------------------------------------------------------------------------
// Short description: neutrino_mu -> mu nuclear XS
// ---------------------------------------------------------------------------------------
...
std::vector<G4double*>* G4QNuMuNuclearCrossSection::TX = new std::vector<G4double*>;
std::vector<G4double*>* G4QNuMuNuclearCrossSection::QE = new std::vector<G4double*>;
