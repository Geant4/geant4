...
G4double* G4QPionPlusNuclearCrossSection::lastLEN=0; // Pointer to the lastArray of LowEn CS
G4double* G4QPionPlusNuclearCrossSection::lastHEN=0; // Pointer to the lastArray of HighEn CS
...
#ifdef pdebug
    G4cout<<"G4QPiPlusNucCS::CSForm: A="<<a<<",P="<<P<<",CS="<<sigma<<",c="<<c<<",g="<<g
