...
//
//
// GEANT4 physics class: G4QKaonZeroNuclearCrossSection -- header file
...
#ifndef G4QKaonZeroNuclearCrossSection_h
#define G4QKaonZeroNuclearCrossSection_h 1
...
class G4QKaonZeroNuclearCrossSection : public G4VQCrossSection
{
protected:
...
private:
  ...
  static G4VQCrossSection* theKMinusCS; // K- cross-section
  static G4VQCrossSection* theKPlusCS;  // K+ cross-section
};
