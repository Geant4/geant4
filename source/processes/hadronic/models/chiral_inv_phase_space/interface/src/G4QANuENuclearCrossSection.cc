...
//
//
// $Id: G4QANuENuclearCrossSection.cc,v 1.1 2007-10-02 10:00:37 mkossov Exp $
                                       ...
                                       G4int , G4int targZ, G4int targN, G4double Momentum)
{
  ...
  static const G4int nE=33;   // !! If change this, change it in GetFunctions() !!
                                                     ...
                                                     G4double* t, G4double* q, G4double* e)
{
  ...
  static const G4double me2=me*me;    // Squared mass of an electron in GeV^2
  static const G4double thresh=me+me2/dmN; // Universal threshold in GeV
  static const G4int nE=33; // !! If change this, change it in CalculateCrossSection() !!
  static const G4double nuEn[nE]={thresh,
																															.000513927, .000543565, .000576714, .000613907, .000655780,
																															.000703091, .000756750, .000817851, .000887722, .000967976,
																															.001060590, .001168010, .001293240, .001440060,
																															.001818600, .002358930, .003152430,
																															.004355250, .006244120,
																															.009329680, .014596700, .024039600,
																															.041921800, .077918400,
																															.155490000, .335863000, .792438000,
																															2.06304000, 5.99360000,
                               19.6774000, 74.0346000, 324.245000};
  static const G4double TOTX[nE]={0.,
																																		.00053259, .00184122, .00265763, .00338121, .00408229,
																																		.00479313, .00553504, .00632574, .00718235, .00812313,
																																		.00916865, .01034300, .01167490, .01319950,
																																		.01700930, .02226050, .02972690,
																																		.04065900, .05710390,
																																		.08240570, .12185800, .18298800,
																																		.27299600, .38562600,
																																		.47300000, .47079900, .41066800,
																																		.35869900, .33444100,
                                  .33408700, .34719900, .36259000};
  static const G4double QELX[nE]={0.,
																										2.73710e-07, 1.00082e-06, 1.53269e-06, 2.07575e-06, 2.67708e-06,
																										3.37001e-06, 4.18864e-06, 5.17351e-06, 6.37593e-06, 7.86300e-06,
																										9.72420e-06, 1.20807e-05, 1.50985e-05, 1.90080e-05,
																										3.09331e-05, 5.25111e-05, 9.37119e-05,
																										0.000177080, 0.000356564,
																										0.000768818, 0.001778730, 0.004398970,
																										0.011444500, 0.030047400,
																										0.073546600, 0.156598000, 0.283235000,
																										0.425058000, 0.528482000,
                          0.577821000, 0.595175000, 0.600135000};
  // --------------------------------
  G4int first=0;
  if(z<0.)
		{
