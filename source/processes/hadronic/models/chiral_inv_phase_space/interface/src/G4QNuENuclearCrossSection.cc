...
//
//
// $Id: G4QNuENuclearCrossSection.cc,v 1.1 2007-10-02 10:00:37 mkossov Exp $
                                        ...
                                        G4int, G4int targZ, G4int targN, G4double Momentum)
{
  ...
  static const G4int nE=33;        // !! If change this, change it in GetFunctions()33/65!!
                                                     ...
                                                     G4double* t, G4double* q, G4double* e)
{
  ...
  static const G4double TOTX[nE]={0.,
																															0.00053968, 0.00186648, 0.00269531, 0.00343092, 0.00414474,
																															0.00486973, 0.00562779, 0.00643731, 0.00731620, 0.00828370,
																															0.00936165, 0.01057580, 0.01195720, 0.01354390,
																															0.01753400, 0.02309100, 0.03110230,
																															0.04305840, 0.06153620,
																															0.09110330, 0.13999500, 0.22295200,
                               0.36438200, 0.59243300,
																															0.88460200, 1.06383000, 0.98336900,
																															0.80902300, 0.69602100,
                               0.64514500, 0.62567400, 0.61077900};
  static const G4double QELX[nE]={0.,
																															2.77356e-7, 1.01455e-6, 1.55442e-6, 2.10626e-6, 2.71804e-6,
																															3.42386e-6, 4.25883e-6, 5.26476e-6, 6.49475e-6, 8.01843e-6,
																															9.92890e-6, 1.23526e-5, 1.54635e-5, 1.95039e-5,
																															3.18874e-5, 5.44701e-5, 9.80479e-5,
																															.000187530, .000384239,
																															.000849964, .002043470, .005359690,
																															.015275600, .046161500,
																															.137546000, .324713000, .507198000,
																															.582753000, .597034000,
																															.600223000, .601250000, .601529000};
  // --------------------------------
  G4int first=0;
  if(z<0.)
		{
