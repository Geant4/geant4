...
//	th14.push_back(aBin);
    ...
    operator()(MEvent * it) 
    {
      double weight = 1074./10000./4; // sigma/10000./binwidth
      int ip = it->getIP();
      if(ip!=2112) return;
...
//	  if( fabs(it->getTheta()-160.)<accept ) th14[j].second+=weight;
    ...
    void dump()
    {
      ...
      cout << "th=133"<<endl; for_each(th12.begin(),  th12.end(), print(binWidth/2.));
      cout << "th=144"<<endl; for_each(th13.begin(),  th13.end(), print(binWidth/2.));
