...
//	th14.push_back(aBin);
    ...
    operator()(MEvent * it) 
    {
      double weight = 1227./10000./2.25; // sigma/10000./binwidth
      int ip = it->getIP();
      if(ip!=2112) return;
...
//	  if( fabs(it->getTheta()-160.)<accept ) th14[j].second+=weight;
    ...
    void dump()
    {
      ...
      cout << "th=10"<<endl;  for_each(th2.begin(),   th2.end(),  print(binWidth/2.));
      cout << "th=20"<<endl;  for_each(th3.begin(),   th3.end(),  print(binWidth/2.));
      cout << "th=30"<<endl;  for_each(th4.begin(),   th4.end(), print(binWidth/2.));
      cout << "th=40"<<endl;  for_each(th5.begin(),   th5.end(), print(binWidth/2.));
      cout << "th=60"<<endl;  for_each(th6.begin(),   th6.end(), print(binWidth/2.));
      cout << "th=80"<<endl;  for_each(th7.begin(),   th7.end(), print(binWidth/2.));
      cout << "th=100"<<endl; for_each(th8.begin(),   th8.end(), print(binWidth/2.));
      cout << "th=120"<<endl; for_each(th9.begin(),   th9.end(), print(binWidth/2.));
      cout << "th=140"<<endl; for_each(th10.begin(),  th10.end(), print(binWidth/2.));
      cout << "th=150"<<endl; for_each(th11.begin(),  th11.end(), print(binWidth/2.));
      cout << "th=160"<<endl; for_each(th12.begin(),  th12.end(), print(binWidth/2.));
