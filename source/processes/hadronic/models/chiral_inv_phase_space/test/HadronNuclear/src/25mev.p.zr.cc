...
//	th14.push_back(aBin);
    ...
    operator()(MEvent * it) 
    {
      double weight = 1351./10000./1.25; // sigma/10000./binwidth
      int ip = it->getIP();
      if(ip!=2112) return;
...
//	  if( fabs(it->getTheta()-160.)<accept ) th14[j].second+=weight;
    ...
    void dump()
    {
      ...
      cout << "th=20"<<endl;  for_each(th2.begin(),   th2.end(),  print(binWidth/2.));
      cout << "th=60"<<endl;  for_each(th3.begin(),   th3.end(),  print(binWidth/2.));
      cout << "th=120"<<endl;  for_each(th4.begin(),   th4.end(), print(binWidth/2.));
      cout << "th=160"<<endl;  for_each(th5.begin(),   th5.end(), print(binWidth/2.));
