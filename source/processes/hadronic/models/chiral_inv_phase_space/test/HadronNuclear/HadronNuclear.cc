...
//
//
// $Id: HadronNuclear.cc,v 1.2 2003-06-19 14:39:49 gunter Exp $
 ...
 int main()
  {
    ...
    G4int numberOfMaterials = 20;
    G4Material *theMaterials[20];
...
//    theProtonInelasticProcess->RegisterMe( theParaModel );
    ...
    *condition = NotForced;
    ...
    do {
      ...
      G4cout << "16) Carbon     17) 6_3_Lithium 18) Tantalum 19) Zirconium"<< G4endl;
