				   ...
				   theDaughterMasses(0)
{
  ...
  if (parentG4MTThreadPrivate != NULL)
  {
      parentmass = parentG4MTThreadPrivate->GetPDGMass();
  } else {
	  parentmass=0.;
  }
...
G4DecayProducts *G4GeneralPhaseSpaceDecay::DecayIt(G4double) 
{
  ...
  if (parentG4MTThreadPrivate == NULL) FillParent();  
  if (daughtersG4MTThreadPrivate == NULL) FillDaughters();
...
//  G4double daughtermass = daughters[0]->GetPDGMass();
  ...
  G4DynamicParticle * daughterparticle = new G4DynamicParticle(daughtersG4MTThreadPrivate[0], dummy, 0.0);
...
G4DecayProducts *G4GeneralPhaseSpaceDecay::TwoBodyDecayIt()
{
  ...
  { 
     ...
     daughtermass[0] = daughtersG4MTThreadPrivate[0]->GetPDGMass();
     daughtermass[1] = daughtersG4MTThreadPrivate[1]->GetPDGMass();
  }
...
//  G4double sumofdaughtermass =  daughtermass[0] + daughtermass[1];
  ...
  G4DynamicParticle * daughterparticle = new G4DynamicParticle( daughtersG4MTThreadPrivate[0],Etotal, direction*daughtermomentum);
  products->PushProducts(daughterparticle);
  Etotal= std::sqrt(daughtermass[1]*daughtermass[1] + daughtermomentum*daughtermomentum);
  daughterparticle = new G4DynamicParticle( daughtersG4MTThreadPrivate[1],Etotal, direction*(-1.0*daughtermomentum));
  products->PushProducts(daughterparticle);
...
// algorism of this code is originally written in GDECA3 of GEANT3
{
  ...
  G4DynamicParticle * daughterparticle 
         = new G4DynamicParticle( daughtersG4MTThreadPrivate[0], Etotal, direction0*daughtermomentum[0]);
  products->PushProducts(daughterparticle);
  ...
  daughterparticle = new G4DynamicParticle( daughtersG4MTThreadPrivate[2],Etotal, direction2*(daughtermomentum[2]/direction2.mag()));
  products->PushProducts(daughterparticle);
  ...
  daughterparticle = 
       new G4DynamicParticle(daughtersG4MTThreadPrivate[1], Etotal, mom);
  products->PushProducts(daughterparticle);
...
//
{
  ...
  daughterparticle[index1] = new G4DynamicParticle( daughtersG4MTThreadPrivate[index1], direction*daughtermomentum[index1] );
  daughterparticle[index1+1] = new G4DynamicParticle( daughtersG4MTThreadPrivate[index1+1], direction*(-1.0*daughtermomentum[index1]) );
  ...
  for (index1 = numberOfDaughters -3;  index1 >= 0; index1--) {
    ...
    //create daughter G4DynamicParticle 
    daughterparticle[index1]= new G4DynamicParticle( daughtersG4MTThreadPrivate[index1], direction*(-1.0*daughtermomentum[index1]));
  }

  //create G4Decayproducts
  G4DynamicParticle *parentparticle; 
  direction.setX(1.0);  direction.setY(0.0); direction.setZ(0.0);
  parentparticle = new G4DynamicParticle( parentG4MTThreadPrivate, direction, 0.0);
