...
namespace G4INCL {
  ...
  public:
    ...
    static G4ThreadLocal NuclearMassFn getTableMass;
    static G4ThreadLocal ParticleMassFn getTableParticleMass;
    ...
    static G4ThreadLocal SeparationEnergyFn getSeparationEnergy;
...
// assert(Z>=0 && A>=0 && Z<=A);
...
#ifdef INCLXX_IN_GEANT4_MODE
    static G4ThreadLocal G4IonTable *theG4IonTable;
#else
  ...
  private:
    ...
    static G4ThreadLocal G4double protonMass;
    static G4ThreadLocal G4double neutronMass;
    static G4ThreadLocal G4double neutronSeparationEnergy;
    static G4ThreadLocal G4double protonSeparationEnergy;
    static G4ThreadLocal G4double piPlusMass, piMinusMass, piZeroMass;
    static G4ThreadLocal G4double theRealProtonMass;
    static G4ThreadLocal G4double theRealNeutronMass;
    static G4ThreadLocal G4double theRealChargedPiMass;
    static G4ThreadLocal G4double theRealPiZeroMass;
