...
// assert(npion > 0 && npion < 5);
    ...
    void NNToMultiPionsChannel::pn_ppPim() {
        isosp[0]=-2;
        iso1=1;
        iso2=1;
    }
    void NNToMultiPionsChannel::pn_pnPi0() {
        isosp[0]=0;
    }
    void NNToMultiPionsChannel::pn_nnPip() {
        isosp[0]=2;
        iso1=-1;
        iso2=-1;
    }
    void NNToMultiPionsChannel::pp_nnPipPip() {
        isosp[0]=2;
        isosp[1]=2;
        iso1=-1;
        iso2=-1;
    }
    void NNToMultiPionsChannel::nn_ppPimPim() {
        isosp[0]=-2;
        isosp[1]=-2;
        iso1=1;
        iso2=1;
    }
    void NNToMultiPionsChannel::pn_pnPipPim() {
        isosp[0]=2;
        isosp[1]=-2;
    }
    void NNToMultiPionsChannel::pn_pnPi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
    }
    void NNToMultiPionsChannel::pp_ppPipPim() {
        isosp[0]=2;
        isosp[1]=-2;
    }
    void NNToMultiPionsChannel::nn_nnPipPim() {
        isosp[0]=2;
        isosp[1]=-2;
    }
    void NNToMultiPionsChannel::pp_ppPi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
    }
    void NNToMultiPionsChannel::nn_nnPi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
    }
    void NNToMultiPionsChannel::pp_pnPipPi0() {
        isosp[0]=2;
        isosp[1]=0;
        iso1=1;
        iso2=-1;
    }
    void NNToMultiPionsChannel::pn_ppPimPi0() {
        isosp[0]=-2;
        isosp[1]=0;
        iso1=1;
        iso2=1;
    }
    void NNToMultiPionsChannel::pn_nnPipPi0() {
        isosp[0]=2;
        isosp[1]=0;
        iso1=-1;
        iso2=-1;
    }
    void NNToMultiPionsChannel::nn_pnPimPi0() {
        isosp[0]=-2;
        isosp[1]=0;
        iso1=1;
        iso2=-1;
    }
    void NNToMultiPionsChannel::pp_pnPipPi0Pi0() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=0;
        iso1=1;
    ...
    void NNToMultiPionsChannel::nn_pnPimPi0Pi0() {
        isosp[0]=-2;
        isosp[1]=0;
        isosp[2]=0;
        iso1=1;
    ...
    void NNToMultiPionsChannel::pn_nnPipPi0Pi0() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=0;
        iso1=-1;
    ...
    void NNToMultiPionsChannel::pp_ppPipPimPi0() {
        isosp[0]=2;
        isosp[1]=-2;
        isosp[2]=0;
    }
    void NNToMultiPionsChannel::nn_nnPipPimPi0() {
        isosp[0]=2;
        isosp[1]=-2;
        isosp[2]=0;
    }
    void NNToMultiPionsChannel::pp_ppPi0Pi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=0;
    }
    void NNToMultiPionsChannel::nn_nnPi0Pi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=0;
    }
    void NNToMultiPionsChannel::pp_pnPipPipPim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=-2;
        iso1=1;
    ...
    void NNToMultiPionsChannel::pp_nnPipPipPi0() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=0;
        iso1=-1;
    ...
    void NNToMultiPionsChannel::pn_ppPimPi0Pi0() {
        isosp[0]=-2;
        isosp[1]=0;
        isosp[2]=0;
        iso1=1;
    ...
    void NNToMultiPionsChannel::pn_ppPimPimPip() {
        isosp[0]=-2;
        isosp[1]=-2;
        isosp[2]=2;
        iso1=1;
    ...
    void NNToMultiPionsChannel::pn_pnPi0PipPim() {
        isosp[0]=0;
        isosp[1]=2;
        isosp[2]=-2;
    }
    void NNToMultiPionsChannel::pn_pnPi0Pi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=0;
    }
    void NNToMultiPionsChannel::pn_nnPipPipPim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=-2;
        iso1=-1;
    ...
    void NNToMultiPionsChannel::nn_pnPipPimPim() {
        isosp[0]=2;
        isosp[1]=-2;
        isosp[2]=-2;
        iso1=1;
    ...
    void NNToMultiPionsChannel::nn_ppPimPimPi0() {
        isosp[0]=-2;
        isosp[1]=-2;
        isosp[2]=0;
        iso1=1;
    ...
    void NNToMultiPionsChannel::pp_nnPipPipPi0Pi0() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=0;
        isosp[3]=0;
    ...
    void NNToMultiPionsChannel::pp_nnPipPipPipPim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=2;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::nn_ppPi0Pi0PimPim() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=-2;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::nn_ppPipPimPimPim() {
        isosp[0]=2;
        isosp[1]=-2;
        isosp[2]=-2;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::pp_ppPi0Pi0Pi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=0;
    }
    void NNToMultiPionsChannel::nn_nnPi0Pi0Pi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=0;
    }
    void NNToMultiPionsChannel::pn_pnPi0Pi0Pi0Pi0() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=0;
    }
    void NNToMultiPionsChannel::pp_ppPipPi0Pi0Pim() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=-2;
    }
    void NNToMultiPionsChannel::nn_nnPipPi0Pi0Pim() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=-2;
    }
    void NNToMultiPionsChannel::pn_pnPipPi0Pi0Pim() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=-2;
    }
    void NNToMultiPionsChannel::pp_ppPipPipPimPim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=-2;
        isosp[3]=-2;
    }
    void NNToMultiPionsChannel::nn_nnPipPipPimPim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=-2;
        isosp[3]=-2;
    }
    void NNToMultiPionsChannel::pn_pnPipPipPimPim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=-2;
        isosp[3]=-2;
    }
    void NNToMultiPionsChannel::pp_pnPipPi0Pi0Pi0() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=0;
    ...
    void NNToMultiPionsChannel::pn_nnPipPi0Pi0Pi0() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=0;
    ...
    void NNToMultiPionsChannel::pp_nnPipPi0Pi0Pi0() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=0;
    ...
    void NNToMultiPionsChannel::pp_pnPipPipPi0Pim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=0;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::pn_nnPipPipPi0Pim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=0;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::pp_nnPipPipPi0Pim() {
        isosp[0]=2;
        isosp[1]=2;
        isosp[2]=0;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::nn_pnPi0Pi0Pi0Pim() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::pn_ppPi0Pi0Pi0Pim() {
        isosp[0]=0;
        isosp[1]=0;
        isosp[2]=0;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::nn_pnPipPi0PimPim() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=-2;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::pn_ppPipPi0PimPim() {
        isosp[0]=2;
        isosp[1]=0;
        isosp[2]=-2;
        isosp[3]=-2;
    ...
    void NNToMultiPionsChannel::inter2Part(const G4double p) {
