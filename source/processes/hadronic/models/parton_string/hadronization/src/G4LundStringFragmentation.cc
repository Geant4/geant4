...
//
//
// $Id: G4LundStringFragmentation.cc 100828 2016-11-02 15:25:59Z gcosmo $
// GEANT4 tag $Name:  $ 1.8
//
// -----------------------------------------------------------------------------
                                                ...
                                                G4double InitialMass) 
{
  ...
  G4double ProbIsotropy = sqr(sqr(938.0/InitialMass));
  ...
  if((Mass > 930. || AntiMass > 930.) && (G4UniformRand() < ProbIsotropy)) {  //If there is a baryon
    // ----------------- Isotropic decay ------------------------------------
