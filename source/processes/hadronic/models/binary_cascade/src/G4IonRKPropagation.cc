...
//
//      File name:     G4IonRKPropagation.cc
//
...
G4IonRKPropagation::G4IonRKPropagation() : theNucleus(0),
				     theFieldMap(0), theEquationMap(0),
				     theField(0)
{ }


G4IonRKPropagation::G4IonRKPropagation(const  G4IonRKPropagation &right)
{ }


G4IonRKPropagation::~G4IonRKPropagation()
{
...
//----------------------------------------------------------------------------
void G4IonRKPropagation::Init(G4V3DNucleus * nucleus)
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
void G4IonRKPropagation::Transport(G4KineticTrackVector & active,
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
  G4ThreeVector G4IonRKPropagation::GetMomentumTransfer() const
//----------------------------------------------------------------------------
{
...
//----------------------------------------------------------------------------
G4bool G4IonRKPropagation::FieldTransport(G4KineticTrack * kt, const G4double timeStep)
//----------------------------------------------------------------------------
{
    theMomentumTranfer=0;
...
//    G4cout << "currTimeStep = " << currTimeStep << G4endl;
    ...
    {  // cannot track this particle
      std::cerr << "G4IonRKPropagation::FieldTransport() warning: integration error."
...
//----------------------------------------------------------------------------
G4bool G4IonRKPropagation::FreeTransport(G4KineticTrack * kt, const G4double timeStep)
//----------------------------------------------------------------------------
{
...
/*
G4bool G4IonRKPropagation::WillBeCaptured(const G4KineticTrack * kt)
{
...
//----------------------------------------------------------------------------
G4bool G4IonRKPropagation::GetSphereIntersectionTimes(const G4double radius,
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
G4bool G4IonRKPropagation::GetSphereIntersectionTimes(const G4KineticTrack * kt,
				  G4double & t1, G4double & t2)
{
...
//----------------------------------------------------------------------------
void G4IonRKPropagation::delete_FieldsAndMap(
//----------------------------------------------------------------------------
...
//----------------------------------------------------------------------------
void G4IonRKPropagation::delete_EquationsAndMap(
//----------------------------------------------------------------------------
