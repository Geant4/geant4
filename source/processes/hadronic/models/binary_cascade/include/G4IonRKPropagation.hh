...
#ifndef G4IonRKPropagation_h
#define G4IonRKPropagation_h 1
...
class G4IonRKPropagation: public G4VFieldPropagation
{

public:
  G4IonRKPropagation();
  virtual ~G4IonRKPropagation();

private:
  G4IonRKPropagation(const  G4IonRKPropagation &right);
  const G4IonRKPropagation & operator=(const G4IonRKPropagation & right);
  G4int operator==(const G4IonRKPropagation & right) const;
  G4int operator!=(const G4IonRKPropagation & right) const;
