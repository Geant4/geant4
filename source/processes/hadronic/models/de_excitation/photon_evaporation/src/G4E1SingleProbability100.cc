...
// ********************************************************************
//
// $Id: G4E1SingleProbability100.cc,v 1.5 2010-11-17 16:50:53 vnivanch Exp $
						       ...
						       G4double exciteE)
{
  ...
  const G4double ScaleFactor = 100.0;     // playing with scale factors

  const G4double Uexcite = frag.GetExcitationEnergy();
  G4double Uafter = Uexcite - exciteE;

  const G4double normC = 3.0;
