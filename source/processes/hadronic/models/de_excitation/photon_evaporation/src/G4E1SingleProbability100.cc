			  ...
			  const G4E1SingleProbability100& ): G4VEmissionProbability()
{
  ...
  throw G4HadronicException(__FILE__, __LINE__, "G4E1SingleProbability100::copy_constructor meant to not be accessible");

}

const G4E1SingleProbability100& G4E1SingleProbability100::
operator=(const G4E1SingleProbability100& ) 
{

 throw G4HadronicException(__FILE__, __LINE__, "G4E1SingleProbability100::operator= meant to not be accessible");
 return *this;
}
