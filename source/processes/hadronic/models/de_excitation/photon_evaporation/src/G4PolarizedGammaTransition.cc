...
G4Fragment* 
G4PolarizedGammaTransition::SampleTransition(G4Fragment* nucleus,
				    ...
				    G4bool isLongLived)
{
  ...
  G4double etrans = nucleus->GetExcitationEnergy() - newExcEnergy 
    - bond_energy;
  //G4cout << "G4PolarizedGammaTransition::GenerateGamma - Etrans(MeV)= " 
  //	 << etrans << "  Eexnew= " << newExcEnergy << G4endl; 
