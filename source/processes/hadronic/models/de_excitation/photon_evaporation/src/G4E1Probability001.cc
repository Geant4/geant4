...

{
 ...
 throw G4HadronicException(__FILE__, __LINE__, "G4E1Probability001::copy_constructor meant to not be accessible");
...
operator=(const G4E1Probability001& ) 
{
  ...
  throw G4HadronicException(__FILE__, __LINE__, "G4E1Probability001::operator= meant to not be accessible");
  return *this;
}
