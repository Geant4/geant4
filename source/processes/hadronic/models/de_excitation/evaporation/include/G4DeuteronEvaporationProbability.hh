...
//
//
// $Id: G4DeuteronEvaporationProbability.hh,v 1.6 2007-08-24 08:50:31 ahoward Exp $
...
private:
  ...
  { G4int NumberCharged = fragment.GetNumberOfCharged(); G4int NumberParticles = fragment.GetNumberOfParticles();
    return 2.0*static_cast<G4double>(NumberCharged*(NumberParticles-NumberCharged))/static_cast<G4double>(NumberParticles*(NumberParticles-1)); } // taken from PreCompound correction - justified? AH 24/8/07
