...
//
//
// $Id: G4AlphaEvaporationProbability.hh,v 1.6 2007-08-24 08:50:31 ahoward Exp $
...
private:
  ...
  { G4int NumberCharged = fragment.GetNumberOfCharged(); G4int NumberParticles = fragment.GetNumberOfParticles();
    return 6.0*static_cast<G4double>(NumberCharged*(NumberCharged-1)*(NumberParticles-NumberCharged)*(NumberParticles-NumberCharged-1))/static_cast<G4double>(NumberParticles*(NumberParticles-1)*(NumberParticles-2)*(NumberParticles-3)); } // taken from PreCompound correction - justified? AH 24/8/07
