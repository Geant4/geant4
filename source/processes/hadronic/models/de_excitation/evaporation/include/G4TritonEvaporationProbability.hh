...
//
//
// $Id: G4TritonEvaporationProbability.hh,v 1.7 2007-10-01 13:21:23 ahoward Exp $
...
private:
  ...
  { G4int NumberCharged = fragment.GetNumberOfCharged(); G4int NumberParticles = fragment.GetNumberOfParticles();
    ...
    if(denominator != 0) rj = 3.0*static_cast<G4double>(NumberCharged*(NumberParticles-NumberCharged)*(NumberParticles-NumberCharged-1))/static_cast<G4double>(denominator);
