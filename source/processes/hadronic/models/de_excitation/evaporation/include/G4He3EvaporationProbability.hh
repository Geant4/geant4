...
//
//
// $Id: G4He3EvaporationProbability.hh,v 1.6 2007-08-24 08:50:31 ahoward Exp $
...
private:
  ...
  return 3.0*static_cast<G4double>(NumberCharged*(NumberCharged-1)*(NumberParticles-NumberCharged))/static_cast<G4double>(NumberParticles*(NumberParticles-1)*(NumberParticles-2)); } // taken from PreCompound correction - justified? AH 24/8/07
