...
{
  if(0 == theInstance) {
    static G4ThreadLocal G4FermiFragmentsPool *pool_G4MT_TLS_ = 0 ; if (!pool_G4MT_TLS_) pool_G4MT_TLS_ = new  G4FermiFragmentsPool  ;  G4FermiFragmentsPool &pool = *pool_G4MT_TLS_;
    theInstance = &pool;
  }
  return theInstance;
}
