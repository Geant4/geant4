...
//
//
// $Id: G4Ne20GEMProbability.cc,v 1.1 2003-08-26 18:44:32 lara Exp $
  ...
  G4GEMProbability(20,10,0.0) // A,Z,Spin
{
  ...
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(1.3E-2*keV));
  ...
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(0.110*keV));
  ...
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(19.0*keV));
  ...
  ExcitSpins.push_back(3.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(3.2*keV));
  ...
  ExcitSpins.push_back(5.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(141.0*keV));
  ...
  ExcitSpins.push_back(3.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(81.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(13.0*keV));
  ...
  ExcitSpins.push_back(0.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(580.0*keV));
  ...
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(172.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(46.0*keV));

  ExcitEnergies.push_back(11925.0*keV);
  ExcitSpins.push_back(4.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(0.44*keV));

  ExcitEnergies.push_back(11948.0*keV);
  ExcitSpins.push_back(8.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(35.0e-3*keV));
  ...
  ExcitSpins.push_back(4.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(142.0*keV));
  ...
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(80.0e-3*keV));
  ...
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(7.1*keV));
  ...
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(115.0*keV));
  ...
  ExcitSpins.push_back(0.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(170.0*keV));

  ExcitEnergies.push_back(13733.0*keV);
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(7.7*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(48.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(140.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(11.8*keV));

  ExcitEnergies.push_back(14197.0*keV);
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(13.9*keV));
  ...
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(125.0*keV));
  ...
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(285.0*keV));
  ...
  ExcitSpins.push_back(6.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(360.0*keV));
  ...
  ExcitSpins.push_back(8.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(1600.0*keV));
...
{
  G4Exception("G4Ne20GEMProbability::copy_constructor meant to not be accessable");
}
...
{
  G4Exception("G4Ne20GEMProbability::operator= meant to not be accessable");
  return *this;
}
