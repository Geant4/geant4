...
//
//
// $Id: G4Mg28GEMProbability.cc,v 1.3 2005/06/04 13:25:25 jwellisc Exp $
...
G4Mg28GEMProbability::G4Mg28GEMProbability(const G4Mg28GEMProbability &) : G4GEMProbability()
{
  throw G4HadronicException(__FILE__, __LINE__, "G4Mg28GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4Mg28GEMProbability &)
{
  throw G4HadronicException(__FILE__, __LINE__, "G4Mg28GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4Mg28GEMProbability::operator==(const G4Mg28GEMProbability &) const
{
  return false;
}
