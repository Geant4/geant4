...
//
//
// $Id: G4N13GEMProbability.cc,v 1.1 2003-08-26 18:44:25 lara Exp $
...
{
  G4Exception("G4N13GEMProbability::copy_constructor meant to not be accessable");
}
...
{
  G4Exception("G4N13GEMProbability::operator= meant to not be accessable");
  return *this;
}
