...
//
//
// J. M. Quesada (July 2009) based on G4DeuteronCoulombBarrier
// Coded strictly according to Furihata's GEM paper 
//

#ifndef G4DeuteronGEMCoulombBarrier_h
#define G4DeuteronGEMCoulombBarrier_h 1
...
private:
  ...
  const G4DeuteronGEMCoulombBarrier & operator=(const G4DeuteronGEMCoulombBarrier & right);
