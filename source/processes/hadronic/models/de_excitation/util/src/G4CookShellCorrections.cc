...
G4ThreadLocal G4CookShellCorrections* G4CookShellCorrections::theInstance = 0;
...
{
  if (!theInstance) { 
    static G4ThreadLocal G4CookShellCorrections *theCorrections_G4MT_TLS_ = 0 ; if (!theCorrections_G4MT_TLS_) theCorrections_G4MT_TLS_ = new  G4CookShellCorrections  ;  G4CookShellCorrections &theCorrections = *theCorrections_G4MT_TLS_;
