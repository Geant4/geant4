...
G4ThreadLocal G4CameronGilbertPairingCorrections* G4CameronGilbertPairingCorrections::theInstance = 0;
...
{
  if (!theInstance)  { 
    static G4ThreadLocal G4CameronGilbertPairingCorrections *theCorrections_G4MT_TLS_ = 0 ; if (!theCorrections_G4MT_TLS_) theCorrections_G4MT_TLS_ = new  G4CameronGilbertPairingCorrections  ;  G4CameronGilbertPairingCorrections &theCorrections = *theCorrections_G4MT_TLS_;
