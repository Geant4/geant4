...
G4ThreadLocal G4CameronTruranHilfShellCorrections* G4CameronTruranHilfShellCorrections::theInstance = 0;
...
{
  if (!theInstance)  { 
    static G4ThreadLocal G4CameronTruranHilfShellCorrections *theCorrections_G4MT_TLS_ = 0 ; if (!theCorrections_G4MT_TLS_) theCorrections_G4MT_TLS_ = new  G4CameronTruranHilfShellCorrections  ;  G4CameronTruranHilfShellCorrections &theCorrections = *theCorrections_G4MT_TLS_;
