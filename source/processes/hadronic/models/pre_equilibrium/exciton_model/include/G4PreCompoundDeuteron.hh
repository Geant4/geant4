...
//
//
// $Id: G4PreCompoundDeuteron.hh,v 1.6 2007-08-23 12:30:43 ahoward Exp $
...
// added Rj method according to literature and JMQ - formula from Jose Quesada
  ...
  {
    return 2.0*static_cast<G4double>(NumberCharged*(NumberParticles-NumberCharged))/static_cast<G4double>(NumberParticles*(NumberParticles-1)); //JMQ re-corrected 23/8/07
