...
// ********************************************************************
//
// $Id: G4InclAblaCascadeInterface.cc,v 1.4 2007-10-11 08:20:08 gcosmo Exp $ 
...
G4ReactionProductVector* G4InclAblaCascadeInterface::Propagate(G4KineticTrackVector* , 
                                                       G4V3DNucleus* ) {
  return 0;
}
