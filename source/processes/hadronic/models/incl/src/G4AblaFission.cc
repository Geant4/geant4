...
// ********************************************************************
//
// $Id: G4AblaFission.cc,v 1.1 2008-05-27 17:31:16 kaitanie Exp $
...
G4AblaFission::G4AblaFission(G4Hazard *hzr, G4InclRandomInterface *rndm)
{
  ...
  setAboutString("Fission model: Based on ABLA V3 and SimFis3");
}
...
G4int G4AblaFission::idnint(G4double value)
{
...
void G4AblaFission::p(G4int a, G4int b) {
  G4cout << a << std::setw(8) << b << G4endl;
}

void G4AblaFission::p(G4double a, G4double b) {
  G4cout << " " << a << std::setw(12) << b << G4endl;
}

void G4AblaFission::p(G4String msg, G4double a, G4double b) {
  G4cout << " " << msg << " " << a << std::setw(12) << b << G4endl;
}
