...
C      CHARACTER*80 TUPLE,ECSERN,VGSTAB,DEFTAB,FILENAME,RACINE,FILEDAT                           
      CHARACTER*1000 TUPLE,ECSERN,VGSTAB,DEFTAB,FILENAME,RACINE,FILEDAT                           
...
C ial generateur pour le cascade (et les IY pour eviter les correlations)
      ...
      real*4 acv,zpcv,pcv,xcv,ycv,zcv,Fission_Proba
      common/volant/acv(200),zpcv(200),pcv(200),xcv(200),
     s              ycv(200),zcv(200),iv,Fission_Proba 

C For debugging
      integer cppevent
      common /debugval/cppevent
C End of debugging common
...
C             
C       if (cppevent.EQ.48) then
C          write(6,*) 'ZF,AF,EE,JPRF',ZF,AF,EE,JPRF
C       endif
...
C Debug
C       if (cppevent.EQ.48) then
C          write(6,*) 'PROBF,PTOTL,K,K+J,IL,SBFIS,SEGS,SELMAX:'
C          write(6,*) PROBF,PTOTL,K,K+J,IL,SBFIS,SEGS,SELMAX
C       endif
C                                                                       
...
C Fission probability for NTUPLE (11/2006, AB PK):
          Fission_Proba = PTOTL - (PROBA+PROBP+PROBN)                                                       
...
C        if (cppevent.EQ.48) then
C           write(6,*) 'SBF', SBF
C           write(6,*) 'A,ZPRF,EE,EF,DENSF,BSHELL,BS,BK,TEMP',                
C      &             'OPTSHP,OPTCOL,DEFBET'
C           write(6,*) A,ZPRF,EE,EF,DENSF,BSHELL,BS,BK,TEMP,                
C      &             OPTSHP,OPTCOL,DEFBET
C        endif
...
C      if (cppevent.eq.48) write(6,*) 'GN,GP,GA,GF',GN,GP,GA,GF
C                                                                       
      ELSE                                                              
...
C         if (cppevent.EQ.48) then
C            write(6,*)'TAUC,TSUM,TS1',TAUC,TSUM,TS1
C         endif
...
C       if (cppevent.EQ.48) then
C          write(6,*) 'DENSF,DENSP,DENSN,DENSA,WF'
C          write(6,*) DENSF,DENSP,DENSN,DENSA,WF
C       endif
