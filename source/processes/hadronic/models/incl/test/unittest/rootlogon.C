...
cout << endl << endl << endl;
cout <<"-------------------------------------------" << endl;
cout <<"INCL4+ABLA C++ port testing framework" << endl;
cout <<"Welcome!" << endl;
cout <<"-------------------------------------------" << endl;
cout << endl << endl;
// End of greeting
...
gStyle->SetCanvasDefW(1000); // Old: 500
gStyle->SetCanvasDefH(1000); // Old: 500
...
gStyle->SetTitleFont(42,"X");  // default 62
gStyle->SetTitleFont(42,"Y");  // default 62
gStyle->SetLabelFont(42,"X");  // default 62
gStyle->SetLabelFont(42,"Y");  // default 62
gStyle->SetStatFont(42);  // default 62
...
// new try
//
gStyle->SetTitleX(0.20);  //fX1NDC
//gStyle->SetTitleY(0.9486);  // fY2NDC, top
gStyle->SetTitleY(0.9586);  // fY2NDC, top
//
// some good values
//.099182 fX1NDL
//.90015 fY1NDC
...
TString referenceImplementation("reference/libINCLABLA.so");

cout <<"Loading INCL4+ABLA FORTRAN reference implementation...(" << referenceImplementation <<")" << endl;
gSystem->Load(referenceImplementation);
cout << endl;

gSystem->Load("libTestingFramework.so");

// Variable for storing the test result:
Bool_t gLastTestStatus = false;
}
