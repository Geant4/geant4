{
  ...
  //							      "h101", 2056.1111,
  //							      100000);
  CalculationAnalysis *fortranAnalysis = new CalculationAnalysis(hf, "./tmp/run47ref.root", //"../tmp/c135_c_i43_dres_fb_INIT.root",
							     "h101", 4479.6943,
							     100000);

  CalculationAnalysis *cppAnalysis = new CalculationAnalysis(hf, "./tmp/run47.root",
							     "h101", 3733,
							     100000);
