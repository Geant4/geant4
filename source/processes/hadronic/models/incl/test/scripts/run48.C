{
  ...
  CalculationAnalysis *fortranAnalysis = new CalculationAnalysis(hf, "./tmp/run48ref.root",
							     "h101", 4479.6943,
							     100000);

  CalculationAnalysis *cppAnalysis = new CalculationAnalysis(hf, "./tmp/run48.root", //"./tmp/run49_XFOISA8.root",
							     "h101", 4479.69, //5664.46,
							     100000);
