...
void nCrossSection(){
  TFile* fref = new TFile("tmp/run27.root");
  TFile* ffref = new TFile("tmp/run27ref.root");

  Char_t* titre="C(400 MeV/nucleon) + 208Pb (INCL4+ABLA)";
	
  Char_t* psFileName="n_cross_section_run27.ps";
  ...
  Double_t fnorm = 5381.24/(100000.0*2.0*pi);
