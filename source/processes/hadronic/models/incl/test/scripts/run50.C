{
  ...
  CalculationAnalysis *fortranAnalysis = new CalculationAnalysis(hf, "./tmp/run50ref.root",
							     "h101", 2056.1111,
							     100000);

  CalculationAnalysis *cppAnalysis = new CalculationAnalysis(hf, "./tmp/run50.root", //"./tmp/run49_XFOISA8.root",
							     "h101", 2056.11, //5664.46,
							     100000);

  
  ViewManager *alpha_vm = new ViewManager(3,2);
  Double_t Emax = 3000.0;
  Double_t Emin = 1.0;
  Bool_t logE = true;

  alpha_vm->plot(cppAnalysis->fillAlphaDoubleDiffXS(1.0, 1.0, logE, Emin, Emax));
  alpha_vm->plot(fortranAnalysis->fillAlphaDoubleDiffXS(1.0, 1.0, logE, Emin, Emax), true);

  alpha_vm->plot(cppAnalysis->fillAlphaDoubleDiffXS(15.0, 2.0, logE, Emin, Emax));
  alpha_vm->plot(fortranAnalysis->fillAlphaDoubleDiffXS(15.0, 2.0, logE, Emin, Emax), true);

  alpha_vm->plot(cppAnalysis->fillAlphaDoubleDiffXS(20.0, 2.0, logE, Emin, Emax));
  alpha_vm->plot(fortranAnalysis->fillNeutronDoubleDiffXS(20.0, 2.0, logE, Emin, Emax), true);

  alpha_vm->plot(cppAnalysis->fillAlphaDoubleDiffXS(30.0, 2.0, logE, Emin, Emax));
  alpha_vm->plot(fortranAnalysis->fillAlphaDoubleDiffXS(30.0, 2.0, logE, Emin, Emax), true);

  alpha_vm->plot(cppAnalysis->fillAlphaDoubleDiffXS(50.0, 2.0, logE, Emin, Emax));
  alpha_vm->plot(fortranAnalysis->fillNeutronDoubleDiffXS(50.0, 2.0, logE, Emin, Emax), true);

  alpha_vm->plot(cppAnalysis->fillAlphaDoubleDiffXS(80.0, 2.0, logE, Emin, Emax));
  alpha_vm->plot(fortranAnalysis->fillNeutronDoubleDiffXS(80.0, 2.0, logE, Emin, Emax), true);
