...
void nCrossSection(){
  TFile* fref = new TFile("tmp/run12.root");
  TFile* ffref = new TFile("tmp/run12ref.root");

  Char_t* titre="p(1.2 GeV) + Zr (INCL4+ABLA)";
	
  Char_t* psFileName="n_cross_section_run12.ps";
  ...
  Double_t fnorm = 2585.46/(100000.0*2.0*pi);
  ...
  // Experimental points:
  Float_t fnorexp=1.;
  //  plotExpTheta("p1200zr30_000",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_010",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_025",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_040",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_055",racine,fnorexp);
  fnorexp = fnorexp/10.;
  //  plotExpTheta("p1200zr30_070",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_085",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_100",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_115",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_130",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_145",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200zr30_160",racine,fnorexp);
