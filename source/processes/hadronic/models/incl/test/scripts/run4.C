...
void nCrossSection(){
  TFile* fref = new TFile("tmp/run4.root");
  TFile* ffref = new TFile("tmp/run4ref.root");

  Char_t* titre="p(1600 MeV) + 208Pb (INCL4+ABLA)";
	
  Char_t* psFileName="n_cross_section_run4.ps";
  ...
  Double_t fnorm = 3792.89/(300000.0*2.0*pi);
  ...
  // Experimental points:
  Float_t fnorexp=1.;
  plotExpTheta("p1600pb20_000",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_010",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_025",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_040",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_055",racine,fnorexp);
  fnorexp = fnorexp/10.;
  //  plotExpTheta("p1600pb20_070",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_085",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_100",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_115",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_130",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_145",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600pb20_160",racine,fnorexp);
