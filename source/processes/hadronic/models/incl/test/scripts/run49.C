{
  ...
  CalculationAnalysis *fortranAnalysis = new CalculationAnalysis(hf, "./tmp/run49ref.root",
							     "h101", 6619.4131,
							     100000);

  CalculationAnalysis *cppAnalysis = new CalculationAnalysis(hf, "./tmp/run49.root", //"./tmp/run49_XFOISA8.root",
							     "h101", 6619.41, //5664.46,
							     100000);
