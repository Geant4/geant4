...
void nCrossSection(){
  TFile* fref = new TFile("tmp/run10.root");
  TFile* ffref = new TFile("tmp/run10ref.root");

  Char_t* titre="p(1.2 GeV) + 232Th (INCL4+ABLA)";
	
  Char_t* psFileName="n_cross_section_run10.ps";
  ...
  Double_t fnorm = 4015.46/(100000.0*2.0*pi);
  ...
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_010",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_025",racine,fnorexp);
  fnorexp = fnorexp/10.;
  //  plotExpTheta("p1200th20_040",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_055",racine,fnorexp);
  fnorexp = fnorexp/10.;
  //  plotExpTheta("p1200th20_070",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_085",racine,fnorexp);
  fnorexp = fnorexp/10.;
  //  plotExpTheta("p1200th20_100",racine,fnorexp);
  fnorexp = fnorexp/10.;
  //  plotExpTheta("p1200th20_115",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_130",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_145",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_160",racine,fnorexp);
  ...
  // Experimental points:
  fnorexp=1.;
  //  plotExpTheta("p1200th20_000",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_010",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200th20_025",racine,fnorexp);
