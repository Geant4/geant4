...
void nCrossSection(){
  TFile* fref = new TFile("tmp/run6.root");
  TFile* ffref = new TFile("tmp/run6ref.root");

  Char_t* titre="p(1600 MeV) + 56Fe (INCL4+ABLA)";
	
  Char_t* psFileName="n_cross_section_run6.ps";
  ...
  // Experimental points:
  Float_t fnorexp=1.;
  plotExpTheta("p1600fe30_000",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_010",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_025",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_040",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_055",racine,fnorexp);
  fnorexp = fnorexp/10.;
  //  plotExpTheta("p1600fe30_070",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_085",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_100",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_115",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_130",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_145",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1600fe30_160",racine,fnorexp);
