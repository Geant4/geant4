...
void nCrossSection(){
  TFile* fref = new TFile("tmp/run3.root");
  TFile* ffref = new TFile("tmp/run3ref.root");

  Char_t* titre="p(800 MeV) + 208Pb (INCL4+ABLA)";
	
  Char_t* psFileName="n_cross_section_run3.ps";
