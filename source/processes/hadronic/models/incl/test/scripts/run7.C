...
void nCrossSection(){
  TFile* fref = new TFile("tmp/run7.root");
  TFile* ffref = new TFile("tmp/run7ref.root");

  Char_t* titre="p(1200 MeV) + 56Fe (INCL4+ABLA)";
	
  Char_t* psFileName="n_cross_section_run7.ps";
  ...
  // Experimental points:
  Float_t fnorexp=1.;
  //  plotExpTheta("p1200fe30_000",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_010",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_025",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_040",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_055",racine,fnorexp);
  fnorexp = fnorexp/10.;
  //  plotExpTheta("p1200fe30_070",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_085",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_100",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_115",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_130",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_145",racine,fnorexp);
  fnorexp = fnorexp/10.;
  plotExpTheta("p1200fe30_160",racine,fnorexp);
