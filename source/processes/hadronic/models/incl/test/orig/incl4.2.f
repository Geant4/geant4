...
c     DIMENSION TEM(15),NSR(40),NSP(40),NSR1(40),NSP1(40)               P-N00400
     ...
     -IHE(2,100),IHF5(100),IHREM(100,100)
      ...
      DIMENSION JPARTICIP(300),eps_c(4),p3_c(4)
      ...
      if (kindf7.le.2)  then
       bmax=bmax     ! comme Alain
        ...
        if (kindf7.lt.6)  then    
         ...
         bmax=rmaxws+rms1      ! maximum extension of the nucleus ( W.S.)
        endif
      endif   
c deutons     
       IRUN=0                                                            P-N03890
...
C Deuteron density from Paris potential in q space:      
      ...
      p1(i)=qdeut*sitet*COS(phi)
      p2(i)=qdeut*sitet*SIN(phi)
      p3(i)=qdeut*cstet
...
C Density of composite as a gaussien in q space:
    ...
    8 continue
      ...
      p2(ia1)=-sp2t1
      p3(ia1)=-sp3t1
      eps(ia1)=w(p1(ia1),p2(ia1),p3(ia1),fmp)
c deutons
        JPARTICIP(ia1)=1
    9 continue
c deutons
...
C pour le ntuple des avatars:
        ...
        if (kindf7.lt.6) then ! pour les pions on laisse
      CALL RIBM(TBID,IY14)
      TBID=TBID*6.283185
