...
//
//
// $Id: G4StringWithqmdTest.cc,v 1.1 2003-10-08 12:04:17 hpw Exp $
 ...
 int main()
  {
    ...
    theTheoModel->SetMaxEnergy(100*TeV);
      ...
      G4qmdStringFragmentation * theStringDecay = new G4qmdStringFragmentation;
...
//    G4DummyCascade * theDummy = new G4DummyCascade;
//    theTheoModel->SetTransport(theDummy);
