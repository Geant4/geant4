...
//
//
// $Id: Mars01DetectorMessenger.cc,v 1.1 2003-10-08 12:32:21 hpw Exp $
...
Mars01DetectorMessenger::Mars01DetectorMessenger(Mars01DetectorConstruction * myDC)
:myDetector(myDC)
{
  G4String defParam;
...
void Mars01DetectorMessenger::SetNewValue(G4UIcommand * command,G4String newValues)
{
