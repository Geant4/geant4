...
//
//
// $Id: StringModel_Analysis.cc,v 1.1 2003-10-08 12:36:00 hpw Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
// Johannes Peter Wellisch, 22.Apr 1997: full test-suite coded.    
    
#include "InclusivePi0/src/ParticleInfo.h"
 ...
 int main()
  {
    ...
    G4HadronInelasticProcess *theProcesses[26];
...
//    theProtonInelasticProcess->RegisterMe( theParaModel );
    ...
    G4PhotoNuclearProcess *theGammaInelasticProcess = new G4PhotoNuclearProcess();
    theGammaInelasticProcess->RegisterMe( theTheoModel );
    theGammaProcessManager->AddDiscreteProcess( theGammaInelasticProcess );
    theProcesses[25] = theGammaInelasticProcess;
    ...
    *condition = NotForced;
    ...
    do {
      ...
      G4cout << "24) anti_omega-  25) Gamma"<< G4endl;
...
//    theTheoModel->SetTransport(theDummyCascade);
    ...
    {
      fileName = "pi_p";
      weight = 25.*millibarn/80*GeV;
    }
    else
    {
      G4Exception("This test goes on Hydrogene only");
    }
