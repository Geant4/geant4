...
#include "InclusivePi0/src/TVPlot.h"
...
//        theDataPoints[i].DumpInfo(aOStream);
    ...
    {
      G4double theCosTh = aPart->GetCosTheta();
      return theFilter->Accept(theCosTh);
    }
         ...
         thePDG(aPDG), theTotalXsec(aTotalXsec), theFilter(aFilter)
{
  theStatistics = 10000;
  theOutputFile = fn;
  theDataPoints.push_back(DataPointType(0.1*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(0.2*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(0.3*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(0.4*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(0.5*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(0.6*GeV, 0.1*GeV, aMass));
  ...
  theDataPoints.push_back(DataPointType(1.7*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(1.8*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(1.9*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(2.0*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(2.1*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(2.2*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(2.3*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(2.4*GeV, 0.1*GeV, aMass));
  theDataPoints.push_back(DataPointType(2.5*GeV, 0.1*GeV, aMass));
}
