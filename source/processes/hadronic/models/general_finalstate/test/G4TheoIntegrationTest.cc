...
// HPW, Mar'99 Additions by Viktor Krylov undone.
 ...
 int main()
  {
    ...
    // annihilation
    G4Annihilator * theAnihilator = new G4Annihilator;
    // elastic
    G4ElasticScatterer * theElasticScatterer = new G4ElasticScatterer;
    // inelastic
    G4InElasticScatterer *  theInElasticScatterer = new G4InElasticScatterer;
    // cross-sections
    ...
    G4StringInfoDump * theCascade = new G4StringInfoDump;
    ...
    G4int choice;
    do {
      cout << "Please select String Model to test(1-FTF, 2-QGS): " << std::flush;
      G4cin >> choice;
...
//        G4ExcitationHandler * theHandler = new G4ExcitationHandler;
//          G4Evaporation * theEvaporation = new G4Evaporation;
//            G4CompetitiveFission * theCompFission = new G4CompetitiveFission;
