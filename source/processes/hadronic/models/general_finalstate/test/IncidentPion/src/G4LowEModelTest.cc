...
//
//
// $Id: G4LowEModelTest.cc,v 1.1 2003-10-08 12:36:20 hpw Exp $
 ...
 int main()
  {
    ...
    theTheoModel = new G4LEProtonInelastic;
    ...
    theTheoModel = new G4LEAntiProtonInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LENeutronInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEAntiNeutronInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEPionPlusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEPionMinusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEKaonPlusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEKaonMinusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEKaonZeroLInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEKaonZeroSInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LELambdaInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEAntiLambdaInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LESigmaPlusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEAntiSigmaPlusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LESigmaMinusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEAntiSigmaMinusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEXiMinusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEAntiXiMinusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEXiZeroInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEAntiXiZeroInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEOmegaMinusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
    ...
    theTheoModel = new G4LEAntiOmegaMinusInelastic;
    theTheoModel->SetMaxEnergy(10000*GeV);
