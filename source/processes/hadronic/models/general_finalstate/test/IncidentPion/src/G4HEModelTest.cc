...
//
//
// $Id: G4HEModelTest.cc,v 1.1 2003-10-08 12:36:20 hpw Exp $
...
#include "../../../src/G4QGSParticipants.cc"
 ...
 int main()
  {
    ...
    G4Material *theMg = new G4Material(name="Magnesium", density=1.53*g/cm3, nEl=1); 
    G4Element *elMg = new G4Element(name="Magnesium", symbol="Mg", iz=12., a=24.3050*g/mole);
    theMg->AddElement( elMg, 1 );
    
    G4Material *theAg = new G4Material(name="Silver", density=1.53*g/cm3, nEl=1); 
    G4Element *elAg = new G4Element(name="Silver", symbol="Ag", iz=47., a=107.8682*g/mole);
    theAg->AddElement( elAg, 1 );

    G4Material *theAu = new G4Material(name="Gold", density=1.53*g/cm3, nEl=1); 
    G4Element *elAu = new G4Element(name="Gold", symbol="Au", iz=79., a=196.96655*g/mole);
    ...
    theMaterials[16] = theMg;
    theMaterials[17] = theAg;
    theMaterials[18] = theAu;
    ...
    G4HadronicInteraction * theTheoModel;
    ...
    theTheoModel = new G4HEProtonInelastic;
    ...
    theTheoModel = new G4HEAntiProtonInelastic;
    ...
    theTheoModel = new G4HENeutronInelastic;
    ...
    theTheoModel = new G4HEAntiNeutronInelastic;
    ...
    theTheoModel = new G4HEPionPlusInelastic;
    ...
    theTheoModel = new G4HEPionMinusInelastic;
    ...
    theTheoModel = new G4HEKaonPlusInelastic;
    ...
    theTheoModel = new G4HEKaonMinusInelastic;
    ...
    theTheoModel = new G4HEKaonZeroLongInelastic;
    ...
    theTheoModel = new G4HEKaonZeroShortInelastic;
    ...
    theTheoModel = new G4HELambdaInelastic;
    ...
    theTheoModel = new G4HEAntiLambdaInelastic;
    ...
    theTheoModel = new G4HESigmaPlusInelastic;
    ...
    theTheoModel = new G4HEAntiSigmaPlusInelastic;
    ...
    theTheoModel = new G4HESigmaMinusInelastic;
    ...
    theTheoModel = new G4HEAntiSigmaMinusInelastic;
    ...
    theTheoModel = new G4HEXiMinusInelastic;
    ...
    theTheoModel = new G4HEAntiXiMinusInelastic;
    ...
    theTheoModel = new G4HEXiZeroInelastic;
    ...
    theTheoModel = new G4HEAntiXiZeroInelastic;
    ...
    theTheoModel = new G4HEOmegaMinusInelastic;
    ...
    theTheoModel = new G4HEAntiOmegaMinusInelastic;
	...
	for( l=0; l<nEvents; ++l ) {
	  ...
	  for( G4int ii=istart; ii<nSec; ++ii ) 
	  {
	    ...
	    if(currentEta>-0.1&&currentEta<2.9) 
	      etWithinCuts += sqrt(currentPx*currentPx + currentPy*currentPy);
	    ipar = currentDefinition->GetPDGEncoding();  
	    G4cout << currentDefinition->GetPDGCharge()<<" ";
	    G4cout << currentDefinition->GetPDGEncoding()<<" ";
	    G4cout << currentTrack->GetMomentum()<<" ";
	    G4cout << currentTrack->GetTotalEnergy() << G4endl;
            delete currentTrack;
	  }
	  aFinalState->Clear();
	  delete aTrack;
