...
//----------------------------------------------------------------------------
G4ReactionProductVector * PCTBinaryCascade::Propagate(G4KineticTrackVector * secondaries, 
...
//----------------------------------------------------------------------------
G4KineticTrackVector* PCTBinaryCascade::CorrectBarionsOnBoundary(G4KineticTrackVector *in, 
