...
//
//
// $Id: TargetMessenger.cc,v 1.1 2003-10-08 12:32:11 hpw Exp $
...
{ 
  ...
  TgtMaterCmd->AvailableForStates(Idle);
  ...
  TgtThickCmd->AvailableForStates(Idle);
  ...
  TgtRadiusCmd->AvailableForStates(Idle);
