...
//
//
// $Id: G4StringModelTest.cc,v 1.1 2003-10-08 12:37:38 hpw Exp $
 ...
 int main()
  {
    ...
    G4Element *elH1 = new G4Element(name="Hydrogen_1", symbol="H1", 1);
    G4Isotope *isoH = new G4Isotope(name="Hydrogen_1", 1., 1., 1.0*g/mole);
    G4Material *theH = new G4Material(name="Hydrogen", density=1.53*g/cm3, nEl=1); 
    elH1->AddIsotope(isoH, 1);
    theH->AddElement( elH1, 1);
