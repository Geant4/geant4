...
G4bool RandomCaloStackingAction::isSwitchedOn = false;


RandomCaloStackingAction::RandomCaloStackingAction() :
  ...
  //***endLOOKHERE***
{
  ...
  //ALB if ( ! filePtr ) {
  //ALB   G4cout << " ***ERROR*** : RandomCaloStackingAction : CANNOT OPEN OUTPUT FILE! "
  //ALB 	 << G4endl;
  //ALB }
  ...
  G4cout << " --- RandomCaloStackingAction constructor --- " << G4endl
...
RandomCaloStackingAction::~RandomCaloStackingAction() {
  ...
  G4cout << " ~RandomCaloStackingAction : WEIGHT DISTRIBUTION " << G4endl;
  ...
  for ( int i = 0; i < Nmax; i++ ) {
    ...
    G4cout << "\t exponent=" << i 
           << "\t weight=" << std::pow( static_cast<double>( gammaBiasingFactor2 ), i )
	   << "\t number of tracks=" << weightGammaVec[ i ] << G4endl;  
  }
  G4cout << " Total number of Gammas = " << totNumTracks << G4endl;
  ...
  for ( int i = 0; i < Nmax; i++ ) {
    ...
    G4cout << "\t exponent=" << i 
	   << "\t weight=" 
	   << std::pow( static_cast<double>( electronBiasingFactor2 ), i )
	   << "\t number of tracks=" << weightElectronVec[ i ] << G4endl;  
  }
  G4cout << " Total number of Electrons = " << totNumTracks << G4endl;
  ...
  for ( int i = 0; i < Nmax; i++ ) {
    ...
    G4cout << "\t exponent=" << i 
	   << "\t weight=" 
	   << std::pow( static_cast<double>( positronBiasingFactor2 ), i )
	   << "\t number of tracks=" << weightPositronVec[ i ] << G4endl;  
  }
  G4cout << " Total number of Positron = " << totNumTracks << G4endl;
  ...
  for ( int i = 0; i < Nmax; i++ ) {
    ...
    G4cout << "\t exponent=" << i 
	   << "\t weight=" << std::pow( static_cast<double>( neutronBiasingFactor ), i )
	   << "\t number of tracks=" << weightNeutronVec[ i ] << G4endl;  
  }
  G4cout << " Total number of Neutron = " << totNumTracks << G4endl;

}


G4ClassificationOfNewTrack 
RandomCaloStackingAction::ClassifyNewTrack( const G4Track * aTrack ) {

  G4ClassificationOfNewTrack result( fUrgent );

  if ( RandomCaloStackingAction::isSwitchedOn ) {
	...
	intWeight = intWeight / gammaBiasingFactor2;
      ...
      //ALB    (*filePtr) << aTrack->GetWeight() << G4endl;
      //ALB }
    }
...
void RandomCaloStackingAction::PrepareNewEvent() { 
  numberGammas1 = 0;
  numberElectrons1 = 0;
  numberPositrons1 = 0;
  numberGammas2 = 0;
