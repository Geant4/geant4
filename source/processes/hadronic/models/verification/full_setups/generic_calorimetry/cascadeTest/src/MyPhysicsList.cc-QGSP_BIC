//----------------------------------------------------
// This file should be copied (or symbolically linked)
// as  MyPhysicsList.cc  if you want to use the 
//             *** QGSP_BIC ***  Physics List
//---------------------------------------------------
...
MyPhysicsList::MyPhysicsList():  G4VModularPhysicsList()
{
  ...
  G4cout << "You are using the simulation engine: QGSP_BIC 0.5"<<G4endl;
