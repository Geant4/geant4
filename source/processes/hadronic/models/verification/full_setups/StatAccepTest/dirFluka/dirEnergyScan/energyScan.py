...
# for all Physics Lists, and eventually also the ones obtained running
# Fluka), and produces in output the file:
#
#         energyScan.txt
#
...
#
# (from here on, "Physics List" is used in an extended sense,
#  including, besides the Geant4 Physics Lists, also "fluka")
