...
//
//
// $Id: PhysicsList.cc,v 1.1 2003-07-31 01:21:28 dwright Exp $
...
void PhysicsList::ConstructHad()
{
  ...
  {
    G4LEPionMinusInelastic* theLEPimModel = new G4LEPionMinusInelastic();
    theModel = theLEPimModel;
  }
  else
  {
  ...
  // pi-
  //
  G4ProcessManager* pimManager = G4PionMinus::PionMinus()->GetProcessManager();
  thePionMinusInelastic.RegisterMe(theModel);
  pimManager->AddDiscreteProcess(&thePionMinusInelastic);
