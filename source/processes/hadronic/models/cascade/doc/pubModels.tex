...
In the following sections we give the overview of submodel features.
...
Fermi break-up is allowed only in some extreme cases, i.e. for light nuclei ($A < 12$ and  $3(a-z) < Z < 6$ ) and $E(exitation) > 3.*Eb$ 
