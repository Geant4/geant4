...
namespace {
  ...
  static __thread G4int x0n2bfs[6][2] =
    {{2,29}, {1,31}, {21,21}, {21,25}, {25,25}, {23,27}};

  static __thread G4int x0n3bfs[24][3] =
  ...
  // 
  static __thread G4double x0nCrossSections[46][31] = {
    //
...
__thread G4CascadeXiZeroNChannelData_t *G4CascadeXiZeroNChannelData::data = 0;
