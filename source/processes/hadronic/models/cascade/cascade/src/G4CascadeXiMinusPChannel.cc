...
namespace {
  ...
  static G4ThreadLocal G4int xmp2bfs[6][2] =
    {{1,31}, {2,29}, {21,21}, {21,25}, {25,25}, {23,27}};

  static G4ThreadLocal G4int xmp3bfs[24][3] =
  ...
  static G4ThreadLocal G4int xmp4bfs[4][4] =
    {{1,7,13,21}, {2,7,17,21}, {1,3,5,31}, {2,3,5,29}};

  static G4ThreadLocal G4int xmp5bfs[4][5] =
    {{1,3,5,13,21}, {2,3,5,17,21}, {1,3,5,7,31}, {2,3,5,7,29}};

  static G4ThreadLocal G4int xmp6bfs[4][6] =
    {{1,3,5,7,13,21}, {2,3,5,7,17,21}, {1,3,3,5,5,31}, {2,3,3,5,5,29}};

  static G4ThreadLocal G4int xmp7bfs[4][7] =
  ...
  // 
  static G4ThreadLocal G4double xmpCrossSections[46][31] = {
    //
...
G4ThreadLocal G4CascadeXiMinusPChannelData_t *G4CascadeXiMinusPChannelData::data = 0;
