...
namespace {
  ...
  static __thread G4int xmp2bfs[6][2] =
    {{1,31}, {2,29}, {21,21}, {21,25}, {25,25}, {23,27}};

  static __thread G4int xmp3bfs[24][3] =
  ...
  // 
  static __thread G4double xmpCrossSections[46][31] = {
    //
...
__thread G4CascadeXiMinusPChannelData_t *G4CascadeXiMinusPChannelData::data = 0;
