...
namespace {
  ...
  {{pro,pi0}, {neu,pip}, {kpl,lam}, {kpl,s0}, {k0,sp}};

  static const G4int pizP3bfs[13][3] =
  {{pro,pip,pim}, {pro,pi0,pi0}, {neu,pip,pi0}, {pi0,kpl,lam}, 
   {pip,k0,lam},  {pi0,kpl,s0},  {pip,k0,s0},   {pi0,k0,sp},
   {pim,kpl,sp},  {pip,kpl,sm},  {pro,kpl,kmi}, {pro,k0,k0b},
   {neu,kpl,k0b}};

  static const G4int pizP4bfs[22][4] =
  {{pro,pip,pim,pi0}, {pro,pi0,pi0,pi0}, {neu,pip,pip,pim},
   {neu,pip,pi0,pi0}, {pip,pim,kpl,lam}, {pip,pim,kpl,s0}, 
   {pi0,pi0,kpl,lam}, {pi0,pi0,kpl,s0},  {pi0,pi0,k0,sp}, 
   {pip,pi0,k0,lam},  {pip,pi0,k0,s0},   {pip,pim,k0,sp}, 
   {pim,pi0,kpl,sp},  {pip,pi0,kpl,sm},  {pip,pip,k0,sm},
   {pro,pi0,kpl,kmi}, {pro,pi0,k0,k0b},  {pro,pip,kmi,k0},
   {pro,pim,kpl,k0b}, {neu,pip,kpl,kmi}, {neu,pip,k0,k0b},
   {neu,pi0,kpl,k0b}}; 

  static const G4int pizP5bfs[31][5] =
  {{pro,pip,pip,pim,pim}, {pro,pip,pim,pi0,pi0}, {pro,pi0,pi0,pi0,pi0},
   {neu,pip,pip,pim,pi0}, {neu,pip,pi0,pi0,pi0}, {pip,pim,pi0,kpl,lam},
   {pi0,pi0,pi0,kpl,lam}, {pip,pip,pim,k0,lam},  {pip,pi0,pi0,k0,lam},
   {pip,pim,pi0,kpl,s0},  {pi0,pi0,pi0,kpl,s0},  {pip,pip,pim,k0,s0},
   {pip,pi0,pi0,k0,s0},   {pip,pim,pi0,k0,sp},   {pi0,pi0,pi0,k0,sp},
   {pip,pim,pim,kpl,sp},  {pim,pi0,pi0,kpl,sp},  {pip,pip,pim,kpl,sm}, 
   {pip,pi0,pi0,kpl,sm},  {pip,pip,pi0,k0,sm},   {pro,pi0,pi0,kpl,kmi},
   {pro,pi0,pi0,k0,k0b},  {pro,pim,pi0,kpl,k0b}, {pro,pip,pi0,kmi,k0},
   {pro,pip,pim,kpl,kmi}, {pro,pip,pim,k0,k0b},  {neu,pip,pi0,kpl,kmi},
   {neu,pip,pi0,k0,k0b},  {neu,pi0,pi0,kpl,k0b}, {neu,pip,pip,kmi,k0},
   {neu,pip,pim,kpl,k0b}};
  ...
  {{pro,pip,pip,pim,pim,pi0}, {pro,pip,pim,pi0,pi0,pi0},
   ...
   {pip,pip,pim,pim,kpl,lam}, {pip,pim,pi0,pi0,kpl,lam},
   {pi0,pi0,pi0,pi0,kpl,lam}, {pip,pip,pim,pi0,k0,lam},
   {pip,pi0,pi0,pi0,k0,lam},  {pip,pip,pim,pim,kpl,s0},
   {pip,pim,pi0,pi0,kpl,s0},  {pi0,pi0,pi0,pi0,kpl,s0},
   {pip,pip,pim,pi0,k0,s0},   {pip,pi0,pi0,pi0,k0,s0},
   {pip,pim,pim,pi0,kpl,sp},  {pim,pi0,pi0,pi0,kpl,sp},
   {pip,pip,pim,pim,k0,sp},   {pip,pim,pi0,pi0,k0,sp},
   {pip,pip,pim,pi0,kpl,sm},  {pip,pi0,pi0,pi0,kpl,sm},
   {pip,pip,pip,pim,k0,sm},   {pip,pip,pi0,pi0,k0,sm},
   {pro,pim,pi0,pi0,kpl,k0b}, {pro,pip,pim,pim,kpl,k0b},
   {pro,pip,pim,pi0,kpl,kmi}, {pro,pi0,pi0,pi0,kpl,kmi},
   {pro,pip,pim,pi0,k0,k0b},  {pro,pi0,pi0,pi0,k0,k0b},
   {pro,pip,pip,pim,kmi,k0},  {pro,pip,pi0,pi0,kmi,k0},
   {neu,pip,pim,pi0,kpl,k0b}, {neu,pi0,pi0,pi0,kpl,k0b},
   {neu,pip,pip,pim,kpl,kmi}, {neu,pip,pi0,pi0,kpl,kmi},
   {neu,pip,pip,pim,k0,k0b},  {neu,pip,pi0,pi0,k0,k0b},
   {neu,pip,pip,pi0,kmi,k0}};
  ...
  {{pro,pip,pip,pip,pim,pim,pim}, {pro,pip,pip,pim,pim,pi0,pi0},
   ...
   {neu,pip,pi0,pi0,pi0,pi0,pi0}, {pip,pip,pim,pim,pi0,kpl,lam}, 
   {pip,pim,pi0,pi0,pi0,kpl,lam}, {pip,pip,pip,pim,pim,k0,lam},
   {pip,pip,pim,pi0,pi0,k0,lam},  {pip,pi0,pi0,pi0,pi0,k0,lam},
   {pip,pip,pim,pim,pi0,kpl,s0},  {pip,pim,pi0,pi0,pi0,kpl,s0},
   {pip,pip,pip,pim,pim,k0,s0},   {pip,pip,pim,pi0,pi0,k0,s0},
   {pip,pi0,pi0,pi0,pi0,k0,s0},   {pip,pip,pim,pim,pim,kpl,sp},  
   {pip,pim,pim,pi0,pi0,kpl,sp},  {pim,pi0,pi0,pi0,pi0,kpl,sp},
   {pip,pip,pim,pim,pi0,k0,sp},   {pip,pim,pi0,pi0,pi0,k0,sp},
   {pip,pip,pip,pim,pim,kpl,sm},  {pip,pip,pim,pi0,pi0,kpl,sm},
   {pip,pi0,pi0,pi0,pi0,kpl,sm},  {pip,pip,pip,pim,pi0,k0,sm},
   {pip,pip,pi0,pi0,pi0,k0,sm},   {pro,pim,pi0,pi0,pi0,kpl,k0b},
   {pro,pip,pim,pim,pi0,kpl,k0b}, {pro,pi0,pi0,pi0,pi0,kpl,kmi},
   {pro,pip,pim,pi0,pi0,kpl,kmi}, {pro,pip,pip,pim,pim,kpl,kmi},
   {pro,pi0,pi0,pi0,pi0,k0,k0b},  {pro,pip,pim,pi0,pi0,k0,k0b},
   {pro,pip,pip,pim,pim,k0,k0b},  {pro,pip,pi0,pi0,pi0,kmi,k0},
   {pro,pip,pip,pim,pi0,kmi,k0},  {neu,pi0,pi0,pi0,pi0,kpl,k0b},
   {neu,pip,pim,pi0,pi0,kpl,k0b}, {neu,pip,pip,pim,pim,kpl,k0b},
   {neu,pip,pi0,pi0,pi0,kpl,kmi}, {neu,pip,pip,pim,pi0,kpl,kmi},
   {neu,pip,pi0,pi0,pi0,k0,k0b},  {neu,pip,pip,pim,pi0,k0,k0b},
   {neu,pip,pip,pi0,pi0,kmi,k0},  {neu,pip,pip,pip,pim,kmi,k0}};
  ...
  {{pro,pip,pip,pip,pim,pim,pim,pi0}, {pro,pip,pip,pim,pim,pi0,pi0,pi0},
   ...
   {pip,pip,pip,pim,pim,pim,kpl,lam}, {pip,pip,pim,pim,pi0,pi0,kpl,lam},
   {pip,pim,pi0,pi0,pi0,pi0,kpl,lam}, {pip,pip,pip,pim,pim,pi0,k0,lam},
   {pip,pip,pim,pi0,pi0,pi0,k0,lam},  {pip,pi0,pi0,pi0,pi0,pi0,k0,lam},
   {pip,pip,pip,pim,pim,pim,kpl,s0},  {pip,pip,pim,pim,pi0,pi0,kpl,s0},
   {pip,pim,pi0,pi0,pi0,pi0,kpl,s0},  {pip,pip,pip,pim,pim,pi0,k0,s0},
   {pip,pip,pim,pi0,pi0,pi0,k0,s0},   {pip,pip,pim,pim,pim,pi0,kpl,sp},
   {pip,pim,pim,pi0,pi0,pi0,kpl,sp},  {pim,pi0,pi0,pi0,pi0,pi0,kpl,sp},
   {pip,pip,pip,pim,pim,pim,k0,sp},   {pip,pip,pim,pim,pi0,pi0,k0,sp},
   {pip,pim,pi0,pi0,pi0,pi0,k0,sp},   {pip,pip,pip,pim,pim,pi0,kpl,sm},
   {pip,pip,pim,pi0,pi0,pi0,kpl,sm},  {pip,pi0,pi0,pi0,pi0,pi0,kpl,sm},
   {pip,pip,pip,pim,pi0,pi0,k0,sm},   {pip,pip,pip,pip,pim,pim,k0,sm},
   {pip,pip,pi0,pi0,pi0,pi0,k0,sm},   {pro,pip,pip,pim,pim,pim,kpl,k0b}, 
   {pro,pip,pim,pim,pi0,pi0,kpl,k0b}, {pro,pim,pi0,pi0,pi0,pi0,kpl,k0b},
   ...
   {pro,pip,pip,pip,pim,pim,kmi,k0},  {pro,pip,pip,pim,pi0,pi0,kmi,k0},
   {pro,pip,pi0,pi0,pi0,pi0,kmi,k0},  {neu,pip,pip,pim,pim,pi0,kpl,k0b},
   {neu,pip,pim,pi0,pi0,pi0,kpl,k0b}, {neu,pip,pip,pip,pim,pim,kpl,kmi},
   {neu,pip,pim,pim,pi0,pi0,kpl,kmi}, {neu,pip,pi0,pi0,pi0,pi0,kpl,kmi},
   {neu,pip,pip,pip,pim,pim,k0,k0b},  {neu,pip,pip,pim,pi0,pi0,k0,k0b},
   {neu,pip,pi0,pi0,pi0,pi0,k0,k0b},  {neu,pip,pip,pip,pim,pi0,kmi,k0},
   {neu,pip,pip,pi0,pi0,pi0,kmi,k0}};
  ...
  {{pro,pip,pip,pip,pip,pim,pim,pim,pim}, {pro,pip,pip,pip,pim,pim,pim,pi0,pi0},
   ...
   {neu,pip,pi0,pi0,pi0,pi0,pi0,pi0,pi0}, {pip,pip,pip,pim,pim,pim,pi0,kpl,lam},
   {pip,pip,pim,pim,pi0,pi0,pi0,kpl,lam}, {pip,pim,pi0,pi0,pi0,pi0,pi0,kpl,lam},
   {pip,pip,pip,pip,pim,pim,pim,k0,lam},  {pip,pip,pip,pim,pim,pi0,pi0,k0,lam},
   {pip,pip,pim,pi0,pi0,pi0,pi0,k0,lam},  {pip,pi0,pi0,pi0,pi0,pi0,pi0,k0,lam},
   {pip,pip,pip,pim,pim,pim,pi0,kpl,s0},  {pip,pip,pim,pim,pi0,pi0,pi0,kpl,s0},
   {pip,pim,pi0,pi0,pi0,pi0,pi0,kpl,s0},  {pip,pip,pip,pip,pim,pim,pim,k0,s0},
   {pip,pip,pip,pim,pim,pi0,pi0,k0,s0},   {pip,pip,pim,pi0,pi0,pi0,pi0,k0,s0},
   {pip,pip,pip,pim,pim,pim,pim,kpl,sp},  {pip,pip,pim,pim,pim,pi0,pi0,kpl,sp},
   {pip,pim,pim,pi0,pi0,pi0,pi0,kpl,sp},  {pip,pip,pip,pim,pim,pim,pi0,k0,sp},
   {pip,pip,pim,pim,pi0,pi0,pi0,k0,sp},   {pip,pim,pi0,pi0,pi0,pi0,pi0,k0,sp},
   {pip,pip,pip,pip,pim,pim,pim,kpl,sm},  {pip,pip,pip,pim,pim,pi0,pi0,kpl,sm},
   {pip,pip,pim,pi0,pi0,pi0,pi0,kpl,sm},  {pip,pip,pip,pip,pim,pim,pi0,k0,sm},
   {pip,pip,pip,pim,pi0,pi0,pi0,k0,sm},   {pip,pip,pi0,pi0,pi0,pi0,pi0,k0,sm},
   {pro,pip,pip,pim,pim,pim,pi0,kpl,k0b}, {pro,pip,pim,pim,pi0,pi0,pi0,kpl,k0b},
   {pro,pim,pi0,pi0,pi0,pi0,pi0,kpl,k0b}, {pro,pip,pip,pip,pim,pim,pim,kpl,kmi},
   {pro,pip,pip,pim,pim,pi0,pi0,kpl,kmi}, {pro,pip,pim,pi0,pi0,pi0,pi0,kpl,kmi},
   {pro,pip,pip,pip,pim,pim,pim,k0,k0b},  {pro,pip,pip,pim,pim,pi0,pi0,k0,k0b},
   {pro,pip,pim,pi0,pi0,pi0,pi0,k0,k0b},  {pro,pip,pip,pip,pim,pim,pi0,kmi,k0},
   {pro,pip,pip,pim,pi0,pi0,pi0,kmi,k0},  {pro,pip,pi0,pi0,pi0,pi0,pi0,kmi,k0},
   {neu,pip,pip,pip,pim,pim,pim,kpl,k0b}, {neu,pip,pip,pim,pim,pi0,pi0,kpl,k0b},
   {neu,pip,pim,pi0,pi0,pi0,pi0,kpl,k0b}, {neu,pip,pip,pip,pim,pim,pi0,kpl,kmi},
   {neu,pip,pip,pim,pi0,pi0,pi0,kpl,kmi}, {neu,pip,pi0,pi0,pi0,pi0,pi0,kpl,kmi},
   {neu,pip,pip,pip,pim,pim,pi0,k0,k0b},  {neu,pip,pip,pim,pi0,pi0,pi0,k0,k0b},
   {neu,pip,pi0,pi0,pi0,pi0,pi0,k0,k0b},  {neu,pip,pip,pip,pip,pim,pim,kmi,k0},
   {neu,pip,pip,pip,pim,pi0,pi0,kmi,k0},  {neu,pip,pip,pi0,pi0,pi0,pi0,kmi,k0}};
}

namespace {
  // pi0 n : Outgoing particle types of a given multiplicity
  static const G4int pizN2bfs[5][2] =
  {{neu,pi0}, {pro,pim}, {k0,lam}, {k0,s0}, {kpl,sm}};

  static const G4int pizN3bfs[13][3] =
  {{neu,pip,pim}, {neu,pi0,pi0}, {pro,pim,pi0}, {pi0,k0,lam},
   {pim,kpl,lam}, {pi0,k0,s0},   {pim,kpl,s0},  {pi0,kpl,sm},  
   {pip,k0,sm},   {pim,k0,sp},   {neu,k0,k0b},  {neu,kpl,kmi},
   {pro,kmi,k0}};

  static const G4int pizN4bfs[22][4] =
  {{neu,pip,pim,pi0}, {neu,pi0,pi0,pi0}, {pro,pip,pim,pim},
   {pro,pim,pi0,pi0}, {pip,pim,k0,lam},  {pip,pim,k0,s0},
   {pi0,pi0,k0,lam},  {pi0,pi0,k0,s0},   {pi0,pi0,kpl,sm},
   {pim,pi0,kpl,lam}, {pim,pi0,kpl,s0},  {pip,pim,kpl,sm},
   {pip,pi0,k0,sm},   {pim,pi0,k0,sp},   {pim,pim,kpl,sp},
   {neu,pi0,k0,k0b},  {neu,pi0,kpl,kmi}, {neu,pim,kpl,k0b},
   {neu,pip,k0,kmi},  {pro,pim,k0,k0b},  {pro,pim,kpl,kmi},
   {pro,pi0,k0,kmi}};

  static const G4int pizN5bfs[31][5] =
  {{neu,pip,pip,pim,pim}, {neu,pip,pim,pi0,pi0}, {neu,pi0,pi0,pi0,pi0},
   {pro,pip,pim,pim,pi0}, {pro,pim,pi0,pi0,pi0}, {pip,pim,pi0,k0,lam},
   {pi0,pi0,pi0,k0,lam},  {pip,pim,pim,kpl,lam}, {pim,pi0,pi0,kpl,lam},
   {pip,pim,pi0,k0,s0},   {pi0,pi0,pi0,k0,s0},   {pip,pim,pim,kpl,s0},
   {pim,pi0,pi0,kpl,s0},  {pip,pim,pi0,kpl,sm},  {pi0,pi0,pi0,kpl,sm},
   {pip,pip,pim,k0,sm},   {pip,pi0,pi0,k0,sm},   {pip,pim,pim,k0,sp},
   {pim,pi0,pi0,k0,sp},   {pim,pim,pi0,kpl,sp},  {neu,pi0,pi0,k0,k0b},
   {neu,pi0,pi0,kpl,kmi}, {neu,pip,pi0,kmi,k0},  {neu,pim,pi0,kpl,k0b},
   {neu,pip,pim,k0,k0b},  {neu,pip,pim,kpl,kmi}, {pro,pim,pi0,k0,k0b},
   {pro,pim,pi0,kpl,kmi}, {pro,pi0,pi0,kmi,k0},  {pro,pim,pim,kpl,k0b},
   {pro,pip,pim,kmi,k0}};
  ...
  {{neu,pip,pip,pim,pim,pi0}, {neu,pip,pim,pi0,pi0,pi0},
   ...
   {pip,pip,pim,pim,k0,lam},  {pip,pim,pi0,pi0,k0,lam},
   {pi0,pi0,pi0,pi0,k0,lam},  {pip,pim,pim,pi0,kpl,lam},
   {pim,pi0,pi0,pi0,kpl,lam}, {pip,pip,pim,pim,k0,s0},
   {pip,pim,pi0,pi0,k0,s0},   {pi0,pi0,pi0,pi0,k0,s0},
   {pip,pim,pim,pi0,kpl,s0},  {pim,pi0,pi0,pi0,kpl,s0},
   {pip,pip,pim,pi0,k0,sm},   {pip,pi0,pi0,pi0,k0,sm},
   {pip,pip,pim,pim,kpl,sm},  {pip,pim,pi0,pi0,kpl,sm},
   {pip,pim,pim,pi0,k0,sp},   {pim,pi0,pi0,pi0,k0,sp},
   {pip,pim,pim,pim,kpl,sp},  {pim,pim,pi0,pi0,kpl,sp},
   {neu,pip,pi0,pi0,kmi,k0},  {neu,pip,pip,pim,kmi,k0},
   {neu,pip,pim,pi0,k0,k0b},  {neu,pi0,pi0,pi0,k0,k0b},
   {neu,pip,pim,pi0,kpl,kmi}, {neu,pi0,pi0,pi0,kpl,kmi},
   {neu,pip,pim,pim,kpl,k0b}, {neu,pim,pi0,pi0,kpl,k0b},
   {pro,pip,pim,pi0,kmi,k0},  {pro,pi0,pi0,pi0,kmi,k0},
   {pro,pip,pim,pim,k0,k0b},  {pro,pim,pi0,pi0,k0,k0b},
   {pro,pip,pim,pim,kpl,kmi}, {pro,pim,pi0,pi0,kpl,kmi},
   {pro,pim,pim,pi0,kpl,k0b}};
  ...
  {{neu,pip,pip,pip,pim,pim,pim}, {neu,pip,pip,pim,pim,pi0,pi0},
   ...
   {pro,pim,pi0,pi0,pi0,pi0,pi0}, {pip,pip,pim,pim,pi0,k0,lam},
   {pip,pim,pi0,pi0,pi0,k0,lam},  {pip,pip,pim,pim,pim,kpl,lam},
   {pip,pim,pim,pi0,pi0,kpl,lam}, {pim,pi0,pi0,pi0,pi0,kpl,lam},
   {pip,pip,pim,pim,pi0,k0,s0},   {pip,pim,pi0,pi0,pi0,k0,s0},
   {pip,pip,pim,pim,pim,kpl,s0},  {pip,pim,pim,pi0,pi0,kpl,s0},
   {pim,pi0,pi0,pi0,pi0,kpl,s0},  {pip,pip,pip,pim,pim,k0,sm},
   {pip,pip,pim,pi0,pi0,k0,sm},   {pip,pi0,pi0,pi0,pi0,k0,sm},
   {pip,pip,pim,pim,pi0,kpl,sm},  {pip,pim,pi0,pi0,pi0,kpl,sm},
   {pip,pip,pim,pim,pim,k0,sp},   {pip,pim,pim,pi0,pi0,k0,sp},
   {pim,pi0,pi0,pi0,pi0,k0,sp},   {pip,pim,pim,pim,pi0,kpl,sp},
   {pim,pim,pi0,pi0,pi0,kpl,sp},  {neu,pip,pi0,pi0,pi0,kmi,k0},
   {neu,pip,pip,pim,pi0,kmi,k0},  {neu,pi0,pi0,pi0,pi0,k0,k0b},
   {neu,pip,pim,pi0,pi0,k0,k0b},  {neu,pip,pip,pim,pim,k0,k0b},
   {neu,pi0,pi0,pi0,pi0,kpl,kmi}, {neu,pip,pim,pi0,pi0,kpl,kmi},
   {neu,pip,pip,pim,pim,kpl,kmi}, {neu,pim,pi0,pi0,pi0,kpl,k0b},
   {neu,pip,pim,pim,pi0,kpl,k0b}, {pro,pi0,pi0,pi0,pi0,kmi,k0},
   {pro,pip,pim,pi0,pi0,kmi,k0},  {pro,pip,pip,pim,pim,kmi,k0},
   {pro,pim,pi0,pi0,pi0,k0,k0b},  {pro,pip,pim,pim,pi0,k0,k0b},
   {pro,pim,pi0,pi0,pi0,kpl,kmi}, {pro,pip,pim,pim,pi0,kpl,kmi},
   {pro,pim,pim,pi0,pi0,kpl,k0b}, {pro,pip,pim,pim,pim,kpl,k0b}};
  ...
  {{neu,pip,pip,pip,pim,pim,pim,pi0}, {neu,pip,pip,pim,pim,pi0,pi0,pi0},
   ...
   {pip,pip,pip,pim,pim,pim,k0,lam},  {pip,pip,pim,pim,pi0,pi0,k0,lam},
   {pip,pim,pi0,pi0,pi0,pi0,k0,lam},  {pip,pip,pim,pim,pim,pi0,kpl,lam},
   {pip,pim,pim,pi0,pi0,pi0,kpl,lam}, {pim,pi0,pi0,pi0,pi0,pi0,kpl,lam},
   {pip,pip,pip,pim,pim,pim,k0,s0},   {pip,pip,pim,pim,pi0,pi0,k0,s0},
   {pip,pim,pi0,pi0,pi0,pi0,k0,s0},   {pip,pip,pim,pim,pim,pi0,kpl,s0},
   {pip,pim,pim,pi0,pi0,pi0,kpl,s0},  {pip,pip,pip,pim,pim,pi0,k0,sm},
   {pip,pip,pim,pi0,pi0,pi0,k0,sm},   {pip,pi0,pi0,pi0,pi0,pi0,k0,sm},
   {pip,pip,pip,pim,pim,pim,kpl,sm},  {pip,pip,pim,pim,pi0,pi0,kpl,sm},
   {pip,pim,pi0,pi0,pi0,pi0,kpl,sm},  {pip,pip,pim,pim,pim,pi0,k0,sp},
   {pip,pim,pim,pi0,pi0,pi0,k0,sp},   {pim,pi0,pi0,pi0,pi0,pi0,k0,sp},
   {pip,pim,pim,pim,pi0,pi0,kpl,sp},  {pip,pip,pim,pim,pim,pim,kpl,sp},
   {pim,pim,pi0,pi0,pi0,pi0,kpl,sp},  {neu,pip,pip,pip,pim,pim,kmi,k0},
   {neu,pip,pip,pim,pi0,pi0,kmi,k0},  {neu,pip,pi0,pi0,pi0,pi0,kmi,k0},
   ...
   {neu,pip,pip,pim,pim,pim,kpl,k0b}, {neu,pip,pim,pim,pi0,pi0,kpl,k0b},
   {neu,pim,pi0,pi0,pi0,pi0,kpl,k0b}, {pro,pip,pip,pim,pim,pi0,kmi,k0},
   {pro,pip,pim,pi0,pi0,pi0,kmi,k0},  {pro,pip,pip,pim,pim,pim,k0,k0b},
   {pro,pip,pim,pim,pi0,pi0,k0,k0b},  {pro,pim,pi0,pi0,pi0,pi0,k0,k0b},
   {pro,pip,pip,pim,pim,pim,kpl,kmi}, {pro,pip,pim,pim,pi0,pi0,kpl,kmi},
   {pro,pim,pi0,pi0,pi0,pi0,kpl,kmi}, {pro,pip,pim,pim,pim,pi0,kpl,k0b},
   {pro,pim,pim,pi0,pi0,pi0,kpl,k0b}};
  ...
  {{neu,pip,pip,pip,pip,pim,pim,pim,pim}, {neu,pip,pip,pip,pim,pim,pim,pi0,pi0},
   ...
   {pro,pim,pi0,pi0,pi0,pi0,pi0,pi0,pi0}, {pip,pip,pip,pim,pim,pim,pi0,k0,lam},
   {pip,pip,pim,pim,pi0,pi0,pi0,k0,lam},  {pip,pim,pi0,pi0,pi0,pi0,pi0,k0,lam},
   {pip,pip,pip,pim,pim,pim,pim,kpl,lam}, {pip,pip,pim,pim,pim,pi0,pi0,kpl,lam},
   {pip,pim,pim,pi0,pi0,pi0,pi0,kpl,lam}, {pim,pi0,pi0,pi0,pi0,pi0,pi0,kpl,lam},
   {pip,pip,pip,pim,pim,pim,pi0,k0,s0},   {pip,pip,pim,pim,pi0,pi0,pi0,k0,s0},
   {pip,pim,pi0,pi0,pi0,pi0,pi0,k0,s0},   {pip,pip,pip,pim,pim,pim,pim,kpl,s0},
   {pip,pip,pim,pim,pim,pi0,pi0,kpl,s0},  {pip,pim,pim,pi0,pi0,pi0,pi0,kpl,s0},
   {pip,pip,pip,pip,pim,pim,pim,k0,sm},   {pip,pip,pip,pim,pim,pi0,pi0,k0,sm},
   {pip,pip,pim,pi0,pi0,pi0,pi0,k0,sm},   {pip,pip,pip,pim,pim,pim,pi0,kpl,sm},
   {pip,pip,pim,pim,pi0,pi0,pi0,kpl,sm},  {pip,pim,pi0,pi0,pi0,pi0,pi0,kpl,sm},
   {pip,pip,pip,pim,pim,pim,pim,k0,sp},   {pip,pip,pim,pim,pim,pi0,pi0,k0,sp},
   {pip,pim,pim,pi0,pi0,pi0,pi0,k0,sp},   {pip,pip,pim,pim,pim,pim,pi0,kpl,sp},
   {pip,pim,pim,pim,pi0,pi0,pi0,kpl,sp},  {pim,pim,pi0,pi0,pi0,pi0,pi0,kpl,sp},
   {neu,pip,pip,pip,pim,pim,pi0,kmi,k0},  {neu,pip,pip,pim,pi0,pi0,pi0,kmi,k0},
   {neu,pip,pi0,pi0,pi0,pi0,pi0,kmi,k0},  {neu,pip,pip,pip,pim,pim,pim,k0,k0b},
   {neu,pip,pip,pim,pim,pi0,pi0,k0,k0b},  {neu,pip,pim,pi0,pi0,pi0,pi0,k0,k0b},
   {neu,pip,pip,pip,pim,pim,pim,kpl,kmi}, {neu,pip,pip,pim,pim,pi0,pi0,kpl,kmi},
   {neu,pip,pim,pi0,pi0,pi0,pi0,kpl,kmi}, {neu,pip,pip,pim,pim,pim,pi0,kpl,k0b},
   {neu,pip,pim,pim,pi0,pi0,pi0,kpl,k0b}, {neu,pim,pi0,pi0,pi0,pi0,pi0,kpl,k0b},
   {pro,pip,pip,pip,pim,pim,pim,kmi,k0},  {pro,pip,pip,pim,pim,pi0,pi0,kmi,k0},
   {pro,pip,pim,pi0,pi0,pi0,pi0,kmi,k0},  {pro,pip,pip,pim,pim,pim,pi0,k0,k0b},
   {pro,pip,pim,pim,pi0,pi0,pi0,k0,k0b},  {pro,pim,pi0,pi0,pi0,pi0,pi0,k0,k0b},
   {pro,pip,pip,pim,pim,pim,pi0,kpl,kmi}, {pro,pip,pim,pim,pi0,pi0,pi0,kpl,kmi},
   {pro,pim,pi0,pi0,pi0,pi0,pi0,kpl,kmi}, {pro,pip,pip,pim,pim,pim,pim,kpl,k0b},
   {pro,pip,pim,pim,pim,pi0,pi0,kpl,k0b}, {pro,pim,pim,pi0,pi0,pi0,pi0,kpl,k0b}};
}
