...
// and all its terms.
//
// $Id: G4LEKaonZeroLInelastic.cc,v 1.3 2001-06-06 13:43:15 hpw Exp $
...
#include "Randomize.hh"
 ...
 void
   ...
   G4bool &quasiElastic )
  {
    ...
    G4int iplab = static_cast<G4int>(G4std::min( 9.0, 5.0*pOriginal*MeV/GeV ));
    if( (pOriginal*MeV/GeV <= 2.0) && (G4UniformRand() < cech[iplab]) )
    {
      np = nm = nz = nt = 0;
      iplab = static_cast<G4int>(G4std::min( 19.0, pOriginal*MeV/GeV*10.0 ));
