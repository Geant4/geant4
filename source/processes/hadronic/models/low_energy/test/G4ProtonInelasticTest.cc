...
// and all its terms.
//
// $Id: G4ProtonInelasticTest.cc,v 1.2 1999-12-15 14:53:10 gunter Exp $
...
//  G4Material::DumpInfo();
  ...
  theProtonProcessManager->AddProcess(&theProtonInelasticProcess,-1,-1,0);
