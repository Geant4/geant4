...
int main(int argc,char** argv)
{
  ...
  inelasticProcess->RegisterMe(new G4LEProtonInelastic() );
  ...
  inelasticProcess->RegisterMe(new G4LEPionMinusInelastic() );
  processes.push_back(inelasticProcess);

  particles.push_back(G4KaonPlus::KaonPlus() );
  inelasticProcess = new G4KaonPlusInelasticProcess();
  inelasticProcess->RegisterMe(new G4LEKaonPlusInelastic() );
  processes.push_back(inelasticProcess);
