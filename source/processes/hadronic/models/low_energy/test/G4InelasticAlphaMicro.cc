...
//
//
// $Id: G4InelasticAlphaMicro.cc,v 1.3 2001-07-11 10:06:53 gunter Exp $
...
//    G4Material::DumpInfo();
   ...
   G4ParticleDefinition* thePionPlus = G4PionMinus::PionMinusDefinition();
   ...
   *condition = NotForced;
   ...
   //for ( G4int i=0; i<numberOfParticles; i++)
   {
    ...
    G4DynamicParticle*  particle3 = new G4DynamicParticle;
         G4DynamicParticle* aParticle =
           new G4DynamicParticle( theParticles[i], theDirection, incomingEnergy );
    G4DynamicParticle*  particle4 = new G4DynamicParticle;
     ...
     //for ( G4int k=0; k<numberOfMaterials; k++)
     {
       ...
       for( G4int j=0; j<numberOfEnergies; ++j )
       {
         for( G4int l=0; l<ll0; ++l )
         {
           incomingEnergy=theEnergies[j];
           if( i>=6 && i<=8 )incomingEnergy /= 201.;
    G4DynamicParticle*  particle5 = new G4DynamicParticle;
           G4DynamicParticle* aParticle =
             new G4DynamicParticle( theParticles[i], theDirection, incomingEnergy );
    G4DynamicParticle*  particle6 = new G4DynamicParticle;
           G4Track* aTrack = new G4Track( aParticle, aTime, aPosition );
           aTrack->SetVolume( PhysicalFrame );
           aStep.SetTrack( aTrack );
