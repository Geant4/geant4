...
//
//
// $Id: G4LEppTest.cc,v 1.3 2001-07-11 10:04:13 gunter Exp $
...
//      theMaterials[3] = theB;
// 
//      // probem in: src/G4ProtonHPPhotonDist.cc line 82,
...
//      theMaterials[5] = theO;
//      
//      // G4ProtonHPPhotonDist: Transition probability array not sampled for the moment.
...
//      // Now:   G4ProtonHPPhotonDist: Transition probability array not sampled for the moment.
// // Fix for reading, sampling to be tested
//      // Init runs
...
//                << theProtonHPInelastic.GetNiso()
	   ...
	   G4double eventEnergy=0;
	     ...
	     G4cout << G4endl;
             eventEnergy += aSec->GetTotalEnergy();
	     delete second;
           }
	   G4cout << "TOTAL ENERGY IN EVENT = "<<eventEnergy<<G4endl;
           aFinalState->Clear();
	   G4cout << ll0<< "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"<<G4endl;
