...
G4NeutrinoElectronNcModel::G4NeutrinoElectronNcModel(const G4String& name) : G4HadronElastic(name)
{
...
G4HadFinalState* G4NeutrinoElectronNcModel::ApplyYourself(const G4HadProjectile& aTrack, G4Nucleus&)
{
