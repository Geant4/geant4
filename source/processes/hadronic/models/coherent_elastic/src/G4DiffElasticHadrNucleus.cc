...
//
//
// $Id: G4DiffElasticHadrNucleus.cc,v 1.24 2006-10-23 09:12:30 starkov Exp $
...
//            ------ but internal in GeV !!!!  ------
  ...
  G4cout<<"  In  HadeNucDifCrSec  "<<G4endl;
...
//      {
        ...
        Mnojit      = 2.0*3.1416*stepB/16/3.1416*
...
//  =====================================================
  ...
  if(verboselevel==1)
   G4cout<<" GetKinem : Mass Momentum "<<HadronM<<"  "<<MomentumH<<"  MaxT "<<G4endl;
  ...
  if(verboselevel==1)
  G4cout<<"  Code "<<HadrCode<<" GetKinem. MaxT "<<MaxT<<"  MaxTR "<<MaxTR<<G4endl;
...
//  ++++++++++++++++++++++++++++++++++++++++
  ...
  if(verboselevel==1)
  G4cout<<" GetParam: Coeff012 "<<Coeff0<<"  "<<Coeff1<<"  "<<Coeff2<<"  "
        <<" Slope012  "<<Slope0<<"  "<<Slope1<<"  "<<Slope2<<"  "<<G4endl;
  }
//  ++++++++++++++++++++++++++++++++++++++++
  G4double G4DiffElasticHadrNucleus::
