...
//
//
// $Id: G4DiffElasticHadrNucleus.hh,v 1.16 2006-10-23 09:12:43 starkov Exp $
...
#define sqMbToGeV    1.602
#define Fm2ToGeV2  25.68
#define FmToGeV    5.068
...
//  ###############################################
 ...
 public:
   ...
   NucleusParameters() {;}   
  ~NucleusParameters() {;}   
//   NucleusParameters::NucleusParameters(G4int AtWeight) 
//  {;}
