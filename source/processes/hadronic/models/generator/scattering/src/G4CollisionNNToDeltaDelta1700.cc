...
//
//
// $Id: G4CollisionNNToDeltaDelta1700.cc,v 1.2 2002/12/12 19:17:48 gunter Exp $ //
...
{ 
  ...
  G4CollisionComposite::AddComponent(new G4ConcreteNNToDeltaDeltastar(aNeutron, aProton, aDeltapp, aD0_1700));
