...
#ifndef G4CollisionNNToNDelta_h
#define G4CollisionNNToNDelta_h
...
class G4CollisionNNToNDelta : public G4GeneralNNCollision
{
...
public:
  ...
  {
    G4Exception("Tried to call G4CollisionNNToNDelta::GetListOfColliders. Please find out why!");
