...
#ifndef G4ConcreteNNToNDeltaStar_h
#define G4ConcreteNNToNDeltaStar_h
...
class G4ConcreteNNToNDeltaStar : public G4ConcreteNNTwoBodyResonance
{
public:
  G4ConcreteNNToNDeltaStar(const G4ParticleDefinition* aPrimary,
