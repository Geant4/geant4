...
#ifndef G4ConcreteNNToNNStar_h
#define G4ConcreteNNToNNStar_h
...
class G4ConcreteNNToNNStar : public G4ConcreteNNTwoBodyResonance
{
public:
  G4ConcreteNNToNNStar(const G4ParticleDefinition* aPrimary,
