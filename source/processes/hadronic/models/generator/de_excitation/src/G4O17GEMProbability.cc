...
//
//
// $Id: G4O17GEMProbability.cc,v 1.1 2002/06/06 18:03:27 larazb Exp $
...
G4O17GEMProbability::G4O17GEMProbability(const G4O17GEMProbability &right)
{
  G4Exception("G4O17GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4O17GEMProbability &right)
{
  G4Exception("G4O17GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4O17GEMProbability::operator==(const G4O17GEMProbability &right) const
{
  return false;
}
