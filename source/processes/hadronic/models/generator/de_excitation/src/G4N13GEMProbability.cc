...
//
//
// $Id: G4N13GEMProbability.cc,v 1.1 2002/06/06 18:02:17 larazb Exp $
...
G4N13GEMProbability::G4N13GEMProbability(const G4N13GEMProbability &right)
{
...
operator=(const G4N13GEMProbability &right)
{
...
G4bool G4N13GEMProbability::operator==(const G4N13GEMProbability &right) const
{
  return false;
}
