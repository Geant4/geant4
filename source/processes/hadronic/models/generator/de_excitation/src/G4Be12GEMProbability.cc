...
//
//
// $Id: G4Be12GEMProbability.cc,v 1.1 2002/06/06 17:59:32 larazb Exp $
...
G4Be12GEMProbability::G4Be12GEMProbability(const G4Be12GEMProbability &right)
{
...
G4bool G4Be12GEMProbability::operator==(const G4Be12GEMProbability &right) const
{
  return false;
}
