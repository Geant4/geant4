...
//
//
// $Id: G4F18GEMProbability.cc,v 1.1 2002/06/06 18:00:49 larazb Exp $
  ...
  G4GEMProbability(18,9,1.0) // A,Z,Spin
{
  ...
  ExcitSpins.push_back(4.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(108.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(570.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(375.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(290.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(440.0*keV));
  ...
  ExcitSpins.push_back(3.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(235.0*keV));
  ...
  ExcitSpins.push_back(3.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(205.0*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(265.0*keV));
...
{
  G4Exception("G4F18GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4F18GEMProbability &right)
{
  G4Exception("G4F18GEMProbability::operator= meant to not be accessable");
  return *this;
}
