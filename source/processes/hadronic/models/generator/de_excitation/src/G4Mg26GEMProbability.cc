...
//
//
// $Id: G4Mg26GEMProbability.cc,v 1.1 2002/06/06 18:02:13 larazb Exp $
...
G4Mg26GEMProbability::G4Mg26GEMProbability(const G4Mg26GEMProbability &right)
{
  G4Exception("G4Mg26GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4Mg26GEMProbability &right)
{
  G4Exception("G4Mg26GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4Mg26GEMProbability::operator==(const G4Mg26GEMProbability &right) const
{
  return false;
}
