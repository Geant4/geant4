...
//
//
// $Id: G4O18GEMProbability.cc,v 1.1 2002/06/06 18:03:28 larazb Exp $
...
G4O18GEMProbability::G4O18GEMProbability(const G4O18GEMProbability &right)
{
  G4Exception("G4O18GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4O18GEMProbability &right)
{
  G4Exception("G4O18GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4O18GEMProbability::operator==(const G4O18GEMProbability &right) const
{
  return false;
}
