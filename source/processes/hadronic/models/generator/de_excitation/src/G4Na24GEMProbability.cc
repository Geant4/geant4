...
//
//
// $Id: G4Na24GEMProbability.cc,v 1.1 2002/06/06 18:02:25 larazb Exp $
...
G4Na24GEMProbability::G4Na24GEMProbability(const G4Na24GEMProbability &right)
{
  G4Exception("G4Na24GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4Na24GEMProbability &right)
{
  G4Exception("G4Na24GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4Na24GEMProbability::operator==(const G4Na24GEMProbability &right) const
{
  return false;
}
