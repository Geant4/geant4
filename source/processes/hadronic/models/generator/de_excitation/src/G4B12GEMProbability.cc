...
//
//
// $Id: G4B12GEMProbability.cc,v 1.1 2002/06/06 17:59:10 larazb Exp $
...
G4B12GEMProbability::G4B12GEMProbability(const G4B12GEMProbability &right)
{
  G4Exception("G4B12GEMProbability::copy_constructor meant to not be accessable");}




const G4B12GEMProbability & G4B12GEMProbability::
operator=(const G4B12GEMProbability &right)
{
  G4Exception("G4B12GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4B12GEMProbability::operator==(const G4B12GEMProbability &right) const
{
  return false;
}
