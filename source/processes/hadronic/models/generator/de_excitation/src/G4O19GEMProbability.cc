...
//
//
// $Id: G4O19GEMProbability.cc,v 1.1 2002/06/06 18:03:30 larazb Exp $
  ...
  G4GEMProbability(19,8,5.0/2.0) // A,Z,Spin
{
  ...
  ExcitSpins.push_back(1.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(49.0*keV));
  ...
  ExcitSpins.push_back(3.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(7.8*keV));
  ...
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(19.2*keV));
}


G4O19GEMProbability::G4O19GEMProbability(const G4O19GEMProbability &right)
{
  G4Exception("G4O19GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4O19GEMProbability &right)
{
  G4Exception("G4O19GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4O19GEMProbability::operator==(const G4O19GEMProbability &right) const
{
  return false;
}
