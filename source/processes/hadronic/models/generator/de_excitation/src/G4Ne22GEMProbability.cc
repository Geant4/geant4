...
//
//
// $Id: G4Ne22GEMProbability.cc,v 1.2 2003/05/30 13:23:25 hpw Exp $
...
G4Ne22GEMProbability::G4Ne22GEMProbability(const G4Ne22GEMProbability &) : G4GEMProbability()
{
...
operator=(const G4Ne22GEMProbability &)
{
...
G4bool G4Ne22GEMProbability::operator==(const G4Ne22GEMProbability &) const
{
  return false;
}
