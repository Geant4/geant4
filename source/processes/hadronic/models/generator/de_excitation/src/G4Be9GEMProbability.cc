...
//
//
// $Id: G4Be9GEMProbability.cc,v 1.1 2002/06/06 17:59:49 larazb Exp $
...
G4Be9GEMProbability::G4Be9GEMProbability(const G4Be9GEMProbability &right)
{
  G4Exception("G4Be9GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4Be9GEMProbability &right)
{
  G4Exception("G4Be9GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4Be9GEMProbability::operator==(const G4Be9GEMProbability &right) const
{
  return false;
}
