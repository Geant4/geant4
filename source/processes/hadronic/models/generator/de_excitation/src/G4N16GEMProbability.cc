...
//
//
// $Id: G4N16GEMProbability.cc,v 1.1 2002/06/06 18:02:20 larazb Exp $
  ...
  G4GEMProbability(16,7,2.0) // A,Z,Spin
{
  ...
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(3*keV));
  ...
  ExcitSpins.push_back(1.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(82*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(59*keV));

  ExcitEnergies.push_back( 5050*keV);
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(19*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(320*keV));
  ...
  ExcitSpins.push_back(0.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(12*keV));
  ...
  ExcitSpins.push_back(2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(165*keV));
...
G4N16GEMProbability::G4N16GEMProbability(const G4N16GEMProbability &right)
{
  G4Exception("G4N16GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4N16GEMProbability &right)
{
  G4Exception("G4N16GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4N16GEMProbability::operator==(const G4N16GEMProbability &right) const
{
  return false;
}
