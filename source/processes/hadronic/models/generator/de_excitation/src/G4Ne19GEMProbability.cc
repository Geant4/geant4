...
//
//
// $Id: G4Ne19GEMProbability.cc,v 1.1 2002/06/06 18:02:28 larazb Exp $
  ...
  G4GEMProbability(19,10,1.0/2.0) // A,Z,Spin
{
  ...
  ExcitSpins.push_back(1.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(355.0*keV));
...
G4Ne19GEMProbability::G4Ne19GEMProbability(const G4Ne19GEMProbability &right)
{
  G4Exception("G4Ne19GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4Ne19GEMProbability &right)
{
  G4Exception("G4Ne19GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4Ne19GEMProbability::operator==(const G4Ne19GEMProbability &right) const
{
  return false;
}
