...
//
//
// $Id: G4O15GEMProbability.cc,v 1.1 2002/06/06 18:03:25 larazb Exp $
  ...
  G4GEMProbability(15,8,1.0/2.0) // A,Z,Spin
{
  ...
  ExcitSpins.push_back(1.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(3.9*keV));

  ExcitEnergies.push_back(9487.0*keV);
  ExcitSpins.push_back(5.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(10.1*keV));
  ...
  ExcitSpins.push_back(3.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(8.8*keV));
  ...
  ExcitSpins.push_back(1.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(1185.0*keV));
  ...
  ExcitSpins.push_back(1.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(99.0*keV));
  ...
  ExcitSpins.push_back(5.0/2.0);
  ExcitLifetimes.push_back(hbar_Planck*log(2.0)/(77.0*keV));
...
G4O15GEMProbability::G4O15GEMProbability(const G4O15GEMProbability &right)
{
  G4Exception("G4O15GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4O15GEMProbability &right)
{
  G4Exception("G4O15GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4O15GEMProbability::operator==(const G4O15GEMProbability &right) const
{
  return false;
}
