...
//
//
// $Id: G4Mg23GEMProbability.cc,v 1.1 2002/06/06 18:02:10 larazb Exp $
...
G4Mg23GEMProbability::G4Mg23GEMProbability(const G4Mg23GEMProbability &right)
{
  G4Exception("G4Mg23GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4Mg23GEMProbability &right)
{
  G4Exception("G4Mg23GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4Mg23GEMProbability::operator==(const G4Mg23GEMProbability &right) const
{
  return false;
}
