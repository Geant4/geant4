...
//
//
// $Id: G4Na23GEMProbability.cc,v 1.1 2002/06/06 18:02:24 larazb Exp $
...
G4Na23GEMProbability::G4Na23GEMProbability(const G4Na23GEMProbability &right)
{
  G4Exception("G4Na23GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4Na23GEMProbability &right)
{
  G4Exception("G4Na23GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4Na23GEMProbability::operator==(const G4Na23GEMProbability &right) const
{
  return false;
}
