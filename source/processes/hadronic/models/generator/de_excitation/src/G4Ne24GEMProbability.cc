...
//
//
// $Id: G4Ne24GEMProbability.cc,v 1.1 2002/06/06 18:02:34 larazb Exp $
...
G4Ne24GEMProbability::G4Ne24GEMProbability(const G4Ne24GEMProbability &right)
{
  G4Exception("G4Ne24GEMProbability::copy_constructor meant to not be accessable");
}
...
operator=(const G4Ne24GEMProbability &right)
{
  G4Exception("G4Ne24GEMProbability::operator= meant to not be accessable");
  return *this;
}


G4bool G4Ne24GEMProbability::operator==(const G4Ne24GEMProbability &right) const
{
  return false;
}
