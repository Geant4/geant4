...
//
//
// $Id: G4CookShellCorrections.hh,v 1.2 2002/01/15 12:04:29 vlara Exp $
...
private:
  ...
  const static G4double ShellZTable[ZTableSize];
  
  const static G4double ShellNTable[NTableSize];
