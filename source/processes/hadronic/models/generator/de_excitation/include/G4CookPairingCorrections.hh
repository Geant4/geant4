...
//
//
// $Id: G4CookPairingCorrections.hh,v 1.2 2002/01/15 12:04:14 vlara Exp $
...
private:
  ...
  const static G4double PairingZTable[ZTableSize];
  
  const static G4double PairingNTable[NTableSize];
