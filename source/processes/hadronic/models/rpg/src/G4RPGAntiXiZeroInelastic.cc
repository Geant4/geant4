...
// ********************************************************************
//
// $Id: G4RPGAntiXiZeroInelastic.cc 94214 2015-11-09 08:18:05Z gcosmo $
//
//
...
G4HadFinalState*
G4RPGAntiXiZeroInelastic::ApplyYourself( const G4HadProjectile &aTrack,
...
{ 
  ...
  if( verboseLevel > 1 )
  {
    ...
    G4cout << "G4RPGAntiXiZeroInelastic::ApplyYourself called" << G4endl;
...
void G4RPGAntiXiZeroInelastic::Cascade(
   ...
   G4bool &quasiElastic )
{
  // Derived from H. Fesefeldt's original FORTRAN code CASAX0
