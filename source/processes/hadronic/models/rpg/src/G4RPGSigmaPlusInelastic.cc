...
// ********************************************************************
//
// $Id: G4RPGSigmaPlusInelastic.cc 94214 2015-11-09 08:18:05Z gcosmo $
//
...
G4HadFinalState*
G4RPGSigmaPlusInelastic::ApplyYourself( const G4HadProjectile &aTrack,
                                         G4Nucleus &targetNucleus )
{
  ...
  if( verboseLevel > 1 )
  {
    ...
    G4cout << "G4RPGSigmaPlusInelastic::ApplyYourself called" << G4endl;
...
void G4RPGSigmaPlusInelastic::Cascade(
   ...
   G4bool &quasiElastic )
{
  // Derived from H. Fesefeldt's original FORTRAN code CASSP
  //
