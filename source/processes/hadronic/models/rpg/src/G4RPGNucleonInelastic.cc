...
__thread G4double G4RPGNucleonInelastic::pPtot[30];

// p p multiplicities as a function of kinetic energy
__thread G4double G4RPGNucleonInelastic::t1_dSigma_dMult[8][30];
...
__thread G4double G4RPGNucleonInelastic::pNtot[30];

// p n multiplicities as a function of kinetic energy
__thread G4double G4RPGNucleonInelastic::t0_dSigma_dMult[8][30];
