...
G4HadFinalState*
G4RPGAntiXiMinusInelastic::ApplyYourself( const G4HadProjectile &aTrack,
...
{ 
  ...
  G4DynamicParticle *originalTarget = targetNucleus.ReturnTargetParticle();
    ...
    if( verboseLevel > 1 )
    {
      ...
      G4cout << "G4RPGAntiXiMinusInelastic::ApplyYourself called" << G4endl;
...
void G4RPGAntiXiMinusInelastic::Cascade(
   ...
   G4bool &quasiElastic )
{
  // Derived from H. Fesefeldt's original FORTRAN code CASAXM
