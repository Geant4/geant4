...
__thread G4double G4RPGPionInelastic::pipPtot[30];

// pi+ multiplicities as a function of kinetic energy
__thread G4double G4RPGPionInelastic::t32_dSigma_dMult[8][30];
...
// Total pi- cross section as a function of kinetic energy
__thread G4double G4RPGPionInelastic::pimPtot[30];

// pi- multiplicities as a function of kinetic energy
__thread G4double G4RPGPionInelastic::t12_dSigma_dMult[8][30];
