...
#include "G4RPGInelastic.hh"
 ...
 protected:
   ...
   static __thread G4double pipPtot[30];
   static __thread G4double pimPtot[30];
   static __thread G4double t12_dSigma_dMult[8][30];
   static __thread G4double t32_dSigma_dMult[8][30];
