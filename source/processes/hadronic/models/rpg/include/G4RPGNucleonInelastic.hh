...
#include "G4RPGInelastic.hh"
 ...
 protected:
   ...
   static __thread G4double pPtot[30];
   static __thread G4double pNtot[30];
   static __thread G4double t1_dSigma_dMult[8][30];
   static __thread G4double t0_dSigma_dMult[8][30];
