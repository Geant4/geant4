...
class Vektor
{
  ...
  friend std::ostream& operator<<(std::ostream& o,const Vektor& v) { o << "("; for (int k=1; k<v.N; k++) o << v[k] << ","; o << v[v.N] << ")"; return o; }
  friend std::istream& operator>>(std::istream& in,Vektor& v);
...
class Matrize
{
  friend std::ostream& operator<<(std::ostream& o,const Matrize& A);
