...
public:
  ...
  virtual void whatAmI(std::ostream& o) { o << "Error..."; }
...
public:
  ...
  void whatAmI(std::ostream& o) { o << "half space (L = " << L << ")"; }
...
public:
  ...
  void whatAmI(std::ostream& o) { o << "Box (L = " << L << ")"; }
...
public:
  ...
  void whatAmI(std::ostream& o) { o << "Sphere (R = " << R << ")"; }
...
public:
  ...
  void whatAmI(std::ostream& o) { o << "Tube (R = " << R << ",L = " << L << ")"; }
