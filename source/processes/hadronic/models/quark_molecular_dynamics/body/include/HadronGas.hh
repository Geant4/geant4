...
public:
  ...
  DistBase* K;
public:
  gasEnsemble(DistBase* K_,std::vector<ParticleType*>& List_) : List(List_),K(K_) {}
...
{
public:
  grandCanonicalEnsemble( DistBase* K_,std::vector<ParticleType*>& List_) 
...
{
public:
  canonicalEnsemble( DistBase* K_,std::vector<ParticleType*>& List_) 
    : gasEnsemble(K_,List_) {}
