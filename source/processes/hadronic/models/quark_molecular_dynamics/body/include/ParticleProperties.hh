...
{
  friend std::ostream& operator<<(std::ostream& o,const QuantumState& p) { o << p.B() << ": " << p.Spin() << "  " << p.Isospin() << " : " << p.Spin3() << "  " << p.Iso3() << "  "; return o; }
...
{
  friend std::ostream& operator<<(std::ostream& o,const ParticleProperties& p) { p.writeOut(o); return o; }
