...
//
//
// $Id: G4RunManager.cc,v 1.1 2007-09-06 22:19:22 tinslay Exp $
...
G4RunManager::G4RunManager()
  :userDetector(0),physicsList(0),physicsBiasing(0),
...
G4RunManager::~G4RunManager()
{
  ...
  if(physicsBiasing)
  {
    delete physicsBiasing;
    if(verboseLevel>1) G4cout << "UserPhysicsBiasing deleted." << G4endl;
  }
  if(userRunAction)
  {
