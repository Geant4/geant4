...
//
//
// $Id: G4RunManager.hh,v 1.1 2007-09-06 22:19:22 tinslay Exp $
...
class G4RunManager
{
  ...
  public: // with description
    ...
    inline void SetUserInitialization(G4VUserPhysicsBiasing* userInit)
    {
      physicsBiasing = userInit;
      kernel->SetBiasing(userInit);
    }
