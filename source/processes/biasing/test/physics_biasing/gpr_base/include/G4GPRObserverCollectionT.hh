...
// ********************************************************************
//
// $Id: G4GPRObserverCollectionT.hh,v 1.1 2007-07-27 22:13:08 tinslay Exp $
...
//
// where "Arguments" are those specified in the G4GPRTypeList which is used
// as the first template parameter.
// 
// J. Tinslay, June 2007. Creation - basically rename G4Signal.  
//
#ifndef G4GPROBSERVERCOLLECTIONT_HH
#define G4GPROBSERVERCOLLECTIONT_HH
...
public:
  ...
  // to select the operator corresponding to the number of arguments declared in the G4GPRTypeList
