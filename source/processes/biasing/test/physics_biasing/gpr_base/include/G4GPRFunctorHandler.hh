...
// ********************************************************************
//
// $Id: G4GPRFunctorHandler.hh,v 1.2 2007-09-06 22:07:04 tinslay Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
// 
// J. Tinslay, May 2007. Creation. Variation on Loki style functor handler:
//                       "Modern C++ Design, Andrei Alexandrescu"
#ifndef G4GPRFUNCTORHANDLER_HH
#define G4GPRFUNCTORHANDLER_HH

#include "G4GPRFunctorImpl.hh"

template <typename ParentFunctor, typename Fun>
class G4GPRFunctorHandler : public ParentFunctor::Impl {
...
public:
  ...
  G4GPRFunctorHandler(const Identifier& id, const Fun& fun) 
