...
// ********************************************************************
//
// $Id: regionTest_ThreePhysicsLists.cc,v 1.1 2007-08-30 19:37:45 tinslay Exp $
...
int main(int argc, char** argv) {
  ...
  physicsListTrigger->G4GPRTriggerManagerT<G4GPRScopes::Geometry::NewRegion>::Register(&RegionA::Trigger, listA, 
										       &G4GPRPhysicsList::FlipState, listA->GetState());
  
  physicsListTrigger->G4GPRTriggerManagerT<G4GPRScopes::Geometry::NewRegion>::Register(&RegionB::Trigger, listB, 
										       &G4GPRPhysicsList::FlipState, listA->GetState());
