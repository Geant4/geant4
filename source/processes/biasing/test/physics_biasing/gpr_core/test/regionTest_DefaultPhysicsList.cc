...
// ********************************************************************
//
// $Id: regionTest_DefaultPhysicsList.cc,v 1.3 2007-09-11 03:01:44 tinslay Exp $
...
int main(int argc, char** argv) {
  ...
  triggerStore->G4GPRTriggerManagerT<G4GPRTriggerTypes::Geometry::NewRegion>::Register(&RegionA::Trigger, atRestDoIt_A, 
										 &G4GPRSeedT<G4GPRProcessLists::AtRestDoIt>::ChangeState);
  triggerStore->G4GPRTriggerManagerT<G4GPRTriggerTypes::Geometry::NewRegion>::Register(&RegionB::Trigger, atRestDoIt_B, 
										 &G4GPRSeedT<G4GPRProcessLists::AtRestDoIt>::ChangeState);
  ...
  triggerStore->G4GPRTriggerManagerT<G4GPRTriggerTypes::Geometry::NewRegion>::Register(&RegionA::Trigger, node1, &G4GPRNode::FlipState);
  triggerStore->G4GPRTriggerManagerT<G4GPRTriggerTypes::Geometry::NewRegion>::Register(&RegionB::Trigger, node2, &G4GPRNode::FlipState);
