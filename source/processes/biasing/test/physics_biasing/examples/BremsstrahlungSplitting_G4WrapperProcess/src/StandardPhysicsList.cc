...
// ********************************************************************
//
// $Id: StandardPhysicsList.cc,v 1.1 2007-05-24 21:57:03 tinslay Exp $
...
StandardPhysicsList::StandardPhysicsList(const G4String& name)
  :G4VPhysicsConstructor(name)
{}

StandardPhysicsList::~StandardPhysicsList() {}

void StandardPhysicsList::ConstructProcess()
{
