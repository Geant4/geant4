...
// ********************************************************************
//
// $Id: G4TypeTraits.hh,v 1.1 2007-05-25 19:14:37 tinslay Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
// 
// Jane Tinslay, May 2007. Creation. Loki style type traits:
//                         "Modern C++ Design, Andrei Alexandrescu"   
//
#ifndef G4TYPETRAITS_HH
#define G4TYPETRAITS_HH
...
private:
  ...
  {
    enum { result = false };
    typedef G4NullType PointeeType;
  };
