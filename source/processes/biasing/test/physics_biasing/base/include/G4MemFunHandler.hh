...
// ********************************************************************
//
// $Id: G4MemFunHandler.hh,v 1.1 2007-05-25 19:14:36 tinslay Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
// 
// Jane Tinslay, May 2007. Creation. Variation on Loki style 
//                         member function functor handler:
//                         "Modern C++ Design, Andrei Alexandrescu"
#ifndef G4MEMFUNHANDLER_HH
#define G4MEMFUNHANDLER_HH

template <typename ParentFunctor, typename PointerToObj, 
	  typename PointerToMemFn>
class G4MemFunHandler : public ParentFunctor::Impl {
...
public:
  ...
  G4MemFunHandler(const Identifier& id, const PointerToObj& pObj, PointerToMemFn pMemFn)
