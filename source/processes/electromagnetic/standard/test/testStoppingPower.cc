...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  << dedx*gram/(dens*MeV*cm2) << " MeV/g/cm2 " << G4endl;
  
  G4SimpleMaterialStopping mS1;
  G4double dedx1 = mS1.GetDEDX(3,0,.025*MeV*6.941);
  G4String matN1 = mS1.GetMaterialName(0);
  G4double dens1 = mS1.GetDensity(0);
  G4cout << "DEDX for Z=3 in " << matN1 << " is "<< dedx1*mm/MeV << " MeV/mm    " 
  << dedx1*gram/(dens1*MeV*cm2) << " MeV/g/cm2 " << G4endl;
   
     
  G4IronStopping mS2;
  G4double dedx2 = mS2.GetDEDX(3,.025*MeV*55.847);
  G4String matN2 = mS2.GetMaterialName(0);
  G4double dens2 = mS2.GetDensity(0);
  G4cout << "DEDX for Z=26 in " << matN2 << " is "<< dedx2*mm/MeV << " MeV/mm    " 
  << dedx2*gram/(dens2*MeV*cm2) << " MeV/g/cm2 " << G4endl;
