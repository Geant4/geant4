...
// and all its terms.
//
// $Id: G4VeEnergyLossPlus.hh,v 1.1 2000-04-25 14:33:03 maire Exp $
...
#ifndef G4VeEnergyLossPlus_h
#define G4VeEnergyLossPlus_h 1
...
class G4VeEnergyLossPlus : public G4VEnergyLoss
 
{
  public:
 
    G4VeEnergyLossPlus(const G4String& );
  ...
  private:
    ...
    G4VeEnergyLossPlus & operator=(const G4VeEnergyLossPlus &right);
 ...
 protected:
    ...
    //processes inherited from G4VeEnergyLossPlus 
...
#include "G4VeEnergyLossPlus.icc"
