...
// ********************************************************************
//
// $Id: G4eBremsstrahlung.hh,v 1.35 2007-05-22 17:34:36 vnivanch Exp $
...
inline void G4eBremsstrahlung::SecondariesPostStep(std::vector<G4DynamicParticle*>* newp,
						   G4VEmModel* model,
						   ...
						   G4double& tcut)
{
  ...
  model->SampleSecondaries(newp, couple, dp, tcut);
