...
// ********************************************************************
//
// $Id: G4hIonisation70.hh,v 1.1 2005-02-26 22:01:07 vnivanch Exp $
...
#ifndef G4hIonisation70_h
#define G4hIonisation70_h 1
...
class G4hIonisation70 : public G4VEnergyLossProcess
{

public:

  G4hIonisation70(const G4String& name = "hIoni");

  virtual ~G4hIonisation70();
...
private:
  ...
  G4hIonisation70 & operator=(const G4hIonisation70 &right);
  G4hIonisation70(const G4hIonisation70&);
...
inline G4bool G4hIonisation70::IsApplicable(const G4ParticleDefinition& p)
{
...
inline G4double G4hIonisation70::MinPrimaryEnergy(const G4ParticleDefinition*,
                                                   const G4Material*,
                                                         G4double cut)
{
...
inline G4double G4hIonisation70::MaxSecondaryEnergy(const G4DynamicParticle* dynParticle)
{
...
inline std::vector<G4Track*>*  G4hIonisation70::SecondariesAlongStep(
                           const G4Step&   step,
	             	         G4double& tmax,
			         G4double& eloss,
                                 G4double& kinEnergy)
...
inline void G4hIonisation70::SecondariesPostStep(
                                                  G4VEmModel* model,
