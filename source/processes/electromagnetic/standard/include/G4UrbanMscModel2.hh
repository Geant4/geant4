...
// ********************************************************************
//
// $Id: G4UrbanMscModel2.hh,v 1.1 2008-03-06 18:34:19 vnivanch Exp $
...
class G4UrbanMscModel2 : public G4VEmModel
{

public:

  G4UrbanMscModel2(G4double facrange, G4double dtrl, G4double lambdalimit, 
...
inline
void G4UrbanMscModel2::SetLateralDisplasmentFlag(G4bool val) 
{ 
  latDisplasment = val;
}
...
inline
void G4UrbanMscModel2::SetSkin(G4double val) 
{ 
  skin = val;
...
inline
void G4UrbanMscModel2::SetRangeFactor(G4double val) 
{ 
  facrange = val;
}
...
inline
void G4UrbanMscModel2::SetGeomFactor(G4double val) 
{ 
  facgeom = val;
}
...
inline
void G4UrbanMscModel2::SetStepLimitType(G4MscStepLimitType val) 
{ 
