...
// ********************************************************************
//
// $Id: G4MultipleScattering81.cc,v 1.2 2006-03-03 19:40:36 vnivanch Exp $
...
#include "G4MultipleScattering81.hh"
...
G4MultipleScattering81::G4MultipleScattering81(const G4String& processName)
  : G4VMultipleScattering81(processName)
{
...
G4MultipleScattering81::~G4MultipleScattering81()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4bool G4MultipleScattering81::IsApplicable (const G4ParticleDefinition& p)
{
...
void G4MultipleScattering81::MscStepLimitation(G4bool algorithm, G4double factor) 
{
...
void G4MultipleScattering81::InitialiseProcess
...
void G4MultipleScattering81::PrintInfo()
{
