...
// ********************************************************************
//
// $Id: G4eBremsstrahlungModel.cc,v 1.22 2005-03-28 23:07:54 vnivanch Exp $
...
{
  if(p) SetParticle(p);
  highKinEnergy = HighEnergyLimit(particle);
  lowKinEnergy  = LowEnergyLimit(particle);
...
std::vector<G4DynamicParticle*>* G4eBremsstrahlungModel::PostStepDoIt(
                                const G4MaterialCutsCouple* couple,
