...
// and all its terms.
//
// $Id: G4eIonisationPlus.cc,v 1.10 2000-04-27 14:06:05 maire Exp $
...
G4double G4eIonisationPlus::LowerBoundLambda = 1.*keV ;
G4double G4eIonisationPlus::UpperBoundLambda = 100.*TeV ;
G4int	 G4eIonisationPlus::NbinLambda = 100 ;
