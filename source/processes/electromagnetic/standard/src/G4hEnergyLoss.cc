...
// and all its terms.
//
// $Id: G4hEnergyLoss.cc,v 1.13 1999-08-16 09:56:54 maire Exp $
...
G4int G4hEnergyLoss::NumberOfProcesses = 1 ;
...
G4PhysicsTable* G4hEnergyLoss::theRangeTable = NULL ;
G4PhysicsTable* G4hEnergyLoss::theInverseRangeTable = NULL ;
G4PhysicsTable* G4hEnergyLoss::theLabTimeTable = NULL ;
G4PhysicsTable* G4hEnergyLoss::theProperTimeTable = NULL ;

G4PhysicsTable* G4hEnergyLoss::theRangeCoeffATable = NULL ;
G4PhysicsTable* G4hEnergyLoss::theRangeCoeffBTable = NULL ;
G4PhysicsTable* G4hEnergyLoss::theRangeCoeffCTable = NULL ;
...
G4double G4hEnergyLoss::ParticleMass;
G4double G4hEnergyLoss::ptableElectronCutInRange = 0.0*mm ;
G4double G4hEnergyLoss::pbartableElectronCutInRange = 0.0*mm ;

G4double G4hEnergyLoss::Mass,
         G4hEnergyLoss::taulow, 
         G4hEnergyLoss::tauhigh, 
         G4hEnergyLoss::ltaulow, 
         G4hEnergyLoss::ltauhigh; 

G4double G4hEnergyLoss::dRoverRange = 0.20 ;
G4double G4hEnergyLoss::finalRange = 200.*micrometer ;

G4double     G4hEnergyLoss::c1lim = dRoverRange ;
G4double     G4hEnergyLoss::c2lim = 2.*(1.-dRoverRange)*finalRange ;
G4double     G4hEnergyLoss::c3lim = -(1.-dRoverRange)*finalRange*finalRange;
...
void G4hEnergyLoss::BuildRangeTable(
                             const G4ParticleDefinition& aParticleType)
...
void G4hEnergyLoss::BuildTimeTables(
                             const G4ParticleDefinition& aParticleType)
{
  const G4MaterialTable* theMaterialTable=
                                 G4Material::GetMaterialTable();
...
void G4hEnergyLoss::BuildRangeVector(G4int materialIndex,
...
void G4hEnergyLoss::BuildLabTimeVector(G4int materialIndex,
...
void G4hEnergyLoss::BuildProperTimeVector(G4int materialIndex,
                                     G4PhysicsLogVector* timeVector)
...
G4double G4hEnergyLoss::RangeIntLin(G4PhysicsVector* physicsVector,
                                    G4int nbin)
...
G4double G4hEnergyLoss::RangeIntLog(G4PhysicsVector* physicsVector,
                                    G4int nbin)
...
G4double G4hEnergyLoss::LabTimeIntLog(G4PhysicsVector* physicsVector,
                                    G4int nbin)
//  num. integration, logarithmic binning
{
  G4double ltt,dltau,Value,ui,taui,ti,lossi,ci;
...
G4double G4hEnergyLoss::ProperTimeIntLog(G4PhysicsVector* physicsVector,
                                    G4int nbin)
//  num. integration, logarithmic binning
{
  G4double ltt,dltau,Value,ui,taui,ti,lossi,ci;
...
void G4hEnergyLoss::BuildRangeCoeffATable(
                            const G4ParticleDefinition& aParticleType)
...
void G4hEnergyLoss::BuildRangeCoeffBTable(
                            const G4ParticleDefinition& aParticleType)
// Build tables of coefficients for the energy loss calculation
...
void G4hEnergyLoss::BuildRangeCoeffCTable(
                            const G4ParticleDefinition& aParticleType)
// Build tables of coefficients for the energy loss calculation
...
void G4hEnergyLoss::BuildInverseRangeTable(
                             const G4ParticleDefinition& aParticleType)
...
void G4hEnergyLoss::InvertRangeVector(G4int materialIndex,
                                     G4PhysicsLogVector* aVector)
