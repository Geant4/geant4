...
for(i=0; i<53; i++) {pv->PutValues(i,E[i],H_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv);
for(i=0; i<53; i++) {pv->PutValues(i,E[i],He_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv);
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Be_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]);pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],C_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],N_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) { pv->PutValues(i,E[i],O_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ne_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Al_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Si_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ar_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ti_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++){pv->PutValues(i,E[i],Fe_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ni_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Cu_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ge_Fe[i]*dens[j]*factor);}j++;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); 
for(i=0; i<53; i++){pv->PutValues(i,E[i],Kr_Fe[i]*dens[j]*factor);}j++;
