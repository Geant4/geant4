...
// ********************************************************************
//
// $Id: G4IronStopping.cc,v 1.1 2008-08-08 18:52:40 antoni Exp $
...
G4double G4IronStopping::GetDEDX(G4int idx, G4double kinEnergy)
{
  G4double res = 0.0;
  if(idx < 0 || idx > 15) return res; 
  G4bool b;
...
G4double G4IronStopping::GetDensity(G4int idx)
{
...
G4String G4IronStopping::GetMaterialName(G4int idx)
{
  G4String s = "";
  if( idx< 0 || idx> 15) return s;
  return MatName[idx];
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4PhysicsVector* G4IronStopping::GetPhysicsVector(G4int idx)
{
...
//..List of ions
G4double factor = 55.847*MeV*cm2/milligram;
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],H_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv);for(i=0; i<53; i++) {pv->PutValues(i,E[i],He_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv);for(i=0; i<53; i++) {pv->PutValues(i,E[i],Be_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]);pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],C_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],N_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) { pv->PutValues(i,E[i],O_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ne_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],Al_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],Si_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ar_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ti_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++){pv->PutValues(i,E[i],Fe_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ni_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],Cu_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++) {pv->PutValues(i,E[i],Ge_Fe[i]*dens[i]*factor);}
...
pv =new G4LPhysicsFreeVector(53,E[0],E[52]); pv->SetSpline(spline); dedx.push_back(pv); for(i=0; i<53; i++){pv->PutValues(i,E[i],Kr_Fe[i]*dens[i]*factor);}
