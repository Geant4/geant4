...
// and all its terms.
//
// $Id: G4LowEnergyGammaConversion.cc,v 1.1 1999-01-08 14:16:33 gunter Exp $
...
G4LowEnergyGammaConversion::G4LowEnergyGammaConversion(const G4String& processName)
  : G4GammaConversion(processName),            // initialization
...
G4double G4LowEnergyGammaConversion::DataLogInterpolation(G4double Argument, G4double AtomicNumber, G4PhysicsTable* Table){
...
G4Element* G4LowEnergyGammaConversion::SelectRandomAtom(const G4DynamicParticle* aDynamicGamma,
...
G4int G4LowEnergyGammaConversion::FindBinLocation(G4double arg, G4PhysicsVector* vec){
