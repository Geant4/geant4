...
G4MscModel80::~G4MscModel80()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void G4MscModel80::Initialise(const G4ParticleDefinition* p,
			    const G4DataVector&)
{
...
G4double G4MscModel80::CrossSectionPerVolume(const G4Material* material,
...
G4double G4MscModel80::GeomPathLength(
...
G4double G4MscModel80::TrueStepLength(G4double geomStepLength)
{
...
std::vector<G4DynamicParticle*>* G4MscModel80::SampleSecondaries(
                                      ...
                                      G4double safety)
{
  ...
  /*
    ...
    G4cout << "G4MscModel80: Sample secondary; E(MeV)= " << kineticEnergy/MeV
...
G4double G4MscModel80::SampleCosineTheta(G4double trueStepLength,
                                         G4double KineticEnergy)
{
  G4double cth = 1. ;
...
G4double G4MscModel80::SampleDisplacement()
{
...
G4double G4MscModel80::LatCorrelation()
{
  const G4double kappa = 2.5;
  const G4double kappami1 = kappa-1.;
