...
// ********************************************************************
//
// $Id: G4hIonisation70.cc,v 1.1 2005-02-26 22:01:07 vnivanch Exp $
...
G4hIonisation70::G4hIonisation70(const G4String& name)
...
G4hIonisation70::~G4hIonisation70()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void G4hIonisation70::InitialiseEnergyLossProcess(const G4ParticleDefinition* part,
...
void G4hIonisation70::PrintInfoDefinition()
{
  G4VEnergyLossProcess::PrintInfoDefinition();

  G4cout << "      Bether-Bloch model for Escaled > " << eth << " MeV, "
...
void G4hIonisation70::SetSubCutoff(G4bool val)
{
  subCutoff = val;
}
