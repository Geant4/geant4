...
G4ThreadLocal G4bool G4PolarizedPairProductionCrossSection::scrnInitialized=false;
G4ThreadLocal G4double G4PolarizedPairProductionCrossSection::SCRN [3][20];  
