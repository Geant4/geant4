...
G4ThreadLocal G4bool G4PolarizedBremsstrahlungCrossSection::scrnInitialized=false;
G4ThreadLocal G4double G4PolarizedBremsstrahlungCrossSection::SCRN [3][20];  
