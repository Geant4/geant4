...
bool __1DSortOut::sortOutNDim::operator() (G4KDNode_Base* const& lhs, G4KDNode_Base* const& rhs) //const
{
	   return (*lhs)[fDimension] < (*rhs)[fDimension];
}


__1DSortOut::__1DSortOut(size_t dimension) : fSortOutNDim(dimension)
{}
