...
G4TrackKillerMessenger::G4TrackKillerMessenger(G4NeutronKiller* p)
  :killer(p)
{
...
G4TrackKillerMessenger::~G4TrackKillerMessenger()
{
  delete eCmd;
  delete tCmd;
  delete dir;  
...
void G4TrackKillerMessenger::SetNewValue(G4UIcommand* command, G4String val)
{ 
  if (command == eCmd)
