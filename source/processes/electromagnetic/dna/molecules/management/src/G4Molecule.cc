 ...
 */
//////////////////////////
G4Molecule::G4Molecule(G4MoleculeDefinition * moleculeDefinition) : G4VUserTrackInformation("G4Molecule"), G4IT()
//////////////////////////
{
...
{
	fpMolecularConfiguration = G4MolecularConfiguration::GetMolecularConfiguration(moleculeDefinition, charge);
}
