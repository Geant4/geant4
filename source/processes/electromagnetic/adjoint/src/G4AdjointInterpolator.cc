...
{ if(theInstance == 0) {
    static G4ThreadLocal G4AdjointInterpolator *interpolator_G4MT_TLS_ = 0 ; if (!interpolator_G4MT_TLS_) interpolator_G4MT_TLS_ = new  G4AdjointInterpolator  ;  G4AdjointInterpolator &interpolator = *interpolator_G4MT_TLS_;
