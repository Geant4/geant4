...
G4ThreadLocal G4int    G4ForwardXrayTR::fSympsonNumber =  100;

G4ThreadLocal G4double G4ForwardXrayTR::fTheMinEnergyTR = 1.0*keV;
G4ThreadLocal G4double G4ForwardXrayTR::fTheMaxEnergyTR = 100.0*keV;
G4ThreadLocal G4double G4ForwardXrayTR::fTheMaxAngle    = 1.0e-3;
G4ThreadLocal G4double G4ForwardXrayTR::fTheMinAngle    =  5.0e-6;
G4ThreadLocal G4int    G4ForwardXrayTR::fBinTR          =  50;

G4ThreadLocal G4double G4ForwardXrayTR::fMinProtonTkin = 100.0*GeV;
G4ThreadLocal G4double G4ForwardXrayTR::fMaxProtonTkin = 100.0*TeV;
G4ThreadLocal G4int    G4ForwardXrayTR::fTotBin        =  50;

G4ThreadLocal G4double G4ForwardXrayTR::fPlasmaCof = 4.0*pi*fine_structure_const*
                                       hbarc*hbarc*hbarc/electron_mass_c2;

G4ThreadLocal G4double G4ForwardXrayTR::fCofTR     = fine_structure_const/pi;
