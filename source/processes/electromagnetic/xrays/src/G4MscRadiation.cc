...
G4double G4MscRadiation::GetMeanFreePath(const G4Track& aTrack,
...
void G4MscRadiation::BuildPhysicsTable(const G4ParticleDefinition& pd)
{
  if(pd.GetPDGCharge()  == 0.) 
  {
    G4Exception("G4MscRadiation::BuildPhysicsTable", "Notification", JustWarning,
...
void G4MscRadiation::BuildTable()
{
  ...
  for( iTkin = 0; iTkin < fTotBin; iTkin++ )      // Lorentz factor loop
  {
	...
	//       this,&G4MscRadiation::AngleXTRdEdx,
...
void G4MscRadiation::BuildEnergyTable()
{
}
...
void G4MscRadiation::BuildAngleTable()
{
  G4int iTkin, iTR;
  G4double  energy;
...
G4PhysicsFreeVector* G4MscRadiation::GetAngleVector(G4double energy, G4int n)
{
...
void G4MscRadiation::BuildGlobalAngleTable()
{
  G4int iTkin, iTR, iPlace;
  G4double radiatorCof = 1.0;           // for tuning of XTR yield
  G4double angleSum;
...
G4VParticleChange* G4MscRadiation::PostStepDoIt( const G4Track& aTrack, 
		                                  const G4Step&  aStep   )
{
  G4int iTkin, iPlace;
  ...
  if( aTrack.GetVolume()->GetLogicalVolume() != fEnvelope ) 
  {
    if(verboseLevel > 0)
    {
      G4cout<<"Go out from G4MscRadiation::PostStepDoIt: wrong volume "<<G4endl;
    }
  ...
  else
  {
    ...
    if(iTkin == 0) // Tkin is too small, neglect of TR photon generation
    {
      if( verboseLevel > 0)
      {
        G4cout<<"Go out from G4MscRadiation::PostStepDoIt:iTkin = "<<iTkin<<G4endl;
      }
      return G4VDiscreteProcess::PostStepDoIt(aTrack, aStep);
    } 
    else          // general case: Tkin between two vectors of the material
...
G4complex G4MscRadiation::OneInterfaceXTRdEdx( G4double energy,
                                           G4double gamma,
                                           G4double varAngle ) 
{
...
G4double G4MscRadiation::SpectralAngleXTRdEdx(G4double varAngle)
{
...
G4double G4MscRadiation::SpectralXTRdEdx(G4double energy)
{
  G4int i, iMax = 8;
  G4double result = 0.0;
  ...
  for( i = 0; i < iMax-1; i++ )
  {
    result += integral.Legendre96(this,&G4MscRadiation::SpectralAngleXTRdEdx,
    			   lim[i],lim[i+1]);
    // result += integral.Legendre10(this,&G4MscRadiation::SpectralAngleXTRdEdx,
    //			   lim[i],lim[i+1]);
  }
...
G4double G4MscRadiation::AngleSpectralXTRdEdx(G4double energy)
{
...
G4double G4MscRadiation::AngleXTRdEdx(G4double varAngle) 
{
  ...
  // fVarAngle = varAngle;
  // G4Integrator<G4MscRadiation,G4double(G4MscRadiation::*)(G4double)> integral;
  // result = integral.Legendre10(this,&G4MscRadiation::AngleSpectralXTRdEdx,
...
G4double G4MscRadiation::GetPlateFormationZone( G4double omega ,
                                                G4double gamma ,
                                                G4double varAngle    ) 
{
  G4double cof, lambda;
...
G4complex G4MscRadiation::GetPlateComplexFZ( G4double omega ,
                                             G4double gamma ,
                                             G4double varAngle    ) 
{
...
void G4MscRadiation::ComputePlatePhotoAbsCof() 
{
...
G4double G4MscRadiation::GetGasFormationZone( G4double omega ,
                                              G4double gamma ,
                                              G4double varAngle   ) 
{
  G4double cof, lambda;
...
G4complex G4MscRadiation::GetGasComplexFZ( G4double omega ,
                                           G4double gamma ,
                                           G4double varAngle    ) 
{
  G4double cof, length,delta, real, image;
...
void G4MscRadiation::ComputeGasPhotoAbsCof() 
{
  const G4MaterialTable* theMaterialTable = G4Material::GetMaterialTable();
...
G4double G4MscRadiation::GetPlateZmuProduct( G4double omega ,
                                             G4double gamma ,
                                             G4double varAngle   ) 
{
...
G4double G4MscRadiation::GetGasZmuProduct( G4double omega ,
                                             G4double gamma ,
                                             G4double varAngle   ) 
{
...
G4double G4MscRadiation::GetPlateCompton(G4double omega) 
{
...
G4double G4MscRadiation::GetGasCompton(G4double omega) 
{
  G4int i, numberOfElements;
  G4double xSection = 0., nowZ, sumZ = 0.;
...
G4double G4MscRadiation::GetStackFactor( G4double energy, G4double gamma,
                                                     G4double varAngle )
{
...
G4double G4MscRadiation::GetXTRenergy( G4int    iPlace, 
                                       G4double position, 
                                       G4int    iTransfer )
{
...
G4double G4MscRadiation::GetRandomAngle( G4double energyXTR, G4int iTkin )
{
  G4int iTR, iAngle;
...
G4double G4MscRadiation::GetAngleXTR( G4int    iPlace, 
                                       G4double position, 
                                       G4int    iTransfer )
{
  G4double x1, x2, y1, y2, result;
