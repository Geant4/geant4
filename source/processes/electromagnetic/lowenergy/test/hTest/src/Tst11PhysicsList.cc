...
// and all its terms.
//
// $Id: Tst11PhysicsList.cc,v 1.1 2000-10-21 17:45:43 vnivanch Exp $
   ...
   while ((*theParticleIterator)()) {
	 ...
	 */         
	 ...
	 G4LCapture* theCaptureModel = new G4LCapture;
      ...
      else if (particleName == "IonC12") {
         pmanager->AddDiscreteProcess(theElasticProcess);
         G4IonInelasticProcess* theInelasticProcess = 
                            new G4IonInelasticProcess("inelastic");
         G4LowEIonFragmentation* theFragmentationModel = 
                                 new G4LowEIonFragmentation();

         theInelasticProcess->RegisterMe(theFragmentationModel);
         G4CrossSectionDataStore * theStoreI =
            ((G4IonInelasticProcess*)theInelasticProcess)->GetCrossSectionDataStore();

         G4TripathiCrossSection * theIonData1 = new G4TripathiCrossSection();
         G4IonProtonCrossSection * theIonData2 = new G4IonProtonCrossSection();
         theStoreI->AddDataSet(theIonData1);
         theStoreI->AddDataSet(theIonData2);
