...
hTestEventActionMessenger::hTestEventActionMessenger(hTestEventAction* EvAct)
:eventAction(EvAct)
{ 
...
hTestEventActionMessenger::~hTestEventActionMessenger()
{
...
void hTestEventActionMessenger::SetNewValue(G4UIcommand * command,G4String newValue)
{ 
