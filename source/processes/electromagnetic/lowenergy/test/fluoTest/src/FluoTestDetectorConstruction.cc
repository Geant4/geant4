...
{  
  ...
  detectorMessenger = new FluoTestDetectorMessenger(this);
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
...
G4VPhysicalVolume* FluoTestDetectorConstruction::Construct()
{
  DefineMaterials();
...
void FluoTestDetectorConstruction::DefineMaterials()
{
  //define elements
...
G4VPhysicalVolume* FluoTestDetectorConstruction::ConstructApparate()
{
  ...
  if (Dia2Thickness > 0.)  
    {
      ...
      G4double x,y,z;
      x = Dia3Dist * cos(ThetaDia2);
      y =Dia3Dist * sin(ThetaDia2);
      z = 0.*cm;
  ...
  if(!HPGeSD)
    {
      HPGeSD = new FluoTestHPGeSD ("HPGeSD",this);
...
void FluoTestDetectorConstruction::SetOhmicNegMaterial(G4String materialChoice)
{
  // search the material by its name   
  G4Material* pttoMaterial = G4Material::GetMaterial(materialChoice);     
  if (pttoMaterial)
     {OhmicNegMaterial = pttoMaterial;
      logicOhmicNeg->SetMaterial(pttoMaterial); 
      PrintApparateParameters();
     }             
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....
void FluoTestDetectorConstruction::SetOhmicPosMaterial(G4String materialChoice)
{
  // search the material by its name   
  G4Material* pttoMaterial = G4Material::GetMaterial(materialChoice);     
  if (pttoMaterial)
     {OhmicPosMaterial = pttoMaterial;
      logicOhmicPos->SetMaterial(pttoMaterial); 
      PrintApparateParameters();
     }             
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void FluoTestDetectorConstruction::SetPixelMaterial(G4String materialChoice)
{
  // search the material by its name   
  G4Material* pttoMaterial = G4Material::GetMaterial(materialChoice);     
  if (pttoMaterial)
...
void FluoTestDetectorConstruction::SetOhmicNegThickness(G4double val)
{
  // change OhmicNeg thickness and recompute the Device parameters
  OhmicNegThickness = val;
}
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void FluoTestDetectorConstruction::SetOhmicPosThickness(G4double val)
{
  // change OhmicPos thickness and recompute the Device parameters
...
void FluoTestDetectorConstruction::SetNbOfPixelRows(G4int val)
{
  NbOfPixelRows = val;
}
...
void FluoTestDetectorConstruction::SetNbOfPixelColumns(G4int val)
{
  NbOfPixelColumns = val;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void FluoTestDetectorConstruction::SetNbOfPixels(G4int val)
{
  NbOfPixels = NbOfPixelColumns * NbOfPixelRows ;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....


void FluoTestDetectorConstruction::SetDia1Material(G4String materialChoice)
{
  // search the material by its name 
  G4Material* pttoMaterial = G4Material::GetMaterial(materialChoice);  
  if (pttoMaterial)
...
void FluoTestDetectorConstruction::SetDia2Material(G4String materialChoice)
{
  // search the material by its name 
  G4Material* pttoMaterial = G4Material::GetMaterial(materialChoice);  
  if (pttoMaterial)
...
void FluoTestDetectorConstruction::SetDia3Material(G4String materialChoice)
{
  // search the material by its name 
  G4Material* pttoMaterial = G4Material::GetMaterial(materialChoice);  
  if (pttoMaterial)
...
void FluoTestDetectorConstruction::SetDia2Thickness(G4double val)
{
  // change Sensor thickness 
  Dia2Thickness = val;
}
...
void FluoTestDetectorConstruction::SetDia3Thickness(G4double val)
{
  // change Sensor thickness 
  Dia3Thickness = val;
}
...
void FluoTestDetectorConstruction::SetSensorDistance(G4double val)
{
...
void FluoTestDetectorConstruction::SetDiaphragmDistance(G4double val)
{
  // change the distance between the sensor and the sample
  DistDia = val;
}  
...
void FluoTestDetectorConstruction::SetSiAzimuth(G4double val)
{
...
void FluoTestDetectorConstruction::SetHPGeAzimuth(G4double val)
{
  // change the angular displacement of the sensor from the X-axes
  ThetaHPGe = val;
}  
...
void FluoTestDetectorConstruction::SetDia1Azimuth(G4double val)
{
  // change the angular displacement of the sensor from the X-axes
  ThetaDia1 = val;
} 
...
void FluoTestDetectorConstruction::SetDia2Azimuth(G4double val)
{
  // change the angular displacement of the sensor from the X-axes
  ThetaDia2 = val;
} 
...
void FluoTestDetectorConstruction::SetDia3Azimuth(G4double val)
{
  // change the angular displacement of the sensor from the X-axes
  ThetaDia3 = val;
} 
...
void FluoTestDetectorConstruction::UpdateGeometry()
{
