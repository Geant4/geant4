...
myPhysicsList::myPhysicsList():  G4VUserPhysicsList()
{
 ...
 physicsListMessenger = new myPhysicsListMessenger(this);
 SetVerboseLevel(1);
}
...
void myPhysicsList::SetGELowLimit(G4double lowcut)
{
  if (verboseLevel >0){
...
void myPhysicsList::SetGammaLowLimit(G4double lowcut)
{
  if (verboseLevel >0){
    G4cout << "myPhysicsList::SetCuts:";
...
void myPhysicsList::SetElectronLowLimit(G4double lowcut)
{
  if (verboseLevel >0){
...
void myPhysicsList::SetCutForGamma(G4double cut)
{
  ResetCuts();
  cutForGamma = cut;
}

void myPhysicsList::SetCutForElectron(G4double cut)
{
  ResetCuts();
  cutForElectron = cut;
}

void myPhysicsList::SetCutForProton(G4double cut)
{
  ResetCuts();
  cutForProton = cut;
}

G4double myPhysicsList::GetCutForGamma() const
{
  return cutForGamma;
}
G4double myPhysicsList::GetCutForElectron() const
{
  return cutForElectron;
}

G4double myPhysicsList::GetCutForProton() const
{
  return cutForProton;
}
