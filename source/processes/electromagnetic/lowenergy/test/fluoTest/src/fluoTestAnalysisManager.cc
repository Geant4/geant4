...
void fluoTestAnalysisManager::InsertKEnergy(double gKe)
{
  histoGammaKenergy->fill(gKe);
}


void fluoTestAnalysisManager::InsertIoniEnergy(double Ioe)
{
 histoIoniEnergy->fill(Ioe);
}

void fluoTestAnalysisManager::InsertPhotoEnergy(double Phe)
{
 histoPhotoEnergy->fill(Phe);
}

void fluoTestAnalysisManager::InsertBremEnergy(double Bre)
  {
   histoBremEnergy->fill(Bre);
 }

void fluoTestAnalysisManager::InsertComptEnergy(double Coe)
  {
   histoComptEnergy->fill(Coe);
 }

void fluoTestAnalysisManager::InsertConvEnergy(double Cve)
  {
   histoConvEnergy->fill(Cve);
 }

void fluoTestAnalysisManager::InsertRaylEnergy(double Rae)
  {
  histoRaylEnergy->fill(Rae);
  }
void fluoTestAnalysisManager::InsertOutEnergy(double Goe)
{
 histoGammaOutEnergy->fill(Goe);
}

void fluoTestAnalysisManager::InserteKEnergy(double eKe)
{
  histoElecKenergy->fill(eKe);
}


void fluoTestAnalysisManager::InserteIoniEnergy(double eIoe)
{
 histoeIoniEnergy->fill(eIoe);
}

void fluoTestAnalysisManager::InsertePhotoEnergy(double ePhe)
{
 histoePhotoEnergy->fill(ePhe);
}

void fluoTestAnalysisManager::InserteBremEnergy(double eBre)
  {
   histoeBremEnergy->fill(eBre);
 }

void fluoTestAnalysisManager::InserteComptEnergy(double eCoe)
  {
   histoeComptEnergy->fill(eCoe);
 }

void fluoTestAnalysisManager::InserteConvEnergy(double eCve)
  {
   histoeConvEnergy->fill(eCve);
 }

void fluoTestAnalysisManager::InserteRaylEnergy(double eRae)
  {
  histoeRaylEnergy->fill(eRae);
  }
void fluoTestAnalysisManager::InserteOutEnergy(double Eoe)
{
