...
mySampleSD::mySampleSD(G4String name,
...
void mySampleSD::Initialize(G4HCofThisEvent*HCE)
{
  SamCollection = new mySensorHitsCollection
...
G4bool mySampleSD::ProcessHits(G4Step* aStep,G4TouchableHistory* ROhist)
{
  ...
  if (HitSID[0]==-1)
    { 
      mySensorHit* samHit = new mySensorHit();
...
void mySampleSD::EndOfEvent(G4HCofThisEvent* HCE)
{
  static G4int HCID = -1;
  if(HCID<0)
...
void mySampleSD::clear()
{} 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void mySampleSD::DrawAll()
{} 

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void mySampleSD::PrintAll()
{} 
