...
// ********************************************************************
//
// $Id: G4LowEnergyPolarizedRayleighTest.cc,v 1.1 2005-05-12 09:22:06 capra Exp $
...
G4Step * GenerateStep(const struct Options & options)
{
 ...
 momentumDirection.setRThetaPhi(1., pi * G4UniformRand(), twopi * G4UniformRand());
 ...
 G4DynamicParticle * dynamicPhoton(new G4DynamicParticle(G4Gamma::Gamma(), momentumDirection, std::exp(lnEnergyMin+(lnEnergyMax-lnEnergyMin)*G4UniformRand())));
