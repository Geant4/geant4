...
// Class description:
// Low Energy electromagnetic process, electron BremsstrahlungVI
// Further documentation available from http://www.ge.infn.it/geant4/lowE

// --------------------------------------------------------------


#ifndef G4LOWENERGYBREMSSTRAHLUNGVI_HH
#define G4LOWENERGYBREMSSTRAHLUNGVI_HH 1
...
class G4LowEnergyBremsstrahlungVI : public G4eLowEnergyLoss
{ 
public:
 
  G4LowEnergyBremsstrahlungVI(const G4String& processName = "LowEnBrem");
  
  ~G4LowEnergyBremsstrahlungVI();
...
private:
  ...
  G4LowEnergyBremsstrahlungVI(const G4LowEnergyBremsstrahlungVI& );
  G4LowEnergyBremsstrahlungVI& operator = (const G4LowEnergyBremsstrahlungVI& right);
