...
//
//
// $Id: G4LowEnergyOldIonisation.hh,v 1.1 2001-10-09 11:25:32 vnivanch Exp $
...
//
// Class description:
// Low Energy Electromagnetic process, electron OldIonisation
// Further documentation available from http://www.ge.infn.it/geant4/lowE

// ------------------------------------------------------------
 
#ifndef G4LowEnergyOldIonisation_h
#define G4LowEnergyOldIonisation_h 1
...
class G4LowEnergyOldIonisation : public G4eLowEnergyLoss{

public:
  
  G4LowEnergyOldIonisation(const G4String& processName = "LowEnergyIoni"); 
  
  ~G4LowEnergyOldIonisation();
...
private:
  ...
  G4LowEnergyOldIonisation & operator=(const G4LowEnergyOldIonisation &right);
  G4LowEnergyOldIonisation(const G4LowEnergyOldIonisation&);
...
#include "G4LowEnergyOldIonisation.icc"
