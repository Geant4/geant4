...
public:
  ...
  G4Livermore2012GammaConversionModel(const G4ParticleDefinition* p = 0, 
		     const G4String& nam = "Livermore2012Conversion");

  virtual ~G4Livermore2012GammaConversionModel();
