...
// ********************************************************************
//
// $Id: G4Penelope08BremsstrahlungFS.hh,v 1.1 2010-12-20 14:11:13 pandola Exp $
...
#ifndef G4PENELOPE08BREMSSTRAHLUNGFS_HH
#define G4PENELOPE08BREMSSTRAHLUNGFS_HH 1
...
private:
  ...
  //map of element data vs. Z. The element data is an array [57][33] with 57 energy 
  //points and 32 points in x. The 33-th column gives the total XS vs. E.
  std::map<const G4int,CLHEP::HepMatrix* > *theElementData;
