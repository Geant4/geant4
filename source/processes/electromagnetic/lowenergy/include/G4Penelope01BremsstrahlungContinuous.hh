...
// 
// -------------------------------------------------------------------
// $Id: G4Penelope01BremsstrahlungContinuous.hh,v 1.4 2008-12-09 15:04:05 pandola Exp $
...
// version 2001. It is used both for electrons and positrons
// --------------------------------------------------------------


#ifndef G4PENELOPE01BREMSSTRAHLUNGCONTINUOUS_HH
#define G4PENELOPE01BREMSSTRAHLUNGCONTINUOUS_HH 1
#include "globals.hh"
...
public:
  ...
  G4Penelope01BremsstrahlungContinuous(G4int Z,G4double energyCut, G4double energyMin, 
				     G4double energyMax,
