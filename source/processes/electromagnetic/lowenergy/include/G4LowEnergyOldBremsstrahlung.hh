...
//
//
// $Id: G4LowEnergyOldBremsstrahlung.hh,v 1.1 2001-10-09 11:25:31 vnivanch Exp $
...
//
//      ------------ G4LowEnergyOldBremsstrahlung physics process ------
...
//
// Class description:
// Low Energy electromagnetic process, OldBremsstrahlung
// Further documentation available from http://www.ge.infn.it/geant4/lowE

// ************************************************************

#ifndef G4LowEnergyOldBremsstrahlung_h
#define G4LowEnergyOldBremsstrahlung_h 1

#include "G4eLowEnergyLoss.hh"
#include "G4LowEnergyUtilities.hh"

class G4LowEnergyOldBremsstrahlung : public G4eLowEnergyLoss{
 
public:
 
  G4LowEnergyOldBremsstrahlung(const G4String& processName = "LowEnBrem");
  
  ~G4LowEnergyOldBremsstrahlung();
...
private:
  ...
  G4LowEnergyOldBremsstrahlung & operator=(const G4LowEnergyOldBremsstrahlung &right);
  
  G4LowEnergyOldBremsstrahlung(const G4LowEnergyOldBremsstrahlung&);
...
#include "G4LowEnergyOldBremsstrahlung.icc"
