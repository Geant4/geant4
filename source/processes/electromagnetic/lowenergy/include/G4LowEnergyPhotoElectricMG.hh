...
#ifndef G4LOWENERGYPHOTOELECTRICMG_HH
#define G4LOWENERGYPHOTOELECTRICMG_HH 1
...
class G4LowEnergyPhotoElectricMG : public G4VDiscreteProcess {
  
public:
  
  G4LowEnergyPhotoElectricMG(const G4String& processName ="LowEnPhotoElec");
  
  ~G4LowEnergyPhotoElectricMG();
...
private:
 ...
 // Hide copy constructor and assignment operator as private 
  G4LowEnergyPhotoElectricMG& operator=(const G4LowEnergyPhotoElectricMG& right);
  G4LowEnergyPhotoElectricMG(const G4LowEnergyPhotoElectricMG& );
