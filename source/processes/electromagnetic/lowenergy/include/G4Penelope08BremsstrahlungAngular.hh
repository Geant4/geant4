...
// 
// -------------------------------------------------------------------
// $Id: G4Penelope08BremsstrahlungAngular.hh,v 1.1 2010-12-20 14:11:13 pandola Exp $
...
#ifndef G4PENELOPE08BREMSSTRAHLUNGANGULAR_HH
#define G4PENELOPE08BREMSSTRAHLUNGANGULAR_HH 1
#include "globals.hh"
#include <map>
...
public:
  G4Penelope08BremsstrahlungAngular(); 
  ~G4Penelope08BremsstrahlungAngular();
