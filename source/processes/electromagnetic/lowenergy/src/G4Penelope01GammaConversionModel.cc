...
// ********************************************************************
//
// $Id: G4Penelope01GammaConversionModel.cc,v 1.7 2010-11-25 09:45:13 pandola Exp $
...
#include "G4Penelope01GammaConversionModel.hh"
...
G4Penelope01GammaConversionModel::~G4Penelope01GammaConversionModel()
{  
...
void G4Penelope01GammaConversionModel::Initialise(const G4ParticleDefinition*,
						const G4DataVector& )
{
  if (verboseLevel > 3)
    G4cout << "Calling  G4Penelope01GammaConversionModel::Initialise()" << G4endl;
  ...
  if (verboseLevel > 2) 
    G4cout << "Loaded cross section files for Penelope01GammaConversion" << G4endl;

  if (verboseLevel > 0) { 
    G4cout << "Penelope Gamma Conversion model v2001 is initialized " << G4endl
	   << "Energy range: "
...
G4double G4Penelope01GammaConversionModel::ComputeCrossSectionPerAtom(const G4ParticleDefinition*,
								      G4double energy,
								      G4double Z, G4double,
								      G4double, G4double)
{
  //
  // Penelope model v2001.
...
void 
G4Penelope01GammaConversionModel::SampleSecondaries(std::vector<G4DynamicParticle*>* fvect,
						  ...
						  G4double)
{
  ...
  //
  if (verboseLevel > 3)
    G4cout << "Calling SamplingSecondaries() of G4Penelope01GammaConversionModel" << G4endl;
  ...
  if (verboseLevel > 1)
    {
      G4cout << "-----------------------------------------------------------" << G4endl;
      G4cout << "Energy balance from G4Penelope01GammaConversion" << G4endl;
 ...
 if (verboseLevel > 0)
	...
	G4cout << "Warning from G4Penelope01GammaConversion: problem with energy conservation: " 
...
std::vector<G4double> G4Penelope01GammaConversionModel::ScreenFunction(G4double b)
{
...
G4double G4Penelope01GammaConversionModel::GetScreeningRadius(G4double Z)
{
  G4double result = 0;
