...
// --------------------------------------------------------------
//
// File name:     G4LowEnergyBremsstrahlungVI
//
...
G4LowEnergyBremsstrahlungVI::G4LowEnergyBremsstrahlungVI(const G4String& nam)
...
void G4LowEnergyBremsstrahlungVI::BuildPhysicsTable(const G4ParticleDefinition& aParticleType)
{
  if(verboseLevel > 0) {
...
G4VParticleChange* G4LowEnergyBremsstrahlungVI::PostStepDoIt(const G4Track& track,
							   const G4Step& step)
{
...
void G4LowEnergyBremsstrahlungVI::PrintInfoDefinition()
{
...
G4bool G4LowEnergyBremsstrahlungVI::IsApplicable(const G4ParticleDefinition& particle)
{
  return (  (&particle == G4Electron::Electron())  );
}


G4double G4LowEnergyBremsstrahlungVI::GetMeanFreePath(const G4Track& track,
...
void G4LowEnergyBremsstrahlungVI::SetCutForLowEnSecPhotons(G4double cut)
{
  cutForPhotons = cut;
}
