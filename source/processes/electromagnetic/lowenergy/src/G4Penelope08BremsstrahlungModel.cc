...
// ********************************************************************
//
// $Id: G4Penelope08BremsstrahlungModel.cc,v 1.1 2010-12-20 14:11:37 pandola Exp $
...
#include "G4Penelope08BremsstrahlungFS.hh"
#include "G4Penelope08BremsstrahlungAngular.hh"
...
G4Penelope08BremsstrahlungModel::G4Penelope08BremsstrahlungModel(const G4ParticleDefinition*,
                                             const G4String& nam)
  ...
  
{
  ...
  fPenelopeFSHelper = new G4Penelope08BremsstrahlungFS();
  fPenelopeAngular = new G4Penelope08BremsstrahlungAngular();
...
G4Penelope08BremsstrahlungModel::~G4Penelope08BremsstrahlungModel()
{
  ClearTables();
...
void G4Penelope08BremsstrahlungModel::Initialise(const G4ParticleDefinition*,
                                             const G4DataVector&)
{
  if (verboseLevel > 3)
    G4cout << "Calling G4Penelope08BremsstrahlungModel::Initialise()" << G4endl;
...
G4double G4Penelope08BremsstrahlungModel::CrossSectionPerVolume(const G4Material* material,
                                           ...
                                           G4double)
{
  //
  if (verboseLevel > 3)
    G4cout << "Calling CrossSectionPerVolume() of G4Penelope08BremsstrahlungModel" << G4endl;
  ...
  if (verboseLevel > 2)
  {
    G4cout << "G4Penelope08BremsstrahlungModel " << G4endl;
...
//G4EmCalculator.
G4double G4Penelope08BremsstrahlungModel::ComputeCrossSectionPerAtom(const G4ParticleDefinition*,
								     G4double,
								     G4double,
								     G4double,
								     G4double,
								     G4double)
{
  G4cout << "*** G4Penelope08BremsstrahlungModel -- WARNING ***" << G4endl;
  G4cout << "Penelope08 Bremsstrahlung model does not calculate cross section _per atom_ " << G4endl;
...
G4double G4Penelope08BremsstrahlungModel::ComputeDEDXPerVolume(const G4Material* material,
							       const G4ParticleDefinition* theParticle,
							       G4double kineticEnergy,
							       G4double cutEnergy)
{
  if (verboseLevel > 3)
    G4cout << "Calling ComputeDEDX() of G4Penelope08BremsstrahlungModel" << G4endl;
...
void G4Penelope08BremsstrahlungModel::SampleSecondaries(std::vector<G4DynamicParticle*>*fvect,
...
{
  if (verboseLevel > 3)
    G4cout << "Calling SampleSecondaries() of G4Penelope08BremsstrahlungModel" << G4endl;
  ...
  if (verboseLevel > 1)
    {
      G4cout << "-----------------------------------------------------------" << G4endl;
      G4cout << "Energy balance from G4Penelope08Bremsstrahlung" << G4endl;
...
void G4Penelope08BremsstrahlungModel::ClearTables()
{  
  ...
  if (verboseLevel > 2)
    G4cout << "G4Penelope08BremsstrahlungModel: cleared tables" << G4endl;
 return;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

G4double G4Penelope08BremsstrahlungModel::MinEnergyCut(const G4ParticleDefinition*,
...
void G4Penelope08BremsstrahlungModel::BuildXSTable(const G4Material* mat,G4double cut)
{
//
  ...
  if (verboseLevel > 2)
    {
      G4cout << "G4Penelope08BremsstrahlungModel: going to build cross section table " << G4endl;
  ...
  if (energyGrid->GetVectorLength() != nBins) 
    {
      G4cout << "G4Penelope08BremsstrahlungModel::BuildXSTable" << G4endl;
...
G4Penelope08BremsstrahlungModel::GetCrossSectionTableForCouple(const G4ParticleDefinition* part,
...
G4double G4Penelope08BremsstrahlungModel::GetPositronXSCorrection(const G4Material* mat,
								  G4double energy)
{
