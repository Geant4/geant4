...
//
//
// $Id: G4LowEnergyOldIonisation.cc,v 1.1 2001-10-09 11:26:38 vnivanch Exp $
...
//
//      --- G4LowEnergyOldIonisation physics process for electrons
...
// This Class Header
#include "G4LowEnergyOldIonisation.hh"
...
G4LowEnergyOldIonisation::G4LowEnergyOldIonisation(const G4String& processName)
...
G4LowEnergyOldIonisation::~G4LowEnergyOldIonisation() 
{
...
void G4LowEnergyOldIonisation::SetCutForLowEnSecPhotons(G4double cut)
{
...
void G4LowEnergyOldIonisation::SetCutForLowEnSecElectrons(G4double cut){
...
void G4LowEnergyOldIonisation::BuildPhysicsTable(const G4ParticleDefinition& aParticleType)
...
void G4LowEnergyOldIonisation::BuildLossTable(const G4ParticleDefinition& aParticleType) 
{
...
void G4LowEnergyOldIonisation::BuildShellCrossSectionTable(){
...
void G4LowEnergyOldIonisation::BuildBindingEnergyTable(){
...
void G4LowEnergyOldIonisation::BuildFluorTransitionTable(){
...
void G4LowEnergyOldIonisation::BuildSamplingCoeffTable(){
...
// 
void G4LowEnergyOldIonisation::BuildZVec(){
...
void G4LowEnergyOldIonisation::BuildLambdaTable(const G4ParticleDefinition& aParticleType)
{
...
G4double G4LowEnergyOldIonisation::ComputeCrossSection(const G4double AtomIndex,
...
G4double G4LowEnergyOldIonisation::ComputeCrossSectionWithCut(
...
G4double G4LowEnergyOldIonisation::GetShellCrossSection(
...
G4double G4LowEnergyOldIonisation::GetShellCrossSectionwithCut(
                                             const G4double AtomicNumber,
                                             const G4int index,
					     const G4double KineticEnergy,
                                             const G4double Tcut)
...
G4double G4LowEnergyOldIonisation::GetShellEnergyLosswithCut(
                                              const G4double AtomicNumber,
                                              const G4int index,
				              const G4double KineticEnergy,
                                              const G4double Tcut)
...
G4VParticleChange* G4LowEnergyOldIonisation::PostStepDoIt(const G4Track& track,   
						       const G4Step&  step)
{
  ...
  { 
    if(KineticEnergy < 0.) {
      G4cout << "G4LowEnergyOldIonisation: negative kinetic energy (eV) = " 
 ...
 // Generation of fluorescence
  ...
  if(finalKineticEnergy > DeltaThreshold){
    ...
    if(theEnergyDeposit < 0.) {
      G4cout << "G4LowEnergyOldIonisation: Negative energy deposit: " 
...
// 
G4int G4LowEnergyOldIonisation::SelectRandomShell(const G4int AtomIndex
                                             , const G4double IncEnergy
					     , const G4double CutEnergy)
{  
  ...
  G4Exception("LEOldIonisation: Cannot select a shell");
  return 0;
}
...
// 
G4Element* G4LowEnergyOldIonisation::SelectRandomAtom(
...
G4bool G4LowEnergyOldIonisation::SelectRandomTransition(G4int thePrimShell, 
					G4double* TransParam,
...
G4double G4LowEnergyOldIonisation::EnergySampling(const G4int AtomicNumber, 
					     ...
					     , const G4double deltaRayMinE)
{
  ...
  if(minEn>=maxEn) {
     G4cout << "G4LowEnergyOldIonisation::EnergySampling not enought energy left!"
            << G4endl;
...
void G4LowEnergyOldIonisation::PrintInfoDefinition()
{
