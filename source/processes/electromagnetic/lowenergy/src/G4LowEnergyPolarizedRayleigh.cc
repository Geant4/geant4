...
// ********************************************************************
//
// $Id: G4LowEnergyPolarizedRayleigh.cc,v 1.3 2005-05-12 09:22:05 capra Exp $
...
//! \file    G4LowEnergyPolarizedRayleigh.cc
//! \brief   Implementation of G4LowEnergyPolarizedRayleigh class
//! \author  Capra Riccardo
//! \date    May 2005
//! \par     History:
//! <TABLE>
...
G4VParticleChange *                     	G4LowEnergyPolarizedRayleigh :: PostStepDoIt(const G4Track & aTrack, const G4Step & aStep)
{
 ...
 G4VCrossSectionHandler * crossSectionHandler = GetCrossSectionHandler();
 const G4MaterialCutsCouple * couple = aTrack.GetMaterialCutsCouple();
 G4int zAtom = crossSectionHandler->SelectRandomAtom(couple, incomingPhotonEnergy);
