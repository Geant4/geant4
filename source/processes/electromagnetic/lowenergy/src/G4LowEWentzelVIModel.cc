  ...
  singleScatteringMode(false)
{
  ...
  wokvi = new G4WentzelOKandVIxSection(false);
  fixedCut = -1.0;
...
void G4LowEWentzelVIModel::Initialise(const G4ParticleDefinition* p,
				  const G4DataVector& cuts)
{
  ...
  /*
  G4cout << "G4LowEWentzelVIModel: " << particle->GetParticleName()
...
G4double G4LowEWentzelVIModel::ComputeCrossSectionPerAtom( 
			     ...
			     G4double cutEnergy, G4double)
{
  ...
  if(!CurrentCouple()) {
    G4Exception("G4LowEWentzelVIModel::ComputeCrossSectionPerAtom", "em0011",
  ...
  if(cosTetMaxNuc < 1.0) {
    ...
    G4cout << "G4LowEWentzelVIModel::CS: Z= " << G4int(Z) << " e(MeV)= " << kinEnergy 
...
void G4LowEWentzelVIModel::StartTracking(G4Track* track)
{
...
G4double G4LowEWentzelVIModel::ComputeGeomPathLength(G4double truelength)
{
...
G4double G4LowEWentzelVIModel::ComputeTrueStepLength(G4double geomStepLength)
{
  ...
  */
  ...
  if(lambdaeff == DBL_MAX) { 
    ...
    if(geomStepLength < lambdaeff*singleScatLimit) {
      singleScatteringMode = true;
      cosThetaMin = 1.0;
      zPathLength  = geomStepLength;
      tPathLength  = geomStepLength;
...
G4ThreeVector& 
G4LowEWentzelVIModel::SampleScattering(const G4ThreeVector& oldDirection,
				   G4double safety)
{
  fDisplacement.set(0.0,0.0,0.0);
  //G4cout << "!##! G4LowEWentzelVIModel::SampleScattering for " 
  //	 << particle->GetParticleName() << G4endl;
  ...
  */
  ...
  //G4cout<<"G4LowEWentzelVIModel sampling is done 1-cost= "<< 1.-dir.z()<<G4endl;
  // end of sampling -------------------------------
  ...
  */
  ...
  //G4cout<< "G4LowEWentzelVIModel::SampleScattering end NewDir= " << dir<< G4endl;
  return fDisplacement;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4double G4LowEWentzelVIModel::ComputeXSectionPerVolume()
{
