...
// ********************************************************************
//
// $Id: G4Penelope01BremsstrahlungAngular.cc,v 1.10 2010-12-01 15:20:20 pandola Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
// 
// --------------------------------------------------------------
//
// File name:     G4Penelope01BremsstrahlungAngular
//
...
G4Penelope01BremsstrahlungAngular::G4Penelope01BremsstrahlungAngular (G4int Zed)
  : Zmat(Zed)
{
...
G4Penelope01BremsstrahlungAngular::~G4Penelope01BremsstrahlungAngular()
{
}

G4int G4Penelope01BremsstrahlungAngular::GetAtomicNumber()
{
  return Zmat;
}

void G4Penelope01BremsstrahlungAngular::InterpolationTableForZ()
{
...
void G4Penelope01BremsstrahlungAngular::InterpolationForK()
{
...
G4double G4Penelope01BremsstrahlungAngular::ExtractCosTheta(G4double e1,G4double e2)
{
