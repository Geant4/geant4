...
// ********************************************************************
//
// $Id: G4MuMscModel.cc,v 1.10 2008-01-05 18:29:30 vnivanch Exp $
			     ...
			     G4double cutEnergy, G4double)
{
  ...
  if(t1 > 0.0) {
    ...
    if(ctm > -1.0 && ctm < 1.0) cosTetMaxElec = ctm;
  }
				    ...
				    G4double safety)
{
  ...
  G4double t1 = tPathLength/GetLambda(e);
  G4double t2 = tPathLength*GetLambda2(e); 
