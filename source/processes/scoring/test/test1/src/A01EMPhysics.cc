...
// ********************************************************************
//
// $Id: A01EMPhysics.cc,v 1.2 2006-12-13 15:49:03 gunter Exp $
// --------------------------------------------------------------
//
//
...
A01EMPhysics::A01EMPhysics(const G4String& name,G4bool ifDisplace)
...
void A01EMPhysics::ConstructProcess()
{
   ...
   theeminusMultipleScattering->SetLateralDisplasmentFlag(ifDisp);
   ...
   theeplusMultipleScattering->SetLateralDisplasmentFlag(ifDisp);
