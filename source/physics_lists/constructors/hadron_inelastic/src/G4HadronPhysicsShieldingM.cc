...
// ********************************************************************
//
// $Id: G4HadronPhysicsShieldingM.cc 73040 2013-08-15 09:36:57Z gcosmo $
//
//---------------------------------------------------------------------------
//
// ClassName:   
...
#include "G4HadronPhysicsShieldingM.hh"
...
//
G4_DECLARE_PHYSCONSTR_FACTORY(G4HadronPhysicsShieldingM);

G4ThreadLocal G4HadronPhysicsShieldingM::ThreadPrivate* 
G4HadronPhysicsShieldingM::tpdata = 0;

G4HadronPhysicsShieldingM::G4HadronPhysicsShieldingM( G4int )
    :  G4VPhysicsConstructor("hInelastic ShieldingM")
    , useLEND_(false)
    , evaluation_()
...
G4HadronPhysicsShieldingM::G4HadronPhysicsShieldingM(const G4String& name)
...
void G4HadronPhysicsShieldingM::CreateModels()
{
...
G4HadronPhysicsShieldingM::~G4HadronPhysicsShieldingM()
{
...
void G4HadronPhysicsShieldingM::ConstructParticle()
{
...
void G4HadronPhysicsShieldingM::ConstructProcess()
{
