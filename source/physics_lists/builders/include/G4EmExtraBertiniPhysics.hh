...
// ********************************************************************
//
// $Id: G4EmExtraBertiniPhysics.hh,v 1.3 2010-06-02 17:21:29 vnivanch Exp $
...
#ifndef G4EmExtraBertiniPhysics_h
#define G4EmExtraBertiniPhysics_h 1

#include "G4VPhysicsConstructor.hh"
#include "globals.hh"

#include "G4EmBertiniMessenger.hh"
...
class G4EmExtraBertiniPhysics : public G4VPhysicsConstructor
{
public:

  G4EmExtraBertiniPhysics(G4int ver = 1);

  // obsolete
  G4EmExtraBertiniPhysics(const G4String& name);

  virtual ~G4EmExtraBertiniPhysics();
...
private:
  ...
  G4EmBertiniMessenger*           theMessenger;
