...
// ********************************************************************
//
// $Id: G4EmQMessenger.cc,v 1.1 2006-10-31 11:35:02 gunter Exp $
...
G4EmQMessenger::G4EmQMessenger(G4EmQExtraPhysics* ab)
{
  G4HadronicDeprecate("G4EmQMessenger");
...
void G4EmQMessenger::SetNewValue(G4UIcommand* aComm, G4String aS)
{
