...
// ********************************************************************
//
// $Id: G4EmBertiniMessenger.cc,v 1.1 2006-10-31 11:35:02 gunter Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
//---------------------------------------------------------------------------
//
// ClassName:   G4EmBertiniMessenger
//
...
G4EmBertiniMessenger::G4EmBertiniMessenger(G4EmExtraBertiniPhysics* ab)
{
  theB = ab;
...
G4EmBertiniMessenger::~G4EmBertiniMessenger()
{
  delete theSynch;
  delete theGN;
  delete theMUN;
...
void G4EmBertiniMessenger::SetNewValue(G4UIcommand* aComm, G4String aS)
{
