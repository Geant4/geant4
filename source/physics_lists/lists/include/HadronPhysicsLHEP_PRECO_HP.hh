...
// ********************************************************************
//
// $Id: HadronPhysicsLHEP_PRECO_HP.hh,v 1.2 2010-06-03 10:42:44 gunter Exp $
...
{
  public: 
    HadronPhysicsLHEP_PRECO_HP(G4int verbose =1);
    HadronPhysicsLHEP_PRECO_HP(const G4String& name);
