...
// ********************************************************************
//
// $Id: HadronPhysicsQGSC_QGSC.hh,v 1.5 2010-06-03 10:42:44 gunter Exp $
...
{
  public: 
    HadronPhysicsQGSC_QGSC(G4int verbose =1);
    HadronPhysicsQGSC_QGSC(const G4String& name, G4bool quasiElastic=true);
