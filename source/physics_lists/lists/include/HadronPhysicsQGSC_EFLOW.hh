...
// ********************************************************************
//
// $Id: HadronPhysicsQGSC_EFLOW.hh,v 1.3 2010-06-03 10:42:44 gunter Exp $
...
{
  public: 
    HadronPhysicsQGSC_EFLOW(G4int);
    HadronPhysicsQGSC_EFLOW(const G4String& name, G4bool quasiElastic=true);
