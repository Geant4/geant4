...
// ********************************************************************
//
// $Id: HadronPhysicsFTFC.hh,v 1.4 2010-06-03 10:42:44 gunter Exp $
...
{
  public: 
    HadronPhysicsFTFC(G4int verbose =1);
    HadronPhysicsFTFC(const G4String& name,G4bool quasiElastic=false);
