...
// ********************************************************************
//
// $Id: HadronPhysicsLHEP_BERT_HP.hh,v 1.2 2010-06-03 10:42:44 gunter Exp $
...
{
  public: 
    HadronPhysicsLHEP_BERT_HP(G4int verbose =1);
    HadronPhysicsLHEP_BERT_HP(const G4String& name );
