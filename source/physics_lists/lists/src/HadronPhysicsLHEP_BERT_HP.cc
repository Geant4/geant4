...
// ********************************************************************
//
// $Id: HadronPhysicsLHEP_BERT_HP.cc,v 1.2 2010-06-03 10:42:44 gunter Exp $
...
HadronPhysicsLHEP_BERT_HP::HadronPhysicsLHEP_BERT_HP(G4int)
                    :  G4VPhysicsConstructor("hInelastic LHEP_BERT_HP") 
{}
