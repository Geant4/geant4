...
// ********************************************************************
//
// $Id: HadronPhysicsQGSC_QGSC.cc,v 1.5 2010-06-03 10:42:44 gunter Exp $
...
HadronPhysicsQGSC_QGSC::HadronPhysicsQGSC_QGSC(G4int)
                    :  G4VPhysicsConstructor("hInelastic QGSC_QGSC")
		     , QuasiElastic(true)
{}
