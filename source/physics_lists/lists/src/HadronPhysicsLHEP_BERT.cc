...
// ********************************************************************
//
// $Id: HadronPhysicsLHEP_BERT.cc,v 1.2 2010-06-03 10:42:44 gunter Exp $
...
HadronPhysicsLHEP_BERT::HadronPhysicsLHEP_BERT(G4int)
                    :  G4VPhysicsConstructor("hInelastic LHEP_BERT") 
{}
