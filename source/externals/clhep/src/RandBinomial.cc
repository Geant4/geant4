...
static double StirlingCorrection(long int k)
{
  ...
  static G4ThreadLocal double  c[31] = {   0.0,
...
#define DMAX_KM  20L
  ...
  static G4ThreadLocal long int      n_last = -1L,  n_prev = -1L;
  static G4ThreadLocal double        par,np,p0,q,p_last = -1.0, p_prev = -1.0;
  static G4ThreadLocal long          b,m,nm;
  static G4ThreadLocal double        pq, rc, ss, xm, xl, xr, ll, lr, c,
				 p1, p2, p3, p4, ch;
