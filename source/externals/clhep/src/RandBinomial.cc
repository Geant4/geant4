...
static double StirlingCorrection(long int k)
{
  ...
  static __thread double  c[31] = {   0.0,
...
#define DMAX_KM  20L
  ...
  static __thread long int      n_last = -1L,  n_prev = -1L;
  static __thread double        par,np,p0,q,p_last = -1.0, p_prev = -1.0;
  static __thread long          b,m,nm;
  static __thread double        pq, rc, ss, xm, xl, xr, ll, lr, c,
				 p1, p2, p3, p4, ch;
