...
G4ThreadLocal double RandPoisson::status_st[3] = {0., 0., 0.};
G4ThreadLocal double RandPoisson::oldm_st = -1.0;
...
// (Adapted from Numerical Recipes in C)
  ...
  static G4ThreadLocal double cof[6] = {76.18009172947146,-86.50532032941677,
