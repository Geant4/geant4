...
// and all its terms.
//
// $Id: testG4Polyhedron.cc,v 1.1 1999-01-08 16:32:05 gunter Exp $
...
//   P G O N
  ...
  G4cout << "=== G4PolyhedronPgon(Nz=4, N=1)" << endl;
  polyhedron = G4PolyhedronPgon(5.*deg, 45.*deg, 1, 4, z01, rmin01, rmax01);

  G4cout << "=== G4PolyhedronPgon(Nz=4, Rmin=Rmax)" << endl;
  ...
  G4cout << "=== G4PolyhedronPgon(Nz=4, N=1, Rmin=Rmax)" << endl;
  polyhedron = G4PolyhedronPgon(5.*deg, 45.*deg, 1, 4, z02, rmin02, rmax02);

  G4cout << "=== G4PolyhedronPgon(Nz=4, Rmin=Rmax=0)" << endl;
  ...
  G4cout << "=== G4PolyhedronPgon(Nz=4, N=1, Rmin=Rmax=0)" << endl;
  polyhedron = G4PolyhedronPgon(5.*deg, 45.*deg, 1, 4, z03, rmin03, rmax03);

  G4cout << "=== G4PolyhedronPgon(Nz=4, Rmin=100)" << endl;
  ...
  G4cout << "=== G4PolyhedronPgon(Nz=4, Rmin=0, Dphi=180)" << endl;
  ...
  G4cout << "=== G4PolyhedronPgon(Nz=3, Rmin=Rmax)" << endl;
