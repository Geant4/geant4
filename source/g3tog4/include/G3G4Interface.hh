...
// and all its terms.
//
// $Id: G3G4Interface.hh,v 1.2 1999-05-15 00:16:44 lockman Exp $
...
void G4gspos(const G4String& name, G4int num, const G4String& moth, G4double x,
             G4double y, G4double z, G4int irot, const G4String& only);
