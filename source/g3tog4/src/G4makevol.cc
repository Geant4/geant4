...
// and all its terms.
//
// $Id: G4makevol.cc,v 1.7 1999-05-13 03:56:02 lockman Exp $
...
G4LogicalVolume* G4makevol(G4String vname, G4String shape, G4int nmed,
  ...
  if ( shape == "BOX" ) {
    ...
    solid = new 
      G4Trd(vname, pdx1, pdx2, pdy1, pdy2, pdz);
    ...
    solid = new 
      G4Tubs(vname, pRMin, pRMax, pDz, pSPhi, pDPhi);
    ...
    solid = new 
      G4Sphere(vname, pRmin, pRmax, pThe1, pDThe, pPhi1, pDPhi);
    ...
    solid = new 
      G4Para(vname, pDx, pDy, pDz, pAlph, pThet, pPhi);
    ...
    solid = new 
      G4Polyhedra(vname, pPhi1, dPhi, npdv, nz, DzArray, Rmin, Rmax);
    delete [] DzArray;
    delete [] Rmin;
    delete [] Rmax;
    ...
    solid = new 
      G4Polycone(vname, pPhi1, dPhi, nz, DzArray, Rmin, Rmax);
    delete [] DzArray;
    delete [] Rmin;
    delete [] Rmax;
    ...
    solid = new
      G4Hype(vname, pRmin, pRmax, pThet, pThet, pDz);
