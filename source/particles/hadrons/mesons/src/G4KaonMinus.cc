...
//
//
// $Id: G4KaonMinus.cc,v 1.11 2004-09-02 01:52:38 asaim Exp $
...
G4ParticleDefinition* G4KaonMinus::theInstance = 0;

G4ParticleDefinition* G4KaonMinus::Definition()
{
...
G4ParticleDefinition*  G4KaonMinus::KaonMinusDefinition()
{
  return Definition();
}

G4ParticleDefinition*  G4KaonMinus::KaonMinus()
{
  return Definition();
}
