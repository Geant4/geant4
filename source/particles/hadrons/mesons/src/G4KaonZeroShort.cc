...
//
//
// $Id: G4KaonZeroShort.cc,v 1.14 2004-09-02 01:52:38 asaim Exp $
...
G4ParticleDefinition* G4KaonZeroShort::theInstance = 0;

G4ParticleDefinition* G4KaonZeroShort::Definition()
{
...
G4ParticleDefinition*  G4KaonZeroShort::KaonZeroShortDefinition()
{
  return Definition();
}

G4ParticleDefinition*  G4KaonZeroShort::KaonZeroShort()
{
  return Definition();
}
