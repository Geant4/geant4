...
////////////////////
G4ParticleDefinition* G4ParticleTable::FindParticle(const G4String &particle_name) const
{
...
////////////////////
G4ParticleDefinition* G4ParticleTable::FindParticle(const G4ParticleDefinition *particle ) const
{
  CheckReadiness();
