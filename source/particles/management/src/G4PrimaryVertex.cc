...
{  ;;;   if (!aPrimaryVertexAllocator_G4MT_TLS_) aPrimaryVertexAllocator_G4MT_TLS_ = new G4Allocator<G4PrimaryVertex>  ; G4Allocator<G4PrimaryVertex> &aPrimaryVertexAllocator = *aPrimaryVertexAllocator_G4MT_TLS_;  ;;;   return (this==&right); }
