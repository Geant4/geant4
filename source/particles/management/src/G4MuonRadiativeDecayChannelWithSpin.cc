...
G4DecayProducts *G4MuonRadiativeDecayChannelWithSpin::DecayIt(G4double) 
{
  ...
  G4DynamicParticle * parentparticle = 
                               new G4DynamicParticle( parentG4MTThreadPrivate, dummy, 0.0);
...
//
  ...
  G4DynamicParticle * daughterparticle0 
    = new G4DynamicParticle( daughtersG4MTThreadPrivate[0], daughtermomentum[0]*direction0);
  ...
  G4DynamicParticle * daughterparticle1
    = new G4DynamicParticle( daughtersG4MTThreadPrivate[1], daughtermomentum[1]*direction1);
  ...
  G4DynamicParticle * daughterparticle2
    = new G4DynamicParticle( daughtersG4MTThreadPrivate[2], direction2*(vmass/2.));
  G4DynamicParticle * daughterparticle3
    = new G4DynamicParticle( daughtersG4MTThreadPrivate[3], direction2*(-1.0*vmass/2.));
