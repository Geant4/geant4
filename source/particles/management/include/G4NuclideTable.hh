...
//  G4NuclideTable(const  G4NuclideTable &right);
//  G4NuclideTable & operator= (const  G4NuclideTable &right);
...
private:
  ...
  std::map< G4int , std::multimap< G4double , G4IsotopeList* > > map_full_list;
