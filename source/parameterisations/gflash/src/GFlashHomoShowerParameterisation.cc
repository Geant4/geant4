...
// ********************************************************************
//
// $Id: GFlashHomoShowerParameterisation.cc,v 1.1 2005-10-04 09:07:37 gcosmo Exp $
...
G4double GFlashHomoShowerParameterisation::GetEffZ(const G4Material * mat  )
{
...
G4double GFlashHomoShowerParameterisation::GetEffA  (const G4Material * mat  )
{
...
void GFlashHomoShowerParameterisation::PrintMaterial()
{
  G4cout<<"/********************************************/ " << G4endl;
  G4cout<<"  - GFlashHomoShowerParameterisation::Material -  " << G4endl;
...
G4double GFlashHomoShowerParameterisation::gam(G4double x, G4double a) const 
{
  static MyGamma theG;
