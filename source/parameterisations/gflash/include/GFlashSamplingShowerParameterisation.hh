...
//
//
// $Id: GFlashSamplingShowerParameterisation.hh,v 1.1 2005-11-30 14:49:16 weng Exp $
...
class G4Material;
class  GFlashSamplingShowerParameterisation: public GFlashShowerParameterisation
{
	public:
	
	GFlashSamplingShowerParameterisation(G4Material * aMat1, G4Material * aMat2, G4double d1, G4double d2,
	...
	//void PrintMaterial(G4Material *material);
