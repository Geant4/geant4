...
//
//
// $Id: G4PSPopulation3D.cc,v 1.1 2007-08-14 16:51:10 taso Exp $
...
G4PSPopulation3D::G4PSPopulation3D(G4String name,G4int nx, 
			     G4int ny, G4int nz,
			     G4int depX, G4int depY, G4int depZ)
    :G4PSPopulation(name),fNx(nx),fNy(ny),fNz(nz),
