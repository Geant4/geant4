...
//
//
// $Id: G4GDMLSolids.hh,v 1.8 2007-11-21 13:23:53 ztorzsok Exp $
...
public:
   ...
   G4bool Read(const xercesc::DOMElement* const,G4GDMLEvaluator*,const G4String& file0,const G4String& loop0="");
