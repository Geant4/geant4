...
// ********************************************************************
//
// G4tgrSolidMulti implementation
//
...
// --------------------------------------------------------------------
G4tgrSolidMulti::G4tgrSolidMulti(const std::vector<G4String>& wl)
{
  // :SOLID/:VOLU SOL MUNION NSOL SOL1 ROTM1 POSX1 POSY1 POSZ1
  ...
  {
    G4String Err1 = "Solid type MUNION with ";
    ...
    G4tgrUtils::DumpVS(wl, "G4tgrSolidMulti::G4tgrSolidMulti()");
    G4Exception("G4tgrSolidMulti::G4tgrSolidMulti()", "InvalidInput",
...
// --------------------------------------------------------------------
G4tgrSolidMulti::~G4tgrSolidMulti()
{
}

// --------------------------------------------------------------------
std::ostream& operator<<(std::ostream& os, const G4tgrSolidMulti& sol)
{
  os << "G4tgrSolidMulti= " << sol.theName << " of type " << sol.theType
     << " PARAMS: ";
