...
// ********************************************************************
//
// G4tgrSolidScale implementation
//
...
// --------------------------------------------------------------------
G4tgrSolidScale::G4tgrSolidScale(const std::vector<G4String>& wl)
{
  // :SOLID/:VOLU SOL1 SCALED SOL0 SCLAEX SCALEY SCALEZ 

  if(wl.size() != 7)
  {
    G4tgrUtils::DumpVS(wl, "G4tgrSolidScale::G4tgrSolidScale()");
    G4Exception("G4tgrSolidScale::G4tgrSolidScale()", "InvalidInput",
...
// --------------------------------------------------------------------
G4tgrSolidScale::~G4tgrSolidScale()
{
}

// --------------------------------------------------------------------
std::ostream& operator<<(std::ostream& os, const G4tgrSolidScale& sol)
{
  os << "G4tgrSolidScale= " << sol.theName << " of type " << sol.theType
