...
{ 
  ...
  ID_of_last_particle_that_reach_the_external_source=0;
  ...
  bool aBool = electron_last_weight_vector->Store(FileOutputElectronWeight, true);
...
void G4AdjointSimManager::SetAdjointTrackingMode(G4bool aBool)
{
  ...
  if (adjoint_tracking_mode) {
	...
	if (GetDidAdjParticleReachTheExternalSource()){
		theAdjointStackingAction->SetKillTracks(false);
...
///////////////////////////////////////////////////////////////////////////////
//
bool G4AdjointSimManager::GetDidAdjParticleReachTheExternalSource()
{ return theAdjointSteppingAction->GetDidAdjParticleReachTheExternalSource();
}
///////////////////////////////////////////////////////////////////////////////
//
...
{ last_pos = theAdjointSteppingAction->GetLastPosition();  
  ...
  */
   ...
   ID_of_last_particle_that_reach_the_external_source++;
 }
///////////////////////////////////////////////////////////////////////////////
//
bool  G4AdjointSimManager::DefineSphericalExternalSource(G4double radius, G4ThreeVector pos)
{	
   G4double area;
...
///////////////////////////////////////////////////////////////////////////////
//
bool  G4AdjointSimManager::DefineSphericalExternalSourceWithCentreAtTheCentreOfAVolume(G4double radius, G4String volume_name)
{  G4double area;
...
///////////////////////////////////////////////////////////////////////////////
//
bool  G4AdjointSimManager::DefineExternalSourceOnTheExternalSurfaceOfAVolume(G4String volume_name)
{  G4double area;

   return G4AdjointCrossSurfChecker::GetInstance()->AddanExternalSurfaceOfAvolume( "ExternalSource", volume_name,area);
}
///////////////////////////////////////////////////////////////////////////////
//
void  G4AdjointSimManager::SetExternalSourceEmax(G4double Emax)
{  theAdjointSteppingAction->SetExtSourceEMax(Emax);
}
///////////////////////////////////////////////////////////////////////////////
//
bool  G4AdjointSimManager::DefineSphericalAdjointSource(G4double radius, G4ThreeVector pos)
{	
   G4double area;
...
///////////////////////////////////////////////////////////////////////////////
//
bool  G4AdjointSimManager::DefineSphericalAdjointSourceWithCentreAtTheCentreOfAVolume(G4double radius, G4String volume_name)
{  G4double area;
   G4ThreeVector center;
...
///////////////////////////////////////////////////////////////////////////////
//
bool  G4AdjointSimManager::DefineAdjointSourceOnTheExternalSurfaceOfAVolume(G4String volume_name)
{  G4double area;
   G4bool aBool = G4AdjointCrossSurfChecker::GetInstance()->AddanExternalSurfaceOfAvolume( "AdjointSource", volume_name,area); 
   area_of_the_adjoint_source=area; 
   if (aBool) { 
   	theAdjointPrimaryGeneratorAction->SetAdjointPrimarySourceOnAnExternalSurfaceOfAVolume(volume_name);
   }
   return aBool;	 
...
///////////////////////////////////////////////////////////////////////////////
//
void G4AdjointSimManager::ConsiderParticleAsPrimary(G4String particle_name)
{theAdjointPrimaryGeneratorAction->ConsiderParticleAsPrimary(particle_name);
}
///////////////////////////////////////////////////////////////////////////////
//
void G4AdjointSimManager::NeglectParticleAsPrimary(G4String particle_name)
...
///////////////////////////////////////////////////////////////////////////////
//
G4String G4AdjointSimManager::GetPrimaryIonName()
