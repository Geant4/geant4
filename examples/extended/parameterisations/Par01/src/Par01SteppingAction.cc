...
//
//
// $Id: Par01SteppingAction.cc,v 1.7 2006-06-29 17:53:47 gunter Exp $
...
Par01SteppingAction::Par01SteppingAction()
:drawFlag(false)
{
  new Par01SteppingActionMessenger(this);
}

void Par01SteppingAction::UserSteppingAction(const G4Step*)
{
  if(drawFlag)
  {
