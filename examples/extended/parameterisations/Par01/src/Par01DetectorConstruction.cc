...
//
//
// $Id: Par01DetectorConstruction.cc,v 1.10 2006-11-03 17:58:49 mverderi Exp $
...
G4VPhysicalVolume* Par01DetectorConstruction::Construct()
{
  ...
  Par01CalorimeterSD* CalorimeterSD = new Par01CalorimeterSD( calorimeterSDname, nX*nY, "CalCollection" );
  SDman->AddNewDetector( CalorimeterSD );
  theCrystalLog->SetSensitiveDetector(CalorimeterSD); 

   G4String hadCalorimeterSDname = "Par01/HadronCalorimeter";
   Par01CalorimeterSD* HadCalorimeterSD = new Par01CalorimeterSD( hadCalorimeterSDname, nXhad*nYhad, "HadCollection" );
  ...
  // builds a model and sets it to the envelope of the calorimeter:
   ...
   // -- uncomment for seeing warning message with /param/showSetup command  new Par01PiModel(caloRegion);
