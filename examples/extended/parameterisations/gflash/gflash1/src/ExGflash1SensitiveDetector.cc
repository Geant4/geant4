...
//
//
/// \file ExGflash1SensitiveDetector.cc
/// \brief Implementation of the ExGflash1SensitiveDetector class
//
...
ExGflash1SensitiveDetector::~ExGflash1SensitiveDetector() = default;
...
void ExGflash1SensitiveDetector::EndOfEvent(G4HCofThisEvent*) {}
