...
ExGflash3SensitiveDetector::ExGflash3SensitiveDetector(G4String name, ExGflash3ParallelWorld* det)
...
ExGflash3SensitiveDetector::~ExGflash3SensitiveDetector() = default;
