...
// and all its terms.
//
// $Id: Em8IrregularXrayTRmodel.cc,v 1.1 2000-02-09 10:49:16 grichine Exp $
...
Em8IrregularXrayTRmodel::Em8IrregularXrayTRmodel(G4Envelope *anEnvelope, 
...
Em8IrregularXrayTRmodel::~Em8IrregularXrayTRmodel()
{
  ;
}
...
void Em8IrregularXrayTRmodel::DoIt( const G4FastTrack& fastTrack , 
		                          G4FastStep&  fastStep         )
{
...
G4double 
Em8IrregularXrayTRmodel::GetStackFactor( G4double energy, 
