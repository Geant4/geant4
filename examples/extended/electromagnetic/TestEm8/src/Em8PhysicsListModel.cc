...
//
//
// $Id: Em8PhysicsListModel.cc,v 1.1 2003-10-27 15:31:04 grichine Exp $
...
Em8PhysicsListModel::Em8PhysicsListModel(Em8DetectorConstruction* p)
:  G4VUserPhysicsList(),
...
Em8PhysicsListModel::~Em8PhysicsListModel()
{
...
void Em8PhysicsListModel::ConstructParticle()
{
...
void Em8PhysicsListModel::ConstructBosons()
{
  // gamma
  G4Gamma::GammaDefinition();
}

void Em8PhysicsListModel::ConstructLeptons()
{
  // leptons
...
void Em8PhysicsListModel::ConstructMesons()
{
 //  mesons
...
void Em8PhysicsListModel::ConstructBarions()
{
//  barions
...
void Em8PhysicsListModel::ConstructProcess()
{
  AddTransportation();
  AddParameterisation();
...
void Em8PhysicsListModel::ConstructEM()
{
...
void Em8PhysicsListModel::ConstructGeneral()
{
  // Add Decay Process
...
void Em8PhysicsListModel::AddParameterisation()
{
...
void Em8PhysicsListModel::SetCuts()
{
  G4Timer theTimer ;
  theTimer.Start() ;
  if (verboseLevel >0)
  {
    G4cout << "Em8PhysicsListModel::SetCuts:";
...
void Em8PhysicsListModel::SetGammaCut(G4double val)
{
  cutForGamma = val;
}
...
void Em8PhysicsListModel::SetElectronCut(G4double val)
{
  cutForElectron = val;
}
...
void Em8PhysicsListModel::SetMaxStep(G4double step)
{
  MaxChargedStep = step ;
