...
: G4VUserPhysicsList(),theGammaToMuPairProcess(NULL)
{
  ...
  pMessenger = new Em6PhysicsListMessenger(this);
...
void Em6PhysicsList::SetCutForGamma(G4double cut)
{
  ResetCuts();
  cutForGamma = cut;
}

void Em6PhysicsList::SetCutForElectron(G4double cut)
{
  ResetCuts();
  cutForElectron = cut;
}

void Em6PhysicsList::SetCutForProton(G4double cut)
{
  ResetCuts();
  cutForProton = cut;
}

void Em6PhysicsList::setGammaToMuPairFac(G4double fac)
{
  if( theGammaToMuPairProcess!=NULL) theGammaToMuPairProcess->SetCrossSecFactor(fac);
}
