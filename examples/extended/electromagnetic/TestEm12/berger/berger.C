{
   ...
   /* data */
   // 1MeV-DPK.ascii came from berger
   ifstream in;
   in.open("./data/1MeV-DPK.ascii");


   // Create a new histogramm which 1MeV-DPK.acsii values
   double x_min = 0;
   double x_max = 1.2;
   int nbdata = 0;
   ...
   in.close();
   // Draw histogram
   h1d->SetTitle(" 1MeV   Dose point kernel : energy deposition profil ");
   ...
   legend->AddEntry(hroot,"G4-9.1","l");
   legend->AddEntry(h1d,"Berger data","l");
   legend->Draw();
