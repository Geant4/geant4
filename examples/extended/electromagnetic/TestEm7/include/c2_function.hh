...
class c2_function
{
  ...
  public:
    ...
    float_type partial_integrals(std::vector<float_type> xgrid,
                                 ...
                                 bool extrapolate = true) const /* throw(c2_exception) */;
    ...
    float_type integral(float_type amin, float_type amax, std::vector<float_type>* partials = 0,
                        ...
                        bool adapt = true, bool extrapolate = true) const /* throw(c2_exception) */;
    ...
    adaptively_sample(float_type amin, float_type amax, float_type abs_tol = 1e-12,
                      ...
                      std::vector<float_type>* xvals = 0, std::vector<float_type>* yvals = 0) const
      /* throw(c2_exception) */;
...
class c2_const_ptr
{
  public:
    ...
    /// \return a new c2_function
    c2_sum_p<float_type>&
    operator+(const c2_function<float_type>& rhs) const /* throw(c2_exception) */
    {
...
class c2_composed_function_p : public c2_binary_function<float_type>
{
  public:
    ...
    static float_type combine(const c2_function<float_type>& left,
                              const c2_function<float_type>& right, float_type x,
                              float_type* yprime, float_type* yprime2) /* throw(c2_exception) */
    {
      float_type y0, y1;
      if (yprime || yprime2) {
  ...
  public:
                              ...
                              float_type* yprime, float_type* yprime2) /* throw(c2_exception) */
    {
      ...
      if (yprime || yprime2) {
        ...
        if (yprime2)
          *yprime2 = (y1 * y1 * ypp0 + y0 * (2 * yp1 * yp1 - y1 * ypp1) - 2 * y1 * yp0 * yp1)
                     / (y1 * y1 * y1);
      }
      else {
        y0 = left(x);
...
class c2_transformation
{
  public:
    ...
    c2_transformation(bool transformed, float_type (*xin)(float_type),
      ...
      : fTransformed(transformed),
        fHasStaticTransforms(true),
        pIn(xin),
        pInPrime(xinp),
        pInDPrime(xinpp),
        pOut(xout)
    ...
    c2_transformation(bool transformed)
      : fTransformed(transformed),
        fHasStaticTransforms(false),
        pIn(report_error),
        pInPrime(report_error),
        pInDPrime(report_error),
        pOut(report_error)
    {}
...
class interpolating_function_p : public c2_function<float_type>
{
  public:
    ...
    interpolating_function_p()
      : c2_function<float_type>(), fTransform(*new c2_lin_lin_function_transformation<float_type>)
    {}
    ...
    interpolating_function_p<float_type>& load(const std::vector<float_type>& x,
                                               ...
                                               bool splined = true) /* throw(c2_exception) */;
    ...
    sample_function(const c2_function<float_type>& func, float_type amin, float_type amax,
                    ...
                    float_type lowerSlope, bool upperSlopeNatural,
                    float_type upperSlope) /* throw(c2_exception) */;
...
class log_lin_interpolating_function_p : public interpolating_function_p<float_type>
{
  public:
    ...
    log_lin_interpolating_function_p()
      : interpolating_function_p<float_type>(*new c2_log_lin_function_transformation<float_type>)
    {}
    virtual interpolating_function_p<float_type>& clone() const /* throw(c2_exception) */
    {
...
class lin_log_interpolating_function_p : public interpolating_function_p<float_type>
{
  public:
    ...
    lin_log_interpolating_function_p()
      : interpolating_function_p<float_type>(*new c2_lin_log_function_transformation<float_type>)
    {}
    virtual interpolating_function_p<float_type>& clone() const /* throw(c2_exception) */
    {
...
class log_log_interpolating_function_p : public interpolating_function_p<float_type>
{
  public:
    ...
    log_log_interpolating_function_p()
      : interpolating_function_p<float_type>(*new c2_log_log_function_transformation<float_type>)
    {}
    virtual interpolating_function_p<float_type>& clone() const /* throw(c2_exception) */
    {
...
class arrhenius_interpolating_function_p : public interpolating_function_p<float_type>
{
  public:
    ...
    arrhenius_interpolating_function_p()
      : interpolating_function_p<float_type>(*new c2_arrhenius_function_transformation<float_type>)
    {}
    virtual interpolating_function_p<float_type>& clone() const /* throw(c2_exception) */
    {
