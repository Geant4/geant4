...
#include "Pers01DetectorMessenger.hh"
...
Pers01DetectorConstruction::Pers01DetectorConstruction()
 ...
 magField(0),calorimeterSD(0)
{
  ...
  detectorMessenger = new Pers01DetectorMessenger(this);
}
...
G4VPhysicalVolume* Pers01DetectorConstruction::Construct()
{
  DefineMaterials();
...
void Pers01DetectorConstruction::DefineMaterials()
{ 
...
G4VPhysicalVolume* Pers01DetectorConstruction::ConstructCalorimeter()
{
  ...
  if(!calorimeterSD)
  {
    calorimeterSD = new Pers01CalorimeterSD("CalorSD",this);
...
void Pers01DetectorConstruction::PrintCalorParameters()
{
  G4cout << "\n------------------------------------------------------------"
...
void Pers01DetectorConstruction::SetAbsorberMaterial(G4String materialChoice)
{
...
void Pers01DetectorConstruction::SetGapMaterial(G4String materialChoice)
{
  // search the material by its name 
  G4Material* pttoMaterial = G4Material::GetMaterial(materialChoice);  
  if (pttoMaterial)
...
void Pers01DetectorConstruction::SetAbsorberThickness(G4double val)
{
...
void Pers01DetectorConstruction::SetGapThickness(G4double val)
{
...
void Pers01DetectorConstruction::SetCalorSizeYZ(G4double val)
{
...
void Pers01DetectorConstruction::SetNbOfLayers(G4int val)
{
  NbOfLayers = val;
}
...
void Pers01DetectorConstruction::SetMagField(G4double fieldValue)
{
...
void Pers01DetectorConstruction::UpdateGeometry()
{
