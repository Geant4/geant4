...
//
//
// $Id: ExP01PhysicsList.cc,v 1.2 2006/06/29 17:39:29 gunter Exp $
...
ExP01PhysicsList::ExP01PhysicsList():  G4VUserPhysicsList()
{
...
void ExP01PhysicsList::ConstructParticle()
{
...
void ExP01PhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructGeneral();
