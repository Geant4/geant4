...
September 15th, 2021 Gabriele Cosmo G01-V10-06-04
- Fixed minor overlaps in assembly.gdml and axes.gdml samples.

February 3rd, 2021 Gabriele Cosmo G01-V10-06-03
- Fixed auxiliary.gdml sample to define proper Region tags.

January 11th, 2021 Gabriele Cosmo
- Added scaledSolids.gdml sample setup.

November 10th, 2020 Ben Morgan G01-V10-06-02
- Migration to G4RunManagerFactory.

November 5th, 2020 Witek Pokorski G01-V10-06-01
- Added a line (commented out) indicating the possibility to overwrite
output files.

May 14th, 2020 Gabriele Cosmo G01-V10-06-00
- Use [] brackets in loop.gdml sample to show how to index names
  and dimensions in loops.

November 28th, 2019 Ivana Hrivnacova G01-V10-05-06
- Fixed Doxygen warning in .README.txt

September 24th, 2019 Gabriele Cosmo G01-V10-05-05
- Enable overlaps checking in example.
- Corrected overlap in assembly.gdml sample.

August 17th, 2019 John Allison G01-V10-05-04
- Added block.gdml to list copied to project directories.

May 2nd, 2019 Witek Pokorski G01-V10-05-03
- Added BeamOn(0) to initialize range to energy converters
  needed when exporting cuts per volume

April 25th, 2019 Ben Morgan G01-V10-05-02
- Include G4Types.hh before use of G4MULTITHREADED

April 1st, 2019 Gabriele Cosmo G01-V10-05-01
- Migrated example to multi-threading, to test MT in writing.

March 4th, 2019 Gabriele Cosmo G01-V10-05-00
