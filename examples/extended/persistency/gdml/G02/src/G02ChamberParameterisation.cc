...
G02ChamberParameterisation::G02ChamberParameterisation(G4int NoChambers,
                                                       ...
                                                       G4double lengthInitial, G4double lengthFinal)
  : G4VPVParameterisation()
{
  ...
  if (NoChambers > 0) {
    ...
    if (spacingZ < widthChamber) {
      G4Exception("ExN02G02ChamberParameterisation::G02ChamberParameterisation()", "InvalidSetup",
                  FatalException, "Invalid construction: Width>Spacing");
    }
  }
}
...
void G02ChamberParameterisation::ComputeDimensions(G4Box& trackerChamber, const G4int copyNo,
