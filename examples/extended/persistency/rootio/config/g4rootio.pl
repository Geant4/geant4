...
sub fads_create_io_source_file{
  ...
  print(OUT "      std::cout << \"${class_io}: Branch \\\"\" << f_branchName\n");
  print(OUT "                << \"\\\" initialized with bufsize = \" << bufsize\n");
  print(OUT "                << \", split level = \" << split << \".\" << std::endl;\n");
  print(OUT "    }\n");
  print(OUT "  } else {\n");
  ...
  print(OUT "              << \"collection \\\"\" << ahc->GetName() << \"\\\".\" << std::endl\n");
  print(OUT "              << \"  # of entries: \" << ahc->$collection_class_method_entries << \".\" << std::endl;\n");
  print(OUT "  }\n");
  print(OUT "\n");
  ...
  print(OUT "        std::cout << \"${class_io}: Storing ${class_name} #\"\n");
  print(OUT "                  << i << \".\" << std::endl;\n");
  ...
  print(OUT "  TBranch* branch = tree->GetBranch(f_branchName.c_str());\n");
  print(OUT "  if ( branch == 0 ) {\n");
  print(OUT "    std::cerr << \"${class_io}::Retrieve: error getting the ROOT file branch \\\"\" << f_branchName << \"\\\".\" << std::endl;\n");
  print(OUT "    return false;\n");
  print(OUT "  }\n");
  print(OUT "  branch->SetAddress(&f_hc);\n");
  print(OUT "\n");
  print(OUT "  if ( m_verbose > 2 ) {\n");
  print(OUT "    std::cout << \"${class_io}: Retrieving ${class_name} collectoin \"\n");
  print(OUT "              << \"for \\\"\" << f_detName << \"\\\", \"\n");
  print(OUT "              << \"collection \\\"\" << f_colName << \"\\\".\" << std::endl;\n");
  print(OUT "  }\n");
  print(OUT "\n");
  ...
  print(OUT "    std::cout << \"${class_io}: Retrieved \" << nb\n");
  print(OUT "              << \" bytes for event \" << f_nev-1 << \".\" << std::endl;\n");
  print(OUT "\n");
