...
{
  fSumR = 0;
  fNevt = fNelec = fNposit = fNgam = fNstep = fNgamPh = fNgamTar = fNeTar =
    fNePh = fNstepTarget = 0;
...
void Run::EndOfRun()
{
  ...
  G4cout << std::setprecision(4)
         << "Average number of e-                         " << xe << G4endl;
  G4cout << std::setprecision(4)
         << "Average number of gamma                      " << xg << G4endl;
  G4cout << std::setprecision(4)
         << "Average number of e+                         " << xp << G4endl;
  G4cout << std::setprecision(4)
         << "Average number of steps in the phantom       " << xs << G4endl;
  G4cout << std::setprecision(4)
         << "Average number of e- steps in the target     " << xes << G4endl;
  G4cout << std::setprecision(4)
         << "Average number of g  produced in the target  " << xgt << G4endl;
  G4cout << std::setprecision(4)
         << "Average number of e- produced in the target  " << xet << G4endl;
  G4cout << std::setprecision(4)
         << "Average number of g produced in the phantom  " << xph << G4endl;
  G4cout << std::setprecision(4)
         << "Average number of e- produced in the phantom " << xphe << G4endl;
  G4cout << std::setprecision(4)
         << "Total fGamma fluence in front of the phantom " << x * fSumR / MeV
         << " MeV " << G4endl;
  G4cout << "========================================================"
         << G4endl;
  G4cout << G4endl;
...
void Run::AddPhantomPhoton(const G4DynamicParticle*) { ++fNgamPh; }
...
void Run::AddPhantomStep(G4double edep, G4double r1, G4double z1, G4double r2,
