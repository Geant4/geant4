...
class PrimaryKiller : public G4VPrimitiveScorer, public G4UImessenger
{
  public:
    ...
    /** Set the energy loss from which the primary is
     killed*/
    inline void SetMinLossEnergyLimit(const G4double& energy) { fELossRange_Min = energy; }

    /** Set the energy loss from which the event is
     aborted*/
    inline void SetMaxLossEnergyLimit(const G4double& energy) { fELossRange_Max = energy; }
