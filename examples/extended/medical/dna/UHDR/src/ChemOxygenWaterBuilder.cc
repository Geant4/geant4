...
void ChemOxygenWaterBuilder::OxygenScavengerReaction(G4DNAMolecularReactionTable* pReactionTable)
{
...
void ChemOxygenWaterBuilder::CO2ScavengerReaction(G4DNAMolecularReactionTable* pReactionTable)
{
  auto table = G4MoleculeTable::Instance();
  //-----------------------------------
  // Get the molecular configuration
  ...
  //------------------------------------------------------------------
  // OH + CO2(B) -> HCO3
  reactionData = new G4DNAMolecularReactionData(1.e6 * (1e-3 * m3 / (mole * s)), OH, CO2);
...
void ChemOxygenWaterBuilder::SecondOrderReactionExtended(
  ...
  //------------------------------------------------------------------
  // e_aq + O2- -> H2O2 + OH- + OH-
  reactionData = new G4DNAMolecularReactionData(1.3e10 * (1e-3 * m3 / (mole * s)), e_aq, O2m);
  reactionData->AddProduct(H2O2);
  reactionData->AddProduct(OHm);
  reactionData->AddProduct(OHm);
  SetReactionType(reactionData, model);
  ...
  //------------------------------------------------------------------
  // H3O+ + HO2- -> H2O2
  reactionData = new G4DNAMolecularReactionData(4.78e10 * (1e-3 * m3 / (mole * s)), H3Op, HO2m);
  reactionData->AddProduct(H2O2);
  SetReactionType(reactionData, model);
  pReactionTable->SetReaction(reactionData);
  //------------------------------------------------------------------
  ...
  //------------------------------------------------------------------
  // OH + OH- -> O-
  reactionData = new G4DNAMolecularReactionData(1.27e10 * (1e-3 * m3 / (mole * s)), OH, OHm);
  reactionData->AddProduct(Om);
  SetReactionType(reactionData, model);
  pReactionTable->SetReaction(reactionData);
  //------------------------------------------------------------------
  ...
  //------------------------------------------------------------------
  // OH- + HO2 -> O2-
  reactionData = new G4DNAMolecularReactionData(1.27e10 * (1e-3 * m3 / (mole * s)), OHm,
  ...
  //------------------------------------------------------------------
  // H2O2 + OH- -> HO2-
  reactionData = new G4DNAMolecularReactionData(1.3e10 * (1e-3 * m3 / (mole * s)), H2O2,
  ...
  // O2- + O2- -> H2O2 + O2 + 2 OH-
  reactionData = new G4DNAMolecularReactionData(1.0e2 * (1e-3 * m3 / (mole * s)), O2m, O2m);
  reactionData->AddProduct(H2O2);
  reactionData->AddProduct(O2);
  reactionData->AddProduct(OHm);
  reactionData->AddProduct(OHm);
  ...
  reactionData = new G4DNAMolecularReactionData(2.0e10 * (1e-3 * m3 / (mole * s)), O, OH);
  reactionData->AddProduct(HO2);
  pReactionTable->SetReaction(reactionData);
...
void ChemOxygenWaterBuilder::SetReactionType(G4DNAMolecularReactionData* pData, G4ChemTimeStepModel model)
{
