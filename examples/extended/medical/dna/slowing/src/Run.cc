...
Run::Run(const DetectorConstruction* detector)
  : G4Run(), fDetector(detector), fParticle(0), fEkin(0.), fEdeposit(0.), fEdeposit2(0.)
{}
...
void Run::EndOfRun()
{
  ...
  G4cout << "\n The run is " << numberOfEvent << " " << partName << " of "
         << G4BestUnit(fEkin, "Energy") << " through a volume of " << material->GetName()
         << " (density: " << G4BestUnit(density, "Volumic Mass") << ") of mass "
         << G4BestUnit(fDetector->GetAbsorMass(), "Mass") << G4endl;
