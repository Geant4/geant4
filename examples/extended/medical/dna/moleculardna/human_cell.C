...
Double_t r3 = 7100e-9 * 2500e-9 * 7100e-9;  // a * b * c   // Chromosome size, as defined in the mac file, but in meters. If sphere, a=b=c
Double_t Nbp = 6405.886128; // Mbp // Length of the DNA chain in Mbp
