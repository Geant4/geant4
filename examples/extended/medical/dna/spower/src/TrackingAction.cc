...
void TrackingAction::PreUserTrackingAction(const G4Track* aTrack)
{
  ...
  analysisManager->FillNtupleDColumn(4, dirx);
  analysisManager->FillNtupleDColumn(5, diry);
  analysisManager->FillNtupleDColumn(6, dirz);
  analysisManager->FillNtupleDColumn(7, aTrack->GetKineticEnergy() / eV);
  analysisManager->FillNtupleIColumn(8, aTrack->GetTrackID());
  analysisManager->FillNtupleIColumn(9, aTrack->GetParentID());
