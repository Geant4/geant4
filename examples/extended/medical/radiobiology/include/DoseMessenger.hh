...
// ********************************************************************
//
/// \file radiobiology/include/DoseMessenger.hh
/// \brief Definition of the RadioBio::DoseMessenger class
...
class DoseMessenger : public G4UImessenger
{
  ...
  private:
    ...
    G4UIdirectory* fDoseDir = nullptr;
    ...
    G4UIcmdWithAString* fDosePathCmd = nullptr;
