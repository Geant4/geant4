...
//
//
// $Id: UVA_DetectorConstruction.cc,v 1.1 2005/10/18 18:09:14 allison Exp $
...
UVA_DetectorConstruction::UVA_DetectorConstruction()
...
{
  fpMagField = new UVA_MagneticField();
  detectorMessenger = new UVA_DetectorMessenger(this);
}
...
G4VPhysicalVolume* UVA_DetectorConstruction::Construct()
{
//--------- Material definition ---------
...
//--------- Definitions of Solids, Logical Volumes, Physical Volumes ---------
 ...
 logicWorld= new G4LogicalVolume( solidWorld, Air, "World", 0, 0, 0);
  ...
  G4VPVParameterisation* chamberParam = new UVA_ChamberParameterisation(  
  ...
  G4String trackerChamberSDname = "UVA_/TrackerChamberSD";
  UVA_TrackerSD* aTrackerSD = new UVA_TrackerSD( trackerChamberSDname );
...
void UVA_DetectorConstruction::setTargetMaterial(G4String materialName)
{
...
void UVA_DetectorConstruction::setChamberMaterial(G4String materialName)
{
  // search the material by its name 
  G4Material* pttoMaterial = G4Material::GetMaterial(materialName);  
  if (pttoMaterial)
...
void UVA_DetectorConstruction::SetMagField(G4double fieldValue)
{
