...
//
//
// $Id: UVA_ChamberParameterisation.hh,v 1.1 2005/10/18 18:09:14 allison Exp $
...
#ifndef UVA_ChamberParameterisation_H
#define UVA_ChamberParameterisation_H 1
...
class UVA_ChamberParameterisation : public G4VPVParameterisation
{ 
  public:
  
    UVA_ChamberParameterisation(G4int    NoChambers, 
                                 G4double startZ, 
                                 G4double spacing,
