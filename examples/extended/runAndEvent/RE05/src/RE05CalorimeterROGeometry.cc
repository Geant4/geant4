...
RE05CalorimeterROGeometry::RE05CalorimeterROGeometry(G4String aString)
...
G4VPhysicalVolume* RE05CalorimeterROGeometry::Build()
{
...
//  G4VPhysicalVolume * caloROcellPhys =
  ...
  RE05DummySD * dummySensi = new RE05DummySD;
