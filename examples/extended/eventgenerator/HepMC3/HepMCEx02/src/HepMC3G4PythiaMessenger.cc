...
// ********************************************************************
//
/// \file eventgenerator/HepMC/HepMCEx01/src/HepMC3G4PythiaMessenger.cc
/// \brief Implementation of the HepMC3G4PythiaMessenger class
//
//
...
HepMC3G4PythiaMessenger::HepMC3G4PythiaMessenger(HepMC3G4PythiaInterface* agen)
  : gen(agen)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
HepMC3G4PythiaMessenger::~HepMC3G4PythiaMessenger()
{
  delete verbose;
  delete mpylist;
  delete print;
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void HepMC3G4PythiaMessenger::SetNewValue(G4UIcommand* command,
                                         G4String newValues)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4String HepMC3G4PythiaMessenger::GetCurrentValue(G4UIcommand* command)
{
  G4String cv;
  if (command == verbose) {
