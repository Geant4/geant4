...
//
//
// $Id: HistoManager.cc,v 1.1 2010-05-16 21:36:47 maire Exp $
                 ...
                 G4int nbins, G4double valmin, G4double valmax, const G4String& unit)
{
  ...
  const G4String title[] = 
          { "dummy",						//0
            "vertex posi: radial  distr dN/dv = f(r)",		//1
            "vertex posi: angular distr dN/dv = f(theta)",	//2
            "vertex posi: angular distr dN/dv = f(phi)",	//3		  
            "moment dir: angular distr dN/dOmega = f(alpha) ",	//4
            "moment dir: angular distr dN/dOmega = f(psi) "	//6
          };
