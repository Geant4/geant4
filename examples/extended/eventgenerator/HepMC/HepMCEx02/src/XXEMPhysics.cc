...
//
//
// $Id: XXEMPhysics.cc,v 1.1 2002-04-29 20:44:54 asaim Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
// 

#include "XXEMPhysics.hh"
...
XXEMPhysics::XXEMPhysics(const G4String& name)
               :  G4VPhysicsConstructor(name)
{
}

XXEMPhysics::~XXEMPhysics()
{
}
...
void XXEMPhysics::ConstructParticle()
{
  // gamma
...
void XXEMPhysics::ConstructProcess()
{
