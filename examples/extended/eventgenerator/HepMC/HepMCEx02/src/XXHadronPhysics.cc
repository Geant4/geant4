...
//
//
// $Id: XXHadronPhysics.cc,v 1.1 2002-04-29 20:44:57 asaim Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
// 

#include "XXHadronPhysics.hh"
...
XXHadronPhysics::XXHadronPhysics(const G4String& name)
                    :  G4VPhysicsConstructor(name)
{
}

XXHadronPhysics::~XXHadronPhysics()
{
}
...
void XXHadronPhysics::ConstructParticle()
{
...
void XXHadronPhysics::ConstructProcess()
{
