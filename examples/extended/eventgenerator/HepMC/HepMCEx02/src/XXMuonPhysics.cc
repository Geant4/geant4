...
//
//
// $Id: XXMuonPhysics.cc,v 1.1 2002-04-29 20:45:00 asaim Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
// 

#include "XXMuonPhysics.hh"
...
XXMuonPhysics::XXMuonPhysics(const G4String& name)
                   :  G4VPhysicsConstructor(name)
{
}

XXMuonPhysics::~XXMuonPhysics()
{
}
...
void XXMuonPhysics::ConstructParticle()
{
  // Mu
...
void XXMuonPhysics::ConstructProcess()
{
