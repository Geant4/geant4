...
// ====================================================================
//
//   XXPrimaryGeneratorMessenger.cc
//   $Id: XXPrimaryGeneratorMessenger.cc,v 1.1 2002-04-29 20:45:03 asaim Exp $
//
// ====================================================================
...
#include "XXPrimaryGeneratorMessenger.hh"
#include "XXPrimaryGeneratorAction.hh"

/////////////////////////////////////////////////////////////////
XXPrimaryGeneratorMessenger::XXPrimaryGeneratorMessenger
                            (XXPrimaryGeneratorAction* genaction)
...
///////////////////////////////////////////////////////////////////
void XXPrimaryGeneratorMessenger::SetNewValue(G4UIcommand* command, 
					      G4String newValues)
///////////////////////////////////////////////////////////////////
{
  if ( command==select) {
...
///////////////////////////////////////////////////////////////////////////
G4String XXPrimaryGeneratorMessenger::GetCurrentValue(G4UIcommand* command)
///////////////////////////////////////////////////////////////////////////
{
  G4String cv, st;
  if (command == select) {
