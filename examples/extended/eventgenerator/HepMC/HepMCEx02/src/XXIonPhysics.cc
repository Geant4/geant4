...
//
//
// $Id: XXIonPhysics.cc,v 1.1 2002-04-29 20:44:57 asaim Exp $
// GEANT4 tag $Name: not supported by cvs2svn $
//
// 

#include "XXIonPhysics.hh"
...
XXIonPhysics::XXIonPhysics(const G4String& name)
                 :  G4VPhysicsConstructor(name)
{
}

XXIonPhysics::~XXIonPhysics()
{
}
...
void XXIonPhysics::ConstructParticle()
{
...
void XXIonPhysics::ConstructProcess()
{
