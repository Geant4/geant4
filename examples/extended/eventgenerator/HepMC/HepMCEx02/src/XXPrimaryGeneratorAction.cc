...
// ====================================================================
//
//   XXPrimaryGeneratorAction.cc
//   $Id: XXPrimaryGeneratorAction.cc,v 1.1 2002-04-29 20:45:02 asaim Exp $
//
// ====================================================================
...
////////////////////////////////////////////////////
XXPrimaryGeneratorAction::XXPrimaryGeneratorAction()
////////////////////////////////////////////////////
{
  ...
  messenger= new XXPrimaryGeneratorMessenger(this);  
}
...
//////////////////////////////////////////////////////////////////
void XXPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
//////////////////////////////////////////////////////////////////
{
  if(currentGenerator)
