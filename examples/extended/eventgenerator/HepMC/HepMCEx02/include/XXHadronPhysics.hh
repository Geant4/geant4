...
//
//
// $Id: XXHadronPhysics.hh,v 1.1 2002-04-29 20:44:36 asaim Exp $
...
// ------------------------------------------------------------
#ifndef XXHadronPhysics_h
#define XXHadronPhysics_h 1
...
class XXHadronPhysics : public G4VPhysicsConstructor
{
  public: 
    XXHadronPhysics(const G4String& name ="hadron");
    virtual ~XXHadronPhysics();
