...
//
//
// $Id: XXIonPhysics.hh,v 1.1 2002-04-29 20:44:38 asaim Exp $
...
// ------------------------------------------------------------
#ifndef XXIonPhysics_h
#define XXIonPhysics_h 1
...
class XXIonPhysics : public G4VPhysicsConstructor
{
  public: 
    XXIonPhysics(const G4String& name="ion");
    virtual ~XXIonPhysics();
