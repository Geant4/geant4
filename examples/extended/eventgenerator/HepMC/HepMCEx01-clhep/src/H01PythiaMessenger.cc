...
//   $Id: H01PythiaMessenger.cc,v 1.4 2005/11/15 15:02:26 gcosmo Exp $
//
// ====================================================================
...
////////////////////////////////////////////////////////////////
H01PythiaMessenger::H01PythiaMessenger(H01PythiaInterface* agen)
  : gen(agen)
////////////////////////////////////////////////////////////////
{
...
/////////////////////////////////////////
H01PythiaMessenger::~H01PythiaMessenger()
/////////////////////////////////////////
{
  delete verbose;
  delete mpylist;
...
////////////////////////////////////////////////////////////
void H01PythiaMessenger::SetNewValue(G4UIcommand* command, 
					 G4String newValues)
////////////////////////////////////////////////////////////
{
...
//////////////////////////////////////////////////////////////////////
G4String H01PythiaMessenger::GetCurrentValue(G4UIcommand* command)
//////////////////////////////////////////////////////////////////////
{
  G4String cv;
  if (command == verbose) {
