...
//   $Id: H02PythiaMessenger.cc,v 1.4 2005/11/15 15:02:27 gcosmo Exp $
//
// ====================================================================
...
////////////////////////////////////////////////////////////////
H02PythiaMessenger::H02PythiaMessenger(H02PythiaInterface* agen)
  : gen(agen)
////////////////////////////////////////////////////////////////
{
  ...
  printRandomStatus-> SetDefaultValue("G4cout");
}

/////////////////////////////////////////
H02PythiaMessenger::~H02PythiaMessenger()
/////////////////////////////////////////
{
  delete verbose;
  delete mpylist;
...
////////////////////////////////////////////////////////////
void H02PythiaMessenger::SetNewValue(G4UIcommand* command, 
					 G4String newValues)
////////////////////////////////////////////////////////////
{
...
//////////////////////////////////////////////////////////////////////
G4String H02PythiaMessenger::GetCurrentValue(G4UIcommand* command)
//////////////////////////////////////////////////////////////////////
{
  G4String cv;
  if (command == verbose) {
