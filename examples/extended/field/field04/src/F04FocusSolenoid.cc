...
F04FocusSolenoid::F04FocusSolenoid(G4double Ba, G4double Bb, G4double fz, G4LogicalVolume* lv,
                                   G4ThreeVector c)
  : F04SimpleSolenoid(Ba, fz, lv, c), fB1(Ba), fB2(Bb)
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void F04FocusSolenoid::AddFieldValue(const G4double point[4], G4double field[6]) const
{
