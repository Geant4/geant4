...
class F04Trajectory : public G4VTrajectory
{
  ...
  public:  // without description
    ...
    inline int operator==(const F04Trajectory& right) const { return (this == &right); }
...
{
  if (!F04TrajectoryAllocator) F04TrajectoryAllocator = new G4Allocator<F04Trajectory>;
