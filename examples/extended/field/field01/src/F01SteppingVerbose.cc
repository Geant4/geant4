...
void F01SteppingVerbose::StepInfo()
{
  ...
  if (verboseLevel >= 1) {
    ...
    G4cout << std::setw(5) << fTrack->GetCurrentStepNumber() << " " << std::setw(10)
           << G4BestUnit(fTrack->GetPosition().x(), "Length") << std::setw(10)
           << G4BestUnit(fTrack->GetPosition().y(), "Length") << std::setw(10)
           << G4BestUnit(fTrack->GetPosition().z(), "Length");
    G4cout << std::setw(10) << fTrack->GetMomentumDirection().x() << " " << std::setw(10)
           << fTrack->GetMomentumDirection().y() << " " << std::setw(10)
    ...
    G4cout << std::setw(8) << G4BestUnit(fTrack->GetKineticEnergy(), "Energy") << " "
           ...
           << std::setw(10) << G4BestUnit(fStep->GetStepLength(), "Length") << " " << std::setw(10)
...
void F01SteppingVerbose::TrackingStarted()
{
  ...
  if (verboseLevel > 0) {
    ...
    G4cout << std::setw(10) << fTrack->GetMomentumDirection().x() << " " << std::setw(10)
           << fTrack->GetMomentumDirection().y() << " " << std::setw(10)
           << fTrack->GetMomentumDirection().z() << " ";
    G4cout << std::setw(8) << G4BestUnit(fTrack->GetKineticEnergy(), "Energy") << std::setw(6)
           << G4BestUnit(fStep->GetTotalEnergyDeposit(), "Energy") << std::setw(10)
           << G4BestUnit(fStep->GetStepLength(), "Length") << std::setw(10)
           << G4BestUnit(fTrack->GetTrackLength(), "Length");
