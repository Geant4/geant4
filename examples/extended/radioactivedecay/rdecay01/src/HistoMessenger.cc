...
// ********************************************************************
//
/// \file radioactivedecay/rdecay01/src/HistoMessenger.cc
...
{
  fHistoDir = new G4UIdirectory("/rdecay01/histo/");
  fHistoDir->SetGuidance("histograms control");

  fFileNameCmd = new G4UIcmdWithAString("/rdecay01/histo/setFileName",this);
  fFileNameCmd->SetGuidance("set name for the histograms file");
  
  fHistoCmd = new G4UIcommand("/rdecay01/histo/setHisto",this);
  ...
  fPrtHistoCmd = new G4UIcmdWithAnInteger("/rdecay01/histo/printHisto",this);
