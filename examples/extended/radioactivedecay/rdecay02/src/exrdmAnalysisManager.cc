...
exrdmAnalysisManager::exrdmAnalysisManager()
{
  ...
  fNEvt1   = -1;
  fNEvt2   = -1;
  fTargetThresE = 10*keV;
  fDetectorThresE = 10*keV;
  fPulseWidth = 1.*microsecond;
...
void exrdmAnalysisManager::BookHisto()
{
  ...
  fHisto->Add1D("H12",
    "Total energy spectrum (MeV) of the traget and detector",fHistNBin,fHistEMin,fHistEMax,MeV);
  fHisto->Add1D("H13",
    "Coincidence spectrum (MeV) between the traget and detector",fHistNBin,fHistEMin,fHistEMax,MeV);
  fHisto->Add1D("H14",
    "Anti-coincidence spectrum (MeV) in the traget",fHistNBin,fHistEMin,fHistEMax,MeV);
  fHisto->Add1D("H15",
    "Anti-coincidence spectrum (MeV) in the detector",fHistNBin,fHistEMin,fHistEMax,MeV);
  fHisto->Add1D("H16",
...
void exrdmAnalysisManager::AddDecayProduct(G4double pid,G4int Z, G4int A, G4double energy, G4double time,
												 G4double weight)
{
