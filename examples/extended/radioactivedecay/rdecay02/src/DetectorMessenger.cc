...
DetectorMessenger::DetectorMessenger(DetectorConstruction* det) : fDetector(det)
{
  ...
  fTargRadiusCmd = new G4UIcmdWithADoubleAndUnit("/rdecay02/det/setTargetRadius", this);
  ...
  fTargLengthCmd = new G4UIcmdWithADoubleAndUnit("/rdecay02/det/setTargetLength", this);
  ...
  fDetectThicknessCmd = new G4UIcmdWithADoubleAndUnit("/rdecay02/det/setDetectorThickness", this);
  ...
  fDetectLengthCmd = new G4UIcmdWithADoubleAndUnit("/rdecay02/det/setDetectorLength", this);
