  ...
  if (verboseLevel >= 1) {
    ...
    if (verboseLevel >= 3) {
      ...
      G4cout << std::setw(5) << "#Step#"
             ...
             << "    " << std::setw(6) << "Z"
             << "    " << std::setw(8) << "KineE"
             << "    " << std::setw(9) << "Velocity" << std::setw(9) << "dEStep"
    ...
    G4cout << std::setw(5) << fTrack->GetCurrentStepNumber() << " " << std::setw(6)
           ...
           << G4BestUnit(fStep->GetPreStepPoint()->GetVelocity(), "Velocity") << std::setw(6)
...
void SteppingVerbose::TrackingStarted()
{
  ...
  if (verboseLevel > 0) {
    G4cout << std::setw(5) << "Step#"
           ...
           << "    " << std::setw(6) << "Z"
           << "    " << std::setw(9) << "KineE"
           << "    " << std::setw(9) << "Velocity" << std::setw(9) << "dEStep" << std::setw(10)
           << "StepLeng" << std::setw(10) << "TrakLeng" << std::setw(13) << "Volume"
           << "  " << std::setw(10) << "Process" << G4endl;
