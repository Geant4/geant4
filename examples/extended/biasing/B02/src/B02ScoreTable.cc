...
//
//
// $Id: B02ScoreTable.cc,v 1.1 2007-06-13 13:31:41 ahoward Exp $
...
B02ScoreTable::B02ScoreTable(const G4VIStore *aIStore) :
  fIStore(aIStore),
  FieldName(25),
  FieldValue(12)
{}
...
G4String B02ScoreTable::CreateName(const G4GeometryCell &gCell) {
