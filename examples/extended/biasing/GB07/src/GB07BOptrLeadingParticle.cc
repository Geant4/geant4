...
{
  fLeadingParticleBiasingOperation = new G4BOptnLeadingParticle("LeadingParticleBiasingOperation");
}
...
G4VBiasingOperation* GB07BOptrLeadingParticle::ProposeFinalStateBiasingOperation(
