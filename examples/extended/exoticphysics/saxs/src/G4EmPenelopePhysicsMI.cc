...
G4EmPenelopePhysicsMI::G4EmPenelopePhysicsMI(G4int ver, const G4String&, G4bool UseMIFlag)
...
void G4EmPenelopePhysicsMI::ConstructProcess()
{
  ...
  for (const auto& particleName : fPartList.PartNames()) {
    ...
    if (particleName == "gamma") {
      ...
      G4PenelopeRayleighModelMI* theRayleighPenelopeModel = new G4PenelopeRayleighModelMI();
