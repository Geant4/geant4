  ...
  : G4UImessenger(), fDetector(detconstr)
{
  ...
  fSetCustomMatDensityCmd = new G4UIcmdWithADouble("/det/setCustomMatDensity", this);
  ...
  fSetCustomMatHmassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatHmassfract", this);
  fSetCustomMatHmassfractCmd->SetGuidance("Set H mass fraction for custom material");
  ...
  fSetCustomMatCmassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatCmassfract", this);
  fSetCustomMatCmassfractCmd->SetGuidance("Set C mass fraction for custom material");
  ...
  fSetCustomMatNmassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatNmassfract", this);
  fSetCustomMatNmassfractCmd->SetGuidance("Set N mass fraction for custom material");
  ...
  fSetCustomMatOmassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatOmassfract", this);
  fSetCustomMatOmassfractCmd->SetGuidance("Set O mass fraction for custom material");
  ...
  fSetCustomMatNamassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatNamassfract", this);
  fSetCustomMatNamassfractCmd->SetGuidance("Set Na mass fraction for custom material");
  ...
  fSetCustomMatPmassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatPmassfract", this);
  fSetCustomMatPmassfractCmd->SetGuidance("Set P mass fraction for custom material");
  ...
  fSetCustomMatSmassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatSmassfract", this);
  fSetCustomMatSmassfractCmd->SetGuidance("Set S mass fraction for custom material");
  ...
  fSetCustomMatClmassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatClmassfract", this);
  fSetCustomMatClmassfractCmd->SetGuidance("Set Cl mass fraction for custom material");
  ...
  fSetCustomMatKmassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatKmassfract", this);
  fSetCustomMatKmassfractCmd->SetGuidance("Set K mass fraction for custom material");
  ...
  fSetCustomMatCamassfractCmd = new G4UIcmdWithADouble("/det/setCustomMatCamassfract", this);
  fSetCustomMatCamassfractCmd->SetGuidance("Set Ca mass fraction for custom material");
  ...
  fPhantomDiameterCmd = new G4UIcmdWithADoubleAndUnit("/det/setPhantomDiameter", this);
  ...
  fSlit1DistanceCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit1SampleDistance", this);
  ...
  fSlit2DistanceCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit2SampleDistance", this);
  ...
  fSlit3DistanceCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit3SampleDistance", this);
  ...
  fSlit4DistanceCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit4SampleDistance", this);
  ...
  fSlit1xApertureCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit1xAperture", this);
  ...
  fSlit2xApertureCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit2xAperture", this);
  ...
  fSlit3xApertureCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit3xAperture", this);
  ...
  fSlit4xApertureCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit4xAperture", this);
  ...
  fSlit1yApertureCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit1yAperture", this);
  ...
  fSlit2yApertureCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit2yAperture", this);
  ...
  fSlit3yApertureCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit3yAperture", this);
  ...
  fSlit4yApertureCmd = new G4UIcmdWithADoubleAndUnit("/det/setSlit4yAperture", this);
  ...
  fDetectorThicknessCmd = new G4UIcmdWithADoubleAndUnit("/det/setDetectorThickness", this);
  ...
  fDetectorDistanceCmd = new G4UIcmdWithADoubleAndUnit("/det/setDetectorSampleDistance", this);
...
void SAXSDetectorConstructionMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
  if (command == fSetCustomMatFFfilename) fDetector->SetCustomMatFF(newValue);

  if (command == fSetCustomMatDensityCmd)
    fDetector->SetCustomMatDensity(fSetCustomMatDensityCmd->GetNewDoubleValue(newValue));

  if (command == fSetCustomMatHmassfractCmd)
    fDetector->SetCustomMatHmassfract(fSetCustomMatHmassfractCmd->GetNewDoubleValue(newValue));

  if (command == fSetCustomMatCmassfractCmd)
    fDetector->SetCustomMatCmassfract(fSetCustomMatCmassfractCmd->GetNewDoubleValue(newValue));
  if (command == fSetCustomMatNmassfractCmd)
    fDetector->SetCustomMatNmassfract(fSetCustomMatNmassfractCmd->GetNewDoubleValue(newValue));
  if (command == fSetCustomMatOmassfractCmd)
    fDetector->SetCustomMatOmassfract(fSetCustomMatOmassfractCmd->GetNewDoubleValue(newValue));
  if (command == fSetCustomMatNamassfractCmd)
    fDetector->SetCustomMatNamassfract(fSetCustomMatNamassfractCmd->GetNewDoubleValue(newValue));
  if (command == fSetCustomMatPmassfractCmd)
    fDetector->SetCustomMatPmassfract(fSetCustomMatPmassfractCmd->GetNewDoubleValue(newValue));
  if (command == fSetCustomMatSmassfractCmd)
    fDetector->SetCustomMatSmassfract(fSetCustomMatSmassfractCmd->GetNewDoubleValue(newValue));
  if (command == fSetCustomMatClmassfractCmd)
    fDetector->SetCustomMatClmassfract(fSetCustomMatClmassfractCmd->GetNewDoubleValue(newValue));
  if (command == fSetCustomMatKmassfractCmd)
    fDetector->SetCustomMatKmassfract(fSetCustomMatKmassfractCmd->GetNewDoubleValue(newValue));
  if (command == fSetCustomMatCamassfractCmd)
    fDetector->SetCustomMatCamassfract(fSetCustomMatCamassfractCmd->GetNewDoubleValue(newValue));

  if (command == fPhantomMaterialCmd) {
    fDetector->SetPhantomMaterial(fPhantomMaterialCmd->GetNewIntValue(newValue));
  }
  if (command == fPhantomDiameterCmd) {
    fDetector->SetPhantomDiameter(fPhantomDiameterCmd->GetNewDoubleValue(newValue));
  }
  if (command == fPhantomHeightCmd) {
    fDetector->SetPhantomHeight(fPhantomHeightCmd->GetNewDoubleValue(newValue));
  }
  if (command == fPhantomZCmd) {
    fDetector->SetPhantomZ(fPhantomZCmd->GetNewDoubleValue(newValue));
  }

  if (command == fSetComp0Cmd) fDetector->SetComp0(fSetComp0Cmd->GetNewDoubleValue(newValue));
  if (command == fSetComp1Cmd) fDetector->SetComp1(fSetComp1Cmd->GetNewDoubleValue(newValue));
  if (command == fSetComp2Cmd) fDetector->SetComp2(fSetComp2Cmd->GetNewDoubleValue(newValue));
  if (command == fSetComp3Cmd) fDetector->SetComp3(fSetComp3Cmd->GetNewDoubleValue(newValue));

  if (command == fThetaSetupCmd)
    fDetector->SetThetaSetup(fThetaSetupCmd->GetNewDoubleValue(newValue));
  if (command == fSetSlitsCmd) fDetector->SetSlits(fSetSlitsCmd->GetNewBoolValue(newValue));
  if (command == fSlit1ThicknessCmd)
    fDetector->SetSlit1Thickness(fSlit1ThicknessCmd->GetNewDoubleValue(newValue));
  if (command == fSlit2ThicknessCmd)
    fDetector->SetSlit2Thickness(fSlit2ThicknessCmd->GetNewDoubleValue(newValue));
  if (command == fSlit3ThicknessCmd)
    fDetector->SetSlit3Thickness(fSlit3ThicknessCmd->GetNewDoubleValue(newValue));
  if (command == fSlit4ThicknessCmd)
    fDetector->SetSlit4Thickness(fSlit4ThicknessCmd->GetNewDoubleValue(newValue));
  if (command == fSlit1DistanceCmd)
    fDetector->SetSlit1SampleDistance(fSlit1DistanceCmd->GetNewDoubleValue(newValue));
  if (command == fSlit2DistanceCmd)
    fDetector->SetSlit2SampleDistance(fSlit2DistanceCmd->GetNewDoubleValue(newValue));
  if (command == fSlit3DistanceCmd)
    fDetector->SetSlit3SampleDistance(fSlit3DistanceCmd->GetNewDoubleValue(newValue));
  if (command == fSlit4DistanceCmd)
    fDetector->SetSlit4SampleDistance(fSlit4DistanceCmd->GetNewDoubleValue(newValue));
  if (command == fSlit1xApertureCmd)
    fDetector->SetSlit1xAperture(fSlit1xApertureCmd->GetNewDoubleValue(newValue));
  if (command == fSlit2xApertureCmd)
    fDetector->SetSlit2xAperture(fSlit2xApertureCmd->GetNewDoubleValue(newValue));
  if (command == fSlit3xApertureCmd)
    fDetector->SetSlit3xAperture(fSlit3xApertureCmd->GetNewDoubleValue(newValue));
  if (command == fSlit4xApertureCmd)
    fDetector->SetSlit4xAperture(fSlit4xApertureCmd->GetNewDoubleValue(newValue));
  if (command == fSlit1yApertureCmd)
    fDetector->SetSlit1yAperture(fSlit1yApertureCmd->GetNewDoubleValue(newValue));
  if (command == fSlit2yApertureCmd)
    fDetector->SetSlit2yAperture(fSlit2yApertureCmd->GetNewDoubleValue(newValue));
  if (command == fSlit3yApertureCmd)
    fDetector->SetSlit3yAperture(fSlit3yApertureCmd->GetNewDoubleValue(newValue));
  if (command == fSlit4yApertureCmd)
    fDetector->SetSlit4yAperture(fSlit4yApertureCmd->GetNewDoubleValue(newValue));
  ...
  if (command == fDetectorDistanceCmd)
    fDetector->SetDetectorSampleDistance(fDetectorDistanceCmd->GetNewDoubleValue(newValue));
}
