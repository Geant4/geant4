...
// G4ThreadLocal ExN02DetectorMessenger* 
//   ExN02DetectorConstruction::detectorMessenger = 0;
...
//--------- Material definition ---------
  ...
  //Xenon gas
  G4Material* Xenon = 
  new G4Material("XenonGas", z=54., a=131.29*g/mole, 
...
//--------- Definitions of Solids, Logical Volumes, Physical Volumes ------
  ...
  solidWorld= new G4Box("world",
                     HalfWorldLength,HalfWorldLength, HalfWorldLength);
...
"World",         // its name
  ...
  logicChamber = new G4LogicalVolume(solidChamber,ChamberMater,
                                     "Chamber",0,0,0);
...
//--------- example of User Limits -------------------------------
  ...
  //
  // G4double maxLength = 2*fTrackerLength, maxTime = 0.1*ns;
...
void ExN02DetectorConstruction::ConstructSDandField()
{
    ...
    //and sets it to the per-thread manager
    fpMagField = new ExN02MagneticField();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
// Clean up what was constructed by ConstructSlave
