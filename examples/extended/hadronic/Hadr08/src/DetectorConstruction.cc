...
DetectorConstruction::DetectorConstruction()
  : G4VUserDetectorConstruction(),
    fSiliconTrackerLogical(nullptr),
    fEmCaloLogical(nullptr),
    fHadCaloLogical(nullptr)
{}
...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  G4PVPlacement* worldPhys =
    new G4PVPlacement(0, G4ThreeVector(), "WorldPhysical", worldLogical, 0, false, 0);
  ...
  fSiliconTrackerLogical =
    new G4LogicalVolume(siliconBox, silicon, "SiliconTrackerLogical", 0, 0, 0);
  ...
  new G4PVPlacement(0, G4ThreeVector(0.0, 0.0, 35.0 * cm), "EmCalorimeterPhysical", fEmCaloLogical,
                    worldPhys, false, 0);
  ...
  new G4PVPlacement(0, G4ThreeVector(0.0, 0.0, 110.0 * cm), "HadCaloPhysical", fHadCaloLogical,
                    worldPhys, false, 0);
