...
//
G4double 
G4DPMJET2_5CrossSection::GetIsoCrossSection(const G4DynamicParticle* theProjectile, 
	...
	for (G4int i = 0; i < nIso; i++)
	  {
		...
		theCrossSectionIndex.insert(G4DPMJET2_5CrossSectionIndex::value_type(AA,a));
	      }
	  }
      }
