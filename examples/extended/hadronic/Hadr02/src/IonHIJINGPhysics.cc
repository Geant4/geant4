...
IonHIJINGPhysics::IonHIJINGPhysics(G4int ver)
  : G4VHadronPhysics("ionInelasticHIJING"), fVerbose(ver), fWasActivated(false)
{
  fModel = 0;
  SetPhysicsType(bIons);
  if (fVerbose > 1) {
    G4cout << "### IonHIJINGPhysics" << G4endl;
  }
}
...
void IonHIJINGPhysics::ConstructProcess()
{
  ...
  theNuclNuclData = new G4CrossSectionInelastic(new G4ComponentGGNuclNuclXsc());
  ...
  if (fVerbose > 1) {
    G4cout << "IonHIJINGPhysics::ConstructProcess done! " << G4endl;
  }
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void IonHIJINGPhysics::AddProcess(const G4String& name, G4ParticleDefinition* part, G4bool isIon)
{
