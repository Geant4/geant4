...
// ********************************************************************
//
/// \file hadronic/Hadr03/src/HistoMessenger.cc
...
:fHistoManager (manager)
{
  ...
  fFileNameCmd = new G4UIcmdWithAString("/testhadr/histo/setFileName",this);
  ...
  fPrtHistoCmd = new G4UIcmdWithAnInteger("/testhadr/histo/printHisto",this);
