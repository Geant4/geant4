...
// $Id$
//
/// \file B4dDetectorMessenger.cc
/// \brief Implementation of the B4dDetectorMessenger class
...
B4dDetectorMessenger::B4dDetectorMessenger(B4dDetectorConstruction* Det)
 : G4UImessenger(),
...
B4dDetectorMessenger::~B4dDetectorMessenger()
{
...
void B4dDetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{ 
