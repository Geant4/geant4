...
// $Id$
// 
/// \file B4cDetectorMessenger.cc
/// \brief Implementation of the B4cDetectorMessenger class
...
B4cDetectorMessenger::B4cDetectorMessenger(B4cDetectorConstruction* Det)
 : G4UImessenger(),
...
B4cDetectorMessenger::~B4cDetectorMessenger()
{
...
void B4cDetectorMessenger::SetNewValue(G4UIcommand* command,G4String newValue)
{ 
