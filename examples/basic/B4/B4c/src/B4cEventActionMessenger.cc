...
// $Id$
// 
/// \file B4cEventActionMessenger.cc
/// \brief Implementation of the B4cEventActionMessenger class
...
B4cEventActionMessenger::B4cEventActionMessenger(B4cEventAction* eventAction)
 : G4UImessenger(),
...
void B4cEventActionMessenger::SetNewValue(
