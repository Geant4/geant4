...
// $Id$
//
/// \file B3DetectorConstruction2.cc
/// \brief Implementation of the B3DetectorConstruction2 class

#include "B3DetectorConstruction2.hh"
...
B3DetectorConstruction2::B3DetectorConstruction2()
...
void B3DetectorConstruction2::DefineMaterials()
{
...
G4VPhysicalVolume* B3DetectorConstruction2::Construct()
{  
  ...
  //
  G4Tubs* solidDphi =
    new G4Tubs("dPhi", ring_R1, ring_R2, 0.5*cryst_dX, -half_dPhi, dPhi);
      
  G4LogicalVolume* logicDphi =                         
    new G4LogicalVolume(solidDphi,           //its solid
                        default_mat,         //its material
                        "dPhi");             //its name
             
  // 
  // duplicate dPhi within a ring
  //                        
     new G4PVReplica("dPhi",                 //its name
                     logicDphi,              //its logical volume
                     logicRing,              //its mother
                     kPhi,                   //axis of replication
                     nb_cryst,               //number of replica                
                     dPhi,                   //witdth of replica
                     -half_dPhi);            //offset of first replica
		                         
  //     
  // define crystal and put it in dPhi sector
  //
  ...
  G4LogicalVolume* logicDetector =                         
    new G4LogicalVolume(solidDetector,       //its solid
                        ...
                        "Detector");         //its name                  
  // 
  // duplicate ring within detector
  //                        
    new G4PVReplica("ring",                  //its name
                        logicRing,           //its logical volume
                     logicDetector,          //its mother
                     kZAxis,                 //axis of replication
                     nb_rings,               //number of replica
                     cryst_dX);              //witdth of replica
  ...
  logicDphi->SetVisAttributes (G4VisAttributes::Invisible);
...
void B3DetectorConstruction2::CreateScorers()
{
  ...
  G4VPrimitiveScorer* primitiv1 = new G4PSEnergyDeposit("edep", 1);
