...
Physics_CASCADE_HP::Physics_CASCADE_HP():  G4VModularPhysicsList()
{
  ...
  RegisterPhysics(  new MuonPhysics("muon"));
   ...
   // Hadron Physics
  RegisterPhysics(  new HadronPhysicsCASCADE_HP("hadron"));
...
Physics_CASCADE_HP::~Physics_CASCADE_HP()
{
}

void Physics_CASCADE_HP::SetCuts()
{
  if (verboseLevel >1){
    G4cout << "Physics_CASCADE_HP::SetCuts:";
  }  
