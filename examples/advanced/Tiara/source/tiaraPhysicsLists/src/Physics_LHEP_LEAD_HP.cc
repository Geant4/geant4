...
Physics_LHEP_LEAD_HP::Physics_LHEP_LEAD_HP():  G4VModularPhysicsList()
{
...
Physics_LHEP_LEAD_HP::~Physics_LHEP_LEAD_HP()
{
}

void Physics_LHEP_LEAD_HP::SetCuts()
{
  if (verboseLevel >1){
    G4cout << "Physics_LHEP_LEAD_HP::SetCuts:";
  }  
  //  " G4VUserPhysics_LHEP_LEAD_HP::SetCutsWithDefault" method sets 
