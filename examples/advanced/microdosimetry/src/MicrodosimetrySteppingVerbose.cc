...
//
// -------------------------------------------------------------------
// $Id: MicrodosimetrySteppingVerbose.cc,v 1.1 2007-10-09 08:00:29 sincerti Exp $
// -------------------------------------------------------------------

#include "G4UnitsTable.hh"

#include "MicrodosimetrySteppingVerbose.hh"

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

MicrodosimetrySteppingVerbose::MicrodosimetrySteppingVerbose()
{}
...
void MicrodosimetrySteppingVerbose::StepInfo()
{
  CopyState();
...
void MicrodosimetrySteppingVerbose::TrackingStarted()
{
  CopyState();
G4int prec = G4cout.precision(3);
  ...
  G4cout.precision(prec);
  G4cout<< "exit MicrodosimetrySteppingVerbose::TrackingStarted()   " <<G4endl;
}
