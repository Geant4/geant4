...
//
// -------------------------------------------------------------------
// $Id: MicrodosimetryRunAction.cc,v 1.1 2007-10-09 08:00:29 sincerti Exp $
// -------------------------------------------------------------------
...
MicrodosimetryRunAction::MicrodosimetryRunAction(MicrodosimetryDetectorConstruction* det)
:Detector(det)
{   
  saveRndm = 0;  
}
...
MicrodosimetryRunAction::~MicrodosimetryRunAction()
{
  delete[] dose3DDose;
  delete[] mapVoxels;
}
...
void MicrodosimetryRunAction::BeginOfRunAction(const G4Run* /*aRun*/)
{  
  ...
  {
  	mapVoxels [i]=myMicrodosimetryPhantomConfiguration.GetVoxelThreeVector(i);
  	dose3DDose[i]=0;
...
void MicrodosimetryRunAction::EndOfRunAction(const G4Run* /*aRun*/)
{     
  //drawing
