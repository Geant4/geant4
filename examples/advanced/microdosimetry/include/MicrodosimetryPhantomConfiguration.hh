...
//
// -------------------------------------------------------------------
// $Id: MicrodosimetryPhantomConfiguration.hh,v 1.1 2007-10-09 08:00:28 sincerti Exp $
// -------------------------------------------------------------------

#ifndef MicrodosimetryPhantomConfiguration_h
#define MicrodosimetryPhantomDicomConfiguration_h 1

#include "G4ThreeVector.hh"

class MicrodosimetryPhantomConfiguration
{
public:

   MicrodosimetryPhantomConfiguration();
  ~MicrodosimetryPhantomConfiguration();
