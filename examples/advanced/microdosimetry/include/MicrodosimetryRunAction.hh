...
//
// -------------------------------------------------------------------
// $Id: MicrodosimetryRunAction.hh,v 1.1 2007-10-09 08:00:28 sincerti Exp $
// -------------------------------------------------------------------

#ifndef MicrodosimetryRunAction_h
#define MicrodosimetryRunAction_h 1
...
class MicrodosimetryRunAction : public G4UserRunAction
{
public:
  
  MicrodosimetryRunAction(MicrodosimetryDetectorConstruction*);
  ~MicrodosimetryRunAction();
