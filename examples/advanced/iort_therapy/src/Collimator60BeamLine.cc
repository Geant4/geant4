...
{
  // Messenger to change parameters of the collimator60BeamLine geometry
  collimatorMessenger = new Collimator60BeamLineMessenger(this);
...
G4VPhysicalVolume* Collimator60BeamLine::Construct()
{ 
...
void Collimator60BeamLine::SetDefaultDimensions()
{
 ...
 // Geometry FINAL COLLIMATOR DEFAULTS
  ...
  G4double defaultOuterRadiusFinalCollimatorIORT = 35. *mm;
  OuterRadiusFinalCollimatorIORT = defaultOuterRadiusFinalCollimatorIORT;

  G4double defaultinnerRadiusFinalCollimatorIORT = 30. *mm;
