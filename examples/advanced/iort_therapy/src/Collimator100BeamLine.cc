...
G4VPhysicalVolume* Collimator100BeamLine::Construct()
{ 
...
void Collimator100BeamLine::SetDefaultDimensions()
{
  ...
  G4double defaultOuterRadiusFinalCollimatorIORT = 55. *mm;
  OuterRadiusFinalCollimatorIORT = defaultOuterRadiusFinalCollimatorIORT;

  G4double defaultinnerRadiusFinalCollimatorIORT = 50. *mm;
