...
#ifndef CellSurvivalSiHaLQWouters_h
#define CellSurvivalSiHaLQWouters_h 1

#include "globals.hh"

class CellSurvivalSiHaLQWouters 
{
  public:
    CellSurvivalSiHaLQWouters();
   ~CellSurvivalSiHaLQWouters();
