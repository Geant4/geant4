...
#include "globals.hh"
#include "CellSurvivalV79LQPerrisP2.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQPerrisP2::CellSurvivalV79LQPerrisP2()
{
...
void CellSurvivalV79LQPerrisP2::SurvivalFormula(G4double dose)
{
...
G4double CellSurvivalV79LQPerrisP2::GetSurvival()
{
  return probability; 
}
