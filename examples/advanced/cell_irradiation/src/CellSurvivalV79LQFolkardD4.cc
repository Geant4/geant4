...
#include "globals.hh"
#include "CellSurvivalV79LQFolkardD4.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQFolkardD4::CellSurvivalV79LQFolkardD4()
{
...
void CellSurvivalV79LQFolkardD4::SurvivalFormula(G4double dose)
{
  G4double alpha = 0.81 * ( gray );
...
G4double CellSurvivalV79LQFolkardD4::GetSurvival()
{
  return probability; 
}
