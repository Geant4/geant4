...
CellPositronStandard::CellPositronStandard(const G4String& name): G4VPhysicsConstructor(name)
{ }

CellPositronStandard::~CellPositronStandard()
{ }

void CellPositronStandard::ConstructProcess()
{
