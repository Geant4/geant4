...
#include "globals.hh"
#include "CellSurvivalRT112LQLambin.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalRT112LQLambin::CellSurvivalRT112LQLambin()
{
...
void CellSurvivalRT112LQLambin::SurvivalFormula(G4double dose)
{
  ...
  //
  // ******************************************************************************
  // BIBLIOGRAPHY: Lambin et al, Int J Rad Biol, vol. 69, pp. 279-290, 1996.
  // Cell line: RT112
...
G4double CellSurvivalRT112LQLambin::GetSurvival()
{
  return probability; 
}
