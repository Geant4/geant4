...
#include "globals.hh"
#include "CellSurvivalV79LQCeraP3.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQCeraP3::CellSurvivalV79LQCeraP3()
{
...
void CellSurvivalV79LQCeraP3::SurvivalFormula(G4double dose)
{
  G4double alpha = 2.13 * ( gray );
...
G4double CellSurvivalV79LQCeraP3::GetSurvival()
{
  return probability; 
}
