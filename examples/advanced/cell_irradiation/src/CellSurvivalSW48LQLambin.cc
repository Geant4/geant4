...
#include "globals.hh"
#include "CellSurvivalSW48LQLambin.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalSW48LQLambin::CellSurvivalSW48LQLambin()
{
...
void CellSurvivalSW48LQLambin::SurvivalFormula(G4double dose)
{
...
G4double CellSurvivalSW48LQLambin::GetSurvival()
{
  return probability; 
}
