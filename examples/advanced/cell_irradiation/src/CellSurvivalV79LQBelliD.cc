...
#include "globals.hh"
#include "CellSurvivalV79LQBelliD.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQBelliD::CellSurvivalV79LQBelliD()
{
...
void CellSurvivalV79LQBelliD::SurvivalFormula(G4double dose)
{
  G4double alpha = 1.52 * ( gray );
  ...
  //
  // ******************************************************************************
  // BIBLIOGRAPHY: Belli et al, Int J Rad Biol, vol. 63, no. 3, pp. XXX-XXX, 1993.
  // Cell line: XXXXXXXX
  // Particle: deuteron
  // Energy: 1.50 MeV/u
  // Survival model: Linear-quadratic
  // Parameters:
  //            alpha = (0.66 +/- 0.01) Gy^-1
  //            beta  = (0.00 +/- 0.00) Gy^-2
  //********************************************************************************
  //
...
G4double CellSurvivalV79LQBelliD::GetSurvival()
{
  return probability; 
}
