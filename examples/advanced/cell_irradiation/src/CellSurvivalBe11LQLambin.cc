...
#include "globals.hh"
#include "CellSurvivalBe11LQLambin.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalBe11LQLambin::CellSurvivalBe11LQLambin()
{
...
void CellSurvivalBe11LQLambin::SurvivalFormula(G4double dose)
{
...
G4double CellSurvivalBe11LQLambin::GetSurvival()
{
  return probability; 
}
