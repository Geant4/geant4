...
#include "globals.hh"
#include "CellSurvivalSiHaLQWouters.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalSiHaLQWouters::CellSurvivalSiHaLQWouters()
{
...
void CellSurvivalSiHaLQWouters::SurvivalFormula(G4double dose)
{
  G4double alpha = 8.33 * ( gray );
  G4double alpha_gray = alpha * gray; 
  G4double beta = 16.67 * gray;
  ...
  //
  // ******************************************************************************
  // BIBLIOGRAPHY: Wouters et al, Rad Res, vol. 146, no. 6, pp. 399-413, 1996.
  // Cell line: SiHa
...
G4double CellSurvivalSiHaLQWouters::GetSurvival()
{
  return probability; 
}
