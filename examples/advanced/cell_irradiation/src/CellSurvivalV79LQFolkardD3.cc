...
#include "globals.hh"
#include "CellSurvivalV79LQFolkardD3.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQFolkardD3::CellSurvivalV79LQFolkardD3()
{
...
void CellSurvivalV79LQFolkardD3::SurvivalFormula(G4double dose)
{
  G4double alpha = 0.91 * ( gray );
...
G4double CellSurvivalV79LQFolkardD3::GetSurvival()
{
  return probability; 
}
