...
#include "globals.hh"
#include "CellSurvivalV79LQCeraD2.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQCeraD2::CellSurvivalV79LQCeraD2()
{
...
void CellSurvivalV79LQCeraD2::SurvivalFormula(G4double dose)
{
  G4double alpha = 2.04 * ( gray );
...
G4double CellSurvivalV79LQCeraD2::GetSurvival()
{
  return probability; 
}
