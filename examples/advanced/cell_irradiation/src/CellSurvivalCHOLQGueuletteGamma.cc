...
//    ***************************************
//    *                                     *
//    * CellSurvivalCHOLQGueuletteGamma.cc  *
//    *                                     *
//    ***************************************
//
...
#include "globals.hh"
#include "CellSurvivalCHOLQGueuletteGamma.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalCHOLQGueuletteGamma::CellSurvivalCHOLQGueuletteGamma()
{
...
void CellSurvivalCHOLQGueuletteGamma::SurvivalFormula(G4double dose)
{
  G4double alpha = 7.69 * ( gray );
  G4double alpha_gray = alpha * gray; 
  G4double beta = 14.29 * gray;
  ...
  // Particle: 60Co
  // Energy: gamma spectrum
  // Survival model: Linear-quadratic
  // Parameters:
  //            alpha = (0.13 +/- 0.04) Gy^-1
  //            beta  = (0.07 +/- 0.01) Gy^-2
  //********************************************************************************
  //
...
G4double CellSurvivalCHOLQGueuletteGamma::GetSurvival()
{
  return probability; 
}
