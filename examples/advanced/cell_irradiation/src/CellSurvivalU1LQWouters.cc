...
#include "globals.hh"
#include "CellSurvivalU1LQWouters.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalU1LQWouters::CellSurvivalU1LQWouters()
{
...
void CellSurvivalU1LQWouters::SurvivalFormula(G4double dose)
{
...
G4double CellSurvivalU1LQWouters::GetSurvival()
{
  return probability; 
}
