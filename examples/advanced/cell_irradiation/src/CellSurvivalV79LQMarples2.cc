...
#include "globals.hh"
#include "CellSurvivalV79LQMarples2.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQMarples2::CellSurvivalV79LQMarples2()
{
...
void CellSurvivalV79LQMarples2::SurvivalFormula(G4double dose)
{
  G4double alpha = 5.88 * ( gray );
  ...
  //
  // ******************************************************************************
  // BIBLIOGRAPHY: Marples et al, Rad Res, vol. 133, pp. 41-51, 1993.
  // Cell line: V79-379A
  // Particle: XXXXXXXXXX
  // Energy: XXXXXXXXXXXX
...
G4double CellSurvivalV79LQMarples2::GetSurvival()
{
  return probability; 
}
