...
#include "globals.hh"
#include "CellSurvivalHX142LQLambin.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalHX142LQLambin::CellSurvivalHX142LQLambin()
{
...
void CellSurvivalHX142LQLambin::SurvivalFormula(G4double dose)
{
  G4double alpha = 1.43 * ( gray );
  G4double alpha_gray = alpha * gray; 
  G4double beta = 2.00 * gray;
  ...
  //
  // ******************************************************************************
  // BIBLIOGRAPHY: Lambin et al, Int J Rad Biol, vol. 69, no. 6, pp. 729-738, 1996.
  // Cell line: HX142
...
G4double CellSurvivalHX142LQLambin::GetSurvival()
{
  return probability; 
}
