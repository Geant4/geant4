...
#include "globals.hh"
#include "CellSurvivalV79LQFolkardP3.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQFolkardP3::CellSurvivalV79LQFolkardP3()
{
...
void CellSurvivalV79LQFolkardP3::SurvivalFormula(G4double dose)
{
  G4double alpha = 1.35 * ( gray );
  G4double alpha_gray = alpha * gray; 
  G4double beta = 100.00 * gray;
...
G4double CellSurvivalV79LQFolkardP3::GetSurvival()
{
  return probability; 
}
