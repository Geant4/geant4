...
#include "globals.hh"
#include "CellSurvivalV79LQFolkardD2.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQFolkardD2::CellSurvivalV79LQFolkardD2()
{
...
void CellSurvivalV79LQFolkardD2::SurvivalFormula(G4double dose)
{
  G4double alpha = 1.32 * ( gray );
...
G4double CellSurvivalV79LQFolkardD2::GetSurvival()
{
  return probability; 
}
