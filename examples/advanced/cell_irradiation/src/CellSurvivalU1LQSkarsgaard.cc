...
#include "globals.hh"
#include "CellSurvivalU1LQSkarsgaard.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalU1LQSkarsgaard::CellSurvivalU1LQSkarsgaard()
{
...
void CellSurvivalU1LQSkarsgaard::SurvivalFormula(G4double dose)
{
  G4double alpha = 100.00 * ( gray );
  ...
  //
  // ******************************************************************************
  // BIBLIOGRAPHY: Skarsgaard, personal communication, 1999.
  // Cell line: U1
  // Particle: XXXXXXXXXXX
  // Energy: XXXXXXXXX
  // Survival model: Linear-quadratic
  // Parameters:
  //            alpha = (0.01 +/- XXXX) Gy^-1
  //            beta  = (0.01 +/- XXXX) Gy^-2
  //********************************************************************************
  //
...
G4double CellSurvivalU1LQSkarsgaard::GetSurvival()
{
  return probability; 
}
