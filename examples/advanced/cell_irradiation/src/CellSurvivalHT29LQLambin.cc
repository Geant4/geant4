...
#include "globals.hh"
#include "CellSurvivalHT29LQLambin.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalHT29LQLambin::CellSurvivalHT29LQLambin()
{
...
void CellSurvivalHT29LQLambin::SurvivalFormula(G4double dose)
{
  G4double alpha = 20.00 * ( gray );
...
G4double CellSurvivalHT29LQLambin::GetSurvival()
{
  return probability; 
}
