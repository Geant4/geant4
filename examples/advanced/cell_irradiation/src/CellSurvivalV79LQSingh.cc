...
#include "globals.hh"
#include "CellSurvivalV79LQSingh.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQSingh::CellSurvivalV79LQSingh()
{
...
void CellSurvivalV79LQSingh::SurvivalFormula(G4double dose)
{
  G4double alpha = 5.00 * ( gray );
  ...
  //
  // ******************************************************************************
  // BIBLIOGRAPHY: Singh et al, Int J Rad Biol, vol. 65, pp. 457-464, 1994.
  // Cell line: V79
  // Particle: XXXXXXXXXX
  // Energy: XXXXXXXXXXXX
...
G4double CellSurvivalV79LQSingh::GetSurvival()
{
  return probability; 
}
