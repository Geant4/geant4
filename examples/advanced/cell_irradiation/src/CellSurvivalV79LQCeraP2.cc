...
#include "globals.hh"
#include "CellSurvivalV79LQCeraP2.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQCeraP2::CellSurvivalV79LQCeraP2()
{
...
void CellSurvivalV79LQCeraP2::SurvivalFormula(G4double dose)
{
  G4double alpha = 2.70 * ( gray );
...
G4double CellSurvivalV79LQCeraP2::GetSurvival()
{
  return probability; 
}
