...
#include "globals.hh"
#include "CellSurvivalV79LQTillyN2.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQTillyN2::CellSurvivalV79LQTillyN2()
{
...
void CellSurvivalV79LQTillyN2::SurvivalFormula(G4double dose)
{
  G4double alpha = 1.43 * ( gray );
  G4double alpha_gray = alpha * gray; 
  G4double beta = 7.14 * gray;
...
G4double CellSurvivalV79LQTillyN2::GetSurvival()
{
  return probability; 
}
