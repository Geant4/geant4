...
#include "globals.hh"
#include "CellSurvivalV79LQFolkardX.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQFolkardX::CellSurvivalV79LQFolkardX()
{
...
void CellSurvivalV79LQFolkardX::SurvivalFormula(G4double dose)
{
...
G4double CellSurvivalV79LQFolkardX::GetSurvival()
{
  return probability; 
}
