...
CellElectronEEDL::CellElectronEEDL(const G4String& name): G4VPhysicsConstructor(name)
{ }

CellElectronEEDL::~CellElectronEEDL()
{ }

void CellElectronEEDL::ConstructProcess()
{
