...
#include "globals.hh"
#include "CellSurvivalV79LQCeraP4.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalV79LQCeraP4::CellSurvivalV79LQCeraP4()
{
...
void CellSurvivalV79LQCeraP4::SurvivalFormula(G4double dose)
{
  G4double alpha = 1.35 * ( gray );
  G4double alpha_gray = alpha * gray; 
  // G4double beta = XXX * gray;
...
G4double CellSurvivalV79LQCeraP4::GetSurvival()
{
  return probability; 
}
