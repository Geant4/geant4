...
#include "globals.hh"
#include "CellSurvivalMeWoLQLambin.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalMeWoLQLambin::CellSurvivalMeWoLQLambin()
{
...
void CellSurvivalMeWoLQLambin::SurvivalFormula(G4double dose)
{
  G4double alpha = 4.55 * ( gray );
  G4double alpha_gray = alpha * gray; 
  G4double beta = 5.00 * gray;
...
G4double CellSurvivalMeWoLQLambin::GetSurvival()
{
  return probability; 
}
