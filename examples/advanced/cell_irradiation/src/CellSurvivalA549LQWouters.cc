...
#include "globals.hh"
#include "CellSurvivalA549LQWouters.hh"
#include "CellPrimaryGeneratorAction.hh"
#include "G4RunManager.hh"

 
CellSurvivalA549LQWouters::CellSurvivalA549LQWouters()
{
...
void CellSurvivalA549LQWouters::SurvivalFormula(G4double dose)
{
  G4double alpha = 10.00 * ( gray );
  G4double alpha_gray = alpha * gray; 
  G4double beta = 20.00 * gray;
...
G4double CellSurvivalA549LQWouters::GetSurvival()
{
  return probability; 
}
