...
// ********************************************************************
//
// $Id: MedLinacSimulation.cc,v 1.1 2005-07-03 23:27:37 mpiergen Exp $
//
// --------------------------------------------------------------
...
MedLinacSimulation::MedLinacSimulation(int sd)

{ 
  seed=sd;
}

MedLinacSimulation::~MedLinacSimulation()

{ }

void MedLinacSimulation::setSeed(int sd)
{
  seed = sd;
  HepRandom ::setTheSeed(seed);
}

bool MedLinacSimulation::initialize(int argc,char** argv)
{
...
void MedLinacSimulation::executeMacro(std::string macroFileName)
{
  // Never interactive
 G4UIsession* session = 0;
...
std::string MedLinacSimulation::getOutputFilename()
{
  return "MedLinac.xml";
}
extern "C" 
DIANE::IG4Simulation* createG4Simulation(int seed) { return new MedLinacSimulation(seed); }
