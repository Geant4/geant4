...
private:
	DetectorConstruction* detPointer;

	G4UIcmdWithADoubleAndUnit* fieldSide;
	G4UIcmdWithADoubleAndUnit* sourceToSkinDistance;
	G4UIcmdWithADoubleAndUnit* phantomSide;
	G4UIcmdWithADoubleAndUnit* voxelSide;
	G4UIcmdWithADoubleAndUnit* voxelDepth;
};
