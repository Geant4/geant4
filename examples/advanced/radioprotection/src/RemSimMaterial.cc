...
void RemSimMaterial::DefineMaterials()
{
  ...
  kevlar -> AddElement(elH,0.0199);
  kevlar -> AddElement(elC,0.4733);
  kevlar -> AddElement(elO,0.1576);
  kevlar -> AddElement(elCl,0.3493);
}
