...
ThyroidPhysicsList::ThyroidPhysicsList():  G4VUserPhysicsList()
{
...
ThyroidPhysicsList::~ThyroidPhysicsList()
{
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo....

void ThyroidPhysicsList::ConstructParticle()
{
...
void ThyroidPhysicsList::ConstructBosons()
{ 
  // gamma
...
void ThyroidPhysicsList::ConstructLeptons()
{
  // leptons
...
void ThyroidPhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
}
...
void ThyroidPhysicsList::ConstructEM()
{
...
void ThyroidPhysicsList::SetCuts()
{
  if (verboseLevel >0){
    G4cout << "ThyroidPhysicsList::SetCuts:";
...
void ThyroidPhysicsList::SetGammaLowLimit(G4double lowcut)
{
  if (verboseLevel >0){
    G4cout << "ThyroidPhysicsList::SetCuts:";
...
void ThyroidPhysicsList::SetElectronLowLimit(G4double lowcut)
{
  if (verboseLevel >0){
...
void ThyroidPhysicsList::SetGELowLimit(G4double lowcut)
{
  if (verboseLevel >0){
    G4cout << "ThyroidPhysicsList::SetCuts:";
...
void ThyroidPhysicsList::SetGammaCut(G4double val)
{
  ResetCuts();
  cutForGamma = val;
}
...
void ThyroidPhysicsList::SetElectronCut(G4double val)
{
  //  ResetCuts();
  cutForElectron = val;
}
...
void ThyroidPhysicsList::SetPositronCut(G4double val)
{
  //  ResetCuts();
  cutForPositron = val;
}
...
void ThyroidPhysicsList::SetLowEnSecPhotCut(G4double cut){
...
void ThyroidPhysicsList::SetLowEnSecElecCut(G4double cut){
