...
G4VPhysicalVolume* G4MIRDLeftBreast::ConstructOrgan(G4VPhysicalVolume* mother, G4String sex, G4bool sensitivity, 
						    G4String volumeName, G4String logicalVolumeName, G4String colourName, G4bool wireFrame)
{
 ...
 /*
 G4UnionSolid* LeftBreastUnion =  new G4UnionSolid("LeftBreastUnion",
					       oneLeftBreast,oneLeftBreast,
					       0,
 ...
 */
 ...
 G4SubtractionSolid* breast = new G4SubtractionSolid("LeftBreast",
  ...
  G4LogicalVolume* logicLeftBreast = new G4LogicalVolume(breast, soft,logicalVolumeName, 0, 0,0);

    
  // Define rotation and position here!
  G4VPhysicalVolume* physLeftBreast = new G4PVPlacement(0,G4ThreeVector(8.63*cm, 46.87* cm, 8.4854 *cm),
      			       "physicalLeftBreast",
  			       logicLeftBreast,
			       mother,
			       false,
