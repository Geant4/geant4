...
G4ORNLUpperSpine::G4ORNLUpperSpine()
{
}
...
G4VPhysicalVolume* G4ORNLUpperSpine::ConstructUpperSpine(G4VPhysicalVolume* mother, G4String sex, G4bool sensitivity)
{
  // Initialize GDML Processor
  sxp.Initialize();
  config.SetURI( "gdmlData/"+sex+"/ORNLUpperSpine.gdml" );
  ...
  G4VisAttributes* UpperSpineVisAtt = new G4VisAttributes(G4Colour(1.0,1.0,0.0));
