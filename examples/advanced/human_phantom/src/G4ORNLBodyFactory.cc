...
G4VPhysicalVolume* G4ORNLBodyFactory::CreateLeftArmBone(G4VPhysicalVolume* motherVolume, G4String sex, G4bool sensitivity)
{
  G4ORNLLeftArmBone* armBone = new G4ORNLLeftArmBone();
  return armBone -> ConstructLeftArmBone(motherVolume, sex, sensitivity);
}
G4VPhysicalVolume* G4ORNLBodyFactory::CreateRightArmBone(G4VPhysicalVolume* motherVolume, G4String sex, G4bool sensitivity)
{
  G4ORNLRightArmBone* armBone = new G4ORNLRightArmBone();
