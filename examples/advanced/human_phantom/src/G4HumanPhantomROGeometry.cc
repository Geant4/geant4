...
//    ************************************
//
// $Id: G4HumanPhantomROGeometry.cc,v 1.1 2006-09-26 17:29:00 guatelli Exp $
...
G4HumanPhantomROGeometry::~G4HumanPhantomROGeometry()
{
}

G4VPhysicalVolume* G4HumanPhantomROGeometry::Build()
{
  ...
  G4Tubs* ROinnerBreast = new G4Tubs("inner_breast",
				   rmin, rmax,
				   zz/2., startPhi, spanningPhi);
  
  G4LogicalVolume* ROinnerBreast_log = new G4LogicalVolume(ROinnerBreast,
							dummyMat,
							"InnerBreast",
							 0, 0, 0);
 ...
 G4VPhysicalVolume* ROphysInnerBreast = new G4PVPlacement(matrix,
			       G4ThreeVector(8.63*cm, 46.87* cm, 8.4854 *cm),
  ...
  G4VPhysicalVolume* ROvoxelz_phys = new G4PVReplica("LinearArray", ROvoxelz_log, ROphysInnerBreast,
