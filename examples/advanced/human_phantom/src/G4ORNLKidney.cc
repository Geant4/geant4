...
G4VPhysicalVolume* G4ORNLKidney::ConstructKidney(G4VPhysicalVolume* mother, G4String sex, G4bool sensitivity)
{
  // Initialize GDML Processor
  sxp.Initialize();
  config.SetURI( "gdmlData/"+sex+"/ORNLKidney.gdml" );
