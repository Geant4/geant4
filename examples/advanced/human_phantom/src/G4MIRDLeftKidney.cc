...
G4VPhysicalVolume* G4MIRDLeftKidney::ConstructLeftKidney(G4VPhysicalVolume* mother, G4String sex, G4bool sensitivity)
{
 G4cout << "ConstructLeftKidney for " << sex << G4endl;
