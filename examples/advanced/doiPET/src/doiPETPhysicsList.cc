...
doiPETPhysicsList::doiPETPhysicsList():  G4VModularPhysicsList()
{
	SetVerboseLevel(1); 
	...
	decayPhysicsList = new G4DecayPhysics(); //decay physics
	raddecayList = new G4RadioactiveDecayPhysics(); //radioactive decay
...
void doiPETPhysicsList::ConstructParticle()
{
	decayPhysicsList -> ConstructParticle();
}

void doiPETPhysicsList::ConstructProcess()
{
	AddTransportation();
