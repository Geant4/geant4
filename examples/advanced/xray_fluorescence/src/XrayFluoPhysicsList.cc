...
XrayFluoPhysicsList::XrayFluoPhysicsList():  G4VUserPhysicsList()
{
...
void XrayFluoPhysicsList::ConstructMesons()
{
 //  mesons
...
void XrayFluoPhysicsList::ConstructBaryons()
{
//  barions
...
void XrayFluoPhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
G4double XrayFluoPhysicsList::GetCutForGamma() const
{
  return cutForGamma;
}
G4double XrayFluoPhysicsList::GetCutForElectron() const
{
  return cutForElectron;
}

G4double XrayFluoPhysicsList::GetCutForProton() const
{
  return cutForProton;
}
