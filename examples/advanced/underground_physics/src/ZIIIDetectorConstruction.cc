...
Glass->AddElement( elementO, 1.0 );
Glass->AddElement( elementSi, 0.5 );
...
Steel->AddElement( elementFe, 1.0 );
Steel->AddElement( elementCo, 0.1 );

// Materials from Scratch

G4Material* LXe = new G4Material("LXe", 54, 131.29*g/mole, 3.02*g/cm3,kStateLiquid, 173.15*kelvin, 1.5*atmosphere );
