...
//
//
// $Id: ZIIIPhysicsList.cc,v 1.4 2001-07-11 09:57:01 gunter Exp $
...
ZIIIPhysicsList::ZIIIPhysicsList():  G4VUserPhysicsList()
{
...
ZIIIPhysicsList::~ZIIIPhysicsList()
{
}

void ZIIIPhysicsList::ConstructParticle()
{
...
void ZIIIPhysicsList::ConstructProcess()
{
  AddTransportation();
...
void ZIIIPhysicsList::ConstructEM()
{
...
void ZIIIPhysicsList::ConstructHad()
{
...
#include "G4Decay.hh"
void ZIIIPhysicsList::ConstructGeneral()
{
  // Add Decay Process
...
void ZIIIPhysicsList::ConstructAllBosons()
{
...
void ZIIIPhysicsList::ConstructAllLeptons()
{
...
void ZIIIPhysicsList::ConstructAllMesons()
{
...
void ZIIIPhysicsList::ConstructAllBaryons()
{
...
void ZIIIPhysicsList::ConstructAllIons()
{
...
void ZIIIPhysicsList::ConstructAllShortLiveds()
{
