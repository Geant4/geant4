...
//
//
// File name:     RadmonPhysicsHadronsBertini.cc
// Creation date: Nov 2005
// Main author:   Riccardo Capra <capra@ge.infn.it>
//
// Id:            $Id: RadmonPhysicsHadronsBertini.cc,v 1.4 2006/06/29 16:18:45 gunter Exp $
...
RadmonVSubPhysicsListWithLabel *                RadmonPhysicsHadronsBertini :: New(void) const
{
 return new RadmonPhysicsHadronsBertini;
}



void                                            RadmonPhysicsHadronsBertini :: ConstructParticle(void)
{
...
void                                            RadmonPhysicsHadronsBertini :: ConstructProcess(void)
{
 // Models
 ...
 protonLEPModel->SetMinEnergy(2.8*GeV);
 ...
 pionPlusLEPModel->SetMinEnergy(2.8*GeV);
 ...
 pionMinusLEPModel->SetMinEnergy(2.8*GeV);
 ...
 G4BinaryLightIonReaction * alphaBertiniModel(new G4BinaryLightIonReaction());
 ...
 alphaInelasticProcess->RegisterMe(alphaBertiniModel);
 manager->AddDiscreteProcess(alphaInelasticProcess);
}



void                                            RadmonPhysicsHadronsBertini :: SetCuts(void)
{
}
...
const RadmonPhysicsInfoList &                   RadmonPhysicsHadronsBertini :: Provides(void) const
{
