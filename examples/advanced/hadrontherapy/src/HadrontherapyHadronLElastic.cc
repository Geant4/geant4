...
//
// HADRONIC ELASTIC SCATTERING WITH LEMODEL
//

HadrontherapyHadronLElastic::HadrontherapyHadronLElastic(const G4String& name): 
  G4VPhysicsConstructor(name)
{
  G4cout<<"****** Hadronic LElastic scattering is active !!!!!! ******"
	<<G4endl;
}

HadrontherapyHadronLElastic::~HadrontherapyHadronLElastic()
{}

void HadrontherapyHadronLElastic::ConstructProcess()
{
