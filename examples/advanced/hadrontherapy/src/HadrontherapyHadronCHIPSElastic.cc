...
//
// HADRONIC ELASTIC SCATTERING WITH CHIPS
//

HadrontherapyHadronCHIPSElastic::HadrontherapyHadronCHIPSElastic(const G4String& name): 
  G4VPhysicsConstructor(name)
{
  G4cout<<"****** Hadronic CHIPS Elastic scattering is active !!!!!! ******"
	<<G4endl;
}

HadrontherapyHadronCHIPSElastic::~HadrontherapyHadronCHIPSElastic()
{}

void HadrontherapyHadronCHIPSElastic::ConstructProcess()
{
 G4ParticleDefinition* particle = 0;
 G4ProcessManager* pmanager = 0;

 // Elastic scattering: CHIPS for p and n 
 //                     Low Energy Parameterised model (LElastic model)  for pi-, pi+, d, t, alpha
 
  G4QElastic* chipsElasticScattering = new G4QElastic();
  ...
  pmanager -> AddDiscreteProcess(chipsElasticScattering); 
