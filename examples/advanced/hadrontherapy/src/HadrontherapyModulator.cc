...
delete material;
 ...
 // Volume madre di tutto il modulatore
 ...
 G4ThreeVector positionMod18 = G4ThreeVector(0*cm,0*cm,-0.51*cm);
  ...
  //----------------------------------------------------------
  //Volume Madre  2/4 del Modulatore  Mod 20
  //----------------------------------------------------------
