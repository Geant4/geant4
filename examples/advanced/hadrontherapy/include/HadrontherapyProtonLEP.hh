...
// * cirrone@lns.infn.it
// ----------------------------------------------------------------------------
#ifndef HadrontherapyProtonLEP_h
#define HadrontherapyProtonLEP_h 1
...
class HadrontherapyProtonLEP: public G4VPhysicsConstructor 
{
 public:
   HadrontherapyProtonLEP(const G4String& name = "proton-LEP");
   virtual ~HadrontherapyProtonLEP();
