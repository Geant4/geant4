...
// * cirrone@lns.infn.it
// ----------------------------------------------------------------------------
#ifndef HadrontherapyProtonBertiniElastic_h
#define HadrontherapyProtonBertiniElastic_h 1
...
class HadrontherapyProtonBertiniElastic: public G4VPhysicsConstructor 
{
 public:
   HadrontherapyProtonBertiniElastic(const G4String& name = "proton-bertini-elastic");
   virtual ~HadrontherapyProtonBertiniElastic();
