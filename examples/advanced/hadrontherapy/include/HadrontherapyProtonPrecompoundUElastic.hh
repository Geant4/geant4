...
#ifndef HadrontherapyProtonPrecompoundUElastic_h
#define HadrontherapyProtonPrecompoundUElastic_h 1
...
class HadrontherapyProtonPrecompoundUElastic: public G4VPhysicsConstructor 
{
public:
  HadrontherapyProtonPrecompoundUElastic(const G4String& name = "proton-precompound-uelastic");
  virtual ~HadrontherapyProtonPrecompoundUElastic();
