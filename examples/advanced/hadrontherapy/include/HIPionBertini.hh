...
#ifndef HIPIONBERTINI_H
#define HIPIONBERTINI_H 1

#include "G4VPhysicsConstructor.hh"
#include "globals.hh" 

class HIPionBertini: public G4VPhysicsConstructor 
{
 public:
   HIPionBertini(const G4String& name = "Pion-Bertini");
   virtual ~HIPionBertini();
