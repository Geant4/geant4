...
MACRO(GEANT4_GLOBAL_LIBRARY_TARGET)
    ...
    foreach(_comp ${G4GLOBLIB_COMPONENTS})
        ...
        list(APPEND ${G4GLOBLIB_NAME}_SOURCES ${${G4MODULENAME}_SOURCES})
        list(APPEND ${G4GLOBLIB_NAME}_HEADERS ${${G4MODULENAME}_HEADERS})
    ...
    GEANT4_LIBRARY_TARGET(NAME ${G4GLOBLIB_NAME} 
        SOURCES ${${G4GLOBLIB_NAME}_SOURCES} ${${G4GLOBLIB_NAME}_HEADERS}
        GEANT4_LINK_LIBRARIES ${${G4GLOBLIB_NAME}_GLOBAL_DEPENDENCIES}
        LINK_LIBRARIES ${${G4GLOBLIB_NAME}_LINK_LIBRARIES})

    # Header install?
    install(FILES ${${G4GLOBLIB_NAME}_HEADERS}
        DESTINATION include/${CMAKE_PROJECT_NAME}
        COMPONENT headers)
ENDMACRO()
